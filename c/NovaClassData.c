...
spectra_tree_nodes_vtable_Accessible spectra_tree_nodes_vtable_Accessible_value_default = {0,0,0,0};
...
spectra_tree_nodes_annotations_vtable_Modifier spectra_tree_nodes_annotations_vtable_Modifier_value_default = {0,0,0};
spectra_tree_nodes_annotations_vtable_VisibilityModifier spectra_tree_nodes_annotations_vtable_VisibilityModifier_value_default = {0};
