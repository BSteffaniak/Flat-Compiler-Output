...
nova_operators_vtable_GreaterThanOperator nova_operators_vtable_GreaterThanOperator_value_default = {0};
nova_operators_vtable_GreaterThanOrEqualToOperator nova_operators_vtable_GreaterThanOrEqualToOperator_value_default = {0};
nova_operators_vtable_LessThanOperator nova_operators_vtable_LessThanOperator_value_default = {0};
nova_operators_vtable_LessThanOrEqualToOperator nova_operators_vtable_LessThanOrEqualToOperator_value_default = {0};
