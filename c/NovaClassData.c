...
compiler_tree_nodes_functions_vtable_CallableFunction compiler_tree_nodes_functions_vtable_CallableFunction_value_default = {0,0,0};
compiler_tree_nodes_generics_vtable_GenericCompatible compiler_tree_nodes_generics_vtable_GenericCompatible_value_default = {0,0};
compiler_tree_nodes_operations_vtable_Assignable compiler_tree_nodes_operations_vtable_Assignable_value_default = {0};
