#pragma once
#ifndef FILE_compiler_tree_Nova_AnnotationSearchResult_NOVA
#define FILE_compiler_tree_Nova_AnnotationSearchResult_NOVA

typedef struct compiler_tree_Nova_AnnotationSearchResult compiler_tree_Nova_AnnotationSearchResult;
...
typedef struct compiler_tree_AnnotationSearchResult_Extension_VTable compiler_tree_AnnotationSearchResult_Extension_VTable;
struct compiler_tree_AnnotationSearchResult_Extension_VTable
{
...
extern compiler_tree_AnnotationSearchResult_Extension_VTable compiler_tree_AnnotationSearchResult_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_Nova_AnnotationSearchResult, 
	
	compiler_tree_AnnotationSearchResult_Extension_VTable* vtable;
	nova_datastruct_list_Nova_Array* compiler_tree_Nova_AnnotationSearchResult_Nova_annotations;
	nova_Nova_String* compiler_tree_Nova_AnnotationSearchResult_Nova_remainingStatement;
)
