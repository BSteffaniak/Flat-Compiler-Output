...
compiler_tree_node_closures_ClosureDeclaration_Extension_VTable compiler_tree_node_closures_ClosureDeclaration_Extension_VTable_val =
{
	{
		0,
		0,
...
{
	CCLASS_NEW(compiler_tree_node_closures_Nova_ClosureDeclaration, this,);
	this->vtable = &compiler_tree_node_closures_ClosureDeclaration_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	compiler_tree_node_Nova_Node_Nova_super((compiler_tree_node_Nova_Node*)this, exceptionData);
	compiler_tree_node_closures_Nova_ClosureDeclaration_Nova_super(this, exceptionData);
	
	{
		compiler_tree_node_closures_Nova_ClosureDeclaration_Nova_this(this, exceptionData);
	}
