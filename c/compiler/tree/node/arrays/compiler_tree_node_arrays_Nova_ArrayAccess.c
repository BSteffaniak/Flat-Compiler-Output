...
compiler_tree_node_arrays_ArrayAccess_Extension_VTable compiler_tree_node_arrays_ArrayAccess_Extension_VTable_val =
{
	{
		0,
		0,
...
{
	CCLASS_NEW(compiler_tree_node_arrays_Nova_ArrayAccess, this,);
	this->vtable = &compiler_tree_node_arrays_ArrayAccess_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	compiler_tree_node_Nova_Node_Nova_super((compiler_tree_node_Nova_Node*)this, exceptionData);
	compiler_tree_node_arrays_Nova_ArrayAccess_Nova_super(this, exceptionData);
	
	{
		compiler_tree_node_arrays_Nova_ArrayAccess_Nova_this(this, exceptionData, parent, location);
	}
...
compiler_tree_node_arrays_Nova_ArrayAccess* compiler_tree_node_arrays_Nova_ArrayAccess_Nova_parse(compiler_tree_node_arrays_Nova_ArrayAccess* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_node_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	{
		compiler_tree_node_arrays_Nova_ArrayAccess* l1_Nova_node = (compiler_tree_node_arrays_Nova_ArrayAccess*)nova_null;
		
		l1_Nova_node = compiler_tree_node_arrays_Nova_ArrayAccess_Nova_construct(0, exceptionData, parent, location);
		if (1)
		{
			return l1_Nova_node;
		}
	}
	return (compiler_tree_node_arrays_Nova_ArrayAccess*)(nova_Nova_Object*)nova_null;
}
