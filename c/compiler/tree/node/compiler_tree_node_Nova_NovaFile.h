...
struct compiler_tree_node_NovaFile_Extension_VTable
{
	...
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(compiler_tree_node_Nova_NovaFile*, nova_exception_Nova_ExceptionData*);
	long_long (*nova_Nova_Object_virtual_Accessor_Nova_hashCodeLong)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*);
	compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_virtual_Nova_parseChild)(compiler_tree_node_Nova_NovaFile*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
	...
	compiler_tree_node_Nova_NovaFile* (*compiler_tree_node_Nova_Node_virtual_Accessor_Nova_parentFile)(compiler_tree_node_Nova_NovaFile*, nova_exception_Nova_ExceptionData*);
...
(
	...
	compiler_tree_node_Nova_ImportList* compiler_tree_node_Nova_NovaFile_Nova_importList;
