...
compiler_tree_node_Skeleton_Extension_VTable compiler_tree_node_Skeleton_Extension_VTable_val =
{
	{
		0,
		0,
...
{
	CCLASS_NEW(compiler_tree_node_Nova_Skeleton, this,);
	this->vtable = &compiler_tree_node_Skeleton_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	compiler_tree_node_Nova_Node_Nova_super((compiler_tree_node_Nova_Node*)this, exceptionData);
	compiler_tree_node_Nova_Skeleton_Nova_super(this, exceptionData);
	
	{
		compiler_tree_node_Nova_Skeleton_Nova_this(this, exceptionData, parent, location);
	}
...
compiler_tree_node_Nova_Skeleton* compiler_tree_node_Nova_Skeleton_static_Nova_tryParse(compiler_tree_node_Nova_Skeleton* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_node_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	if (1)
	{
		compiler_tree_node_Nova_Skeleton* l1_Nova_node = (compiler_tree_node_Nova_Skeleton*)nova_null;
		
		l1_Nova_node = compiler_tree_node_Nova_Skeleton_Nova_construct(0, exceptionData, parent, location);
		return l1_Nova_node;
	}
	return (compiler_tree_node_Nova_Skeleton*)(nova_Nova_Object*)nova_null;
}
