...
compiler_tree_node_variables_LocalDeclaration_Extension_VTable compiler_tree_node_variables_LocalDeclaration_Extension_VTable_val =
{
	{
		0,
		0,
	...
	compiler_tree_node_variables_Nova_LocalDeclaration_static_Nova_parse,
...
void compiler_tree_node_variables_Nova_LocalDeclaration_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

compiler_tree_node_variables_Nova_LocalDeclaration* compiler_tree_node_variables_Nova_LocalDeclaration_Nova_construct(compiler_tree_node_variables_Nova_LocalDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_node_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	CCLASS_NEW(compiler_tree_node_variables_Nova_LocalDeclaration, this,);
	this->vtable = &compiler_tree_node_variables_LocalDeclaration_Extension_VTable_val;
	...
	compiler_tree_node_variables_Nova_LocalDeclaration_Nova_super(this, exceptionData);
	
	{
		compiler_tree_node_variables_Nova_LocalDeclaration_Nova_this(this, exceptionData, parent, location);
	}
	
	return this;
}

void compiler_tree_node_variables_Nova_LocalDeclaration_Nova_destroy(compiler_tree_node_variables_Nova_LocalDeclaration** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void compiler_tree_node_variables_Nova_LocalDeclaration_Nova_this(compiler_tree_node_variables_Nova_LocalDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_node_Nova_Node* parent, compiler_util_Nova_Location* location)
{
...
compiler_tree_node_variables_Nova_LocalDeclaration* compiler_tree_node_variables_Nova_LocalDeclaration_static_Nova_parse(compiler_tree_node_variables_Nova_LocalDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_node_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	{
		compiler_tree_node_variables_Nova_LocalDeclaration* l1_Nova_node = (compiler_tree_node_variables_Nova_LocalDeclaration*)nova_null;
		
		l1_Nova_node = compiler_tree_node_variables_Nova_LocalDeclaration_Nova_construct(0, exceptionData, parent, location);
		return (compiler_tree_node_variables_Nova_LocalDeclaration*)compiler_tree_node_variables_Nova_VariableDeclaration_Nova_cloneTo(l1_Nova_declaration, exceptionData, (compiler_tree_node_variables_Nova_VariableDeclaration*)(l1_Nova_node));
	}
	return (compiler_tree_node_variables_Nova_LocalDeclaration*)(nova_Nova_Object*)nova_null;
}

void compiler_tree_node_variables_Nova_LocalDeclaration_Nova_super(compiler_tree_node_variables_Nova_LocalDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
