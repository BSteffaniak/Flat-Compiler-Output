...
struct compiler_tree_node_NovaClass_Extension_VTable
{
	...
	compiler_tree_node_Nova_NovaClass* (*compiler_tree_node_Nova_Node_virtual_Accessor_func_Nova_parentClass)(compiler_tree_node_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
};
...
compiler_tree_node_Nova_NovaClass* compiler_tree_node_Nova_NovaClass_Nova_construct(compiler_tree_node_Nova_NovaClass* this, nova_exception_Nova_ExceptionData* exceptionData);
...
void compiler_tree_node_Nova_NovaClass_Nova_this(compiler_tree_node_Nova_NovaClass* this, nova_exception_Nova_ExceptionData* exceptionData);
compiler_tree_node_Nova_NovaClass* compiler_tree_node_Nova_NovaClass_Accessor_func_Nova_parentClass(compiler_tree_node_Nova_NovaClass* this, nova_exception_Nova_ExceptionData* exceptionData);
