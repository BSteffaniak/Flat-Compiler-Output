...
compiler_tree_node_exceptionhandling_ExceptionHandler_Extension_VTable compiler_tree_node_exceptionhandling_ExceptionHandler_Extension_VTable_val =
{
	{
		0,
		0,
...
compiler_tree_node_exceptionhandling_Nova_ExceptionHandler* compiler_tree_node_exceptionhandling_Nova_ExceptionHandler_Nova_construct(compiler_tree_node_exceptionhandling_Nova_ExceptionHandler* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &compiler_tree_node_exceptionhandling_ExceptionHandler_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	compiler_tree_node_Nova_Node_Nova_super((compiler_tree_node_Nova_Node*)this, exceptionData);
	compiler_tree_node_exceptionhandling_Nova_ExceptionHandler_Nova_super(this, exceptionData);
	
	{
		compiler_tree_node_exceptionhandling_Nova_ExceptionHandler_Nova_this(this, exceptionData);
	}
