#pragma once
#ifndef FILE_compiler_tree_node_Nova_Identifier_NOVA
#define FILE_compiler_tree_node_Nova_Identifier_NOVA

typedef struct compiler_tree_node_Nova_Identifier compiler_tree_node_Nova_Identifier;
...
typedef struct compiler_tree_node_Identifier_Extension_VTable compiler_tree_node_Identifier_Extension_VTable;
struct compiler_tree_node_Identifier_Extension_VTable
{
	...
	compiler_tree_node_Nova_Identifier* (*compiler_tree_node_Nova_Node_virtual_Nova_cloneTo)(compiler_tree_node_Nova_Identifier*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Identifier*);
	...
	compiler_tree_node_Nova_Identifier* (*compiler_tree_node_Nova_Identifier_virtual_static_Nova_parse)(compiler_tree_node_Nova_Identifier*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
};

extern compiler_tree_node_Identifier_Extension_VTable compiler_tree_node_Identifier_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_node_Nova_Identifier, 
	
	compiler_tree_node_Identifier_Extension_VTable* vtable;
