#pragma once
#ifndef FILE_compiler_tree_node_Nova_NodeList_NOVA
#define FILE_compiler_tree_node_Nova_NodeList_NOVA

typedef struct compiler_tree_node_Nova_NodeList compiler_tree_node_Nova_NodeList;
...
typedef struct compiler_tree_node_NodeList_Extension_VTable compiler_tree_node_NodeList_Extension_VTable;
struct compiler_tree_node_NodeList_Extension_VTable
{
...
extern compiler_tree_node_NodeList_Extension_VTable compiler_tree_node_NodeList_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_node_Nova_NodeList, 
	
	compiler_tree_node_NodeList_Extension_VTable* vtable;
...
void compiler_tree_node_Nova_NodeList_Nova_destroy(compiler_tree_node_Nova_NodeList** this, nova_exception_Nova_ExceptionData* exceptionData);
