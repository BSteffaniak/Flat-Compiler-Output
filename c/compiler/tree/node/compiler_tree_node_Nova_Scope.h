...
typedef struct compiler_tree_node_Scope_Extension_VTable compiler_tree_node_Scope_Extension_VTable;
struct compiler_tree_node_Scope_Extension_VTable
{
	nova_Interface_VTable itable;
	char (*nova_operators_Nova_Equals_virtual_Nova_equals)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*);
	long_long (*nova_Nova_Object_virtual_Accessor_Nova_hashCodeLong)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*);
	compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_virtual_Nova_parseChild)(compiler_tree_node_Nova_Scope*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
...
extern compiler_tree_node_Scope_Extension_VTable compiler_tree_node_Scope_Extension_VTable_val;
...
(
	...
	compiler_tree_node_Scope_Extension_VTable* vtable;
