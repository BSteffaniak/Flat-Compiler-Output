...
struct compiler_tree_node_Program_Extension_VTable
{
	...
	compiler_tree_node_Nova_Program* (*compiler_tree_node_Nova_Node_virtual_Accessor_func_Nova_program)(compiler_tree_node_Nova_Program*, nova_exception_Nova_ExceptionData*);
