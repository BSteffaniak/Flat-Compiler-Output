#pragma once
#ifndef FILE_compiler_tree_node_Nova_Skeleton_NOVA
#define FILE_compiler_tree_node_Nova_Skeleton_NOVA

typedef struct compiler_tree_node_Nova_Skeleton compiler_tree_node_Nova_Skeleton;
...
typedef struct compiler_tree_node_Skeleton_Extension_VTable compiler_tree_node_Skeleton_Extension_VTable;
struct compiler_tree_node_Skeleton_Extension_VTable
{
...
extern compiler_tree_node_Skeleton_Extension_VTable compiler_tree_node_Skeleton_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_node_Nova_Skeleton, 
	
	compiler_tree_node_Skeleton_Extension_VTable* vtable;
...
void compiler_tree_node_Nova_Skeleton_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData);
