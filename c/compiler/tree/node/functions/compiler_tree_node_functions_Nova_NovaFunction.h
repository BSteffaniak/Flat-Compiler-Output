...
struct compiler_tree_node_functions_NovaFunction_Extension_VTable
{
	...
	compiler_tree_node_functions_Nova_NovaFunction* (*compiler_tree_node_Nova_Node_virtual_Accessor_func_Nova_parentFunction)(compiler_tree_node_functions_Nova_NovaFunction*, nova_exception_Nova_ExceptionData*);
