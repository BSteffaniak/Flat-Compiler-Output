#pragma once
#ifndef FILE_compiler_tree_node_functions_Nova_BodyFunction_NOVA
#define FILE_compiler_tree_node_functions_Nova_BodyFunction_NOVA

typedef struct compiler_tree_node_functions_Nova_BodyFunction compiler_tree_node_functions_Nova_BodyFunction;
...
typedef struct compiler_tree_node_functions_BodyFunction_Extension_VTable compiler_tree_node_functions_BodyFunction_Extension_VTable;
struct compiler_tree_node_functions_BodyFunction_Extension_VTable
{
	...
	compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_virtual_Nova_parseChild)(compiler_tree_node_functions_Nova_BodyFunction*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
	...
	compiler_tree_node_functions_Nova_BodyFunction* (*compiler_tree_node_Nova_Identifier_virtual_static_Nova_parse)(compiler_tree_node_functions_Nova_BodyFunction*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, int);
...
extern compiler_tree_node_functions_BodyFunction_Extension_VTable compiler_tree_node_functions_BodyFunction_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_node_functions_Nova_BodyFunction, 
	
	compiler_tree_node_functions_BodyFunction_Extension_VTable* vtable;
	...
	compiler_tree_node_Nova_Scope* compiler_tree_node_functions_Nova_BodyFunction_Nova_scope;
)
