...
compiler_tree_nodes_PlaceholderValue_Extension_VTable compiler_tree_nodes_PlaceholderValue_Extension_VTable_val =
{
	...
	compiler_tree_nodes_Nova_PlaceholderValue_Nova_addChild,
...
nova_Nova_String* compiler_tree_nodes_Nova_PlaceholderValue_Nova_lambda39(compiler_tree_nodes_Nova_PlaceholderValue* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_PlaceholderValue* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
...
void compiler_tree_nodes_Nova_PlaceholderValue_Nova_destroy(compiler_tree_nodes_Nova_PlaceholderValue** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	compiler_tree_nodes_Nova_NodeList_Nova_destroy(&(*this)->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes, exceptionData);
...
void compiler_tree_nodes_Nova_PlaceholderValue_Nova_addChild(compiler_tree_nodes_Nova_PlaceholderValue* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* child)
{
	...
	{
		compiler_tree_nodes_Nova_NodeList* l1_Nova_nova_local_0 = (compiler_tree_nodes_Nova_NodeList*)nova_null;
		
		this->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes = (compiler_tree_nodes_Nova_NodeList*)((l1_Nova_nova_local_0 = this->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes) != (compiler_tree_nodes_Nova_NodeList*)nova_null ? l1_Nova_nova_local_0 : compiler_tree_nodes_Nova_NodeList_Nova_construct(0, exceptionData, (compiler_tree_nodes_Nova_Node*)(this), this->compiler_tree_nodes_Nova_Node_Nova_location));
		nova_datastruct_list_Nova_Array_0_Nova_add((nova_datastruct_list_Nova_Array*)(this->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes->compiler_tree_nodes_Nova_NodeList_Nova_children), exceptionData, (nova_Nova_Object*)((compiler_tree_nodes_Nova_PlaceholderValue*)child));
		compiler_tree_nodes_Nova_Node_Nova_addChild((compiler_tree_nodes_Nova_Node*)(((compiler_tree_nodes_Nova_Value*)this)), exceptionData, child);
	}
	else
	{
		THROW(nova_exception_Nova_Exception_Nova_construct(0, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Invalid child '"))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((child)), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("' added to placeholder value"))))), 0);
	}
}
...
nova_Nova_String* compiler_tree_nodes_Nova_PlaceholderValue_Nova_writeChildren(compiler_tree_nodes_Nova_PlaceholderValue* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	Context1 contextArg39 = 
	{
	};
	
	return (nova_Nova_String*)(this->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes != (compiler_tree_nodes_Nova_NodeList*)nova_null ? nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(this->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes->compiler_tree_nodes_Nova_NodeList_Nova_children), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&compiler_tree_nodes_Nova_PlaceholderValue_Nova_lambda39, this, &contextArg39))), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")));
}
...
void compiler_tree_nodes_Nova_PlaceholderValue_Nova_super(compiler_tree_nodes_Nova_PlaceholderValue* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->compiler_tree_nodes_Nova_PlaceholderValue_Nova_nodes = (compiler_tree_nodes_Nova_NodeList*)nova_null;
}
