#pragma once
#ifndef FILE_compiler_tree_nodes_arrays_Nova_ArrayAccess_NOVA
#define FILE_compiler_tree_nodes_arrays_Nova_ArrayAccess_NOVA

typedef struct compiler_tree_nodes_arrays_Nova_ArrayAccess compiler_tree_nodes_arrays_Nova_ArrayAccess;
...
typedef struct compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable;
struct compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_arrays_Nova_ArrayAccess*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_arrays_Nova_ArrayAccess, 
	
	compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable* vtable;
	...
	nova_datastruct_list_Nova_Array* compiler_tree_nodes_arrays_Nova_ArrayAccess_Nova_dimensions;
)
...
nova_Nova_String* compiler_tree_nodes_arrays_Nova_ArrayAccess_Nova_writeNova(compiler_tree_nodes_arrays_Nova_ArrayAccess* this, nova_exception_Nova_ExceptionData* exceptionData);
