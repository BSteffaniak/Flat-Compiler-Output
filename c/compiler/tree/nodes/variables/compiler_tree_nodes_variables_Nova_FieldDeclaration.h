...
struct compiler_tree_nodes_variables_FieldDeclaration_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_variables_Nova_FieldDeclaration*, nova_exception_Nova_ExceptionData*);
...
(
	...
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_variables_Nova_FieldDeclaration_Nova_accessorValue;
	char compiler_tree_nodes_variables_Nova_FieldDeclaration_Nova_isTwoWayAccessor;
)
