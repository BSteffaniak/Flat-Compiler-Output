...
struct compiler_tree_nodes_variables_InstanceDeclaration_Extension_VTable
{
	...
	compiler_tree_nodes_variables_Nova_InstanceDeclaration* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
