...
compiler_tree_nodes_variables_Variable_Extension_VTable compiler_tree_nodes_variables_Variable_Extension_VTable_val =
{
	...
	compiler_tree_nodes_variables_Nova_Variable_Nova_toString,
...
nova_Nova_String* compiler_tree_nodes_variables_Nova_Variable_Nova_toString(compiler_tree_nodes_variables_Nova_Variable* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
{
	return (nova_Nova_String*)compiler_tree_nodes_Nova_Value_virtual_Accessorfunc_Nova_type((compiler_tree_nodes_Nova_Value*)(this->compiler_tree_nodes_variables_Nova_Variable_Nova_declaration), exceptionData);
}
