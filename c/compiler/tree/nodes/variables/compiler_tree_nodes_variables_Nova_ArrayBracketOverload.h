...
struct compiler_tree_nodes_variables_ArrayBracketOverload_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_variables_Nova_ArrayBracketOverload*, nova_exception_Nova_ExceptionData*);
