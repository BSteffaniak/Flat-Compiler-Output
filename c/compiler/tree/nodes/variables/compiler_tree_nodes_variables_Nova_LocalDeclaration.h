...
struct compiler_tree_nodes_variables_LocalDeclaration_Extension_VTable
{
	...
	compiler_tree_nodes_variables_Nova_LocalDeclaration* (*compiler_tree_nodes_Nova_Value_virtual_static_Nova_parse)(compiler_tree_nodes_variables_Nova_LocalDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
