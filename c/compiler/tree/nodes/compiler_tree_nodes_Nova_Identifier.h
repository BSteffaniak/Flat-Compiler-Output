#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_Identifier_NOVA
#define FILE_compiler_tree_nodes_Nova_Identifier_NOVA

typedef struct compiler_tree_nodes_Nova_Identifier compiler_tree_nodes_Nova_Identifier;
...
typedef struct compiler_tree_nodes_Identifier_Extension_VTable compiler_tree_nodes_Identifier_Extension_VTable;
struct compiler_tree_nodes_Identifier_Extension_VTable
{
	nova_Nova_Class* classInstance;
	nova_Interface_VTable itable;
	char (*nova_operators_Nova_Equals_virtual_Nova_equals)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(compiler_tree_nodes_Nova_Identifier*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_Nova_Identifier* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_Nova_Identifier*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
extern compiler_tree_nodes_Identifier_Extension_VTable compiler_tree_nodes_Identifier_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_Nova_Identifier, 
	
	compiler_tree_nodes_Identifier_Extension_VTable* vtable;
	...
	char compiler_tree_nodes_Nova_Identifier_Nova_safeNavigation;
	compiler_tree_nodes_Nova_Identifier* compiler_tree_nodes_Nova_Identifier_Nova_accessedNode;
