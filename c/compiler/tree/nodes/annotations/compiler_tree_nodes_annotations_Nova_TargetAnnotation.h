...
struct compiler_tree_nodes_annotations_TargetAnnotation_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_annotations_Nova_TargetAnnotation*, nova_exception_Nova_ExceptionData*);
