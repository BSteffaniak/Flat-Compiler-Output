...
compiler_tree_nodes_InterfaceDeclaration_Extension_VTable compiler_tree_nodes_InterfaceDeclaration_Extension_VTable_val =
{
	0,
	{
		0,
...
void compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

compiler_tree_nodes_Nova_InterfaceDeclaration* compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_construct(compiler_tree_nodes_Nova_InterfaceDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(compiler_tree_nodes_Nova_InterfaceDeclaration, this,);
	this->vtable = &compiler_tree_nodes_InterfaceDeclaration_Extension_VTable_val;
	...
	compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_super(this, exceptionData);
	
	{
		compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_this(this, exceptionData);
	}
	
	return this;
}

void compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_destroy(compiler_tree_nodes_Nova_InterfaceDeclaration** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_this(compiler_tree_nodes_Nova_InterfaceDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void compiler_tree_nodes_Nova_InterfaceDeclaration_Nova_super(compiler_tree_nodes_Nova_InterfaceDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
