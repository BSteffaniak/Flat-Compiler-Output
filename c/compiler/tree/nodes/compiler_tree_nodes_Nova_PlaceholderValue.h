#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_PlaceholderValue_NOVA
#define FILE_compiler_tree_nodes_Nova_PlaceholderValue_NOVA

typedef struct compiler_tree_nodes_Nova_PlaceholderValue compiler_tree_nodes_Nova_PlaceholderValue;
...
typedef struct compiler_tree_nodes_PlaceholderValue_Extension_VTable compiler_tree_nodes_PlaceholderValue_Extension_VTable;
struct compiler_tree_nodes_PlaceholderValue_Extension_VTable
{
	...
	void (*compiler_tree_nodes_Nova_Node_virtual_Nova_addChild)(compiler_tree_nodes_Nova_PlaceholderValue*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_Nova_Node*);
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_PlaceholderValue*, nova_exception_Nova_ExceptionData*);
	compiler_tree_nodes_Nova_Scope* (*compiler_tree_nodes_Nova_Node_virtual_Mutator_Nova_scope)(compiler_tree_nodes_Nova_PlaceholderValue*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_Nova_Scope*);
	...
	compiler_tree_nodes_Nova_Scope* (*compiler_tree_nodes_Nova_Node_virtual_Accessor_Nova_scope)(compiler_tree_nodes_Nova_PlaceholderValue*, nova_exception_Nova_ExceptionData*);
	compiler_tree_nodes_Nova_PlaceholderValue* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_Nova_PlaceholderValue*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
extern compiler_tree_nodes_PlaceholderValue_Extension_VTable compiler_tree_nodes_PlaceholderValue_Extension_VTable_val;
...
(
	...
	compiler_tree_nodes_PlaceholderValue_Extension_VTable* vtable;
	...
	compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_Nova_PlaceholderValue_Nova_scope;
)
...
compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_Nova_PlaceholderValue_Accessorfunc_Nova_scope(compiler_tree_nodes_Nova_PlaceholderValue* this, nova_exception_Nova_ExceptionData* exceptionData);
compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_Nova_PlaceholderValue_Mutatorfunc_Nova_scope(compiler_tree_nodes_Nova_PlaceholderValue* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Scope* value);
