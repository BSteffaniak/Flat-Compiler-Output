...
nova_Nova_String* compiler_tree_nodes_generics_Nova_GenericCompatible_Nova_testLambda24(compiler_tree_nodes_generics_Nova_GenericCompatible* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_generics_Nova_GenericParameter* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
compiler_tree_nodes_generics_Nova_GenericParameter* compiler_tree_nodes_generics_Nova_GenericCompatible_Nova_testLambda117(compiler_tree_nodes_generics_Nova_GenericCompatible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
char compiler_tree_nodes_generics_Nova_GenericCompatible_Nova_testLambda118(compiler_tree_nodes_generics_Nova_GenericCompatible* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_generics_Nova_GenericParameter* _1, Context3* context);
...
char compiler_tree_nodes_generics_Nova_GenericCompatible_Nova_parseGenericParameters(compiler_tree_nodes_generics_Nova_GenericCompatible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, int requireWholeString)
{
	...
	if (l1_Nova_genericIndex >= 0 && (!requireWholeString || l1_Nova_genericIndex == 0))
	{
		...
		if (l2_Nova_end > 0 && (!requireWholeString || l2_Nova_end == input->nova_Nova_String_Nova_count - 1))
		{
			...
			l3_Nova_params = (nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(compiler_util_Nova_CompilerStringFunctions_Nova_splitAtCommas(l3_Nova_contents, exceptionData, (intptr_t)nova_null, (intptr_t)nova_null)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&compiler_tree_nodes_generics_Nova_GenericCompatible_Nova_testLambda117, this, &contextArg117));
