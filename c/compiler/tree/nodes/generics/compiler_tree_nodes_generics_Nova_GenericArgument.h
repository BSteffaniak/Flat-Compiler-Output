...
struct compiler_tree_nodes_generics_GenericArgument_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_generics_Nova_GenericArgument*, nova_exception_Nova_ExceptionData*);
...
nova_Nova_String* compiler_tree_nodes_generics_Nova_GenericArgument_Nova_writeNova(compiler_tree_nodes_generics_Nova_GenericArgument* this, nova_exception_Nova_ExceptionData* exceptionData);
