#pragma once
#ifndef FILE_compiler_tree_nodes_generics_Nova_GenericParameter_NOVA
#define FILE_compiler_tree_nodes_generics_Nova_GenericParameter_NOVA

typedef struct compiler_tree_nodes_generics_Nova_GenericParameter compiler_tree_nodes_generics_Nova_GenericParameter;
...
typedef struct compiler_tree_nodes_generics_GenericParameter_Extension_VTable compiler_tree_nodes_generics_GenericParameter_Extension_VTable;
struct compiler_tree_nodes_generics_GenericParameter_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_generics_Nova_GenericParameter*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_generics_GenericParameter_Extension_VTable compiler_tree_nodes_generics_GenericParameter_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_generics_Nova_GenericParameter, 
	
	compiler_tree_nodes_generics_GenericParameter_Extension_VTable* vtable;
...
nova_Nova_String* compiler_tree_nodes_generics_Nova_GenericParameter_Nova_toNova(compiler_tree_nodes_generics_Nova_GenericParameter* this, nova_exception_Nova_ExceptionData* exceptionData);
