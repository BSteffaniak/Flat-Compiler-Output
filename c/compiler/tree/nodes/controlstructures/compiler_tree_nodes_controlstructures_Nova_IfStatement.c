...
compiler_tree_nodes_controlstructures_IfStatement_Extension_VTable compiler_tree_nodes_controlstructures_IfStatement_Extension_VTable_val =
{
	0,
	{
		0,
	...
	compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_writeNova,
...
void compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

compiler_tree_nodes_controlstructures_Nova_IfStatement* compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_construct(compiler_tree_nodes_controlstructures_Nova_IfStatement* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	CCLASS_NEW(compiler_tree_nodes_controlstructures_Nova_IfStatement, this,);
	this->vtable = &compiler_tree_nodes_controlstructures_IfStatement_Extension_VTable_val;
	...
	compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_super(this, exceptionData);
	
	{
		compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_this(this, exceptionData, parent, location);
	}
	
	return this;
}

void compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_destroy(compiler_tree_nodes_controlstructures_Nova_IfStatement** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
	...
	compiler_tree_nodes_Nova_Value_Nova_destroy(&(*this)->compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_condition, exceptionData);
	
	NOVA_FREE(*this);
}

void compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_this(compiler_tree_nodes_controlstructures_Nova_IfStatement* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
...
compiler_tree_nodes_controlstructures_Nova_IfStatement* compiler_tree_nodes_controlstructures_Nova_IfStatement_static_Nova_parse(compiler_tree_nodes_controlstructures_Nova_IfStatement* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	parent = (compiler_tree_nodes_Nova_Node*)(parent == 0 ? (nova_Nova_Object*)(nova_Nova_Object*)nova_null : (nova_Nova_Object*)parent);
	location = (compiler_util_Nova_Location*)(location == 0 ? (nova_Nova_Object*)compiler_util_Nova_Location_Nova_INVALID : (nova_Nova_Object*)location);
	require = (int)(require == (intptr_t)nova_null ? 1 : require);
	if (nova_Nova_String_Nova_equals(compiler_util_Nova_CompilerStringFunctions_Nova_nextWord(input, exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("if"))))
	{
...
nova_Nova_String* compiler_tree_nodes_controlstructures_Nova_IfStatement_Nova_writeNova(compiler_tree_nodes_controlstructures_Nova_IfStatement* this, nova_exception_Nova_ExceptionData* exceptionData)
{
