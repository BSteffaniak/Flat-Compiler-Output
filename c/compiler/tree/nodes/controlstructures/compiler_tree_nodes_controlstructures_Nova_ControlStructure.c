...
compiler_tree_nodes_controlstructures_ControlStructure_Extension_VTable compiler_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val =
{
	0,
	{
		0,
...
void compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
void compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_destroy(compiler_tree_nodes_controlstructures_Nova_ControlStructure** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
	...
	compiler_tree_nodes_Nova_Scope_Nova_destroy(&(*this)->compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_scope, exceptionData);
...
{
	return this->compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_scope;
}

compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_controlstructures_Nova_ControlStructure_Mutatorfunc_Nova_scope(compiler_tree_nodes_controlstructures_Nova_ControlStructure* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Scope* value)
{
	this->compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_scope = value;
	return value;
}

void compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_super(compiler_tree_nodes_controlstructures_Nova_ControlStructure* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	this->compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_scope = (compiler_tree_nodes_Nova_Scope*)nova_null;
}
