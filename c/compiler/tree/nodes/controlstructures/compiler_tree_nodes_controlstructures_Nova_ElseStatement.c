...
nova_Nova_String* compiler_tree_nodes_controlstructures_Nova_ElseStatement_Nova_writeNova(compiler_tree_nodes_controlstructures_Nova_ElseStatement* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("else "))), exceptionData, ((nova_Nova_String*)(this->compiler_tree_nodes_controlstructures_Nova_ElseStatement_Nova_inlineIf != (compiler_tree_nodes_controlstructures_Nova_IfStatement*)nova_null ? compiler_tree_nodes_Nova_Node_virtual_Nova_toNova((compiler_tree_nodes_Nova_Node*)(this->compiler_tree_nodes_controlstructures_Nova_ElseStatement_Nova_inlineIf), exceptionData) : compiler_tree_nodes_Nova_Node_virtual_Nova_toNova((compiler_tree_nodes_Nova_Node*)(compiler_tree_nodes_controlstructures_Nova_ElseStatement_Accessorfunc_Nova_scope(this, exceptionData)), exceptionData))));
}
