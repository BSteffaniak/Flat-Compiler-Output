...
struct compiler_tree_nodes_controlstructures_IfStatement_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_controlstructures_Nova_IfStatement*, nova_exception_Nova_ExceptionData*);
