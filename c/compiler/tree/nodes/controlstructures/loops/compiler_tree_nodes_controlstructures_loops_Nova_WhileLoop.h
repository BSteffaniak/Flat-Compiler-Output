#pragma once
#ifndef FILE_compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_NOVA
#define FILE_compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_NOVA

typedef struct compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop;
...
typedef struct compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable;
struct compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* (*compiler_tree_nodes_controlstructures_loops_Nova_Loop_virtual_static_Nova_parse)(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
};

extern compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val;
...
(
	...
	compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable* vtable;
	...
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_condition;
)
