...
compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val =
{
	0,
	{
		0,
	...
	compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_static_Nova_parse,
};



char compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_parseCondition(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input);
void compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_construct(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	CCLASS_NEW(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop, this,);
	this->vtable = &compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val;
	...
	compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_super(this, exceptionData);
	
	{
		compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_this(this, exceptionData, parent, location);
	}
	
	return this;
}

void compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_destroy(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
	...
	compiler_tree_nodes_Nova_Value_Nova_destroy(&(*this)->compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_condition, exceptionData);
	
	NOVA_FREE(*this);
}

void compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_this(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	parent = (compiler_tree_nodes_Nova_Node*)(parent == 0 ? (nova_Nova_Object*)(nova_Nova_Object*)nova_null : (nova_Nova_Object*)parent);
	location = (compiler_util_Nova_Location*)(location == 0 ? (nova_Nova_Object*)compiler_util_Nova_Location_Nova_INVALID : (nova_Nova_Object*)location);
	compiler_tree_nodes_controlstructures_Nova_ControlStructure_Nova_this((compiler_tree_nodes_controlstructures_Nova_ControlStructure*)(this), exceptionData, parent, location);
}
...
compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_static_Nova_parse(compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	if (nova_Nova_String_Nova_equals(compiler_util_Nova_CompilerStringFunctions_Nova_nextWord(input, exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("while"))))
	{
		compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop* l1_Nova_node = (compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop*)nova_null;
...
return (compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop*)(nova_Nova_Object*)nova_null;}
...
{
	this->compiler_tree_nodes_controlstructures_loops_Nova_WhileLoop_Nova_condition = (compiler_tree_nodes_Nova_Value*)nova_null;
}
