#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_Import_NOVA
#define FILE_compiler_tree_nodes_Nova_Import_NOVA

typedef struct compiler_tree_nodes_Nova_Import compiler_tree_nodes_Nova_Import;
...
typedef struct compiler_tree_nodes_Import_Extension_VTable compiler_tree_nodes_Import_Extension_VTable;
struct compiler_tree_nodes_Import_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_Import*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_Import_Extension_VTable compiler_tree_nodes_Import_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_Nova_Import, 
	
	compiler_tree_nodes_Import_Extension_VTable* vtable;
	...
	char compiler_tree_nodes_Nova_Import_Nova_used;
	nova_Nova_String* compiler_tree_nodes_Nova_Import_Nova_alias;
	nova_Nova_String* compiler_tree_nodes_Nova_Import_Nova_importLocation;
)
extern nova_Nova_String* compiler_tree_nodes_Nova_Import_Nova_IDENTIFIER;
extern nova_Nova_String* compiler_tree_nodes_Nova_Import_Nova_ALIAS_IDENTIFIER;
...
nova_Nova_String* compiler_tree_nodes_Nova_Import_Nova_writeNova(compiler_tree_nodes_Nova_Import* this, nova_exception_Nova_ExceptionData* exceptionData);
