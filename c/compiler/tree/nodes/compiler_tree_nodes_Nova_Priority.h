#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_Priority_NOVA
#define FILE_compiler_tree_nodes_Nova_Priority_NOVA

typedef struct compiler_tree_nodes_Nova_Priority compiler_tree_nodes_Nova_Priority;
...
typedef struct compiler_tree_nodes_Priority_Extension_VTable compiler_tree_nodes_Priority_Extension_VTable;
struct compiler_tree_nodes_Priority_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_Priority*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_Nova_Priority* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_Nova_Priority*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
	...
	compiler_tree_nodes_Nova_Type* (*compiler_tree_nodes_Nova_Value_virtual_Accessorfunc_Nova_type)(compiler_tree_nodes_Nova_Priority*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_Priority_Extension_VTable compiler_tree_nodes_Priority_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_Nova_Priority, 
	
	compiler_tree_nodes_Priority_Extension_VTable* vtable;
	...
	char compiler_tree_nodes_Nova_Priority_Nova_safeNavigation;
	compiler_tree_nodes_Nova_Accessible* compiler_tree_nodes_Nova_Priority_Nova_accessedNode;
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_Nova_Priority_Nova_value;
)
