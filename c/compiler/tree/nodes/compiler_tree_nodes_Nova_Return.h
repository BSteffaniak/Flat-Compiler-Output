#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_Return_NOVA
#define FILE_compiler_tree_nodes_Nova_Return_NOVA

typedef struct compiler_tree_nodes_Nova_Return compiler_tree_nodes_Nova_Return;
...
typedef struct compiler_tree_nodes_Return_Extension_VTable compiler_tree_nodes_Return_Extension_VTable;
struct compiler_tree_nodes_Return_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_Return*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_Return_Extension_VTable compiler_tree_nodes_Return_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_Nova_Return, 
	
	compiler_tree_nodes_Return_Extension_VTable* vtable;
	...
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_Nova_Return_Nova_value;
)
...
nova_Nova_String* compiler_tree_nodes_Nova_Return_Nova_writeNova(compiler_tree_nodes_Nova_Return* this, nova_exception_Nova_ExceptionData* exceptionData);
