...
struct compiler_tree_nodes_Package_Extension_VTable
{
	...
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(compiler_tree_nodes_Nova_Package*, nova_exception_Nova_ExceptionData*);
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_Nova_Package*, nova_exception_Nova_ExceptionData*);
