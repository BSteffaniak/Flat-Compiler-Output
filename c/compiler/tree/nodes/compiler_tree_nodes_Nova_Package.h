#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_Package_NOVA
#define FILE_compiler_tree_nodes_Nova_Package_NOVA

typedef struct compiler_tree_nodes_Nova_Package compiler_tree_nodes_Nova_Package;
...
typedef struct compiler_tree_nodes_Package_Extension_VTable compiler_tree_nodes_Package_Extension_VTable;
struct compiler_tree_nodes_Package_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_Package*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_Package_Extension_VTable compiler_tree_nodes_Package_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_Nova_Package, 
	
	compiler_tree_nodes_Package_Extension_VTable* vtable;
	...
	nova_Nova_String* compiler_tree_nodes_Nova_Package_Nova_location;
)
...
nova_Nova_String* compiler_tree_nodes_Nova_Package_Nova_writeNova(compiler_tree_nodes_Nova_Package* this, nova_exception_Nova_ExceptionData* exceptionData);
