...
compiler_tree_nodes_exceptionhandling_Try_Extension_VTable compiler_tree_nodes_exceptionhandling_Try_Extension_VTable_val =
{
	...
	compiler_tree_nodes_exceptionhandling_Nova_Try_Accessorfunc_Nova_scope,
...
compiler_tree_nodes_exceptionhandling_Nova_Try* compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_construct(compiler_tree_nodes_exceptionhandling_Nova_Try* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	...
	{
		compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_this(this, exceptionData, parent, location);
	}
...
void compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_destroy(compiler_tree_nodes_exceptionhandling_Nova_Try** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	compiler_tree_nodes_Nova_Scope_Nova_destroy(&(*this)->compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_scope, exceptionData);
	
	NOVA_FREE(*this);
}

void compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_this(compiler_tree_nodes_exceptionhandling_Nova_Try* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	...
	compiler_tree_nodes_exceptionhandling_Nova_Try_Mutatorfunc_Nova_scope(this, exceptionData, compiler_tree_nodes_Nova_Scope_Nova_construct(0, exceptionData, (compiler_tree_nodes_Nova_Node*)(this), location));
}

compiler_tree_nodes_exceptionhandling_Nova_Try* compiler_tree_nodes_exceptionhandling_Nova_Try_static_Nova_parse(compiler_tree_nodes_exceptionhandling_Nova_Try* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	parent = (compiler_tree_nodes_Nova_Node*)(parent == 0 ? (nova_Nova_Object*)(nova_Nova_Object*)nova_null : (nova_Nova_Object*)parent);
	location = (compiler_util_Nova_Location*)(location == 0 ? (nova_Nova_Object*)compiler_util_Nova_Location_Nova_INVALID : (nova_Nova_Object*)location);
	require = (int)(require == (intptr_t)nova_null ? 1 : require);
	if (nova_Nova_String_Nova_equals(compiler_util_Nova_CompilerStringFunctions_Nova_nextWord(input, exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0), exceptionData, compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_IDENTIFIER))
	{
		compiler_tree_nodes_exceptionhandling_Nova_Try* l1_Nova_node = (compiler_tree_nodes_exceptionhandling_Nova_Try*)nova_null;
...
compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_exceptionhandling_Nova_Try_Accessorfunc_Nova_scope(compiler_tree_nodes_exceptionhandling_Nova_Try* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return this->compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_scope;
}

compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_exceptionhandling_Nova_Try_Mutatorfunc_Nova_scope(compiler_tree_nodes_exceptionhandling_Nova_Try* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Scope* value)
{
	this->compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_scope = value;
	return value;
}
...
{
	this->compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_scope = (compiler_tree_nodes_Nova_Scope*)nova_null;
}
