#pragma once
#ifndef FILE_compiler_tree_nodes_exceptionhandling_Nova_Try_NOVA
#define FILE_compiler_tree_nodes_exceptionhandling_Nova_Try_NOVA

typedef struct compiler_tree_nodes_exceptionhandling_Nova_Try compiler_tree_nodes_exceptionhandling_Nova_Try;
...
typedef struct compiler_tree_nodes_exceptionhandling_Try_Extension_VTable compiler_tree_nodes_exceptionhandling_Try_Extension_VTable;
struct compiler_tree_nodes_exceptionhandling_Try_Extension_VTable
{
	...
	compiler_tree_nodes_exceptionhandling_Nova_Try* (*compiler_tree_nodes_Nova_Node_virtual_Accessor_Nova_parentTry)(compiler_tree_nodes_exceptionhandling_Nova_Try*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_exceptionhandling_Try_Extension_VTable compiler_tree_nodes_exceptionhandling_Try_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_exceptionhandling_Nova_Try, 
	
	compiler_tree_nodes_exceptionhandling_Try_Extension_VTable* vtable;
...
extern nova_Nova_String* compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_IDENTIFIER;
