...
struct compiler_tree_nodes_exceptionhandling_Try_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_exceptionhandling_Nova_Try*, nova_exception_Nova_ExceptionData*);
	compiler_tree_nodes_Nova_Scope* (*compiler_tree_nodes_Nova_Node_virtual_Accessor_Nova_scope)(compiler_tree_nodes_exceptionhandling_Nova_Try*, nova_exception_Nova_ExceptionData*);
	compiler_tree_nodes_Nova_Scope* (*compiler_tree_nodes_Nova_Node_virtual_Mutator_Nova_scope)(compiler_tree_nodes_exceptionhandling_Nova_Try*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_Nova_Scope*);
...
(
	...
	compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_exceptionhandling_Nova_Try_Nova_scope;
)
