...
struct compiler_tree_nodes_exceptionhandling_Catch_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_exceptionhandling_Nova_Catch*, nova_exception_Nova_ExceptionData*);
