#pragma once
#ifndef FILE_compiler_tree_nodes_exceptionhandling_Nova_Throw_NOVA
#define FILE_compiler_tree_nodes_exceptionhandling_Nova_Throw_NOVA

typedef struct compiler_tree_nodes_exceptionhandling_Nova_Throw compiler_tree_nodes_exceptionhandling_Nova_Throw;
...
typedef struct compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable;
struct compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_exceptionhandling_Nova_Throw*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_exceptionhandling_Nova_Throw, 
	
	compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable* vtable;
	...
	char compiler_tree_nodes_exceptionhandling_Nova_Throw_Nova_soft;
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_exceptionhandling_Nova_Throw_Nova_exception;
)
