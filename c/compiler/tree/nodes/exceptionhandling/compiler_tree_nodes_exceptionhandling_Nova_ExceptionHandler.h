#pragma once
#ifndef FILE_compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_NOVA
#define FILE_compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_NOVA

typedef struct compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler;
...
typedef struct compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable;
struct compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable
{
...
extern compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler, 
	
	compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable* vtable;
...
void compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData);
compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler* compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_Nova_construct(compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler* this, nova_exception_Nova_ExceptionData* exceptionData);
void compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_Nova_destroy(compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler** this, nova_exception_Nova_ExceptionData* exceptionData);
void compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_Nova_this(compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler* this, nova_exception_Nova_ExceptionData* exceptionData);
void compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler_Nova_super(compiler_tree_nodes_exceptionhandling_Nova_ExceptionHandler* this, nova_exception_Nova_ExceptionData* exceptionData);
