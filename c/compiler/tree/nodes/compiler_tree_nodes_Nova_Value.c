...
char compiler_tree_nodes_Nova_Value_Nova_testLambda109(compiler_tree_nodes_Nova_Value* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Import* _1, Context3* context);
