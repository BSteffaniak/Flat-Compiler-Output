#pragma once
#ifndef FILE_compiler_tree_nodes_Nova_NovaInterface_NOVA
#define FILE_compiler_tree_nodes_Nova_NovaInterface_NOVA

typedef struct compiler_tree_nodes_Nova_NovaInterface compiler_tree_nodes_Nova_NovaInterface;
...
typedef struct compiler_tree_nodes_NovaInterface_Extension_VTable compiler_tree_nodes_NovaInterface_Extension_VTable;
struct compiler_tree_nodes_NovaInterface_Extension_VTable
{
	nova_Interface_VTable itable;
	char (*nova_operators_Nova_Equals_virtual_Nova_equals)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
	long_long (*nova_Nova_Object_virtual_Accessor_Nova_hashCodeLong)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*);
	compiler_tree_nodes_Nova_Node* (*compiler_tree_nodes_Nova_Node_virtual_Nova_parseChild)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
	...
	compiler_tree_nodes_Nova_NovaClass* (*compiler_tree_nodes_Nova_Node_virtual_Accessor_Nova_parentClass)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
	compiler_tree_nodes_Nova_NovaClass* (*compiler_tree_nodes_Nova_Identifier_virtual_static_Nova_parse)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
	char (*compiler_tree_nodes_variables_Nova_VariableDeclaration_virtual_Nova_parseModifier)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
	nova_Nova_String* (*compiler_tree_nodes_variables_Nova_VariableDeclaration_virtual_Nova_writeModifiers)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
	nova_Nova_String* (*compiler_tree_nodes_Nova_Abstractable_virtual_Nova_writeAbstract)(compiler_tree_nodes_Nova_NovaClass*, nova_exception_Nova_ExceptionData*);
};

extern compiler_tree_nodes_NovaInterface_Extension_VTable compiler_tree_nodes_NovaInterface_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_Nova_NovaInterface, 
	
	compiler_tree_nodes_NovaInterface_Extension_VTable* vtable;
	...
	char compiler_tree_nodes_Nova_NovaClass_Nova_isAbstract;
	nova_Nova_String* compiler_tree_nodes_Nova_NovaClass_Nova_extendedClass;
	nova_datastruct_list_Nova_Array* compiler_tree_nodes_Nova_NovaClass_Nova_implementedInterfaces;
	compiler_tree_nodes_Nova_Scope* compiler_tree_nodes_Nova_NovaClass_Nova_scope;
)
