...
compiler_tree_nodes_NumericRange_Extension_VTable compiler_tree_nodes_NumericRange_Extension_VTable_val =
{
	...
	compiler_tree_nodes_Nova_NumericRange_Nova_toNova,
...
compiler_tree_nodes_Nova_NumericRange* compiler_tree_nodes_Nova_NumericRange_static_Nova_parse(compiler_tree_nodes_Nova_NumericRange* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	if (l1_Nova_startIndex > 0 && compiler_util_Nova_CompilerStringFunctions_1_Nova_isStrictlyOperator(input, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("..")), l1_Nova_startIndex))
	{
		...
		l1_Nova_start = nova_Nova_String_Nova_trim(nova_Nova_String_Nova_substring(input, exceptionData, (intptr_t)nova_null, l1_Nova_startIndex), exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0);
		l1_Nova_end = nova_Nova_String_Nova_trim(nova_Nova_String_Nova_substring(input, exceptionData, l1_Nova_startIndex + nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(".."))->nova_Nova_String_Nova_count, (intptr_t)nova_null), exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0);
...
nova_Nova_String* compiler_tree_nodes_Nova_NumericRange_Nova_toNova(compiler_tree_nodes_Nova_NumericRange* this, nova_exception_Nova_ExceptionData* exceptionData)
{
