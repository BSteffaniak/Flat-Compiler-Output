...
struct compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration*, nova_exception_Nova_ExceptionData*);
