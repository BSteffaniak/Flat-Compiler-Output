#pragma once
#ifndef FILE_compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration_NOVA
#define FILE_compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration_NOVA

typedef struct compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration;
...
typedef struct compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable;
struct compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
	char (*compiler_tree_nodes_Nova_Value_virtual_Nova_parseType)(compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
	nova_Nova_String* (*compiler_tree_nodes_Nova_Value_virtual_Nova_writeType)(compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val;
...
(
	...
	compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable* vtable;
	...
	compiler_tree_nodes_functions_Nova_ParameterList* compiler_tree_nodes_functions_closures_Nova_ClosureDeclaration_Nova_parameterList;
)
