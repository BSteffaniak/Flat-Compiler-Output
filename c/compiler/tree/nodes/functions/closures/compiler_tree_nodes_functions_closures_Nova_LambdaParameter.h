#pragma once
#ifndef FILE_compiler_tree_nodes_functions_closures_Nova_LambdaParameter_NOVA
#define FILE_compiler_tree_nodes_functions_closures_Nova_LambdaParameter_NOVA

typedef struct compiler_tree_nodes_functions_closures_Nova_LambdaParameter compiler_tree_nodes_functions_closures_Nova_LambdaParameter;
...
typedef struct compiler_tree_nodes_functions_closures_LambdaParameter_Extension_VTable compiler_tree_nodes_functions_closures_LambdaParameter_Extension_VTable;
struct compiler_tree_nodes_functions_closures_LambdaParameter_Extension_VTable
{
	...
	compiler_tree_nodes_functions_closures_Nova_LambdaParameter* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_functions_closures_Nova_LambdaParameter*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
extern compiler_tree_nodes_functions_closures_LambdaParameter_Extension_VTable compiler_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val;
...
(
	...
	compiler_tree_nodes_functions_closures_LambdaParameter_Extension_VTable* vtable;
