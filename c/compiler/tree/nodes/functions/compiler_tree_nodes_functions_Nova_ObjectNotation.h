#pragma once
#ifndef FILE_compiler_tree_nodes_functions_Nova_ObjectNotation_NOVA
#define FILE_compiler_tree_nodes_functions_Nova_ObjectNotation_NOVA

typedef struct compiler_tree_nodes_functions_Nova_ObjectNotation compiler_tree_nodes_functions_Nova_ObjectNotation;
...
typedef struct compiler_tree_nodes_functions_ObjectNotation_Extension_VTable compiler_tree_nodes_functions_ObjectNotation_Extension_VTable;
struct compiler_tree_nodes_functions_ObjectNotation_Extension_VTable
{
	...
	compiler_tree_nodes_variables_Nova_VariableDeclaration* (*compiler_tree_nodes_Nova_Node_virtual_Nova_findVariableDeclaration)(compiler_tree_nodes_functions_Nova_ObjectNotation*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_functions_Nova_ObjectNotation*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_functions_ObjectNotation_Extension_VTable compiler_tree_nodes_functions_ObjectNotation_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_functions_Nova_ObjectNotation, 
	
	compiler_tree_nodes_functions_ObjectNotation_Extension_VTable* vtable;
