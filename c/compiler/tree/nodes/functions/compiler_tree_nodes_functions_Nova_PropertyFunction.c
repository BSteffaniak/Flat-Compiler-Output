...
compiler_tree_nodes_functions_PropertyFunction_Extension_VTable compiler_tree_nodes_functions_PropertyFunction_Extension_VTable_val =
{
	0,
	{
		0,
	...
	compiler_tree_nodes_functions_Nova_PropertyFunction_static_Nova_parse,
...
void compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

compiler_tree_nodes_functions_Nova_PropertyFunction* compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_construct(compiler_tree_nodes_functions_Nova_PropertyFunction* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
	CCLASS_NEW(compiler_tree_nodes_functions_Nova_PropertyFunction, this,);
	this->vtable = &compiler_tree_nodes_functions_PropertyFunction_Extension_VTable_val;
	...
	compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_super(this, exceptionData);
	
	{
		compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_this(this, exceptionData, parent, location);
	}
	
	return this;
}

void compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_destroy(compiler_tree_nodes_functions_Nova_PropertyFunction** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_this(compiler_tree_nodes_functions_Nova_PropertyFunction* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location)
{
...
compiler_tree_nodes_functions_Nova_PropertyFunction* compiler_tree_nodes_functions_Nova_PropertyFunction_static_Nova_parse(compiler_tree_nodes_functions_Nova_PropertyFunction* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	parent = (compiler_tree_nodes_Nova_Node*)(parent == 0 ? (nova_Nova_Object*)(nova_Nova_Object*)nova_null : (nova_Nova_Object*)parent);
	location = (compiler_util_Nova_Location*)(location == 0 ? (nova_Nova_Object*)compiler_util_Nova_Location_Nova_INVALID : (nova_Nova_Object*)location);
...
void compiler_tree_nodes_functions_Nova_PropertyFunction_Nova_super(compiler_tree_nodes_functions_Nova_PropertyFunction* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
