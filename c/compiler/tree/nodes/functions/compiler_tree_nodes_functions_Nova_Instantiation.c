...
compiler_tree_nodes_functions_Instantiation_Extension_VTable compiler_tree_nodes_functions_Instantiation_Extension_VTable_val =
{
	...
	compiler_tree_nodes_functions_Nova_FunctionCall_Accessor_Nova_parentFunctionCall,
...
char compiler_tree_nodes_functions_Nova_Instantiation_Nova_lambda49(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_PlaceholderValue* placeholder, int _2, nova_datastruct_list_Nova_List* _3, Context1* context);
char compiler_tree_nodes_functions_Nova_Instantiation_static_Nova_lambda120(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_functions_Nova_FunctionDeclaration* _1, Context2* context);
...
void compiler_tree_nodes_functions_Nova_Instantiation_Nova_destroy(compiler_tree_nodes_functions_Nova_Instantiation** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	compiler_tree_nodes_functions_Nova_ObjectNotation_Nova_destroy(&(*this)->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation, exceptionData);
...
void compiler_tree_nodes_functions_Nova_Instantiation_Nova_addChild(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* node)
{
	compiler_tree_nodes_functions_Nova_ObjectNotation* l1_Nova_nova_local_0 = (compiler_tree_nodes_functions_Nova_ObjectNotation*)nova_null;
	
	this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation = (compiler_tree_nodes_functions_Nova_ObjectNotation*)((l1_Nova_nova_local_0 = this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation) != (compiler_tree_nodes_functions_Nova_ObjectNotation*)nova_null ? l1_Nova_nova_local_0 : compiler_tree_nodes_functions_Nova_ObjectNotation_Nova_construct(0, exceptionData, (compiler_tree_nodes_Nova_Node*)(this), 0));
	compiler_tree_nodes_Nova_NodeList_Nova_addChild((compiler_tree_nodes_Nova_NodeList*)(this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation), exceptionData, node, (intptr_t)nova_null, (intptr_t)nova_null);
}

char compiler_tree_nodes_functions_Nova_Instantiation_Nova_parsePlaceholderChildren(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_NodeList* nodes)
{
	Context1 contextArg49 = 
	{
	};
	
	return nova_datastruct_list_Nova_List_virtual0_Nova_all((nova_datastruct_list_Nova_List*)(nodes->compiler_tree_nodes_Nova_NodeList_Nova_children), exceptionData, (nova_datastruct_list_Nova_List_closure12_Nova_allFunc)&compiler_tree_nodes_functions_Nova_Instantiation_Nova_lambda49, this, &contextArg49, 0);
}

compiler_tree_nodes_Nova_Node* compiler_tree_nodes_functions_Nova_Instantiation_Nova_parseStatement(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	l1_Nova_node = (compiler_tree_nodes_functions_Nova_ObjectNotationProperty*)(compiler_tree_nodes_functions_Nova_ObjectNotationProperty_static_Nova_parse(0, exceptionData, input, parent, location, require));
	...
	if (nova_Nova_String_Nova_equals(compiler_util_Nova_CompilerStringFunctions_Nova_nextWord(input, exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("new"))))
	{
		...
		if (compiler_util_Nova_CompilerStringFunctions_Accessor_Nova_isIdentifier(l1_Nova_className, exceptionData))
		{
			...
			if (l2_Nova_clazz != (compiler_tree_nodes_Nova_ClassDeclaration*)nova_null)
			{
				...
				l3_Nova_constructor = (compiler_tree_nodes_functions_Nova_FunctionDeclaration*)(nova_datastruct_list_Nova_List_virtual0_Nova_firstWhere((nova_datastruct_list_Nova_List*)(l2_Nova_clazz->compiler_tree_nodes_Nova_ClassDeclaration_Nova_functions), exceptionData, (nova_datastruct_list_Nova_List_closure24_Nova_func)&compiler_tree_nodes_functions_Nova_Instantiation_static_Nova_lambda120, nova_null, &contextArg120));
...
nova_Nova_String* compiler_tree_nodes_functions_Nova_Instantiation_Nova_writeObjectNotation(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return (nova_Nova_String*)(this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation != (compiler_tree_nodes_functions_Nova_ObjectNotation*)nova_null ? nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" "))), exceptionData, compiler_tree_nodes_Nova_Node_virtual_Nova_toNova((compiler_tree_nodes_Nova_Node*)(this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation), exceptionData)) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")));
}
...
{
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("new "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((compiler_tree_nodes_functions_Nova_FunctionCall_Nova_writeNova(((compiler_tree_nodes_functions_Nova_FunctionCall*)this), exceptionData))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""))))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(compiler_tree_nodes_Nova_Value_Nova_writeArrayAccess((compiler_tree_nodes_Nova_Value*)(this), exceptionData)), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(compiler_tree_nodes_functions_Nova_Instantiation_Nova_writeObjectNotation(this, exceptionData)), exceptionData, compiler_tree_nodes_Nova_Accessible_Nova_writeAccessedNodes((compiler_tree_nodes_Nova_Accessible*)(this), exceptionData))));
}

char compiler_tree_nodes_functions_Nova_Instantiation_Nova_lambda49(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_PlaceholderValue* placeholder, int _2, nova_datastruct_list_Nova_List* _3, Context1* context)
{
	compiler_tree_nodes_Nova_Node* l1_Nova_property = (compiler_tree_nodes_Nova_Node*)nova_null;
	
	compiler_tree_nodes_functions_Nova_Instantiation_Nova_addChild(this, exceptionData, (compiler_tree_nodes_Nova_Node*)(placeholder));
	l1_Nova_property = (compiler_tree_nodes_Nova_Node*)(compiler_tree_nodes_functions_Nova_Instantiation_Nova_parseStatement(this, exceptionData, placeholder->compiler_tree_nodes_Nova_PlaceholderValue_Nova_value, (compiler_tree_nodes_Nova_Node*)(this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation), 0, (intptr_t)nova_null));
	if (l1_Nova_property != (compiler_tree_nodes_Nova_Node*)nova_null)
	{
		compiler_tree_nodes_Nova_NodeList_Nova_replace((compiler_tree_nodes_Nova_NodeList*)(this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation), exceptionData, (compiler_tree_nodes_Nova_Node*)(placeholder), l1_Nova_property, (intptr_t)nova_null);
	}
	return l1_Nova_property != (compiler_tree_nodes_Nova_Node*)nova_null;
}
...
compiler_tree_nodes_functions_Nova_Instantiation* compiler_tree_nodes_functions_Nova_Instantiation_Accessor_Nova_parentInstantiation(compiler_tree_nodes_functions_Nova_Instantiation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return this;
}
...
{
	this->compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation = (compiler_tree_nodes_functions_Nova_ObjectNotation*)nova_null;
}
