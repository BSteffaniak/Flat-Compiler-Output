#pragma once
#ifndef FILE_compiler_tree_nodes_functions_Nova_NovaFunction_NOVA
#define FILE_compiler_tree_nodes_functions_Nova_NovaFunction_NOVA

typedef struct compiler_tree_nodes_functions_Nova_NovaFunction compiler_tree_nodes_functions_Nova_NovaFunction;
...
typedef struct compiler_tree_nodes_functions_NovaFunction_Extension_VTable compiler_tree_nodes_functions_NovaFunction_Extension_VTable;
struct compiler_tree_nodes_functions_NovaFunction_Extension_VTable
{
	...
	compiler_tree_nodes_variables_Nova_InstanceDeclaration* (*compiler_tree_nodes_Nova_Identifier_virtual_static_Nova_parse)(compiler_tree_nodes_variables_Nova_InstanceDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
extern compiler_tree_nodes_functions_NovaFunction_Extension_VTable compiler_tree_nodes_functions_NovaFunction_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_functions_Nova_NovaFunction, 
	
	compiler_tree_nodes_functions_NovaFunction_Extension_VTable* vtable;
