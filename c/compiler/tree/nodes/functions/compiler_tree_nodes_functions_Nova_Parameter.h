...
struct compiler_tree_nodes_functions_Parameter_Extension_VTable
{
	...
	compiler_tree_nodes_functions_Nova_Parameter* (*compiler_tree_nodes_Nova_Identifier_virtual_static_Nova_parse)(compiler_tree_nodes_functions_Nova_Parameter*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
