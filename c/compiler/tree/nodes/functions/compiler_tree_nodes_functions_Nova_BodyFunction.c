...
nova_Nova_String* compiler_tree_nodes_functions_Nova_BodyFunction_Nova_writeInlineBody(compiler_tree_nodes_functions_Nova_BodyFunction* this, nova_exception_Nova_ExceptionData* exceptionData);
...
compiler_tree_nodes_functions_Nova_BodyFunction* compiler_tree_nodes_functions_Nova_BodyFunction_static_Nova_parse(compiler_tree_nodes_functions_Nova_BodyFunction* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location, int require)
{
	...
	if (l1_Nova_function != (compiler_tree_nodes_functions_Nova_FunctionDeclaration*)nova_null)
	{
		...
		return (compiler_tree_nodes_functions_Nova_BodyFunction*)compiler_tree_nodes_Nova_Node_virtual_Nova_cloneTo((compiler_tree_nodes_Nova_Node*)(l1_Nova_function), exceptionData, (compiler_tree_nodes_Nova_Node*)(l2_Nova_node));
	}
	if (require)
	{
...
char compiler_tree_nodes_functions_Nova_BodyFunction_Nova_parseInlineBody(compiler_tree_nodes_functions_Nova_BodyFunction* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (nova_Nova_Class_Nova_isOfType(this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody->vtable->classInstance, exceptionData, (nova_Nova_Class*)(compiler_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance)))
	{
		...
		if (nova_Nova_Class_Nova_isOfType(this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody->vtable->classInstance, exceptionData, (nova_Nova_Class*)(compiler_tree_nodes_Value_Extension_VTable_val.classInstance)))
		{
			compiler_tree_nodes_Nova_Type* l2_Nova_type = (compiler_tree_nodes_Nova_Type*)nova_null;
			
			l2_Nova_type = (compiler_tree_nodes_Nova_Type*)(compiler_tree_nodes_Nova_Value_virtual_Accessorfunc_Nova_type((compiler_tree_nodes_Nova_Value*)(((compiler_tree_nodes_Nova_Value*)this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody)), exceptionData));
			...
			{
				compiler_tree_nodes_Nova_Value_Mutatorfunc_Nova_type((compiler_tree_nodes_Nova_Value*)(this), exceptionData, l2_Nova_type);
				this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_implicitType = 1;
			}
		}
		return this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody != (compiler_tree_nodes_Nova_Node*)nova_null;
	}
	return 1;
}
...
nova_Nova_String* compiler_tree_nodes_functions_Nova_BodyFunction_Nova_writeInlineBody(compiler_tree_nodes_functions_Nova_BodyFunction* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("=> "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(compiler_tree_nodes_Nova_Node_virtual_Nova_toNova((compiler_tree_nodes_Nova_Node*)(this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody), exceptionData)), exceptionData, ((nova_Nova_String*)(nova_datastruct_list_Nova_Array_Accessorfunc_Nova_count((nova_datastruct_list_Nova_Array*)(compiler_tree_nodes_functions_Nova_BodyFunction_Accessorfunc_Nova_scope(this, exceptionData)->compiler_tree_nodes_Nova_NodeList_Nova_children), exceptionData) > 0 ? nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" "))), exceptionData, compiler_tree_nodes_Nova_Node_virtual_Nova_toNova((compiler_tree_nodes_Nova_Node*)(compiler_tree_nodes_functions_Nova_BodyFunction_Accessorfunc_Nova_scope(this, exceptionData)), exceptionData)) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""))))));
}
...
{
	return (nova_Nova_String*)(this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody != (compiler_tree_nodes_Nova_Node*)nova_null ? compiler_tree_nodes_functions_Nova_BodyFunction_Nova_writeInlineBody(this, exceptionData) : compiler_tree_nodes_Nova_Node_virtual_Nova_toNova((compiler_tree_nodes_Nova_Node*)(compiler_tree_nodes_functions_Nova_BodyFunction_Accessorfunc_Nova_scope(this, exceptionData)), exceptionData));
}

nova_Nova_String* compiler_tree_nodes_functions_Nova_BodyFunction_Nova_writeNova(compiler_tree_nodes_functions_Nova_BodyFunction* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
compiler_tree_nodes_functions_Nova_BodyFunction* compiler_tree_nodes_functions_Nova_BodyFunction_Nova_cloneTo(compiler_tree_nodes_functions_Nova_BodyFunction* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_functions_Nova_BodyFunction* other)
{
	compiler_tree_nodes_functions_Nova_FunctionDeclaration_Nova_cloneTo(((compiler_tree_nodes_functions_Nova_FunctionDeclaration*)this), exceptionData, (compiler_tree_nodes_functions_Nova_FunctionDeclaration*)(other));
	compiler_tree_nodes_functions_Nova_BodyFunction_Mutatorfunc_Nova_scope(other, exceptionData, compiler_tree_nodes_functions_Nova_BodyFunction_Accessorfunc_Nova_scope(this, exceptionData));
	other->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody = this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody;
	other->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_implicitType = this->compiler_tree_nodes_functions_Nova_BodyFunction_Nova_implicitType;
	return other;
}
