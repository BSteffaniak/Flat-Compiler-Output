#pragma once
#ifndef FILE_compiler_tree_nodes_functions_Nova_FunctionArgumentList_NOVA
#define FILE_compiler_tree_nodes_functions_Nova_FunctionArgumentList_NOVA

typedef struct compiler_tree_nodes_functions_Nova_FunctionArgumentList compiler_tree_nodes_functions_Nova_FunctionArgumentList;
...
typedef struct compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable;
struct compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable
{
	nova_Nova_Class* classInstance;
	nova_Interface_VTable itable;
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(compiler_tree_nodes_Nova_ArgumentList*, nova_exception_Nova_ExceptionData*);
...
extern compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_functions_Nova_FunctionArgumentList, 
	
	compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable* vtable;
...
void compiler_tree_nodes_functions_Nova_FunctionArgumentList_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData);
compiler_tree_nodes_functions_Nova_FunctionArgumentList* compiler_tree_nodes_functions_Nova_FunctionArgumentList_Nova_construct(compiler_tree_nodes_functions_Nova_FunctionArgumentList* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location);
void compiler_tree_nodes_functions_Nova_FunctionArgumentList_Nova_destroy(compiler_tree_nodes_functions_Nova_FunctionArgumentList** this, nova_exception_Nova_ExceptionData* exceptionData);
void compiler_tree_nodes_functions_Nova_FunctionArgumentList_Nova_this(compiler_tree_nodes_functions_Nova_FunctionArgumentList* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Node* parent, compiler_util_Nova_Location* location);
void compiler_tree_nodes_functions_Nova_FunctionArgumentList_Nova_super(compiler_tree_nodes_functions_Nova_FunctionArgumentList* this, nova_exception_Nova_ExceptionData* exceptionData);
