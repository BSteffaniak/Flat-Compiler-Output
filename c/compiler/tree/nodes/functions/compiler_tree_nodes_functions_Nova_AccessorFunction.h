...
struct compiler_tree_nodes_functions_AccessorFunction_Extension_VTable
{
	...
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(compiler_tree_nodes_functions_Nova_FunctionDeclaration*, nova_exception_Nova_ExceptionData*);
...
(
	...
	nova_Nova_String* compiler_tree_nodes_functions_Nova_BodyFunction_Nova_inlineBody;
)
