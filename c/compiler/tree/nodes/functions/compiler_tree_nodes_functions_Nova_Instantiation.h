#pragma once
#ifndef FILE_compiler_tree_nodes_functions_Nova_Instantiation_NOVA
#define FILE_compiler_tree_nodes_functions_Nova_Instantiation_NOVA

typedef struct compiler_tree_nodes_functions_Nova_Instantiation compiler_tree_nodes_functions_Nova_Instantiation;
...
typedef struct compiler_tree_nodes_functions_Instantiation_Extension_VTable compiler_tree_nodes_functions_Instantiation_Extension_VTable;
struct compiler_tree_nodes_functions_Instantiation_Extension_VTable
{
	...
	void (*compiler_tree_nodes_Nova_Node_virtual_Nova_addChild)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_Nova_Node*);
	...
	compiler_tree_nodes_Nova_Node* (*compiler_tree_nodes_Nova_Node_virtual_Nova_parseStatement)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
	...
	compiler_tree_nodes_functions_Nova_FunctionCall* (*compiler_tree_nodes_Nova_Node_virtual_Nova_cloneTo)(compiler_tree_nodes_functions_Nova_FunctionCall*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_functions_Nova_FunctionCall*);
	...
	char (*compiler_tree_nodes_Nova_Node_virtual_Nova_parsePlaceholderChildren)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_Nova_NodeList*);
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_functions_Nova_Instantiation* (*compiler_tree_nodes_Nova_Node_virtual_Accessor_Nova_parentInstantiation)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_functions_Nova_FunctionCall* (*compiler_tree_nodes_Nova_Node_virtual_Accessor_Nova_parentFunctionCall)(compiler_tree_nodes_functions_Nova_FunctionCall*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_functions_Nova_Instantiation* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
	...
	compiler_tree_nodes_Nova_Type* (*compiler_tree_nodes_Nova_Value_virtual_Accessorfunc_Nova_type)(compiler_tree_nodes_variables_Nova_Variable*, nova_exception_Nova_ExceptionData*);
	...
	nova_Nova_String* (*compiler_tree_nodes_functions_Nova_FunctionCall_virtual_Nova_writeName)(compiler_tree_nodes_functions_Nova_Instantiation*, nova_exception_Nova_ExceptionData*);
};

extern compiler_tree_nodes_functions_Instantiation_Extension_VTable compiler_tree_nodes_functions_Instantiation_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_functions_Nova_Instantiation, 
	
	compiler_tree_nodes_functions_Instantiation_Extension_VTable* vtable;
	...
	compiler_tree_nodes_functions_Nova_ObjectNotation* compiler_tree_nodes_functions_Nova_Instantiation_Nova_objectNotation;
)
