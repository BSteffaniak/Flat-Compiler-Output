...
char compiler_tree_nodes_Nova_StaticClassReference_static_Nova_testLambda36(compiler_tree_nodes_Nova_StaticClassReference* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_Import* _1, Context1* context);
