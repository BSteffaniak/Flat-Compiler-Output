...
{
	return (compiler_tree_nodes_Nova_Value*)compiler_tree_nodes_Nova_Value_Accessor_Nova_returnedNode(this->compiler_tree_nodes_Nova_Priority_Nova_value, exceptionData);
}
