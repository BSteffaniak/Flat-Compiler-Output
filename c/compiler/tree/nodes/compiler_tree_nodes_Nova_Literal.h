...
struct compiler_tree_nodes_Literal_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_Literal*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_Nova_Literal* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_Nova_Literal*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
(
	...
	char compiler_tree_nodes_Nova_Literal_Nova_safeNavigation;
	compiler_tree_nodes_Nova_Accessible* compiler_tree_nodes_Nova_Literal_Nova_accessedNode;
