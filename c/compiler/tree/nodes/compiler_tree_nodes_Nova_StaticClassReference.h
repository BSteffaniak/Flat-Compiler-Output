...
struct compiler_tree_nodes_StaticClassReference_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_Nova_StaticClassReference*, nova_exception_Nova_ExceptionData*);
...
(
	...
	char compiler_tree_nodes_Nova_StaticClassReference_Nova_safeNavigation;
	compiler_tree_nodes_Nova_Accessible* compiler_tree_nodes_Nova_StaticClassReference_Nova_accessedNode;
)
