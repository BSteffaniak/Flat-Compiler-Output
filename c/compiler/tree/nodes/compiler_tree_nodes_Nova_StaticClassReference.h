...
struct compiler_tree_nodes_StaticClassReference_Extension_VTable
{
	...
	compiler_tree_nodes_Nova_StaticClassReference* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_Nova_StaticClassReference*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
