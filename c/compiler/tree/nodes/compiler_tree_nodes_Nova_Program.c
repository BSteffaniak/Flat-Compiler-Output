...
char compiler_tree_nodes_Nova_Program_Nova_lambda41(compiler_tree_nodes_Nova_Program* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_nodes_Nova_NovaFile* f, Context1* context);
