...
struct compiler_tree_nodes_operations_TernaryOperation_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_operations_Nova_TernaryOperation*, nova_exception_Nova_ExceptionData*);
