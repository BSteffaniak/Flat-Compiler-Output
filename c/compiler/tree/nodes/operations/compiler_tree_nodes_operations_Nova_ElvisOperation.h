...
struct compiler_tree_nodes_operations_ElvisOperation_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_toNova)(compiler_tree_nodes_operations_Nova_ElvisOperation*, nova_exception_Nova_ExceptionData*);
