#pragma once
#ifndef FILE_compiler_tree_nodes_operations_Nova_ElvisOperation_NOVA
#define FILE_compiler_tree_nodes_operations_Nova_ElvisOperation_NOVA

typedef struct compiler_tree_nodes_operations_Nova_ElvisOperation compiler_tree_nodes_operations_Nova_ElvisOperation;
...
typedef struct compiler_tree_nodes_operations_ElvisOperation_Extension_VTable compiler_tree_nodes_operations_ElvisOperation_Extension_VTable;
struct compiler_tree_nodes_operations_ElvisOperation_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_operations_Nova_ElvisOperation*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_operations_Nova_ElvisOperation* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_operations_Nova_ElvisOperation*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
extern compiler_tree_nodes_operations_ElvisOperation_Extension_VTable compiler_tree_nodes_operations_ElvisOperation_Extension_VTable_val;
...
(
	...
	compiler_tree_nodes_operations_ElvisOperation_Extension_VTable* vtable;
	...
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_operations_Nova_ElvisOperation_Nova_condition;
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_operations_Nova_ElvisOperation_Nova_otherwise;
)
...
nova_Nova_String* compiler_tree_nodes_operations_Nova_ElvisOperation_Nova_writeNova(compiler_tree_nodes_operations_Nova_ElvisOperation* this, nova_exception_Nova_ExceptionData* exceptionData);
