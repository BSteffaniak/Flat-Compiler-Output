#pragma once
#ifndef FILE_compiler_tree_nodes_operations_Nova_Assignable_NOVA
#define FILE_compiler_tree_nodes_operations_Nova_Assignable_NOVA
...
typedef struct compiler_tree_nodes_operations_Assignable_Extension_VTable compiler_tree_nodes_operations_Assignable_Extension_VTable;
struct compiler_tree_nodes_operations_Assignable_Extension_VTable
{
	nova_Nova_Class* classInstance;
	nova_Interface_VTable itable;
};

extern compiler_tree_nodes_operations_Assignable_Extension_VTable compiler_tree_nodes_operations_Assignable_Extension_VTable_val;


CCLASS_CLASS
(
	compiler_tree_nodes_operations_Nova_Assignable, 
	
	compiler_tree_nodes_operations_Assignable_Extension_VTable* vtable;
)
