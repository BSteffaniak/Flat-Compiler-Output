...
struct compiler_tree_nodes_operations_UnaryOperation_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_operations_Nova_UnaryOperation*, nova_exception_Nova_ExceptionData*);
	...
	compiler_tree_nodes_operations_Nova_UnaryOperation* (*compiler_tree_nodes_Nova_Value_virtual0_static_Nova_parse)(compiler_tree_nodes_operations_Nova_UnaryOperation*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
...
(
	...
	char compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_operatorSide;
	compiler_tree_nodes_operations_Nova_Operator* compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_operator;
	compiler_tree_nodes_Nova_Value* compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_operand;
)
extern char compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_LEFT;
extern char compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_EITHER;
extern char compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_RIGHT;
