...
struct compiler_tree_nodes_operations_Operator_Extension_VTable
{
	...
	nova_Nova_String* (*compiler_tree_nodes_Nova_Node_virtual_Nova_writeNova)(compiler_tree_nodes_operations_Nova_Operator*, nova_exception_Nova_ExceptionData*);
...
(
	...
	nova_Nova_String* compiler_tree_nodes_operations_Nova_Operator_Nova_value;
)
...
extern nova_Nova_String* compiler_tree_nodes_operations_Nova_Operator_Nova_SAFE_NAVIGATION;
...
extern nova_datastruct_list_Nova_CharArray* compiler_tree_nodes_operations_Nova_Operator_Nova_OPERATOR_SYMBOLS;
extern nova_datastruct_list_Nova_CharArray* compiler_tree_nodes_operations_Nova_Operator_Nova_UNARY_OPERATOR_CHARS;
