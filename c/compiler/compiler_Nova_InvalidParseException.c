...
compiler_InvalidParseException_Extension_VTable compiler_InvalidParseException_Extension_VTable_val =
{
	0,
	{
		0,
...
{
	CCLASS_NEW(compiler_Nova_InvalidParseException, this,);
	...
	{
		compiler_Nova_InvalidParseException_Nova_this(this, exceptionData, message, node);
	}
...
void compiler_Nova_InvalidParseException_Nova_destroy(compiler_Nova_InvalidParseException** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	compiler_tree_nodes_Nova_Node_Nova_destroy(&(*this)->compiler_Nova_InvalidParseException_Nova_node, exceptionData);
...
{
	this->compiler_Nova_InvalidParseException_Nova_node = (compiler_tree_nodes_Nova_Node*)nova_null;
}
