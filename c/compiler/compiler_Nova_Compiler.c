...
void compiler_Nova_Compiler_Nova_compile(compiler_Nova_Compiler* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		if (compiler_Nova_Compiler_Nova_DEBUG)
		{
				...
				nova_io_Nova_Console_static_Nova_log(0, exceptionData, (nova_Nova_Object*)(l1_Nova_annotationTypes));
...
int main(int argc, char** argvs)
{
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(nova_datastruct_list_ImmutableArray_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces, exceptionData, (nova_Nova_Object*)nova_datastruct_list_List_Extension_VTable_val.classInstance);
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(nova_datastruct_list_ImmutableArrayIterator_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces, exceptionData, (nova_Nova_Object*)nova_datastruct_list_Iterator_Extension_VTable_val.classInstance);
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(compiler_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces, exceptionData, (nova_Nova_Object*)compiler_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance);
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(compiler_tree_nodes_Priority_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces, exceptionData, (nova_Nova_Object*)compiler_tree_nodes_Accessible_Extension_VTable_val.classInstance);
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(compiler_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces, exceptionData, (nova_Nova_Object*)compiler_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance);
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(compiler_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces, exceptionData, (nova_Nova_Object*)compiler_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance);
		...
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 235);
		...
		nova_all_classes[94] = nova_network_ClientSocket_Extension_VTable_val.classInstance;
		nova_all_classes[95] = nova_network_ConnectionSocket_Extension_VTable_val.classInstance;
		nova_all_classes[96] = nova_network_NetworkInputStream_Extension_VTable_val.classInstance;
		nova_all_classes[97] = nova_network_NetworkOutputStream_Extension_VTable_val.classInstance;
		nova_all_classes[98] = nova_network_ServerSocket_Extension_VTable_val.classInstance;
		nova_all_classes[99] = nova_network_Socket_Extension_VTable_val.classInstance;
		nova_all_classes[100] = nova_operators_Equals_Extension_VTable_val.classInstance;
		nova_all_classes[101] = nova_operators_Multiply_Extension_VTable_val.classInstance;
		nova_all_classes[102] = nova_primitive_Bool_Extension_VTable_val.classInstance;
		nova_all_classes[103] = nova_primitive_Null_Extension_VTable_val.classInstance;
		nova_all_classes[104] = nova_primitive_Primitive_Extension_VTable_val.classInstance;
		nova_all_classes[105] = nova_primitive_number_Byte_Extension_VTable_val.classInstance;
		nova_all_classes[106] = nova_primitive_number_Char_Extension_VTable_val.classInstance;
		nova_all_classes[107] = nova_primitive_number_Double_Extension_VTable_val.classInstance;
		nova_all_classes[108] = nova_primitive_number_Float_Extension_VTable_val.classInstance;
		nova_all_classes[109] = nova_primitive_number_Int_Extension_VTable_val.classInstance;
		nova_all_classes[110] = nova_primitive_number_Integer_Extension_VTable_val.classInstance;
		nova_all_classes[111] = nova_primitive_number_Long_Extension_VTable_val.classInstance;
		nova_all_classes[112] = nova_primitive_number_Number_Extension_VTable_val.classInstance;
		nova_all_classes[113] = nova_primitive_number_RealNumber_Extension_VTable_val.classInstance;
		nova_all_classes[114] = nova_primitive_number_Short_Extension_VTable_val.classInstance;
		nova_all_classes[115] = nova_process_Process_Extension_VTable_val.classInstance;
		nova_all_classes[116] = nova_regex_Match_Extension_VTable_val.classInstance;
		nova_all_classes[117] = nova_regex_Pattern_Extension_VTable_val.classInstance;
		nova_all_classes[118] = nova_regex_Regex_Extension_VTable_val.classInstance;
		nova_all_classes[119] = nova_security_MD5_Extension_VTable_val.classInstance;
		nova_all_classes[120] = nova_security_Sha256_Extension_VTable_val.classInstance;
		nova_all_classes[121] = nova_star_Frame_Extension_VTable_val.classInstance;
		nova_all_classes[122] = nova_star_Window_Extension_VTable_val.classInstance;
		nova_all_classes[123] = nova_star_WindowThread_Extension_VTable_val.classInstance;
		nova_all_classes[124] = nova_thread_Thread_Extension_VTable_val.classInstance;
		nova_all_classes[125] = nova_thread_UncaughtExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[126] = nova_thread_async_Async_Extension_VTable_val.classInstance;
		nova_all_classes[127] = nova_thread_async_AsyncResult_Extension_VTable_val.classInstance;
		nova_all_classes[128] = nova_time_Date_Extension_VTable_val.classInstance;
		nova_all_classes[129] = nova_time_Time_Extension_VTable_val.classInstance;
		nova_all_classes[130] = nova_time_Timer_Extension_VTable_val.classInstance;
		nova_all_classes[131] = nova_web_js_json_Json_Extension_VTable_val.classInstance;
		nova_all_classes[132] = nova_web_svg_Svg_Extension_VTable_val.classInstance;
		nova_all_classes[133] = nova_web_svg_SvgCircle_Extension_VTable_val.classInstance;
		nova_all_classes[134] = nova_web_svg_SvgComponent_Extension_VTable_val.classInstance;
		nova_all_classes[135] = nova_web_svg_SvgComponentList_Extension_VTable_val.classInstance;
		nova_all_classes[136] = nova_web_svg_SvgComponentNode_Extension_VTable_val.classInstance;
		nova_all_classes[137] = nova_web_svg_SvgMainComponent_Extension_VTable_val.classInstance;
		nova_all_classes[138] = nova_web_svg_no3_No3_Extension_VTable_val.classInstance;
		nova_all_classes[139] = nova_web_svg_no3_No3Node_Extension_VTable_val.classInstance;
		nova_all_classes[140] = nova_web_svg_no3_No3Select_Extension_VTable_val.classInstance;
		nova_all_classes[141] = nova_web_svg_no3_No3SelectAll_Extension_VTable_val.classInstance;
		nova_all_classes[142] = compiler_Compiler_Extension_VTable_val.classInstance;
		nova_all_classes[143] = compiler_InvalidParseException_Extension_VTable_val.classInstance;
		nova_all_classes[144] = compiler_SyntaxErrorException_Extension_VTable_val.classInstance;
		nova_all_classes[145] = compiler_SyntaxMessage_Extension_VTable_val.classInstance;
		nova_all_classes[146] = compiler_engines_CodeGeneratorEngine_Extension_VTable_val.classInstance;
		nova_all_classes[147] = compiler_error_UnimplementedOperationException_Extension_VTable_val.classInstance;
		nova_all_classes[148] = compiler_tree_AnnotationSearchResult_Extension_VTable_val.classInstance;
		nova_all_classes[149] = compiler_tree_StatementIterator_Extension_VTable_val.classInstance;
		nova_all_classes[150] = compiler_tree_SyntaxTree_Extension_VTable_val.classInstance;
		nova_all_classes[151] = compiler_tree_nodes_Abstractable_Extension_VTable_val.classInstance;
		nova_all_classes[152] = compiler_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		nova_all_classes[153] = compiler_tree_nodes_ArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[154] = compiler_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[155] = compiler_tree_nodes_Identifier_Extension_VTable_val.classInstance;
		nova_all_classes[156] = compiler_tree_nodes_Import_Extension_VTable_val.classInstance;
		nova_all_classes[157] = compiler_tree_nodes_ImportList_Extension_VTable_val.classInstance;
		nova_all_classes[158] = compiler_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[159] = compiler_tree_nodes_Listener_Extension_VTable_val.classInstance;
		nova_all_classes[160] = compiler_tree_nodes_Literal_Extension_VTable_val.classInstance;
		nova_all_classes[161] = compiler_tree_nodes_Node_Extension_VTable_val.classInstance;
		nova_all_classes[162] = compiler_tree_nodes_NodeList_Extension_VTable_val.classInstance;
		nova_all_classes[163] = compiler_tree_nodes_NovaFile_Extension_VTable_val.classInstance;
		nova_all_classes[164] = compiler_tree_nodes_NumericRange_Extension_VTable_val.classInstance;
		nova_all_classes[165] = compiler_tree_nodes_Package_Extension_VTable_val.classInstance;
		nova_all_classes[166] = compiler_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance;
		nova_all_classes[167] = compiler_tree_nodes_Priority_Extension_VTable_val.classInstance;
		nova_all_classes[168] = compiler_tree_nodes_Program_Extension_VTable_val.classInstance;
		nova_all_classes[169] = compiler_tree_nodes_Return_Extension_VTable_val.classInstance;
		nova_all_classes[170] = compiler_tree_nodes_Scope_Extension_VTable_val.classInstance;
		nova_all_classes[171] = compiler_tree_nodes_Skeleton_Extension_VTable_val.classInstance;
		nova_all_classes[172] = compiler_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance;
		nova_all_classes[173] = compiler_tree_nodes_Type_Extension_VTable_val.classInstance;
		nova_all_classes[174] = compiler_tree_nodes_ValidationResult_Extension_VTable_val.classInstance;
		nova_all_classes[175] = compiler_tree_nodes_Value_Extension_VTable_val.classInstance;
		nova_all_classes[176] = compiler_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance;
		nova_all_classes[177] = compiler_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_all_classes[178] = compiler_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[179] = compiler_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[180] = compiler_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[181] = compiler_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance;
		nova_all_classes[182] = compiler_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance;
		nova_all_classes[183] = compiler_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance;
		nova_all_classes[184] = compiler_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance;
		nova_all_classes[185] = compiler_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance;
		nova_all_classes[186] = compiler_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance;
		nova_all_classes[187] = compiler_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance;
		nova_all_classes[188] = compiler_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance;
		nova_all_classes[189] = compiler_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[190] = compiler_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance;
		nova_all_classes[191] = compiler_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance;
		nova_all_classes[192] = compiler_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[193] = compiler_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance;
		nova_all_classes[194] = compiler_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[195] = compiler_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		nova_all_classes[196] = compiler_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance;
		nova_all_classes[197] = compiler_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[198] = compiler_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance;
		nova_all_classes[199] = compiler_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[200] = compiler_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance;
		nova_all_classes[201] = compiler_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance;
		nova_all_classes[202] = compiler_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[203] = compiler_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance;
		nova_all_classes[204] = compiler_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance;
		nova_all_classes[205] = compiler_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance;
		nova_all_classes[206] = compiler_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance;
		nova_all_classes[207] = compiler_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[208] = compiler_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance;
		nova_all_classes[209] = compiler_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[210] = compiler_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance;
		nova_all_classes[211] = compiler_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance;
		nova_all_classes[212] = compiler_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		nova_all_classes[213] = compiler_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance;
		nova_all_classes[214] = compiler_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance;
		nova_all_classes[215] = compiler_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		nova_all_classes[216] = compiler_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance;
		nova_all_classes[217] = compiler_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance;
		nova_all_classes[218] = compiler_tree_nodes_operations_Operation_Extension_VTable_val.classInstance;
		nova_all_classes[219] = compiler_tree_nodes_operations_Operator_Extension_VTable_val.classInstance;
		nova_all_classes[220] = compiler_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[221] = compiler_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[222] = compiler_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance;
		nova_all_classes[223] = compiler_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[224] = compiler_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[225] = compiler_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[226] = compiler_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[227] = compiler_tree_nodes_variables_Variable_Extension_VTable_val.classInstance;
		nova_all_classes[228] = compiler_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[229] = compiler_util_Bounds_Extension_VTable_val.classInstance;
		nova_all_classes[230] = compiler_util_CompilerStringFunctions_Extension_VTable_val.classInstance;
		nova_all_classes[231] = compiler_util_FileUtils_Extension_VTable_val.classInstance;
		nova_all_classes[232] = compiler_util_Location_Extension_VTable_val.classInstance;
		nova_all_classes[233] = compiler_util_OS_Extension_VTable_val.classInstance;
		nova_all_classes[234] = compiler_util_SyntaxUtils_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 235);
