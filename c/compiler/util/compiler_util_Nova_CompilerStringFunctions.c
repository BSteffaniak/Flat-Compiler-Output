...
typedef struct
{
	/* Bool includeEdges = true */ int* compiler_util_Nova_CompilerStringFunctions_Nova_includeEdges;
	/* IntArray matches */ nova_datastruct_list_Nova_IntArray** compiler_util_Nova_CompilerStringFunctions_Nova_matches;
} Context3;
typedef struct
{
	/* Bool inParen */ char* compiler_util_Nova_CompilerStringFunctions_Nova_inParen;
	/* Int lambda */ int* compiler_util_Nova_CompilerStringFunctions_Nova_lambda;
	/* String tabs */ nova_Nova_String** compiler_util_Nova_CompilerStringFunctions_Nova_tabs;
	/* Bool sameLine */ char* compiler_util_Nova_CompilerStringFunctions_Nova_sameLine;
	/* String output */ nova_Nova_String** compiler_util_Nova_CompilerStringFunctions_Nova_output;
	/* Int lastIndex */ int* compiler_util_Nova_CompilerStringFunctions_Nova_lastIndex;
} Context4;
...
char compiler_util_Nova_CompilerStringFunctions_Nova_lambda55(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, Context1* context);
int compiler_util_Nova_CompilerStringFunctions_Nova_lambda56(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* str, char c, int i, int dir, Context2* context);
nova_datastruct_list_Nova_Array* generated25(compiler_util_Nova_CompilerStringFunctions* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* value0);
void compiler_util_Nova_CompilerStringFunctions_Nova_lambda127(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* operator, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
void compiler_util_Nova_CompilerStringFunctions_Nova_lambda128(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* match, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
...
nova_datastruct_list_Nova_CharArray* compiler_util_Nova_CompilerStringFunctions_Nova_WORD_BOUNDARIES;
void compiler_util_Nova_CompilerStringFunctions_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	compiler_util_Nova_CompilerStringFunctions_Nova_WORD_BOUNDARIES = (nova_datastruct_list_Nova_CharArray*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" \t\n\r-+~!=%^&|*/\\><,\"'[]{};:?()"))->nova_Nova_String_Nova_chars);
}}
...
{
	return compiler_tree_Nova_StatementIterator_Nova_construct(0, exceptionData, this, parents);
}
...
nova_datastruct_Nova_Tuple2* compiler_util_Nova_CompilerStringFunctions_Nova_getArrayAccesses(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	while ((char)(intptr_t)nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, l1_Nova_bracketIndex) == ']')
	{
		...
		l1_Nova_start = compiler_util_Nova_CompilerStringFunctions_0_Nova_findEndingMatch(this, exceptionData, l1_Nova_bracketIndex, '[', ']', -1, (intptr_t)nova_null);
		l1_Nova_old = l1_Nova_bracketIndex;
		l1_Nova_bracketIndex = l1_Nova_start - 1;
		if (l1_Nova_start > 0)
		{
			if ((char)(intptr_t)nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, l1_Nova_bracketIndex) == ')' || (char)(intptr_t)nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, l1_Nova_bracketIndex) == ']' || compiler_util_Nova_CompilerStringFunctions_Accessor_Nova_isIdentifier(nova_Nova_String_virtual_Nova_substring((nova_Nova_String*)(this), exceptionData, (intptr_t)nova_null, l1_Nova_start), exceptionData))
		{
...
{
	return nova_Nova_String_virtual_Nova_substring((nova_Nova_String*)(this), exceptionData, bounds->compiler_util_Nova_Bounds_Nova_start, bounds->compiler_util_Nova_Bounds_Nova_end);
}
...
compiler_util_Nova_Bounds* compiler_util_Nova_CompilerStringFunctions_0_Nova_nextWordBounds(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int start)
{
	...
	l1_Nova_index = compiler_util_Nova_CompilerStringFunctions_Nova_nextWhitespaceIndex(this, exceptionData, start, (intptr_t)nova_null, (intptr_t)nova_null);
	if (l1_Nova_index > 0)
	{
...
char compiler_util_Nova_CompilerStringFunctions_0_Nova_containsString(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* needles, int index)
{
	...
	return nova_datastruct_list_Nova_List_virtual0_Nova_any((nova_datastruct_list_Nova_List*)(needles), exceptionData, (nova_datastruct_list_Nova_List_closure9_Nova_anyFunc)&compiler_util_Nova_CompilerStringFunctions_Nova_lambda55, this, &contextArg55);
}
...
int compiler_util_Nova_CompilerStringFunctions_Nova_findEndingQuote(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int start, int direction)
{
	...
	direction = (int)(direction == (intptr_t)nova_null ? 1 : direction);
	return compiler_util_Nova_CompilerStringFunctions_Nova_findEndingChar(this, exceptionData, '"', start, direction, (compiler_util_Nova_CompilerStringFunctions_closure1_Nova_advance)&compiler_util_Nova_CompilerStringFunctions_Nova_lambda56, this, &contextArg56, (intptr_t)nova_null);
}
...
nova_datastruct_list_Nova_Array* compiler_util_Nova_CompilerStringFunctions_Nova_splitAtDotOperator(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* defaultReturnValue)
{
	...
	l1_Nova_prev = 0;
	l1_Nova_dot = compiler_util_Nova_CompilerStringFunctions_Nova_findDotOperatorIndex(this, exceptionData, (intptr_t)nova_null);
	...
	while (l1_Nova_dot > 0)
	{
		...
		l1_Nova_dot = compiler_util_Nova_CompilerStringFunctions_Nova_findDotOperatorIndex(this, exceptionData, l1_Nova_prev);
	}
	if (l1_Nova_prev > 0)
	{
...
nova_datastruct_list_Nova_Array* compiler_util_Nova_CompilerStringFunctions_Nova_splitAtCommas(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int searchGenerics, int allowTrailing)
{
	...
	l1_Nova_oldIndex = 0;
	l1_Nova_index = -1;
	while ((l1_Nova_index = (char)(compiler_util_Nova_CompilerStringFunctions_0_Nova_findCharOnTopLevel(this, exceptionData, ',', l1_Nova_index + 1, searchGenerics))) >= 0)
	{
...
nova_datastruct_list_Nova_IntArray* compiler_util_Nova_CompilerStringFunctions_Nova_findOperatorIndices(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* operators, int includeEdges)
{
	...
	operators = (nova_datastruct_list_Nova_Array*)(operators == 0 ? (nova_Nova_Object*)compiler_tree_nodes_operations_Nova_Operator_Nova_BINARY_OPERATORS : (nova_Nova_Object*)operators);
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(operators), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&compiler_util_Nova_CompilerStringFunctions_Nova_lambda127, this, &contextArg127);
	l2_Nova_i = (int)0;
...
int compiler_util_Nova_CompilerStringFunctions_1_Nova_findOperatorOnTopLevel(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* operator, int start, int searchGenerics)
{
	...
	while (1)
	{
		...
		l1_Nova_index = compiler_util_Nova_CompilerStringFunctions_0_Nova_findStringOnTopLevel(this, exceptionData, operator, start, searchGenerics, (intptr_t)nova_null);
...
int compiler_util_Nova_CompilerStringFunctions_0_Nova_findCharOnTopLevel(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, char needle, int start, int searchGenerics)
{
	...
	return compiler_util_Nova_CompilerStringFunctions_1_Nova_findStringOnTopLevel(this, exceptionData, l1_Nova_array, start, searchGenerics, (intptr_t)nova_null);
}
...
int compiler_util_Nova_CompilerStringFunctions_Nova_findWordOnTopLevel(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* word, int start, int searchGenerics, int defaultReturnValue)
{
	...
	searchGenerics = (int)(searchGenerics == (intptr_t)nova_null ? 0 : searchGenerics);
	defaultReturnValue = (int)(defaultReturnValue == (intptr_t)nova_null ? -1 : defaultReturnValue);
	l1_Nova_index = compiler_util_Nova_CompilerStringFunctions_0_Nova_findStringOnTopLevel(this, exceptionData, word, start, searchGenerics, defaultReturnValue);
	while (l1_Nova_index >= 0 && ((l1_Nova_index > 0 && !nova_datastruct_list_Nova_CharArray_Nova_contains(compiler_util_Nova_CompilerStringFunctions_Nova_WORD_BOUNDARIES, exceptionData, (char)(intptr_t)(nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, l1_Nova_index - 1)))) || (l1_Nova_index + word->nova_Nova_String_Nova_count < this->nova_Nova_String_Nova_count - 1 && !nova_datastruct_list_Nova_CharArray_Nova_contains(compiler_util_Nova_CompilerStringFunctions_Nova_WORD_BOUNDARIES, exceptionData, (char)(intptr_t)(nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, l1_Nova_index + word->nova_Nova_String_Nova_count))))))
	{
		l1_Nova_index = compiler_util_Nova_CompilerStringFunctions_0_Nova_findStringOnTopLevel(this, exceptionData, word, l1_Nova_index + word->nova_Nova_String_Nova_count + 1, searchGenerics, defaultReturnValue);
	}
	return l1_Nova_index;
}
...
int compiler_util_Nova_CompilerStringFunctions_0_Nova_findStringOnTopLevel(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* needle, int start, int searchGenerics, int defaultReturnValue)
{
	...
	searchGenerics = (int)(searchGenerics == (intptr_t)nova_null ? 0 : searchGenerics);
	defaultReturnValue = (int)(defaultReturnValue == (intptr_t)nova_null ? -1 : defaultReturnValue);
	return compiler_util_Nova_CompilerStringFunctions_1_Nova_findStringOnTopLevel(this, exceptionData, generated25((compiler_util_Nova_CompilerStringFunctions*)(this), exceptionData, needle), start, searchGenerics, defaultReturnValue);
}
...
int compiler_util_Nova_CompilerStringFunctions_1_Nova_findStringOnTopLevel(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* needles, int start, int searchGenerics, int defaultReturnValue)
{
	...
	while (start < this->nova_Nova_String_Nova_count)
	{
		...
		if (searchGenerics)
		{
			start = compiler_util_Nova_CompilerStringFunctions_0_Nova_findEndingMatch(this, exceptionData, start, '<', '>', (intptr_t)nova_null, (intptr_t)nova_null);
		}
		default:
		start++;
	}
...
int compiler_util_Nova_CompilerStringFunctions_Nova_calculateStatementEnd(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int currentEnd, int statementEndIndex)
{
	...
	currentEnd = compiler_util_Nova_CompilerStringFunctions_1_Nova_findCharOnTopLevel(this, exceptionData, compiler_util_Nova_CompilerStringFunctions_Nova_EITHER_STATEMENT_END_CHARS, currentEnd, (intptr_t)nova_null);
	if (currentEnd < 0)
	{
...
char compiler_util_Nova_CompilerStringFunctions_Nova_checkStatementContinuation(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int prevCharIndex, int nextCharIndex)
{
	...
	l1_Nova_prevWordBounds = compiler_util_Nova_CompilerStringFunctions_1_Nova_nextWordBounds(this, exceptionData, prevCharIndex, -1);
...
char compiler_util_Nova_CompilerStringFunctions_Nova_containsUnaryOperator(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int index, int stopIndex, int direction)
{
	...
	if (compiler_util_Nova_CompilerStringFunctions_static_Nova_validBounds(0, exceptionData, l1_Nova_bounds, stopIndex, direction))
	{
		...
		l2_Nova_unary = (nova_Nova_String*)(nova_Nova_String_virtual_Nova_substring((nova_Nova_String*)(this), exceptionData, l1_Nova_bounds->compiler_util_Nova_Bounds_Nova_start, l1_Nova_bounds->compiler_util_Nova_Bounds_Nova_end));
		l2_Nova_foundSide = -direction;
		l2_Nova_correctSide = compiler_tree_nodes_operations_Nova_UnaryOperation_Nova_RIGHT;
...
nova_Nova_String* compiler_util_Nova_CompilerStringFunctions_Nova_searchGenericType(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int start, int backwards)
{
	...
	{
		THROW(compiler_error_Nova_UnimplementedOperationException_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("forwards checking not implemented yet... Looks like its time to do that."))), 0);
	}
	return (nova_Nova_String*)(nova_Nova_Object*)nova_null;
}
...
{
	start = (int)(start == (intptr_t)nova_null ? 0 : start);
	return compiler_util_Nova_CompilerStringFunctions_0_Nova_findCharOnTopLevel(this, exceptionData, '.', start, (intptr_t)nova_null);
}
...
nova_Nova_String* compiler_util_Nova_CompilerStringFunctions_Nova_formatIndentation(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_matches), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&compiler_util_Nova_CompilerStringFunctions_Nova_lambda128, this, &contextArg128);
...
void compiler_util_Nova_CompilerStringFunctions_Nova_lambda127(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* operator, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context)
{
	...
	l1_Nova_index = (int)(0);
	while ((l1_Nova_index = compiler_util_Nova_CompilerStringFunctions_0_Nova_findStringOnTopLevel(this, exceptionData, operator, l1_Nova_index + 1, (intptr_t)nova_null, (intptr_t)nova_null)) >= 0)
	{
		if (((*context->compiler_util_Nova_CompilerStringFunctions_Nova_includeEdges) || l1_Nova_index > 0 && l1_Nova_index < this->nova_Nova_String_Nova_count - operator->nova_Nova_String_Nova_count) && compiler_util_Nova_CompilerStringFunctions_1_Nova_isStrictlyOperator(this, exceptionData, operator, l1_Nova_index))
		{
			nova_datastruct_list_Nova_Array_0_Nova_add((nova_datastruct_list_Nova_Array*)((*context->compiler_util_Nova_CompilerStringFunctions_Nova_matches)), exceptionData, (nova_Nova_Object*)(l1_Nova_index));
		}
	}
}
...
void compiler_util_Nova_CompilerStringFunctions_Nova_lambda128(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* match, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context)
{
	...
	{
		if ((*context->compiler_util_Nova_CompilerStringFunctions_Nova_inParen) && l1_Nova_c == '{')
		{
			(*context->compiler_util_Nova_CompilerStringFunctions_Nova_lambda)++;
			return;
		}
		(*context->compiler_util_Nova_CompilerStringFunctions_Nova_tabs) = (nova_Nova_String*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((*context->compiler_util_Nova_CompilerStringFunctions_Nova_tabs)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\t"))));
		(*context->compiler_util_Nova_CompilerStringFunctions_Nova_inParen) = l1_Nova_c == '(';
		(*context->compiler_util_Nova_CompilerStringFunctions_Nova_sameLine) = 1;
	}
	else if (l1_Nova_c == '}' || l1_Nova_c == ')')
{
	if ((*context->compiler_util_Nova_CompilerStringFunctions_Nova_lambda) > 0 && l1_Nova_c == ')')
{
	(*context->compiler_util_Nova_CompilerStringFunctions_Nova_lambda)--;
}
else if ((*context->compiler_util_Nova_CompilerStringFunctions_Nova_tabs)->nova_Nova_String_Nova_count > 0)
{
	(*context->compiler_util_Nova_CompilerStringFunctions_Nova_tabs) = (nova_Nova_String*)(nova_Nova_String_virtual_Nova_substring((nova_Nova_String*)((*context->compiler_util_Nova_CompilerStringFunctions_Nova_tabs)), exceptionData, 1, (intptr_t)nova_null));
}
(*context->compiler_util_Nova_CompilerStringFunctions_Nova_inParen) = (*context->compiler_util_Nova_CompilerStringFunctions_Nova_inParen) && l1_Nova_c != ')';
if ((*context->compiler_util_Nova_CompilerStringFunctions_Nova_output)->nova_Nova_String_Nova_count > 0 && !(*context->compiler_util_Nova_CompilerStringFunctions_Nova_sameLine))
{
	(*context->compiler_util_Nova_CompilerStringFunctions_Nova_output) = (nova_Nova_String*)(nova_Nova_String_virtual_Nova_substring((nova_Nova_String*)((*context->compiler_util_Nova_CompilerStringFunctions_Nova_output)), exceptionData, (intptr_t)nova_null, (*context->compiler_util_Nova_CompilerStringFunctions_Nova_output)->nova_Nova_String_Nova_count - 1));
}}
else if (l1_Nova_c == '\n')
{
	(*context->compiler_util_Nova_CompilerStringFunctions_Nova_output) = (nova_Nova_String*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((*context->compiler_util_Nova_CompilerStringFunctions_Nova_output)), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_virtual_Nova_substring((nova_Nova_String*)(this), exceptionData, (*context->compiler_util_Nova_CompilerStringFunctions_Nova_lastIndex), match->nova_regex_Nova_Match_Nova_start)), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n"))), exceptionData, (*context->compiler_util_Nova_CompilerStringFunctions_Nova_tabs)))));
	(*context->compiler_util_Nova_CompilerStringFunctions_Nova_lastIndex) = match->nova_regex_Nova_Match_Nova_start + 1;
	(*context->compiler_util_Nova_CompilerStringFunctions_Nova_sameLine) = 0;
}}
