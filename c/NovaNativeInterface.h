...
typedef nova_meta_Nova_ModifierFdunctionMap* (*nova_meta_Nova_ModifierFdunctionMap_native_Nova_construct)(nova_meta_Nova_ModifierFdunctionMap*, nova_exception_Nova_ExceptionData*);

typedef struct nova_meta_native_ModifierFdunctionMap
{
nova_meta_Nova_ModifierFdunctionMap_native_Nova_construct ModifierFdunctionMap;
} nova_meta_native_ModifierFdunctionMap;
...
nova_meta_native_ModifierFdunctionMap nova_meta_ModifierFdunctionMap;
