...
typedef nova_datastruct_Nova_BinaryNode* (*nova_datastruct_Nova_BinaryNodeFunctionMap_nativefunctionMapBinaryNodeFunctionMap_Nova_construct)(nova_datastruct_Nova_BinaryNodeFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
...
{
nova_datastruct_Nova_BinaryNodeFunctionMap_nativefunctionMapBinaryNodeFunctionMap_Nova_construct construct;
...
nova_datastruct_Nova_HashMapFunctionMap_nativefunctionMap_Nova_all all;
...
typedef char (*nova_datastruct_Nova_HashSetFunctionMap_nativefunctionMap0_Nova_all)(nova_datastruct_Nova_HashSetFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_Nova_HashSet*, nova_datastruct_Nova_HashSetFunctionMap_closure26_Nova_func nova_datastruct_Nova_HashSetFunctionMap_Nova_func, void* nova_datastruct_Nova_HashSetFunctionMap_ref_Nova_func, void* func_context);
...
nova_datastruct_Nova_HashSetFunctionMap_nativefunctionMap0_Nova_all all__nova_datastruct_HashSet__nova_primitive_Bool;
...
typedef char (*nova_datastruct_Nova_ImmutableHashMapFunctionMap_nativefunctionMap0_Nova_all)(nova_datastruct_Nova_ImmutableHashMapFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_Nova_ImmutableHashMap*, nova_datastruct_Nova_ImmutableHashMapFunctionMap_closure26_Nova_func nova_datastruct_Nova_ImmutableHashMapFunctionMap_Nova_func, void* nova_datastruct_Nova_ImmutableHashMapFunctionMap_ref_Nova_func, void* func_context);
...
nova_datastruct_Nova_ImmutableHashMapFunctionMap_nativefunctionMap0_Nova_all all__nova_datastruct_ImmutableHashMap__nova_primitive_Bool;
...
typedef char (*nova_datastruct_Nova_TupleFunctionMap_nativefunctionMap0_Nova_all)(nova_datastruct_Nova_TupleFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_Nova_Tuple*, nova_datastruct_Nova_TupleFunctionMap_closure27_Nova_allFunc nova_datastruct_Nova_TupleFunctionMap_Nova_allFunc, void* nova_datastruct_Nova_TupleFunctionMap_ref_Nova_allFunc, void* allFunc_context);
...
nova_datastruct_Nova_TupleFunctionMap_nativefunctionMap0_Nova_all all__nova_datastruct_Tuple__nova_primitive_Bool;
...
typedef char (*nova_datastruct_list_Nova_CharArrayFunctionMap_nativefunctionMap_Nova_all)(nova_datastruct_list_Nova_CharArrayFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_CharArray*, nova_datastruct_list_Nova_CharArrayFunctionMap_closure38_Nova_allFunc nova_datastruct_list_Nova_CharArrayFunctionMap_Nova_allFunc, void* nova_datastruct_list_Nova_CharArrayFunctionMap_ref_Nova_allFunc, void* allFunc_context);
...
nova_datastruct_list_Nova_CharArrayFunctionMap_nativefunctionMap_Nova_all all;
...
typedef char (*nova_datastruct_list_Nova_DoubleArrayFunctionMap_nativefunctionMap_Nova_all)(nova_datastruct_list_Nova_DoubleArrayFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_DoubleArray*, nova_datastruct_list_Nova_DoubleArrayFunctionMap_closure33_Nova_allFunc nova_datastruct_list_Nova_DoubleArrayFunctionMap_Nova_allFunc, void* nova_datastruct_list_Nova_DoubleArrayFunctionMap_ref_Nova_allFunc, void* allFunc_context);
...
nova_datastruct_list_Nova_DoubleArrayFunctionMap_nativefunctionMap_Nova_all all;
...
typedef char (*nova_datastruct_list_Nova_IntRangeFunctionMap_nativefunctionMap0_Nova_all)(nova_datastruct_list_Nova_IntRangeFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_IntRange*, nova_datastruct_list_Nova_IntRangeFunctionMap_closure28_Nova_allFunc nova_datastruct_list_Nova_IntRangeFunctionMap_Nova_allFunc, void* nova_datastruct_list_Nova_IntRangeFunctionMap_ref_Nova_allFunc, void* allFunc_context);
...
nova_datastruct_list_Nova_IntRangeFunctionMap_nativefunctionMap0_Nova_all all__nova_datastruct_list_IntRange__nova_primitive_Bool;
...
nova_datastruct_list_Nova_LinkedListFunctionMap_nativefunctionMap0_Nova_all all__nova_datastruct_list_LinkedList__nova_primitive_Bool;
...
typedef nova_process_Nova_Process* (*nova_process_Nova_ProcessFunctionMap_nativefunctionMapProcessFunctionMap_Nova_construct)(nova_process_Nova_ProcessFunctionMap*, nova_exception_Nova_ExceptionData*, nova_io_Nova_InputStream*);
...
typedef spectra_tree_nodes_annotations_Nova_AbstractAnnotation* (*spectra_tree_nodes_annotations_Nova_AbstractAnnotationFunctionMap_nativefunctionMap_static_Nova_parse)(spectra_tree_nodes_annotations_Nova_AbstractAnnotationFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, nova_Nova_String*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*, char);
...
typedef spectra_tree_nodes_annotations_Nova_NativeAnnotation* (*spectra_tree_nodes_annotations_Nova_NativeAnnotationFunctionMap_nativefunctionMap_static_Nova_parse)(spectra_tree_nodes_annotations_Nova_NativeAnnotationFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, nova_Nova_String*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*, char);
...
typedef spectra_tree_nodes_annotations_Nova_PrivateAnnotation* (*spectra_tree_nodes_annotations_Nova_PrivateAnnotationFunctionMap_nativefunctionMap_static_Nova_parse)(spectra_tree_nodes_annotations_Nova_PrivateAnnotationFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, nova_Nova_String*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*, char);
...
typedef spectra_tree_nodes_annotations_Nova_StaticAnnotation* (*spectra_tree_nodes_annotations_Nova_StaticAnnotationFunctionMap_nativefunctionMap_static_Nova_parse)(spectra_tree_nodes_annotations_Nova_StaticAnnotationFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, nova_Nova_String*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*, char);
...
typedef example_Nova_Animal* (*example_Nova_AnimalFunctionMap_nativefunctionMapAnimalFunctionMap_Nova_construct)(example_Nova_AnimalFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef int (*example_Nova_AnimalFunctionMap_nativefunctionMap_Nova_getNumLegs)(example_Nova_AnimalFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Animal*);
typedef int (*example_Nova_AnimalFunctionMap_nativefunctionMap_Nova_getNumEyes)(example_Nova_AnimalFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Animal*);
typedef nova_Nova_String* (*example_Nova_AnimalFunctionMap_nativefunctionMap_Nova_getDescription)(example_Nova_AnimalFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Animal*);
typedef nova_Nova_String* (*example_Nova_AnimalFunctionMap_nativefunctionMap_Nova_toString)(example_Nova_AnimalFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Animal*);
typedef example_Nova_AnimalFunctionMap* (*example_Nova_AnimalFunctionMap_native_Nova_construct)(example_Nova_AnimalFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_ArrayDemo* (*example_Nova_ArrayDemoFunctionMap_nativefunctionMapArrayDemoFunctionMap_Nova_construct)(example_Nova_ArrayDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_ArrayDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_ArrayDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_ArrayDemoFunctionMap* (*example_Nova_ArrayDemoFunctionMap_native_Nova_construct)(example_Nova_ArrayDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_BodyBuilder* (*example_Nova_BodyBuilderFunctionMap_nativefunctionMapBodyBuilderFunctionMap_Nova_construct)(example_Nova_BodyBuilderFunctionMap*, nova_exception_Nova_ExceptionData*, int, nova_Nova_String*);
typedef example_Nova_BodyBuilderFunctionMap* (*example_Nova_BodyBuilderFunctionMap_native_Nova_construct)(example_Nova_BodyBuilderFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_ClosureDemo* (*example_Nova_ClosureDemoFunctionMap_nativefunctionMapClosureDemoFunctionMap_Nova_construct)(example_Nova_ClosureDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_ClosureDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_ClosureDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_ClosureDemoFunctionMap* (*example_Nova_ClosureDemoFunctionMap_native_Nova_construct)(example_Nova_ClosureDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_DogFunctionMap* (*example_Nova_DogFunctionMap_native_Nova_construct)(example_Nova_DogFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_ExceptionHandlingDemo* (*example_Nova_ExceptionHandlingDemoFunctionMap_nativefunctionMapExceptionHandlingDemoFunctionMap_Nova_construct)(example_Nova_ExceptionHandlingDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_ExceptionHandlingDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_ExceptionHandlingDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_ExceptionHandlingDemoFunctionMap* (*example_Nova_ExceptionHandlingDemoFunctionMap_native_Nova_construct)(example_Nova_ExceptionHandlingDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_FileTest* (*example_Nova_FileTestFunctionMap_nativefunctionMapFileTestFunctionMap_Nova_construct)(example_Nova_FileTestFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_FileTestFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_FileTestFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_FileTestFunctionMap* (*example_Nova_FileTestFunctionMap_native_Nova_construct)(example_Nova_FileTestFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_GenericDemo* (*example_Nova_GenericDemoFunctionMap_nativefunctionMapGenericDemoFunctionMap_Nova_construct)(example_Nova_GenericDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_GenericDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_GenericDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_GenericDemoFunctionMap* (*example_Nova_GenericDemoFunctionMap_native_Nova_construct)(example_Nova_GenericDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_HashMapDemo* (*example_Nova_HashMapDemoFunctionMap_nativefunctionMapHashMapDemoFunctionMap_Nova_construct)(example_Nova_HashMapDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_HashMapDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_HashMapDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_HashMapDemoFunctionMap* (*example_Nova_HashMapDemoFunctionMap_native_Nova_construct)(example_Nova_HashMapDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_HashSetDemo* (*example_Nova_HashSetDemoFunctionMap_nativefunctionMapHashSetDemoFunctionMap_Nova_construct)(example_Nova_HashSetDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_HashSetDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_HashSetDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_HashSetDemoFunctionMap* (*example_Nova_HashSetDemoFunctionMap_native_Nova_construct)(example_Nova_HashSetDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_IntegerTest* (*example_Nova_IntegerTestFunctionMap_nativefunctionMapIntegerTestFunctionMap_Nova_construct)(example_Nova_IntegerTestFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_IntegerTestFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_IntegerTestFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_IntegerTestFunctionMap* (*example_Nova_IntegerTestFunctionMap_native_Nova_construct)(example_Nova_IntegerTestFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_Lab* (*example_Nova_LabFunctionMap_nativefunctionMapLabFunctionMap_Nova_construct)(example_Nova_LabFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_LabFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_LabFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_LabFunctionMap* (*example_Nova_LabFunctionMap_native_Nova_construct)(example_Nova_LabFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_MathDemo* (*example_Nova_MathDemoFunctionMap_nativefunctionMapMathDemoFunctionMap_Nova_construct)(example_Nova_MathDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_MathDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_MathDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_MathDemoFunctionMap* (*example_Nova_MathDemoFunctionMap_native_Nova_construct)(example_Nova_MathDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_NonWholeDivisionException* (*example_Nova_NonWholeDivisionExceptionFunctionMap_nativefunctionMapNonWholeDivisionExceptionFunctionMap_Nova_construct)(example_Nova_NonWholeDivisionExceptionFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef example_Nova_NonWholeDivisionExceptionFunctionMap* (*example_Nova_NonWholeDivisionExceptionFunctionMap_native_Nova_construct)(example_Nova_NonWholeDivisionExceptionFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_Person* (*example_Nova_PersonFunctionMap_nativefunctionMapPersonFunctionMap_Nova_construct)(example_Nova_PersonFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
typedef void (*example_Nova_PersonFunctionMap_nativefunctionMap_Nova_sayHello)(example_Nova_PersonFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Person*);
typedef example_Nova_PersonFunctionMap* (*example_Nova_PersonFunctionMap_native_Nova_construct)(example_Nova_PersonFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_PolygonFunctionMap* (*example_Nova_PolygonFunctionMap_native_Nova_construct)(example_Nova_PolygonFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_PolymorphismDemo* (*example_Nova_PolymorphismDemoFunctionMap_nativefunctionMapPolymorphismDemoFunctionMap_Nova_construct)(example_Nova_PolymorphismDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_PolymorphismDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_PolymorphismDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_PolymorphismDemoFunctionMap* (*example_Nova_PolymorphismDemoFunctionMap_native_Nova_construct)(example_Nova_PolymorphismDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_QueueDemo* (*example_Nova_QueueDemoFunctionMap_nativefunctionMapQueueDemoFunctionMap_Nova_construct)(example_Nova_QueueDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_QueueDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_QueueDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_QueueDemoFunctionMap* (*example_Nova_QueueDemoFunctionMap_native_Nova_construct)(example_Nova_QueueDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_SpiderFunctionMap* (*example_Nova_SpiderFunctionMap_native_Nova_construct)(example_Nova_SpiderFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_Square* (*example_Nova_SquareFunctionMap_nativefunctionMapSquareFunctionMap_Nova_construct)(example_Nova_SquareFunctionMap*, nova_exception_Nova_ExceptionData*, int);
typedef int (*example_Nova_SquareFunctionMap_nativefunctionMap_Nova_numberSides)(example_Nova_SquareFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Square*);
typedef double (*example_Nova_SquareFunctionMap_nativefunctionMap_Nova_calculateArea)(example_Nova_SquareFunctionMap*, nova_exception_Nova_ExceptionData*, example_Nova_Square*);
typedef example_Nova_SquareFunctionMap* (*example_Nova_SquareFunctionMap_native_Nova_construct)(example_Nova_SquareFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_SvgChart* (*example_Nova_SvgChartFunctionMap_nativefunctionMapSvgChartFunctionMap_Nova_construct)(example_Nova_SvgChartFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_SvgChartFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_SvgChartFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_SvgChartFunctionMap* (*example_Nova_SvgChartFunctionMap_native_Nova_construct)(example_Nova_SvgChartFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_SvgFractal* (*example_Nova_SvgFractalFunctionMap_nativefunctionMapSvgFractalFunctionMap_Nova_construct)(example_Nova_SvgFractalFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_SvgFractalFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_SvgFractalFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_SvgFractalFunctionMap* (*example_Nova_SvgFractalFunctionMap_native_Nova_construct)(example_Nova_SvgFractalFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_T1* (*example_Nova_T1FunctionMap_nativefunctionMapT1FunctionMap_Nova_construct)(example_Nova_T1FunctionMap*, nova_exception_Nova_ExceptionData*);
typedef example_Nova_T1FunctionMap* (*example_Nova_T1FunctionMap_native_Nova_construct)(example_Nova_T1FunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_T2FunctionMap* (*example_Nova_T2FunctionMap_native_Nova_construct)(example_Nova_T2FunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_Test* (*example_Nova_TestFunctionMap_nativefunctionMapTestFunctionMap_Nova_construct)(example_Nova_TestFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_TestFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_TestFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_TestFunctionMap* (*example_Nova_TestFunctionMap_native_Nova_construct)(example_Nova_TestFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_ThreadDemo* (*example_Nova_ThreadDemoFunctionMap_nativefunctionMapThreadDemoFunctionMap_Nova_construct)(example_Nova_ThreadDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_Nova_ThreadDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_Nova_ThreadDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_Nova_ThreadDemoFunctionMap* (*example_Nova_ThreadDemoFunctionMap_native_Nova_construct)(example_Nova_ThreadDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_Nova_ThreadDemoImplementation* (*example_Nova_ThreadDemoImplementationFunctionMap_nativefunctionMapThreadDemoImplementationFunctionMap_Nova_construct)(example_Nova_ThreadDemoImplementationFunctionMap*, nova_exception_Nova_ExceptionData*, long_long, nova_Nova_String*);
typedef example_Nova_ThreadDemoImplementationFunctionMap* (*example_Nova_ThreadDemoImplementationFunctionMap_native_Nova_construct)(example_Nova_ThreadDemoImplementationFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_ackermann_Nova_Ackermann* (*example_ackermann_Nova_AckermannFunctionMap_nativefunctionMapAckermannFunctionMap_Nova_construct)(example_ackermann_Nova_AckermannFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_ackermann_Nova_AckermannFunctionMap_nativefunctionMap_static_Nova_main)(example_ackermann_Nova_AckermannFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef int (*example_ackermann_Nova_AckermannFunctionMap_nativefunctionMap_static_Nova_run)(example_ackermann_Nova_AckermannFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
typedef int (*example_ackermann_Nova_AckermannFunctionMap_nativefunctionMap_static_Nova_run2)(example_ackermann_Nova_AckermannFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
typedef example_ackermann_Nova_AckermannFunctionMap* (*example_ackermann_Nova_AckermannFunctionMap_native_Nova_construct)(example_ackermann_Nova_AckermannFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_copy_Nova_Dog* (*example_copy_Nova_DogFunctionMap_nativefunctionMapDogFunctionMap_Nova_construct)(example_copy_Nova_DogFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
typedef example_copy_Nova_DogFunctionMap* (*example_copy_Nova_DogFunctionMap_native_Nova_construct)(example_copy_Nova_DogFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_database_Nova_DatabaseDemo* (*example_database_Nova_DatabaseDemoFunctionMap_nativefunctionMapDatabaseDemoFunctionMap_Nova_construct)(example_database_Nova_DatabaseDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_database_Nova_DatabaseDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_database_Nova_DatabaseDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_database_Nova_DatabaseDemoFunctionMap* (*example_database_Nova_DatabaseDemoFunctionMap_native_Nova_construct)(example_database_Nova_DatabaseDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_network_Nova_ClientDemo* (*example_network_Nova_ClientDemoFunctionMap_nativefunctionMapClientDemoFunctionMap_Nova_construct)(example_network_Nova_ClientDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_network_Nova_ClientDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_network_Nova_ClientDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_network_Nova_ClientDemoFunctionMap* (*example_network_Nova_ClientDemoFunctionMap_native_Nova_construct)(example_network_Nova_ClientDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_network_Nova_ConnectionThread* (*example_network_Nova_ConnectionThreadFunctionMap_nativefunctionMapConnectionThreadFunctionMap_Nova_construct)(example_network_Nova_ConnectionThreadFunctionMap*, nova_exception_Nova_ExceptionData*, nova_network_Nova_ConnectionSocket*);
typedef example_network_Nova_ConnectionThreadFunctionMap* (*example_network_Nova_ConnectionThreadFunctionMap_native_Nova_construct)(example_network_Nova_ConnectionThreadFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_network_Nova_OutputThread* (*example_network_Nova_OutputThreadFunctionMap_nativefunctionMapOutputThreadFunctionMap_Nova_construct)(example_network_Nova_OutputThreadFunctionMap*, nova_exception_Nova_ExceptionData*, nova_network_Nova_ServerSocket*, nova_network_Nova_ConnectionSocket*);
typedef example_network_Nova_OutputThreadFunctionMap* (*example_network_Nova_OutputThreadFunctionMap_native_Nova_construct)(example_network_Nova_OutputThreadFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef example_network_Nova_ServerDemo* (*example_network_Nova_ServerDemoFunctionMap_nativefunctionMapServerDemoFunctionMap_Nova_construct)(example_network_Nova_ServerDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*example_network_Nova_ServerDemoFunctionMap_nativefunctionMap_static_Nova_main)(example_network_Nova_ServerDemoFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef example_network_Nova_ServerDemoFunctionMap* (*example_network_Nova_ServerDemoFunctionMap_native_Nova_construct)(example_network_Nova_ServerDemoFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_AssignmentStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_AssignmentStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_AssignmentStability*);
typedef stabilitytest_Nova_AssignmentStabilityFunctionMap* (*stabilitytest_Nova_AssignmentStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_AssignmentStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_ClassWithProperties* (*stabilitytest_Nova_ClassWithPropertiesFunctionMap_nativefunctionMapClassWithPropertiesFunctionMap_Nova_construct)(stabilitytest_Nova_ClassWithPropertiesFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_ClassWithPropertiesFunctionMap* (*stabilitytest_Nova_ClassWithPropertiesFunctionMap_native_Nova_construct)(stabilitytest_Nova_ClassWithPropertiesFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_ClientThread* (*stabilitytest_Nova_ClientThreadFunctionMap_nativefunctionMapClientThreadFunctionMap_Nova_construct)(stabilitytest_Nova_ClientThreadFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*, int);
typedef stabilitytest_Nova_ClientThreadFunctionMap* (*stabilitytest_Nova_ClientThreadFunctionMap_native_Nova_construct)(stabilitytest_Nova_ClientThreadFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_ClosureStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_ClosureStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_ClosureStability*);
typedef stabilitytest_Nova_ClosureStabilityFunctionMap* (*stabilitytest_Nova_ClosureStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_ClosureStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_ExceptionStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_ExceptionStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_ExceptionStability*);
typedef stabilitytest_Nova_ExceptionStabilityFunctionMap* (*stabilitytest_Nova_ExceptionStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_ExceptionStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_ExternalInnerClassStability* (*stabilitytest_Nova_ExternalInnerClassStability_native_Nova_construct)(stabilitytest_Nova_ExternalInnerClassStability*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_ExternalInnerClassStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_ExternalInnerClassStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_ExternalInnerClassStability*);
typedef stabilitytest_Nova_ExternalInnerClassStabilityFunctionMap* (*stabilitytest_Nova_ExternalInnerClassStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_ExternalInnerClassStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_FileStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_FileStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_FileStability*);
typedef stabilitytest_Nova_FileStabilityFunctionMap* (*stabilitytest_Nova_FileStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_FileStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_InnerClassStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_InnerClassStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_InnerClassStability*);
typedef stabilitytest_Nova_InnerClassStabilityFunctionMap* (*stabilitytest_Nova_InnerClassStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_InnerClassStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_MyOuter* (*stabilitytest_Nova_MyOuterFunctionMap_nativefunctionMapMyOuterFunctionMap_Nova_construct)(stabilitytest_Nova_MyOuterFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef void (*stabilitytest_Nova_MyOuterFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_MyOuterFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_MyOuter*);
typedef stabilitytest_Nova_MyOuterFunctionMap* (*stabilitytest_Nova_MyOuterFunctionMap_native_Nova_construct)(stabilitytest_Nova_MyOuterFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_MyInner* (*stabilitytest_Nova_MyInnerFunctionMap_nativefunctionMapMyInnerFunctionMap_Nova_construct)(stabilitytest_Nova_MyInnerFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
typedef stabilitytest_Nova_MyInnerFunctionMap* (*stabilitytest_Nova_MyInnerFunctionMap_native_Nova_construct)(stabilitytest_Nova_MyInnerFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_LambdaStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_LambdaStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_LambdaStability*);
typedef stabilitytest_Nova_LambdaStabilityFunctionMap* (*stabilitytest_Nova_LambdaStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_LambdaStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_NetworkStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_NetworkStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_NetworkStability*);
typedef stabilitytest_Nova_NetworkStabilityFunctionMap* (*stabilitytest_Nova_NetworkStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_NetworkStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_Node* (*stabilitytest_Nova_NodeFunctionMap_nativefunctionMapNodeFunctionMap_Nova_construct)(stabilitytest_Nova_NodeFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_NodeFunctionMap* (*stabilitytest_Nova_NodeFunctionMap_native_Nova_construct)(stabilitytest_Nova_NodeFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_PolymorphicSubClassFunctionMap* (*stabilitytest_Nova_PolymorphicSubClassFunctionMap_native_Nova_construct)(stabilitytest_Nova_PolymorphicSubClassFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_PolymorphicSuperClass* (*stabilitytest_Nova_PolymorphicSuperClassFunctionMap_nativefunctionMapPolymorphicSuperClassFunctionMap_Nova_construct)(stabilitytest_Nova_PolymorphicSuperClassFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_PolymorphicSubClass* (*stabilitytest_Nova_PolymorphicSuperClassFunctionMap_nativefunctionMap_Nova_giveBirth)(stabilitytest_Nova_PolymorphicSuperClassFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_PolymorphicSuperClass*);
typedef nova_Nova_String* (*stabilitytest_Nova_PolymorphicSuperClassFunctionMap_nativefunctionMap_Nova_toString)(stabilitytest_Nova_PolymorphicSuperClassFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_PolymorphicSuperClass*);
typedef stabilitytest_Nova_PolymorphicSuperClassFunctionMap* (*stabilitytest_Nova_PolymorphicSuperClassFunctionMap_native_Nova_construct)(stabilitytest_Nova_PolymorphicSuperClassFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_PolymorphismStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_PolymorphismStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_PolymorphismStability*);
typedef stabilitytest_Nova_PolymorphismStabilityFunctionMap* (*stabilitytest_Nova_PolymorphismStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_PolymorphismStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_RegexStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_RegexStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_RegexStability*);
typedef stabilitytest_Nova_RegexStabilityFunctionMap* (*stabilitytest_Nova_RegexStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_RegexStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_StabilityExceptionHandler* (*stabilitytest_Nova_StabilityExceptionHandlerFunctionMap_nativefunctionMapStabilityExceptionHandlerFunctionMap_Nova_construct)(stabilitytest_Nova_StabilityExceptionHandlerFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
typedef stabilitytest_Nova_StabilityExceptionHandlerFunctionMap* (*stabilitytest_Nova_StabilityExceptionHandlerFunctionMap_native_Nova_construct)(stabilitytest_Nova_StabilityExceptionHandlerFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_StabilityTestFunctionMap_nativefunctionMap_static_Nova_main)(stabilitytest_Nova_StabilityTestFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef void (*stabilitytest_Nova_StabilityTestFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_StabilityTestFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
typedef void (*stabilitytest_Nova_StabilityTestFunctionMap_nativefunctionMap_Nova_fail)(stabilitytest_Nova_StabilityTestFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*, nova_Nova_String*, char);
typedef stabilitytest_Nova_StabilityTestFunctionMap* (*stabilitytest_Nova_StabilityTestFunctionMap_native_Nova_construct)(stabilitytest_Nova_StabilityTestFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_StabilityTestCase* (*stabilitytest_Nova_StabilityTestCaseFunctionMap_nativefunctionMapStabilityTestCaseFunctionMap_Nova_construct)(stabilitytest_Nova_StabilityTestCaseFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
typedef stabilitytest_Nova_StabilityTestCaseFunctionMap* (*stabilitytest_Nova_StabilityTestCaseFunctionMap_native_Nova_construct)(stabilitytest_Nova_StabilityTestCaseFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_StabilityTestException* (*stabilitytest_Nova_StabilityTestExceptionFunctionMap_nativefunctionMapStabilityTestExceptionFunctionMap_Nova_construct)(stabilitytest_Nova_StabilityTestExceptionFunctionMap*, nova_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_StabilityTestExceptionFunctionMap* (*stabilitytest_Nova_StabilityTestExceptionFunctionMap_native_Nova_construct)(stabilitytest_Nova_StabilityTestExceptionFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_StaticImportStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_StaticImportStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_StaticImportStability*);
typedef stabilitytest_Nova_StaticImportStabilityFunctionMap* (*stabilitytest_Nova_StaticImportStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_StaticImportStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_SyntaxStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_SyntaxStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_SyntaxStability*);
typedef stabilitytest_Nova_SyntaxStabilityFunctionMap* (*stabilitytest_Nova_SyntaxStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_SyntaxStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_ThreadImplementation* (*stabilitytest_Nova_ThreadImplementationFunctionMap_nativefunctionMapThreadImplementationFunctionMap_Nova_construct)(stabilitytest_Nova_ThreadImplementationFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
typedef stabilitytest_Nova_ThreadImplementationFunctionMap* (*stabilitytest_Nova_ThreadImplementationFunctionMap_native_Nova_construct)(stabilitytest_Nova_ThreadImplementationFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_ThreadStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_ThreadStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_ThreadStability*);
typedef stabilitytest_Nova_ThreadStabilityFunctionMap* (*stabilitytest_Nova_ThreadStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_ThreadStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_TimeStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_TimeStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_TimeStability*);
typedef stabilitytest_Nova_TimeStabilityFunctionMap* (*stabilitytest_Nova_TimeStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_TimeStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_ToStringStabilityFunctionMap_nativefunctionMap_Nova_test)(stabilitytest_Nova_ToStringStabilityFunctionMap*, nova_exception_Nova_ExceptionData*, stabilitytest_Nova_ToStringStability*);
typedef stabilitytest_Nova_ToStringStabilityFunctionMap* (*stabilitytest_Nova_ToStringStabilityFunctionMap_native_Nova_construct)(stabilitytest_Nova_ToStringStabilityFunctionMap*, nova_exception_Nova_ExceptionData*);
...
typedef stabilitytest_Nova_UnstableExceptionFunctionMap* (*stabilitytest_Nova_UnstableExceptionFunctionMap_native_Nova_construct)(stabilitytest_Nova_UnstableExceptionFunctionMap*, nova_exception_Nova_ExceptionData*);
