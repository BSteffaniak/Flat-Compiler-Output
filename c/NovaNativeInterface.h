...
typedef nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_ImmutableArray_native_Nova_toArray)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*);
...
typedef nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_ImmutableArray_native_Nova_toMutable)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*);
...
nova_datastruct_list_Nova_ImmutableArray_native_Nova_toArray toArray;
