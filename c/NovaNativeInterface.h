...
typedef compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation* (*compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation_native_static_Nova_parse)(compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, nova_Nova_String*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*, int);
typedef compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation* (*compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation_native_Nova_construct)(compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation*, nova_exception_Nova_ExceptionData*, compiler_tree_nodes_Nova_Node*, compiler_util_Nova_Location*);

typedef struct compiler_tree_nodes_annotations_native_PrimitiveArrayAnnotation
{
compiler_tree_nodes_annotations_Nova_PrimitiveArrayAnnotation_native_Nova_construct PrimitiveArrayAnnotation;
} compiler_tree_nodes_annotations_native_PrimitiveArrayAnnotation;
...
compiler_tree_nodes_annotations_native_PrimitiveArrayAnnotation compiler_tree_nodes_annotations_PrimitiveArrayAnnotation;
