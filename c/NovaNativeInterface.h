...
typedef nova_meta_Nova_ModifierFunctionMap* (*nova_meta_Nova_ModifierFunctionMap_native_Nova_construct)(nova_meta_Nova_ModifierFunctionMap*, nova_exception_Nova_ExceptionData*);

typedef struct nova_meta_native_ModifierFunctionMap
{
nova_meta_Nova_ModifierFunctionMap_native_Nova_construct ModifierFunctionMap;
} nova_meta_native_ModifierFunctionMap;
...
nova_meta_native_ModifierFunctionMap nova_meta_ModifierFunctionMap;
