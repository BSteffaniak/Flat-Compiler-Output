...
typedef long_long (*nova_datastruct_list_Nova_ImmutableArray_native_Nova_sumSize)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*);
...
typedef nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_ImmutableArray_native1_Nova_construct)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, int);
typedef nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_ImmutableArray_native2_Nova_construct)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
typedef nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_ImmutableArray_native3_Nova_construct)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_Nova_Object**, int);
...
nova_datastruct_list_Nova_ImmutableArray_native_Nova_sumSize sumSize;
...
nova_datastruct_list_Nova_ImmutableArray_native1_Nova_construct ImmutableArray__nova_primitive_number_Int;
nova_datastruct_list_Nova_ImmutableArray_native2_Nova_construct ImmutableArray__nova_datastruct_list_Array;
nova_datastruct_list_Nova_ImmutableArray_native3_Nova_construct ImmutableArray__Array1d_nova_Object__nova_primitive_number_Int;
...
typedef nova_exception_Nova_ExceptionData* (*nova_exception_Nova_ExceptionData_native_Nova_getDataByException)(nova_exception_Nova_ExceptionData*, nova_exception_Nova_ExceptionData*, nova_exception_Nova_Exception*, int);
typedef void (*nova_exception_Nova_ExceptionData_native_Nova_jumpToBuffer)(nova_exception_Nova_ExceptionData*, nova_exception_Nova_ExceptionData*, nova_exception_Nova_Exception*, int);
...
nova_exception_Nova_ExceptionData_native_Nova_getDataByException getDataByException;
...
typedef nova_Nova_String* (*compiler_tree_nodes_Nova_PlaceholderValue_native_Nova_writeScope)(compiler_tree_nodes_Nova_PlaceholderValue*, nova_exception_Nova_ExceptionData*);
...
{
compiler_tree_nodes_Nova_PlaceholderValue_native_Nova_writeScope writeScope;
...
typedef compiler_tree_nodes_controlstructures_Nova_ControlStructure* (*compiler_tree_nodes_controlstructures_Nova_ControlStructure_native_Nova_construct)(compiler_tree_nodes_controlstructures_Nova_ControlStructure*, nova_exception_Nova_ExceptionData*);
...
typedef char (*compiler_tree_nodes_functions_Nova_CallableFunction_native_Nova_parseParameters)(compiler_tree_nodes_functions_Nova_CallableFunction*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, char);
...
typedef int (*compiler_util_Nova_CompilerStringFunctions_native0_Nova_findOperatorInBaseScope)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, char, int, int);
typedef int (*compiler_util_Nova_CompilerStringFunctions_native1_Nova_findOperatorInBaseScope)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int, int);
...
typedef int (*compiler_util_Nova_CompilerStringFunctions_native_Nova_findWordInBaseScope)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int, int, int);
...
compiler_util_Nova_CompilerStringFunctions_native0_Nova_findOperatorInBaseScope findOperatorInBaseScope__nova_primitive_number_Char__nova_primitive_number_Int__nova_primitive_Bool;
compiler_util_Nova_CompilerStringFunctions_native1_Nova_findOperatorInBaseScope findOperatorInBaseScope__nova_String__nova_primitive_number_Int__nova_primitive_Bool;
...
compiler_util_Nova_CompilerStringFunctions_native_Nova_findWordInBaseScope findWordInBaseScope;
