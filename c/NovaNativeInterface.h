...
typedef nova_Nova_String* (*nova_Nova_String_native_Nova_trim)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, int, int, nova_datastruct_list_Nova_Array*);
...
typedef nova_Nova_String* (*nova_Nova_String_native_Nova_getGroupedChars)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int, int);
...
typedef nova_Nova_String* (*nova_Nova_String_native3_Nova_construct)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
nova_Nova_String_native3_Nova_construct String__nova_datastruct_list_Array;
...
typedef nova_Nova_String* (*nova_Nova_StringFunctionMap_nativefunctionMapStringFunctionMap3_Nova_construct)(nova_Nova_StringFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
typedef nova_Nova_String* (*nova_Nova_StringFunctionMap_nativefunctionMap_Nova_trim)(nova_Nova_StringFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int, int, nova_datastruct_list_Nova_Array*);
...
typedef nova_Nova_String* (*nova_Nova_StringFunctionMap_nativefunctionMap_Nova_getGroupedChars)(nova_Nova_StringFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, nova_datastruct_list_Nova_Array*, int, int, char);
...
nova_Nova_StringFunctionMap_nativefunctionMapStringFunctionMap3_Nova_construct construct__nova_datastruct_list_Array;
...
typedef nova_datastruct_list_Nova_List* (*nova_datastruct_list_Nova_ListFunctionMap_nativefunctionMap0_Nova_forEach)(nova_datastruct_list_Nova_ListFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_ListFunctionMap_closure294_Nova_func nova_datastruct_list_Nova_ListFunctionMap_Nova_func, void* nova_datastruct_list_Nova_ListFunctionMap_ref_Nova_func, void* func_context);
typedef nova_datastruct_list_Nova_List* (*nova_datastruct_list_Nova_ListFunctionMap_nativefunctionMap0_Nova_map)(nova_datastruct_list_Nova_ListFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_ListFunctionMap_closure295_Nova_mapFunc nova_datastruct_list_Nova_ListFunctionMap_Nova_mapFunc, void* nova_datastruct_list_Nova_ListFunctionMap_ref_Nova_mapFunc, void* mapFunc_context);
typedef char (*nova_datastruct_list_Nova_ListFunctionMap_nativefunctionMap0_Nova_any)(nova_datastruct_list_Nova_ListFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_ListFunctionMap_closure296_Nova_anyFunc nova_datastruct_list_Nova_ListFunctionMap_Nova_anyFunc, void* nova_datastruct_list_Nova_ListFunctionMap_ref_Nova_anyFunc, void* anyFunc_context);
typedef char (*nova_datastruct_list_Nova_ListFunctionMap_nativefunctionMap0_Nova_all)(nova_datastruct_list_Nova_ListFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_ListFunctionMap_closure297_Nova_allFunc nova_datastruct_list_Nova_ListFunctionMap_Nova_allFunc, void* nova_datastruct_list_Nova_ListFunctionMap_ref_Nova_allFunc, void* allFunc_context, char);
typedef nova_datastruct_list_Nova_List* (*nova_datastruct_list_Nova_ListFunctionMap_nativefunctionMap0_Nova_filter)(nova_datastruct_list_Nova_ListFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_ListFunctionMap_closure298_Nova_filterFunc nova_datastruct_list_Nova_ListFunctionMap_Nova_filterFunc, void* nova_datastruct_list_Nova_ListFunctionMap_ref_Nova_filterFunc, void* filterFunc_context);
...
typedef char (*nova_datastruct_list_Nova_OrderedListFunctionMap_nativefunctionMap_Nova_findIndex)(nova_datastruct_list_Nova_OrderedListFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_OrderedList*, nova_datastruct_list_Nova_OrderedListFunctionMap_closure305_Nova_condition nova_datastruct_list_Nova_OrderedListFunctionMap_Nova_condition, void* nova_datastruct_list_Nova_OrderedListFunctionMap_ref_Nova_condition, void* condition_context, int);
...
typedef nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_StringCharArray_native_Nova_toCharArray)(nova_datastruct_list_Nova_StringCharArray*, nova_exception_Nova_ExceptionData*);
...
typedef nova_datastruct_list_Nova_StringCharArray* (*nova_datastruct_list_Nova_StringCharArray_native0_Nova_construct)(nova_datastruct_list_Nova_StringCharArray*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
nova_datastruct_list_Nova_StringCharArray_native0_Nova_construct StringCharArray__nova_datastruct_list_Array;
...
typedef nova_datastruct_list_Nova_StringCharArray* (*nova_datastruct_list_Nova_StringCharArrayFunctionMap_nativefunctionMapStringCharArrayFunctionMap0_Nova_construct)(nova_datastruct_list_Nova_StringCharArrayFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
typedef nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_StringCharArrayFunctionMap_nativefunctionMap_Nova_toCharArray)(nova_datastruct_list_Nova_StringCharArrayFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_StringCharArray*);
...
{
nova_datastruct_list_Nova_StringCharArrayFunctionMap_nativefunctionMapStringCharArrayFunctionMap0_Nova_construct construct__nova_datastruct_list_Array;
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_Matrix_native_Nova_get)(nova_math_Nova_Matrix*, nova_exception_Nova_ExceptionData*, int);
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_Matrix_native_Nova_set)(nova_math_Nova_Matrix*, nova_exception_Nova_ExceptionData*, int, nova_datastruct_list_Nova_Array*);
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_MatrixFunctionMap_nativefunctionMap_Nova_get)(nova_math_Nova_MatrixFunctionMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Matrix*, int);
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_MatrixFunctionMap_nativefunctionMap_Nova_set)(nova_math_Nova_MatrixFunctionMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Matrix*, int, nova_datastruct_list_Nova_Array*);
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_PolynomialPropertyMap_nativefunctionMap_Nova_coefficients)(nova_math_Nova_PolynomialPropertyMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Polynomial*);
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_PolynomialPropertyMap_nativefunctionMap_Nova_degrees)(nova_math_Nova_PolynomialPropertyMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Polynomial*);
...
typedef nova_math_Nova_Sequence* (*nova_math_Nova_Sequence_native_Nova_construct)(nova_math_Nova_Sequence*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);

typedef struct nova_math_native_Sequence
{
nova_math_Nova_Sequence_native_Nova_construct Sequence;
} nova_math_native_Sequence;
typedef nova_math_Nova_Sequence* (*nova_math_Nova_SequenceFunctionMap_nativefunctionMapSequenceFunctionMap_Nova_construct)(nova_math_Nova_SequenceFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_SequencePropertyMap_nativefunctionMap_Nova_values)(nova_math_Nova_SequencePropertyMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Sequence*);
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_Vector_native_Nova_scale)(nova_math_Nova_Vector*, nova_exception_Nova_ExceptionData*, double);
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_Vector_native_Nova_normalize)(nova_math_Nova_Vector*, nova_exception_Nova_ExceptionData*);
...
typedef nova_math_Nova_Vector* (*nova_math_Nova_Vector_native1_Nova_construct)(nova_math_Nova_Vector*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
nova_math_Nova_Vector_native1_Nova_construct Vector__nova_datastruct_list_Array;
...
typedef nova_math_Nova_Vector* (*nova_math_Nova_VectorFunctionMap_nativefunctionMapVectorFunctionMap1_Nova_construct)(nova_math_Nova_VectorFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_VectorFunctionMap_nativefunctionMap_Nova_scale)(nova_math_Nova_VectorFunctionMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Vector*, double);
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_VectorFunctionMap_nativefunctionMap_Nova_normalize)(nova_math_Nova_VectorFunctionMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Vector*);
...
nova_math_Nova_VectorFunctionMap_nativefunctionMapVectorFunctionMap1_Nova_construct construct__nova_datastruct_list_Array;
...
typedef nova_datastruct_list_Nova_Array* (*nova_math_Nova_VectorPropertyMap_nativefunctionMap_Nova_data)(nova_math_Nova_VectorPropertyMap*, nova_exception_Nova_ExceptionData*, nova_math_Nova_Vector*);
...
typedef char (*nova_primitive_number_Nova_ByteFunctionMap_nativefunctionMap_Nova_compareTo)(nova_primitive_number_Nova_ByteFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Byte*, nova_primitive_number_Nova_Byte*);
typedef nova_primitive_number_Nova_Byte* (*nova_primitive_number_Nova_ByteFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_ByteFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Byte*, nova_primitive_number_Nova_Byte*);
typedef nova_primitive_number_Nova_Byte* (*nova_primitive_number_Nova_ByteFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_ByteFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Byte*, nova_primitive_number_Nova_Byte*);
typedef char (*nova_primitive_number_Nova_ByteFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_ByteFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Byte*, nova_primitive_number_Nova_Byte*);
...
typedef char (*nova_primitive_number_Nova_CharFunctionMap_nativefunctionMap_Nova_compareTo)(nova_primitive_number_Nova_CharFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Char*, nova_primitive_number_Nova_Char*);
typedef nova_primitive_number_Nova_Char* (*nova_primitive_number_Nova_CharFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_CharFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Char*, nova_primitive_number_Nova_Char*);
typedef nova_primitive_number_Nova_Char* (*nova_primitive_number_Nova_CharFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_CharFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Char*, nova_primitive_number_Nova_Char*);
typedef char (*nova_primitive_number_Nova_CharFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_CharFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Char*, nova_primitive_number_Nova_Char*);
...
typedef nova_primitive_number_Nova_Double* (*nova_primitive_number_Nova_DoubleFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_DoubleFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Double*, nova_primitive_number_Nova_Double*);
typedef nova_primitive_number_Nova_Double* (*nova_primitive_number_Nova_DoubleFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_DoubleFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Double*, nova_primitive_number_Nova_Double*);
typedef char (*nova_primitive_number_Nova_DoubleFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_DoubleFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Double*, nova_primitive_number_Nova_Double*);
...
typedef nova_primitive_number_Nova_Float* (*nova_primitive_number_Nova_FloatFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_FloatFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Float*, nova_primitive_number_Nova_Float*);
typedef nova_primitive_number_Nova_Float* (*nova_primitive_number_Nova_FloatFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_FloatFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Float*, nova_primitive_number_Nova_Float*);
typedef char (*nova_primitive_number_Nova_FloatFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_FloatFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Float*, nova_primitive_number_Nova_Float*);
...
typedef int (*nova_primitive_number_Nova_IntFunctionMap_nativefunctionMap_Nova_compareTo)(nova_primitive_number_Nova_IntFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Int*, nova_primitive_number_Nova_Int*);
typedef nova_primitive_number_Nova_Int* (*nova_primitive_number_Nova_IntFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_IntFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Int*, nova_primitive_number_Nova_Int*);
typedef nova_primitive_number_Nova_Int* (*nova_primitive_number_Nova_IntFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_IntFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Int*, nova_primitive_number_Nova_Int*);
typedef char (*nova_primitive_number_Nova_IntFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_IntFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Int*, nova_primitive_number_Nova_Int*);
...
typedef nova_primitive_number_Nova_Long* (*nova_primitive_number_Nova_LongFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_LongFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Long*, nova_primitive_number_Nova_Long*);
typedef nova_primitive_number_Nova_Long* (*nova_primitive_number_Nova_LongFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_LongFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Long*, nova_primitive_number_Nova_Long*);
typedef char (*nova_primitive_number_Nova_LongFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_LongFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Long*, nova_primitive_number_Nova_Long*);
...
typedef short (*nova_primitive_number_Nova_ShortFunctionMap_nativefunctionMap_Nova_compareTo)(nova_primitive_number_Nova_ShortFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Short*, nova_primitive_number_Nova_Short*);
typedef nova_primitive_number_Nova_Short* (*nova_primitive_number_Nova_ShortFunctionMap_nativefunctionMap_Nova_multiply)(nova_primitive_number_Nova_ShortFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Short*, nova_primitive_number_Nova_Short*);
typedef nova_primitive_number_Nova_Short* (*nova_primitive_number_Nova_ShortFunctionMap_nativefunctionMap_Nova_multiplyEquals)(nova_primitive_number_Nova_ShortFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Short*, nova_primitive_number_Nova_Short*);
typedef char (*nova_primitive_number_Nova_ShortFunctionMap_nativefunctionMap_Nova_equals)(nova_primitive_number_Nova_ShortFunctionMap*, nova_exception_Nova_ExceptionData*, nova_primitive_number_Nova_Short*, nova_primitive_number_Nova_Short*);
...
typedef nova_thread_Nova_Thread* (*nova_thread_Nova_ThreadFunctionMap_nativefunctionMapThreadFunctionMap1_Nova_construct)(nova_thread_Nova_ThreadFunctionMap*, nova_exception_Nova_ExceptionData*, nova_thread_Nova_ThreadFunctionMap_closure306_Nova_action nova_thread_Nova_ThreadFunctionMap_Nova_action, void* nova_thread_Nova_ThreadFunctionMap_ref_Nova_action, void* action_context);
...
typedef nova_time_Nova_Timer* (*nova_time_Nova_TimerFunctionMap_nativefunctionMap_static_Nova_time)(nova_time_Nova_TimerFunctionMap*, nova_exception_Nova_ExceptionData*, nova_time_Nova_TimerFunctionMap_closure309_Nova_action nova_time_Nova_TimerFunctionMap_Nova_action, void* nova_time_Nova_TimerFunctionMap_ref_Nova_action, void* action_context, nova_time_Nova_TimerFunctionMap_closure310_Nova_callback nova_time_Nova_TimerFunctionMap_Nova_callback, void* nova_time_Nova_TimerFunctionMap_ref_Nova_callback, void* callback_context);
...
typedef void (*spectra_tree_Nova_SyntaxTree_native_Nova_processFiles)(spectra_tree_Nova_SyntaxTree*, nova_exception_Nova_ExceptionData*, spectra_tree_Nova_SyntaxTree_closure241_Nova_func spectra_tree_Nova_SyntaxTree_Nova_func, void* spectra_tree_Nova_SyntaxTree_ref_Nova_func, void* func_context);
...
typedef void (*spectra_tree_nodes_Nova_Node_native_static_Nova_strictParse)(spectra_tree_nodes_Nova_Node*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_Node_closure245_Nova_action spectra_tree_nodes_Nova_Node_Nova_action, void* spectra_tree_nodes_Nova_Node_ref_Nova_action, void* action_context);
typedef void (*spectra_tree_nodes_Nova_Node_native_static_Nova_catchSyntaxErrors)(spectra_tree_nodes_Nova_Node*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_Node_closure249_Nova_action spectra_tree_nodes_Nova_Node_Nova_action, void* spectra_tree_nodes_Nova_Node_ref_Nova_action, void* action_context);
...
typedef void (*spectra_tree_nodes_Nova_NodeFunctionMap_nativefunctionMap_static_Nova_strictParse)(spectra_tree_nodes_Nova_NodeFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_NodeFunctionMap_closure312_Nova_action spectra_tree_nodes_Nova_NodeFunctionMap_Nova_action, void* spectra_tree_nodes_Nova_NodeFunctionMap_ref_Nova_action, void* action_context);
typedef void (*spectra_tree_nodes_Nova_NodeFunctionMap_nativefunctionMap_static_Nova_catchSyntaxErrors)(spectra_tree_nodes_Nova_NodeFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_NodeFunctionMap_closure313_Nova_action spectra_tree_nodes_Nova_NodeFunctionMap_Nova_action, void* spectra_tree_nodes_Nova_NodeFunctionMap_ref_Nova_action, void* action_context);
...
typedef nova_datastruct_list_Nova_Array* (*spectra_tree_nodes_operations_Nova_OperatorPropertyMap_nativefunctionMap_static_Nova_OPERATOR_SYMBOLS)(spectra_tree_nodes_operations_Nova_OperatorPropertyMap*, nova_exception_Nova_ExceptionData*);
typedef nova_datastruct_list_Nova_Array* (*spectra_tree_nodes_operations_Nova_OperatorPropertyMap_nativefunctionMap_static_Nova_UNARY_OPERATOR_CHARS)(spectra_tree_nodes_operations_Nova_OperatorPropertyMap*, nova_exception_Nova_ExceptionData*);
...
typedef int (*spectra_util_Nova_CompilerStringFunctions_native_Nova_nextIndexThatDoesntContain)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int, int);
typedef int (*spectra_util_Nova_CompilerStringFunctions_native_Nova_nextIndexThatContains)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int, int, int);
...
typedef int (*spectra_util_Nova_CompilerStringFunctions_native_Nova_findEndingChar)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, char, int, int, spectra_util_Nova_CompilerStringFunctions_closure251_Nova_advance spectra_util_Nova_CompilerStringFunctions_Nova_advance, void* spectra_util_Nova_CompilerStringFunctions_ref_Nova_advance, void* advance_context, int);
...
typedef nova_datastruct_list_Nova_Array* (*spectra_util_Nova_CompilerStringFunctions_native_Nova_findOperatorIndices)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int);
...
typedef int (*spectra_util_Nova_CompilerStringFunctions_native1_Nova_findCharOnTopLevel)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int);
...
typedef nova_Nova_String* (*spectra_util_Nova_CompilerStringFunctions_native_Nova_findGroupedChars)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int);
...
typedef spectra_util_Nova_Bounds* (*spectra_util_Nova_CompilerStringFunctions_native_Nova_findStrings)(nova_Nova_String*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*, int, int, nova_datastruct_list_Nova_Array*);
...
spectra_util_Nova_CompilerStringFunctions_native1_Nova_findCharOnTopLevel findCharOnTopLevel__nova_datastruct_list_Array__nova_primitive_number_Int__nova_primitive_Bool;
