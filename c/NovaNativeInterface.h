...
typedef nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_ImmutableArray_native4_Nova_construct)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_Nova_Object**, int);
...
nova_datastruct_list_Nova_ImmutableArray_native4_Nova_construct ImmutableArray__Array1d_nova_Object__nova_primitive_number_Int;
