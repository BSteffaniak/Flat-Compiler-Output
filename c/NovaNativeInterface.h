...
typedef char (*compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_compatibleArguments)(compiler_tree_nodes_functions_Nova_FunctionDeclaration*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
typedef char (*compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_parseParameter)(compiler_tree_nodes_functions_Nova_FunctionDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, int);
typedef char (*compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_parseParameters)(compiler_tree_nodes_functions_Nova_FunctionDeclaration*, nova_exception_Nova_ExceptionData*, nova_Nova_String*, char);
...
{
compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_compatibleArguments compatibleArguments;
compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_parseSignature parseSignature;
compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_parseParameter parseParameter;
compiler_tree_nodes_functions_Nova_FunctionDeclaration_native_Nova_parseParameters parseParameters;
