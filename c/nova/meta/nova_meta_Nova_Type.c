...
{
	CCLASS_NEW(nova_meta_Nova_TypePropertyMap, this,);
	this->vtable = &nova_meta_Type_TypePropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_meta_Nova_TypePropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_meta_Nova_TypePropertyMap_Nova_this(this, exceptionData);
	}
...
{
	return reference->nova_meta_Nova_Type_Nova_value;
}
...
{
	return reference->nova_meta_Nova_Type_Nova_genericArguments;
}
