...
typedef struct nova_network_Nova_ConnectionSocketPropertyMap nova_network_Nova_ConnectionSocketPropertyMap;
...
(
	...
	nova_network_ConnectionSocket_ConnectionSocketPropertyMap_Extension_VTable* vtable;
)
