...
typedef struct nova_network_Nova_nova_network_ConnectionSocketFunctionMap nova_network_Nova_nova_network_ConnectionSocketFunctionMap;
...
CCLASS_CLASS
(
	nova_network_Nova_nova_network_ConnectionSocketFunctionMap, 
	
	nova_network_ConnectionSocket_nova_network_ConnectionSocketFunctionMap_Extension_VTable* vtable;
)
