...
typedef struct nova_network_Nova_ConnectionSocketFunctionMap nova_network_Nova_ConnectionSocketFunctionMap;
...
(
	...
	nova_network_ConnectionSocket_ConnectionSocketFunctionMap_Extension_VTable* vtable;
)
