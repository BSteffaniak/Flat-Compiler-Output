...
typedef struct nova_star_Nova_WindowThreadFunctionMap nova_star_Nova_WindowThreadFunctionMap;
typedef struct nova_star_Nova_WindowThreadPropertyMap nova_star_Nova_WindowThreadPropertyMap;
...
(
	...
	nova_star_WindowThread_WindowThreadFunctionMap_Extension_VTable* vtable;
)
...
(
	...
	nova_star_WindowThread_WindowThreadPropertyMap_Extension_VTable* vtable;
)
