...
typedef struct nova_star_Nova_nova_star_WindowThreadFunctionMap nova_star_Nova_nova_star_WindowThreadFunctionMap;
...
CCLASS_CLASS
(
	nova_star_Nova_nova_star_WindowThreadFunctionMap, 
	
	nova_star_WindowThread_nova_star_WindowThreadFunctionMap_Extension_VTable* vtable;
)
