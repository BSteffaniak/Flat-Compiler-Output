...
typedef struct nova_math_Nova_nova_math_Vector3DFunctionMap nova_math_Nova_nova_math_Vector3DFunctionMap;
...
CCLASS_CLASS
(
	nova_math_Nova_nova_math_Vector3DFunctionMap, 
	
	nova_math_Vector3D_nova_math_Vector3DFunctionMap_Extension_VTable* vtable;
)
