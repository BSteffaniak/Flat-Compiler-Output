...
typedef struct nova_math_Nova_nova_math_NumericOperandFunctionMap nova_math_Nova_nova_math_NumericOperandFunctionMap;
...
CCLASS_CLASS
(
	nova_math_Nova_nova_math_NumericOperandFunctionMap, 
	
	nova_math_NumericOperand_nova_math_NumericOperandFunctionMap_Extension_VTable* vtable;
)
