...
typedef struct nova_math_Nova_NumericOperandFunctionMap nova_math_Nova_NumericOperandFunctionMap;
...
(
	...
	nova_math_NumericOperand_NumericOperandFunctionMap_Extension_VTable* vtable;
)
...
nova_math_Nova_NumericOperand* nova_math_Nova_NumericOperandFunctionMap_functionMapNumericOperandFunctionMap_static_Nova_construct(nova_math_Nova_NumericOperandFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* data);
...
nova_math_Nova_NumericOperand* nova_math_Nova_NumericOperandFunctionMap_virtualfunctionMapNumericOperandFunctionMap_static_Nova_construct(nova_math_Nova_NumericOperandFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* data);
