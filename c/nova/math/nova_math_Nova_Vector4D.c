...
nova_math_Nova_Vector4D* nova_math_Nova_Vector4D_0_Nova_construct(nova_math_Nova_Vector4D* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_math_Nova_Vector4D_Nova_this(this, exceptionData);
	}
...
nova_math_Nova_Vector4D* nova_math_Nova_Vector4D_1_Nova_construct(nova_math_Nova_Vector4D* this, nova_exception_Nova_ExceptionData* exceptionData, double x, double y, double z, double w)
{
	...
	{
		nova_math_Nova_Vector4D_0_Nova_this(this, exceptionData, x, y, z, w);
	}
...
void nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_math_Nova_nova_math_Vector4DFunctionMap* nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_construct(nova_math_Nova_nova_math_Vector4DFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_math_Nova_nova_math_Vector4DFunctionMap, this,);
	this->vtable = &nova_math_Vector4D_nova_math_Vector4DFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_destroy(nova_math_Nova_nova_math_Vector4DFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_this(nova_math_Nova_nova_math_Vector4DFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_math_Nova_nova_math_Vector4DFunctionMap_Nova_super(nova_math_Nova_nova_math_Vector4DFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
