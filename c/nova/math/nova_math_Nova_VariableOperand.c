...
nova_math_Nova_VariableOperand* nova_math_Nova_VariableOperandFunctionMap_functionMapVariableOperandFunctionMap_Nova_construct(nova_math_Nova_VariableOperandFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return nova_math_Nova_VariableOperand_Nova_construct(0, exceptionData);
}
...
void nova_math_Nova_VariableOperandPropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_math_Nova_VariableOperandPropertyMap* nova_math_Nova_VariableOperandPropertyMap_Nova_construct(nova_math_Nova_VariableOperandPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_math_Nova_VariableOperandPropertyMap, this,);
	this->vtable = &nova_math_VariableOperand_VariableOperandPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_math_Nova_VariableOperandPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_math_Nova_VariableOperandPropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_math_Nova_VariableOperandPropertyMap_Nova_destroy(nova_math_Nova_VariableOperandPropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_math_Nova_VariableOperandPropertyMap_Nova_this(nova_math_Nova_VariableOperandPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_math_Nova_VariableOperandPropertyMap_Nova_super(nova_math_Nova_VariableOperandPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
