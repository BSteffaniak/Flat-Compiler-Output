...
double nova_math_Nova_Vector_Nova_lambda24(nova_math_Nova_Vector* this, nova_exception_Nova_ExceptionData* exceptionData, double x, int i, nova_datastruct_list_Nova_DoubleArray* _3, Context1* context);
void nova_math_Nova_Vector_Nova_lambda25(nova_math_Nova_Vector* this, nova_exception_Nova_ExceptionData* exceptionData, double n, int i, nova_datastruct_list_Nova_DoubleArray* d, Context2* context);
void nova_math_Nova_Vector_Nova_lambda26(nova_math_Nova_Vector* this, nova_exception_Nova_ExceptionData* exceptionData, double n, int i, nova_datastruct_list_Nova_DoubleArray* d, Context3* context);
void nova_math_Nova_Vector_Nova_lambda27(nova_math_Nova_Vector* this, nova_exception_Nova_ExceptionData* exceptionData, double n, int i, nova_datastruct_list_Nova_DoubleArray* d, Context4* context);
double nova_math_Nova_Vector_Nova_lambda28(nova_math_Nova_Vector* this, nova_exception_Nova_ExceptionData* exceptionData, double n, int _2, nova_datastruct_list_Nova_DoubleArray* _3, Context5* context);
...
{
	Context1* contextArg24 = NOVA_MALLOC(sizeof(Context1));
	contextArg24->nova_math_Nova_Vector_Nova_other = &other;
	
	return nova_datastruct_list_Nova_DoubleArray_Nova_sum(this->nova_math_Nova_Vector_Nova_data, exceptionData, (nova_datastruct_list_Nova_DoubleArray_closure4_Nova_func)&nova_math_Nova_Vector_Nova_lambda24, this, contextArg24);
}
...
{
	Context2* contextArg25 = NOVA_MALLOC(sizeof(Context2));
	contextArg25->nova_math_Nova_Vector_Nova_scalar = &scalar;
...
{
	double l1_Nova_m = 0;
	Context3* contextArg26 = NOVA_MALLOC(sizeof(Context3));
	contextArg26->nova_math_Nova_Vector_Nova_m = &l1_Nova_m;
	Context4* contextArg27 = NOVA_MALLOC(sizeof(Context4));
	
	return (nova_datastruct_list_Nova_DoubleArray*)((l1_Nova_m = nova_math_Nova_Vector_Accessor_Nova_magnitude(this, exceptionData)) > 0 ? nova_datastruct_list_Nova_DoubleArray_Nova_forEach(this->nova_math_Nova_Vector_Nova_data, exceptionData, (nova_datastruct_list_Nova_DoubleArray_closure12_Nova_func)&nova_math_Nova_Vector_Nova_lambda26, this, contextArg26) : nova_datastruct_list_Nova_DoubleArray_Nova_forEach(this->nova_math_Nova_Vector_Nova_data, exceptionData, (nova_datastruct_list_Nova_DoubleArray_closure12_Nova_func)&nova_math_Nova_Vector_Nova_lambda27, this, contextArg27));
}
...
{
	Context5* contextArg28 = NOVA_MALLOC(sizeof(Context5));
	
	return nova_math_Nova_Math_static_Nova_sqrt(0, exceptionData, nova_datastruct_list_Nova_DoubleArray_Nova_sum(this->nova_math_Nova_Vector_Nova_data, exceptionData, (nova_datastruct_list_Nova_DoubleArray_closure4_Nova_func)&nova_math_Nova_Vector_Nova_lambda28, this, contextArg28));
}
...
nova_math_Nova_Vector* nova_math_Nova_VectorFunctionMap_functionMapVectorFunctionMap0_static_Nova_construct(nova_math_Nova_VectorFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, int size)
{
	return nova_math_Nova_Vector_0_Nova_construct(0, exceptionData, size);
}

nova_math_Nova_Vector* nova_math_Nova_VectorFunctionMap_functionMapVectorFunctionMap1_static_Nova_construct(nova_math_Nova_VectorFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* data)
{
