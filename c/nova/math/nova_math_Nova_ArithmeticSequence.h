...
typedef struct nova_math_Nova_nova_math_ArithmeticSequenceFunctionMap nova_math_Nova_nova_math_ArithmeticSequenceFunctionMap;
...
CCLASS_CLASS
(
	nova_math_Nova_nova_math_ArithmeticSequenceFunctionMap, 
	
	nova_math_ArithmeticSequence_nova_math_ArithmeticSequenceFunctionMap_Extension_VTable* vtable;
)
