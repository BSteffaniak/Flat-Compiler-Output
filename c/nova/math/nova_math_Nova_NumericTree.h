...
typedef struct nova_math_Nova_NumericTreePropertyMap nova_math_Nova_NumericTreePropertyMap;
...
(
	...
	nova_math_NumericTree_NumericTreePropertyMap_Extension_VTable* vtable;
)
