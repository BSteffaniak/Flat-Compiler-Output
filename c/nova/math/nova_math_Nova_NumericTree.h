...
typedef struct nova_math_Nova_nova_math_NumericTreeFunctionMap nova_math_Nova_nova_math_NumericTreeFunctionMap;
...
CCLASS_CLASS
(
	nova_math_Nova_nova_math_NumericTreeFunctionMap, 
	
	nova_math_NumericTree_nova_math_NumericTreeFunctionMap_Extension_VTable* vtable;
)
