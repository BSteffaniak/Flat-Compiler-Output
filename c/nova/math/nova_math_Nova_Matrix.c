...
nova_datastruct_list_Nova_DoubleArray* nova_math_Nova_Matrix_static_Nova_lambda90(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
void nova_math_Nova_Matrix_Nova_lambda91(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* outRow, int outR, nova_datastruct_list_Nova_Array* _3, Context3* context);
void nova_math_Nova_Matrix_Nova_lambda92(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* row, int r, nova_datastruct_list_Nova_Array* _3, Context4* context);
void nova_math_Nova_Matrix_Nova_lambda93(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* row, int r, nova_datastruct_list_Nova_Array* _3, Context5* context);
nova_datastruct_list_Nova_DoubleArray* nova_math_Nova_Matrix_static_Nova_lambda94(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
nova_datastruct_list_Nova_DoubleArray* nova_math_Nova_Matrix_Nova_lambda95(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
...
{
	Context7* contextArg95 = NOVA_MALLOC(sizeof(Context7));
	contextArg95->nova_math_Nova_Matrix_Nova_cols = &cols;
...
{
	nova_math_Nova_Matrix* l1_Nova_result = (nova_math_Nova_Matrix*)nova_null;
	Context3* contextArg92 = NOVA_MALLOC(sizeof(Context3));
	contextArg92->nova_math_Nova_Matrix_Nova_result = &l1_Nova_result;
	contextArg92->nova_math_Nova_Matrix_Nova_other = &other;
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_result->prv->nova_math_Nova_Matrix_Nova_data), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&nova_math_Nova_Matrix_Nova_lambda91, this, contextArg92);
	return l1_Nova_result;
}
...
{
	nova_math_Nova_Matrix* l1_Nova_result = (nova_math_Nova_Matrix*)nova_null;
	Context5* contextArg93 = NOVA_MALLOC(sizeof(Context5));
	contextArg93->nova_math_Nova_Matrix_Nova_result = &l1_Nova_result;
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->prv->nova_math_Nova_Matrix_Nova_data), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&nova_math_Nova_Matrix_Nova_lambda93, this, contextArg93);
	return l1_Nova_result;
}
...
void nova_math_Nova_Matrix_Nova_lambda91(nova_math_Nova_Matrix* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_DoubleArray* outRow, int outR, nova_datastruct_list_Nova_Array* _3, Context3* context)
{
	Context4* contextArg91 = NOVA_MALLOC(sizeof(Context4));
	contextArg91->nova_math_Nova_Matrix_Nova_result = context->nova_math_Nova_Matrix_Nova_result;
	contextArg91->nova_math_Nova_Matrix_Nova_outR = &outR;
	contextArg91->nova_math_Nova_Matrix_Nova_other = context->nova_math_Nova_Matrix_Nova_other;
	
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->prv->nova_math_Nova_Matrix_Nova_data), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&nova_math_Nova_Matrix_Nova_lambda92, this, contextArg91);
}
