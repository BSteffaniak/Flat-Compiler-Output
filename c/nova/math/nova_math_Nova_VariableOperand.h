...
typedef struct nova_math_Nova_nova_math_VariableOperandFunctionMap nova_math_Nova_nova_math_VariableOperandFunctionMap;
...
CCLASS_CLASS
(
	nova_math_Nova_nova_math_VariableOperandFunctionMap, 
	
	nova_math_VariableOperand_nova_math_VariableOperandFunctionMap_Extension_VTable* vtable;
)
