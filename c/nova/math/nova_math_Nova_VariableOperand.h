...
typedef struct nova_math_Nova_VariableOperandFunctionMap nova_math_Nova_VariableOperandFunctionMap;
typedef struct nova_math_Nova_VariableOperandPropertyMap nova_math_Nova_VariableOperandPropertyMap;
...
(
	...
	nova_math_VariableOperand_VariableOperandFunctionMap_Extension_VTable* vtable;
)
...
(
	...
	nova_math_VariableOperand_VariableOperandPropertyMap_Extension_VTable* vtable;
)
