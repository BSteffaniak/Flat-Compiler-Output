...
void nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_math_Nova_nova_math_NumericTreeFunctionMap* nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_construct(nova_math_Nova_nova_math_NumericTreeFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_math_Nova_nova_math_NumericTreeFunctionMap, this,);
	this->vtable = &nova_math_NumericTree_nova_math_NumericTreeFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_destroy(nova_math_Nova_nova_math_NumericTreeFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_this(nova_math_Nova_nova_math_NumericTreeFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_math_Nova_nova_math_NumericTreeFunctionMap_Nova_super(nova_math_Nova_nova_math_NumericTreeFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
