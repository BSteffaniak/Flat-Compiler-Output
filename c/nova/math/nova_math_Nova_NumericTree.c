...
{
	return (nova_Nova_String*)nova_Nova_String_Nova_plus(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((this->prv->nova_math_Nova_NumericTree_Nova_root)), exceptionData), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")));
}
...
{
	CCLASS_NEW(nova_math_Nova_NumericTreeFunctionMap, this,);
	this->vtable = &nova_math_NumericTree_NumericTreeFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_math_Nova_NumericTreeFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_math_Nova_NumericTreeFunctionMap_Nova_this(this, exceptionData);
	}
...
void nova_math_Nova_NumericTreePropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_math_Nova_NumericTreePropertyMap* nova_math_Nova_NumericTreePropertyMap_Nova_construct(nova_math_Nova_NumericTreePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_math_Nova_NumericTreePropertyMap, this,);
	this->vtable = &nova_math_NumericTree_NumericTreePropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_math_Nova_NumericTreePropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_math_Nova_NumericTreePropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_math_Nova_NumericTreePropertyMap_Nova_destroy(nova_math_Nova_NumericTreePropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_math_Nova_NumericTreePropertyMap_Nova_this(nova_math_Nova_NumericTreePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_math_Nova_NumericTreePropertyMap_Nova_super(nova_math_Nova_NumericTreePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
