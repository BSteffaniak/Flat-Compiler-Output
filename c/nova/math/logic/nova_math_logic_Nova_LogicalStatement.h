...
typedef struct nova_math_logic_Nova_LogicalStatementPropertyMap nova_math_logic_Nova_LogicalStatementPropertyMap;
...
(
	...
	nova_math_logic_LogicalStatement_LogicalStatementPropertyMap_Extension_VTable* vtable;
)
