...
{
	return this->vtable->nova_math_logic_Nova_LogicalStatementFunctionMap_virtualfunctionMapLogicalStatementFunctionMap_static_Nova_construct(0, exceptionData, statement);
}
