...
{
	CCLASS_NEW(nova_math_logic_Nova_ConclusionPropertyMap, this,);
	this->vtable = &nova_math_logic_Conclusion_ConclusionPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	nova_math_logic_Nova_ConclusionPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_math_logic_Nova_ConclusionPropertyMap_Nova_this(this, exceptionData);
	}
