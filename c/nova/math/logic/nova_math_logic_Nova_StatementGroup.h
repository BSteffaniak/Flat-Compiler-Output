...
typedef struct nova_math_logic_Nova_StatementGroupFunctionMap nova_math_logic_Nova_StatementGroupFunctionMap;
...
(
	...
	nova_math_logic_StatementGroup_StatementGroupFunctionMap_Extension_VTable* vtable;
)
