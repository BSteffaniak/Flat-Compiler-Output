...
typedef struct nova_math_logic_Nova_StatementGroupPropertyMap nova_math_logic_Nova_StatementGroupPropertyMap;
...
(
	...
	nova_math_logic_StatementGroup_StatementGroupPropertyMap_Extension_VTable* vtable;
)
