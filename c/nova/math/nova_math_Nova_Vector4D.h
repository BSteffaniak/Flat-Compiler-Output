...
typedef struct nova_math_Nova_nova_math_Vector4DFunctionMap nova_math_Nova_nova_math_Vector4DFunctionMap;
...
CCLASS_CLASS
(
	nova_math_Nova_nova_math_Vector4DFunctionMap, 
	
	nova_math_Vector4D_nova_math_Vector4DFunctionMap_Extension_VTable* vtable;
)
