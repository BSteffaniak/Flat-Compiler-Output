...
{
	CCLASS_NEW(nova_math_Nova_nova_math_MathFunctionMap, this,);
	this->vtable = &nova_math_Math_nova_math_MathFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_math_Nova_nova_math_MathFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_math_Nova_nova_math_MathFunctionMap_Nova_this(this, exceptionData);
	}
