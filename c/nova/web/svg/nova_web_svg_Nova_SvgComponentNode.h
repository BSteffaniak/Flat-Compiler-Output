...
typedef struct nova_web_svg_Nova_SvgComponentNodePropertyMap nova_web_svg_Nova_SvgComponentNodePropertyMap;
...
(
	...
	nova_web_svg_SvgComponentNode_SvgComponentNodePropertyMap_Extension_VTable* vtable;
)
