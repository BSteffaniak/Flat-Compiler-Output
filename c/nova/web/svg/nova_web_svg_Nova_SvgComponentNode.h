...
typedef struct nova_web_svg_Nova_SvgComponentNodeFunctionMap nova_web_svg_Nova_SvgComponentNodeFunctionMap;
...
(
	...
	nova_web_svg_SvgComponentNode_SvgComponentNodeFunctionMap_Extension_VTable* vtable;
)
