...
typedef struct nova_web_svg_Nova_SvgComponentListPropertyMap nova_web_svg_Nova_SvgComponentListPropertyMap;
...
(
	...
	nova_web_svg_SvgComponentList_SvgComponentListPropertyMap_Extension_VTable* vtable;
)
