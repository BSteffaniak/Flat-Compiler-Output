...
{
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("d3.selectAll('"))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((this->nova_web_svg_no3_Nova_No3SelectAll_Nova_selection)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("')"))));
}
