...
typedef struct nova_web_svg_Nova_SvgComponentPropertyMap nova_web_svg_Nova_SvgComponentPropertyMap;
...
(
	...
	nova_web_svg_SvgComponent_SvgComponentPropertyMap_Extension_VTable* vtable;
)
