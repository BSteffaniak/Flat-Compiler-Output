...
typedef struct nova_web_svg_Nova_nova_web_svg_SvgCircleFunctionMap nova_web_svg_Nova_nova_web_svg_SvgCircleFunctionMap;
...
CCLASS_CLASS
(
	nova_web_svg_Nova_nova_web_svg_SvgCircleFunctionMap, 
	
	nova_web_svg_SvgCircle_nova_web_svg_SvgCircleFunctionMap_Extension_VTable* vtable;
)
