...
typedef struct nova_web_js_json_Nova_nova_web_js_json_JsonFunctionMap nova_web_js_json_Nova_nova_web_js_json_JsonFunctionMap;
...
CCLASS_CLASS
(
	nova_web_js_json_Nova_nova_web_js_json_JsonFunctionMap, 
	
	nova_web_js_json_Json_nova_web_js_json_JsonFunctionMap_Extension_VTable* vtable;
)
