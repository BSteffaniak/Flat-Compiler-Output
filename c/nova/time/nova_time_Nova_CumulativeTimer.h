...
typedef struct nova_time_Nova_CumulativeTimerPropertyMap nova_time_Nova_CumulativeTimerPropertyMap;
...
(
	...
	nova_time_CumulativeTimer_CumulativeTimerPropertyMap_Extension_VTable* vtable;
)
