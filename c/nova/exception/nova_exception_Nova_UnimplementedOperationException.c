...
void nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap* nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_construct(nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap, this,);
	this->vtable = &nova_exception_UnimplementedOperationException_nova_exception_UnimplementedOperationExceptionFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_destroy(nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_this(nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap_Nova_super(nova_exception_Nova_nova_exception_UnimplementedOperationExceptionFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
