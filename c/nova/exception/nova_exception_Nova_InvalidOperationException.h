...
typedef struct nova_exception_Nova_InvalidOperationExceptionPropertyMap nova_exception_Nova_InvalidOperationExceptionPropertyMap;
...
(
	...
	nova_exception_InvalidOperationException_InvalidOperationExceptionPropertyMap_Extension_VTable* vtable;
)
