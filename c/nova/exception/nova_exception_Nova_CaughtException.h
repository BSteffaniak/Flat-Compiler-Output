...
typedef struct nova_exception_Nova_CaughtExceptionPropertyMap nova_exception_Nova_CaughtExceptionPropertyMap;
...
(
	...
	nova_exception_CaughtException_CaughtExceptionPropertyMap_Extension_VTable* vtable;
)
