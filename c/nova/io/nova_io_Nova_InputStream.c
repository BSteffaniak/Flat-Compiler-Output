...
{
	CCLASS_NEW(nova_io_Nova_InputStreamPropertyMap, this,);
	this->vtable = &nova_io_InputStream_InputStreamPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_io_Nova_InputStreamPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_io_Nova_InputStreamPropertyMap_Nova_this(this, exceptionData);
	}
