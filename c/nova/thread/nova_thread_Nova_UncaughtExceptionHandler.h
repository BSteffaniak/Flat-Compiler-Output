...
typedef struct nova_thread_Nova_nova_thread_UncaughtExceptionHandlerFunctionMap nova_thread_Nova_nova_thread_UncaughtExceptionHandlerFunctionMap;
...
CCLASS_CLASS
(
	nova_thread_Nova_nova_thread_UncaughtExceptionHandlerFunctionMap, 
	
	nova_thread_UncaughtExceptionHandler_nova_thread_UncaughtExceptionHandlerFunctionMap_Extension_VTable* vtable;
)
