...
typedef struct nova_thread_Nova_nova_thread_ThreadFunctionMap nova_thread_Nova_nova_thread_ThreadFunctionMap;
...
CCLASS_CLASS
(
	nova_thread_Nova_nova_thread_ThreadFunctionMap, 
	
	nova_thread_Thread_nova_thread_ThreadFunctionMap_Extension_VTable* vtable;
)
