...
typedef struct nova_thread_async_Nova_nova_thread_async_AsyncFunctionMap nova_thread_async_Nova_nova_thread_async_AsyncFunctionMap;
...
CCLASS_CLASS
(
	nova_thread_async_Nova_nova_thread_async_AsyncFunctionMap, 
	
	nova_thread_async_Async_nova_thread_async_AsyncFunctionMap_Extension_VTable* vtable;
)
