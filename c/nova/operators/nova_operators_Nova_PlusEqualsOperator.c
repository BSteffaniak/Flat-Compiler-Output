...
{
	CCLASS_NEW(nova_operators_Nova_PlusEqualsOperatorPropertyMap, this,);
	this->vtable = &nova_operators_PlusEqualsOperator_PlusEqualsOperatorPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_operators_Nova_PlusEqualsOperatorPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_operators_Nova_PlusEqualsOperatorPropertyMap_Nova_this(this, exceptionData);
	}
