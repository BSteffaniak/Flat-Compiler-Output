...
nova_datastruct_list_Nova_IntArray* nova_security_Nova_Sha256_Nova_lambda96(nova_security_Nova_Sha256* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_IntArray* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
