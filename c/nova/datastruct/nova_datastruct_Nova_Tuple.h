...
typedef struct nova_datastruct_Nova_TuplePropertyMap nova_datastruct_Nova_TuplePropertyMap;
...
(
	...
	nova_datastruct_Tuple_TuplePropertyMap_Extension_VTable* vtable;
)
