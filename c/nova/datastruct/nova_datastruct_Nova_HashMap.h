...
typedef struct nova_datastruct_Nova_HashMapPropertyMap nova_datastruct_Nova_HashMapPropertyMap;
...
(
	...
	nova_datastruct_HashMap_HashMapPropertyMap_Extension_VTable* vtable;
)
