...
typedef struct nova_datastruct_Nova_nova_datastruct_HashMapFunctionMap nova_datastruct_Nova_nova_datastruct_HashMapFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_Nova_nova_datastruct_HashMapFunctionMap, 
	
	nova_datastruct_HashMap_nova_datastruct_HashMapFunctionMap_Extension_VTable* vtable;
)
