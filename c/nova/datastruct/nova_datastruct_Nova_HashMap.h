...
typedef struct nova_datastruct_Nova_HashMapFunctionMap nova_datastruct_Nova_HashMapFunctionMap;
...
(
	...
	nova_datastruct_HashMap_HashMapFunctionMap_Extension_VTable* vtable;
)
