...
{
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_Nova_Tuple_0_Nova_forEach(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure4_Nova_func)nova_datastruct_Nova_TupleFunctionMap_Nova_func, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_func, func_context);
}
...
{
	return nova_datastruct_Nova_Tuple_0_Nova_any(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure8_Nova_anyFunc)nova_datastruct_Nova_TupleFunctionMap_Nova_anyFunc, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_anyFunc, anyFunc_context);
}
...
{
	return nova_datastruct_Nova_Tuple_0_Nova_all(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure12_Nova_allFunc)nova_datastruct_Nova_TupleFunctionMap_Nova_allFunc, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_allFunc, allFunc_context);
}
...
{
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_Nova_Tuple_0_Nova_filter(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure16_Nova_filterFunc)nova_datastruct_Nova_TupleFunctionMap_Nova_filterFunc, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_filterFunc, filterFunc_context);
}
...
{
	return (nova_Nova_Object*)nova_datastruct_Nova_Tuple_0_Nova_firstWhere(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure20_Nova_func)nova_datastruct_Nova_TupleFunctionMap_Nova_func, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_func, func_context);
}

nova_datastruct_Nova_Tuple* nova_datastruct_Nova_TupleFunctionMap_functionMap0_Nova_reverse(nova_datastruct_Nova_TupleFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple* reference)
{
...
{
	return (nova_datastruct_list_Nova_List*)nova_datastruct_Nova_Tuple_0_Nova_map(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure24_Nova_mapFunc)nova_datastruct_Nova_TupleFunctionMap_Nova_mapFunc, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_mapFunc, mapFunc_context);
}
