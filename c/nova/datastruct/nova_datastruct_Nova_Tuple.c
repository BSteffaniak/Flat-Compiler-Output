...
{
	return nova_datastruct_list_Nova_List_0_Nova_contains((nova_datastruct_list_Nova_List*)(this->nova_datastruct_Nova_Tuple_Nova_items), exceptionData, (nova_Nova_Object*)(value));
}
...
char nova_datastruct_Nova_Tuple_0_Nova_all(nova_datastruct_Nova_Tuple* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple_closure88_Nova_allFunc nova_datastruct_Nova_Tuple_Nova_allFunc, void* nova_datastruct_Nova_Tuple_ref_Nova_allFunc, void* allFunc_context, char stopOnContradiction)
{
...
{
	nova_datastruct_list_Nova_Array_Mutator_Nova_first(this->nova_datastruct_Nova_Tuple_Nova_items, exceptionData, (nova_Nova_Object*)(value));
	return value;
}
...
{
	nova_datastruct_list_Nova_Array_Mutator_Nova_last(this->nova_datastruct_Nova_Tuple_Nova_items, exceptionData, (nova_Nova_Object*)(value));
	return value;
}
...
{
	return nova_datastruct_Nova_Tuple_0_Nova_all(reference, exceptionData, (nova_datastruct_Nova_Tuple_closure88_Nova_allFunc)nova_datastruct_Nova_TupleFunctionMap_Nova_allFunc, nova_datastruct_Nova_TupleFunctionMap_ref_Nova_allFunc, allFunc_context, stopOnContradiction);
}
...
void nova_datastruct_Nova_TuplePropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_datastruct_Nova_TuplePropertyMap* nova_datastruct_Nova_TuplePropertyMap_Nova_construct(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_datastruct_Nova_TuplePropertyMap, this,);
	this->vtable = &nova_datastruct_Tuple_TuplePropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_datastruct_Nova_TuplePropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_Nova_TuplePropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_datastruct_Nova_TuplePropertyMap_Nova_destroy(nova_datastruct_Nova_TuplePropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_datastruct_Nova_TuplePropertyMap_Nova_this(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

nova_datastruct_list_Nova_Array* nova_datastruct_Nova_TuplePropertyMap_functionMap_Nova_items(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple* reference)
{
	return reference->nova_datastruct_Nova_Tuple_Nova_items;
}

nova_datastruct_list_Nova_ArrayIterator* nova_datastruct_Nova_TuplePropertyMap_functionMap0_Nova_iterator(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple* reference)
{
	return (nova_datastruct_list_Nova_ArrayIterator*)nova_datastruct_Nova_Tuple_Accessor_Nova_iterator(reference, exceptionData);
}

nova_Nova_Object* nova_datastruct_Nova_TuplePropertyMap_functionMap0_Nova_first(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple* reference)
{
	return (nova_Nova_Object*)nova_datastruct_Nova_Tuple_Accessor_Nova_first(reference, exceptionData);
}

nova_Nova_Object* nova_datastruct_Nova_TuplePropertyMap_functionMap0_Nova_last(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple* reference)
{
	return (nova_Nova_Object*)nova_datastruct_Nova_Tuple_Accessor_Nova_last(reference, exceptionData);
}

int nova_datastruct_Nova_TuplePropertyMap_functionMap0_Nova_count(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Tuple* reference)
{
	return nova_datastruct_Nova_Tuple_Accessorfunc_Nova_count(reference, exceptionData);
}

void nova_datastruct_Nova_TuplePropertyMap_Nova_super(nova_datastruct_Nova_TuplePropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
