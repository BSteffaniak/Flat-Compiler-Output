...
typedef struct nova_datastruct_Nova_BoundsPropertyMap nova_datastruct_Nova_BoundsPropertyMap;
...
(
	...
	nova_datastruct_Bounds_BoundsPropertyMap_Extension_VTable* vtable;
)
