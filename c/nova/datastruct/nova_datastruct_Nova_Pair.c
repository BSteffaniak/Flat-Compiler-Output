...
{
	return (nova_Nova_String*)nova_operators_Nova_PlusOperator_virtual0_Nova_plus((nova_operators_Nova_PlusOperator*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Pair ("))), exceptionData, (nova_Nova_Object*)(nova_Nova_String_Nova_plus(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((this->nova_datastruct_Nova_Pair_Nova_key)), exceptionData), exceptionData, (nova_Nova_String*)(nova_operators_Nova_PlusOperator_virtual0_Nova_plus((nova_operators_Nova_PlusOperator*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", "))), exceptionData, (nova_Nova_Object*)(nova_Nova_String_Nova_plus(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((this->nova_datastruct_Nova_Pair_Nova_value)), exceptionData), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(")")))))))));
}
...
{
	CCLASS_NEW(nova_datastruct_Nova_PairPropertyMap, this,);
	this->vtable = &nova_datastruct_Pair_PairPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_datastruct_Nova_PairPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_Nova_PairPropertyMap_Nova_this(this, exceptionData);
	}
...
{
	return (nova_Nova_Object*)reference->nova_datastruct_Nova_Pair_Nova_key;
}
...
{
	return (nova_Nova_Object*)reference->nova_datastruct_Nova_Pair_Nova_value;
}
