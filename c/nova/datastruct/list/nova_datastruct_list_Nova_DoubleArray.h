...
typedef struct nova_datastruct_list_Nova_nova_datastruct_list_DoubleArrayFunctionMap nova_datastruct_list_Nova_nova_datastruct_list_DoubleArrayFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_list_Nova_nova_datastruct_list_DoubleArrayFunctionMap, 
	
	nova_datastruct_list_DoubleArray_nova_datastruct_list_DoubleArrayFunctionMap_Extension_VTable* vtable;
)
