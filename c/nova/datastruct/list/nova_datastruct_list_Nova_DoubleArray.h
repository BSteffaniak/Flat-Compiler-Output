...
typedef struct nova_datastruct_list_Nova_DoubleArrayPropertyMap nova_datastruct_list_Nova_DoubleArrayPropertyMap;
...
(
	...
	nova_datastruct_list_DoubleArray_DoubleArrayPropertyMap_Extension_VTable* vtable;
)
