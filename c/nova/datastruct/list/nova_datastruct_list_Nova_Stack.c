...
{
	CCLASS_NEW(nova_datastruct_list_Nova_nova_datastruct_list_StackFunctionMap, this,);
	this->vtable = &nova_datastruct_list_Stack_nova_datastruct_list_StackFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_datastruct_list_Nova_nova_datastruct_list_StackFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_list_Nova_nova_datastruct_list_StackFunctionMap_Nova_this(this, exceptionData);
	}
