...
typedef struct nova_datastruct_list_Nova_EmptyStackExceptionFunctionMap nova_datastruct_list_Nova_EmptyStackExceptionFunctionMap;
...
(
	...
	nova_datastruct_list_EmptyStackException_EmptyStackExceptionFunctionMap_Extension_VTable* vtable;
)
...
nova_datastruct_list_Nova_EmptyStackException* nova_datastruct_list_Nova_EmptyStackExceptionFunctionMap_functionMapEmptyStackExceptionFunctionMap_static_Nova_construct(nova_datastruct_list_Nova_EmptyStackExceptionFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* message);
