...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArray0_static_Nova_construct(nova_datastruct_list_Nova_ArrayFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return this->vtable->nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArray0_static_Nova_construct(0, exceptionData);
}

nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArray1_static_Nova_construct(nova_datastruct_list_Nova_ArrayFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, int count, int initialCapacity)
{
	return this->vtable->nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArray1_static_Nova_construct(0, exceptionData, count, initialCapacity);
}

nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArray2_static_Nova_construct(nova_datastruct_list_Nova_ArrayFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object** data, int count)
{
	return this->vtable->nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArray2_static_Nova_construct(0, exceptionData, data, count);
}
