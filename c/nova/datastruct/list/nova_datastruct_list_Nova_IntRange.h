...
typedef struct nova_datastruct_list_Nova_IntRangeFunctionMap nova_datastruct_list_Nova_IntRangeFunctionMap;
...
(
	...
	nova_datastruct_list_IntRange_IntRangeFunctionMap_Extension_VTable* vtable;
)
