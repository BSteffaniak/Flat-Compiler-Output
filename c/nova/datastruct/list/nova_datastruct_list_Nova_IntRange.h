...
typedef struct nova_datastruct_list_Nova_nova_datastruct_list_IntRangeFunctionMap nova_datastruct_list_Nova_nova_datastruct_list_IntRangeFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_list_Nova_nova_datastruct_list_IntRangeFunctionMap, 
	
	nova_datastruct_list_IntRange_nova_datastruct_list_IntRangeFunctionMap_Extension_VTable* vtable;
)
