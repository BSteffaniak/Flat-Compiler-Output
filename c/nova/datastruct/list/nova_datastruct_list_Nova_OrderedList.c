...
{
	return nova_datastruct_list_Nova_OrderedList_Nova_findIndex(reference, exceptionData, (nova_datastruct_list_Nova_OrderedList_closure332_Nova_condition)nova_datastruct_list_Nova_OrderedListFunctionMap_Nova_condition, nova_datastruct_list_Nova_OrderedListFunctionMap_ref_Nova_condition, condition_context, defaultReturnValue);
}
...
nova_datastruct_list_Nova_OrderedListPropertyMap* nova_datastruct_list_Nova_OrderedListPropertyMap_Nova_construct(nova_datastruct_list_Nova_OrderedListPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_datastruct_list_Nova_OrderedListPropertyMap, this,);
	this->vtable = &nova_datastruct_list_OrderedList_OrderedListPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_datastruct_list_Nova_OrderedListPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_list_Nova_OrderedListPropertyMap_Nova_this(this, exceptionData);
	}
