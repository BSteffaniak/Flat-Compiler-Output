...
char nova_datastruct_list_Nova_LinkedList_Nova_lambda88(nova_datastruct_list_Nova_LinkedList* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* _1, Context1* context);
...
char nova_datastruct_list_Nova_LinkedList_0_Nova_contains(nova_datastruct_list_Nova_LinkedList* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* value)
{
	...
	contextArg88->nova_datastruct_list_Nova_LinkedList_Nova_value = &value;
	
	return nova_datastruct_list_Nova_LinkedList_0_Nova_any(this, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure12_Nova_anyFunc)&nova_datastruct_list_Nova_LinkedList_Nova_lambda88, this, contextArg88);
}
...
{
	return (nova_datastruct_list_Nova_LinkedList*)nova_datastruct_list_Nova_LinkedList_0_Nova_map(reference, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure4_Nova_mapFunc)nova_datastruct_list_Nova_LinkedListFunctionMap_Nova_mapFunc, nova_datastruct_list_Nova_LinkedListFunctionMap_ref_Nova_mapFunc, mapFunc_context);
}
...
{
	return (nova_datastruct_list_Nova_LinkedList*)nova_datastruct_list_Nova_LinkedList_0_Nova_forEach(reference, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure8_Nova_func)nova_datastruct_list_Nova_LinkedListFunctionMap_Nova_func, nova_datastruct_list_Nova_LinkedListFunctionMap_ref_Nova_func, func_context);
}
...
{
	return nova_datastruct_list_Nova_LinkedList_0_Nova_any(reference, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure12_Nova_anyFunc)nova_datastruct_list_Nova_LinkedListFunctionMap_Nova_anyFunc, nova_datastruct_list_Nova_LinkedListFunctionMap_ref_Nova_anyFunc, anyFunc_context);
}
...
{
	return nova_datastruct_list_Nova_LinkedList_0_Nova_all(reference, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure16_Nova_allFunc)nova_datastruct_list_Nova_LinkedListFunctionMap_Nova_allFunc, nova_datastruct_list_Nova_LinkedListFunctionMap_ref_Nova_allFunc, allFunc_context);
}
...
{
	return (nova_datastruct_list_Nova_LinkedList*)nova_datastruct_list_Nova_LinkedList_0_Nova_filter(reference, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure20_Nova_filterFunc)nova_datastruct_list_Nova_LinkedListFunctionMap_Nova_filterFunc, nova_datastruct_list_Nova_LinkedListFunctionMap_ref_Nova_filterFunc, filterFunc_context);
}
...
{
	return (nova_Nova_Object*)nova_datastruct_list_Nova_LinkedList_0_Nova_firstWhere(reference, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure24_Nova_func)nova_datastruct_list_Nova_LinkedListFunctionMap_Nova_func, nova_datastruct_list_Nova_LinkedListFunctionMap_ref_Nova_func, func_context);
}
