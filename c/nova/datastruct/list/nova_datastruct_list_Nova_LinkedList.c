...
char nova_datastruct_list_Nova_LinkedList_Nova_lambda84(nova_datastruct_list_Nova_LinkedList* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* _1, Context1* context);
...
{
	Context1* contextArg84 = NOVA_MALLOC(sizeof(Context1));
	contextArg84->nova_datastruct_list_Nova_LinkedList_Nova_value = &value;
	
	return nova_datastruct_list_Nova_LinkedList_0_Nova_any(this, exceptionData, (nova_datastruct_list_Nova_LinkedList_closure12_Nova_anyFunc)&nova_datastruct_list_Nova_LinkedList_Nova_lambda84, this, contextArg84);
}
...
nova_datastruct_list_Nova_LinkedList* nova_datastruct_list_Nova_LinkedList_Nova_skip(nova_datastruct_list_Nova_LinkedList* this, nova_exception_Nova_ExceptionData* exceptionData, int howMany)
{
	...
	while (nova_datastruct_list_Nova_LinkedListIterator_Accessor_Nova_hasNext(nova_local_0, exceptionData))
	{
		...
		{
			nova_datastruct_list_Nova_Array_virtual0_Nova_add((nova_datastruct_list_Nova_Array*)(l1_Nova_list), exceptionData, (nova_Nova_Object*)(l1_Nova_element));
		}
	}
