...
typedef struct nova_datastruct_list_Nova_nova_datastruct_list_CompiledListFunctionMap nova_datastruct_list_Nova_nova_datastruct_list_CompiledListFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_list_Nova_nova_datastruct_list_CompiledListFunctionMap, 
	
	nova_datastruct_list_CompiledList_nova_datastruct_list_CompiledListFunctionMap_Extension_VTable* vtable;
)
