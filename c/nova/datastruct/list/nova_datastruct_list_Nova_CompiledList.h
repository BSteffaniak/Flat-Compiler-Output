...
typedef struct nova_datastruct_list_Nova_CompiledListFunctionMap nova_datastruct_list_Nova_CompiledListFunctionMap;
...
(
	...
	nova_datastruct_list_CompiledList_CompiledListFunctionMap_Extension_VTable* vtable;
)
