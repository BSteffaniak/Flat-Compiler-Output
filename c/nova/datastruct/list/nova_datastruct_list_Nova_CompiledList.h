...
typedef struct nova_datastruct_list_Nova_CompiledListPropertyMap nova_datastruct_list_Nova_CompiledListPropertyMap;
...
(
	...
	nova_datastruct_list_CompiledList_CompiledListPropertyMap_Extension_VTable* vtable;
)
