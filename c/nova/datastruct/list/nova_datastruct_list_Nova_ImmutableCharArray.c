...
{
	return (nova_datastruct_list_Nova_ImmutableArray*)nova_datastruct_list_Nova_ImmutableArray_0_Nova_construct(0, exceptionData, (nova_datastruct_list_Nova_Array*)(intptr_t)(nova_datastruct_list_Nova_CharArray_Nova_map(this->prv->nova_datastruct_list_Nova_ImmutableCharArray_Nova_array, exceptionData, (nova_datastruct_list_Nova_CharArray_closure12_Nova_mapFunc)(intptr_t)nova_datastruct_list_Nova_ImmutableCharArray_Nova_mapFunc, nova_datastruct_list_Nova_ImmutableCharArray_ref_Nova_mapFunc, mapFunc_context)));
}
...
{
	return nova_datastruct_list_Nova_List_virtual_Accessor1_Nova_count((nova_datastruct_list_Nova_List*)(this->prv->nova_datastruct_list_Nova_ImmutableCharArray_Nova_array), exceptionData);
}
