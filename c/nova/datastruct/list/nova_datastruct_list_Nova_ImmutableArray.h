...
struct nova_datastruct_list_ImmutableArray_Extension_VTable
{
	...
	nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_Array_virtual0_Nova_add)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	nova_datastruct_list_Nova_ImmutableArray* (*nova_datastruct_list_Nova_Array_virtual1_Nova_add)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, int, nova_Nova_Object*);
	int (*nova_datastruct_list_Nova_Array_virtual_Nova_indexOf)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	...
	nova_Nova_Object* (*nova_datastruct_list_Nova_Array_virtual_Nova_get)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, int);
	...
	nova_Nova_Object* (*nova_datastruct_list_Nova_Array_virtual_Mutatorfunc_Nova_first)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	nova_Nova_Object* (*nova_datastruct_list_Nova_Array_virtual_Mutatorfunc_Nova_last)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
	char (*nova_datastruct_list_Nova_Array_virtual_Accessor_Nova_empty)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*);
	nova_Nova_Object* (*nova_datastruct_list_Nova_Array_virtual_Accessorfunc_Nova_first)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*);
	nova_Nova_Object* (*nova_datastruct_list_Nova_Array_virtual_Accessorfunc_Nova_last)(nova_datastruct_list_Nova_ImmutableArray*, nova_exception_Nova_ExceptionData*);
};
