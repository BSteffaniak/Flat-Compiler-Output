...
typedef struct nova_datastruct_list_Nova_IntRangeIteratorFunctionMap nova_datastruct_list_Nova_IntRangeIteratorFunctionMap;
...
(
	...
	nova_datastruct_list_IntRangeIterator_IntRangeIteratorFunctionMap_Extension_VTable* vtable;
)
