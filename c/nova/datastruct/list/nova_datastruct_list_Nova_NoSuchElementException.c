...
void nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	CCLASS_NEW(nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap, this,);
	this->vtable = &nova_datastruct_list_NoSuchElementException_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Nova_destroy(nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Nova_this(nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap_Nova_super(nova_datastruct_list_Nova_nova_datastruct_list_NoSuchElementExceptionFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
