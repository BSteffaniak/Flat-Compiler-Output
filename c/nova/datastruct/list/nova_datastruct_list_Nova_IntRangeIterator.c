...
void nova_datastruct_list_Nova_IntRangeIterator_Nova_destroy(nova_datastruct_list_Nova_IntRangeIterator** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_datastruct_list_Nova_IntRange_Nova_destroy(&(*this)->nova_datastruct_list_Nova_IntRangeIterator_Nova_range, exceptionData);
...
{
	this->nova_datastruct_list_Nova_IntRangeIterator_Nova_range = range;
...
{
	this->nova_datastruct_list_Nova_IntRangeIterator_Nova_position = this->nova_datastruct_list_Nova_IntRangeIterator_Nova_range->nova_datastruct_list_Nova_IntRange_Nova_start;
	return this;
}
...
{
	return this->nova_datastruct_list_Nova_IntRangeIterator_Nova_position < this->nova_datastruct_list_Nova_IntRangeIterator_Nova_range->nova_datastruct_list_Nova_IntRange_Nova_end;
}
...
void nova_datastruct_list_Nova_IntRangeIterator_Nova_super(nova_datastruct_list_Nova_IntRangeIterator* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->nova_datastruct_list_Nova_IntRangeIterator_Nova_range = (nova_datastruct_list_Nova_IntRange*)nova_null;
}
