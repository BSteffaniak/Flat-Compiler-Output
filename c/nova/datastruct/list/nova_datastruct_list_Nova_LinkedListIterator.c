...
void nova_datastruct_list_Nova_LinkedListIterator_Nova_destroy(nova_datastruct_list_Nova_LinkedListIterator** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_datastruct_list_Nova_LinkedList_Nova_destroy(&(*this)->nova_datastruct_list_Nova_LinkedListIterator_Nova_list, exceptionData);
...
{
	this->nova_datastruct_list_Nova_LinkedListIterator_Nova_list = list;
...
{
	this->nova_datastruct_list_Nova_LinkedListIterator_Nova_position = (nova_datastruct_list_Nova_ListNode*)(nova_datastruct_list_Nova_LinkedList_Accessor_Nova_first(this->nova_datastruct_list_Nova_LinkedListIterator_Nova_list, exceptionData));
	return this;
}
...
void nova_datastruct_list_Nova_LinkedListIterator_Nova_super(nova_datastruct_list_Nova_LinkedListIterator* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->nova_datastruct_list_Nova_LinkedListIterator_Nova_list = (nova_datastruct_list_Nova_LinkedList*)nova_null;
}
