...
{
	this->nova_datastruct_list_Nova_LinkedListIterator_Nova_position = (nova_datastruct_list_Nova_ListNode*)(nova_datastruct_list_Nova_LinkedList_Accessor_Nova_first(this->prv->nova_datastruct_list_Nova_LinkedListIterator_Nova_list, exceptionData));
	return this;
}
...
void nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap* nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_construct(nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap, this,);
	this->vtable = &nova_datastruct_list_LinkedListIterator_nova_datastruct_list_LinkedListIteratorFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_destroy(nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_this(nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap_Nova_super(nova_datastruct_list_Nova_nova_datastruct_list_LinkedListIteratorFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
