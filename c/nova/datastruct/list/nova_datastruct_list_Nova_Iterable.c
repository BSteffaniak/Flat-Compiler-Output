...
nova_datastruct_list_Nova_Iterator* nova_datastruct_list_Nova_Iterable_virtual_Mutator_Nova_iterator(nova_datastruct_list_Nova_Iterable* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Iterator* value)
{
	return this->vtable->itable.nova_datastruct_list_Nova_Iterable_virtual_Mutator_Nova_iterator((nova_datastruct_list_Nova_Iterable*)(this), exceptionData, value);
}
...
{
	CCLASS_NEW(nova_datastruct_list_Nova_IterablePropertyMap, this,);
	this->vtable = &nova_datastruct_list_Iterable_IterablePropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_datastruct_list_Nova_IterablePropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_list_Nova_IterablePropertyMap_Nova_this(this, exceptionData);
	}
...
{
	return nova_datastruct_list_Nova_Iterable_Accessor_Nova_iterator(reference, exceptionData);
}
...
{
	return this->vtable->itable.nova_datastruct_list_Nova_IterablePropertyMap_virtualfunctionMap2_Nova_iterator(this, exceptionData, reference);
}
