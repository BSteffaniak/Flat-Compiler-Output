...
void nova_datastruct_list_Nova_ImmutableArray_6_Nova_this(nova_datastruct_list_Nova_ImmutableArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* data)
{
	...
	nova_datastruct_list_Nova_ImmutableArray_Mutatorfunc_Nova_count(this, exceptionData, nova_datastruct_list_Nova_Array_Accessorfunc_Nova_count(data, exceptionData));
}
...
{
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_list_Nova_Array_2_Nova_construct(0, exceptionData, this->nova_datastruct_list_Nova_ImmutableArray_Nova_data, nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count(this, exceptionData));
}
...
{
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_list_Nova_ImmutableArray_Nova_toArray(this, exceptionData);
}
