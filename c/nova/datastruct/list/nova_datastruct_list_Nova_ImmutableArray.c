...
nova_datastruct_list_ImmutableArray_Extension_VTable nova_datastruct_list_ImmutableArray_Extension_VTable_val =
{
	...
	nova_datastruct_list_Nova_ImmutableArray_2_Nova_remove,
...
{
	nova_datastruct_list_Nova_Array_1_Nova_this((nova_datastruct_list_Nova_Array*)(this), exceptionData, (nova_Nova_Object**)((nova_Nova_Object**)(clone ? nova_datastruct_list_Nova_Array_virtual_Nova_clone((nova_datastruct_list_Nova_Array*)(array), exceptionData)->nova_datastruct_list_Nova_Array_Nova_data : array->nova_datastruct_list_Nova_Array_Nova_data)), nova_datastruct_list_Nova_List_virtual_Accessor1_Nova_count((nova_datastruct_list_Nova_List*)(array), exceptionData));
	nova_datastruct_list_Nova_ImmutableArray_Mutatorfunc_Nova_count(this, exceptionData, nova_datastruct_list_Nova_List_virtual_Accessor1_Nova_count((nova_datastruct_list_Nova_List*)(array), exceptionData));
}
...
{
	return (nova_datastruct_list_Nova_ImmutableArray*)nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_0_Nova_map(((nova_datastruct_list_Nova_Array*)this), exceptionData, (nova_datastruct_list_Nova_Array_closure4_Nova_mapFunc)nova_datastruct_list_Nova_ImmutableArray_Nova_mapFunc, nova_datastruct_list_Nova_ImmutableArray_ref_Nova_mapFunc, mapFunc_context)), 0);
}
...
{
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_list_Nova_Array_0_Nova_forEach(((nova_datastruct_list_Nova_Array*)this), exceptionData, (nova_datastruct_list_Nova_Array_closure8_Nova_func)nova_datastruct_list_Nova_ImmutableArray_Nova_func, nova_datastruct_list_Nova_ImmutableArray_ref_Nova_func, func_context);
}
...
{
	return (nova_datastruct_list_Nova_ImmutableArray*)nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_0_Nova_filter(((nova_datastruct_list_Nova_Array*)this), exceptionData, (nova_datastruct_list_Nova_Array_closure12_Nova_filterFunc)nova_datastruct_list_Nova_ImmutableArray_Nova_filterFunc, nova_datastruct_list_Nova_ImmutableArray_ref_Nova_filterFunc, filterFunc_context)), 0);
}
...
nova_datastruct_list_Nova_ImmutableArray* nova_datastruct_list_Nova_ImmutableArray_1_Nova_remove(nova_datastruct_list_Nova_ImmutableArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* element)
{
	return (nova_datastruct_list_Nova_ImmutableArray*)nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, nova_datastruct_list_Nova_Array_virtual1_Nova_remove((nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_ImmutableArray_Nova_toMutable(this, exceptionData)), exceptionData, element)->nova_datastruct_list_Nova_Array_Nova_data, (int)(nova_datastruct_list_Nova_ImmutableArray_Nova_indexOf(this, exceptionData, element) >= 0 ? nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count(this, exceptionData) - 1 : nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count(this, exceptionData)));
}

nova_datastruct_list_Nova_ImmutableArray* nova_datastruct_list_Nova_ImmutableArray_2_Nova_remove(nova_datastruct_list_Nova_ImmutableArray* this, nova_exception_Nova_ExceptionData* exceptionData, int index)
{
	return (nova_datastruct_list_Nova_ImmutableArray*)nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, nova_datastruct_list_Nova_Array_virtual0_Nova_remove((nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_ImmutableArray_Nova_toMutable(this, exceptionData)), exceptionData, index)->nova_datastruct_list_Nova_Array_Nova_data, (int)(index >= 0 && index < nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count(this, exceptionData) ? nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count(this, exceptionData) - 1 : nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count(this, exceptionData)));
}
...
{
	return (nova_Nova_Object*)nova_datastruct_list_Nova_Array_Accessor_Nova_first(((nova_datastruct_list_Nova_Array*)this), exceptionData);
}
...
{
	nova_datastruct_list_Nova_List_virtual_Mutator0_Nova_first((nova_datastruct_list_Nova_List*)(((nova_datastruct_list_Nova_Array*)this)), exceptionData, (nova_Nova_Object*)(value));
...
{
	return (nova_Nova_Object*)nova_datastruct_list_Nova_Array_Accessor_Nova_last(((nova_datastruct_list_Nova_Array*)this), exceptionData);
}
...
{
	nova_datastruct_list_Nova_List_virtual_Mutator0_Nova_last((nova_datastruct_list_Nova_List*)(((nova_datastruct_list_Nova_Array*)this)), exceptionData, (nova_Nova_Object*)(value));
	return (nova_Nova_Object*)value;
}
