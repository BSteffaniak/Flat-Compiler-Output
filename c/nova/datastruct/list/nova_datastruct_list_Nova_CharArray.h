...
typedef struct nova_datastruct_list_Nova_nova_datastruct_list_CharArrayFunctionMap nova_datastruct_list_Nova_nova_datastruct_list_CharArrayFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_list_Nova_nova_datastruct_list_CharArrayFunctionMap, 
	
	nova_datastruct_list_CharArray_nova_datastruct_list_CharArrayFunctionMap_Extension_VTable* vtable;
)
