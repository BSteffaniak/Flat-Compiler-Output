...
void nova_datastruct_list_Nova_IntArrayIterator_Nova_destroy(nova_datastruct_list_Nova_IntArrayIterator** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_datastruct_list_Nova_IntArray_Nova_destroy(&(*this)->nova_datastruct_list_Nova_IntArrayIterator_Nova_array, exceptionData);
...
{
	this->nova_datastruct_list_Nova_IntArrayIterator_Nova_array = array;
...
int nova_datastruct_list_Nova_IntArrayIterator_Accessor_Nova_next(nova_datastruct_list_Nova_IntArrayIterator* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		return (int)(intptr_t)nova_datastruct_list_Nova_IntArray_Nova_get(this->nova_datastruct_list_Nova_IntArrayIterator_Nova_array, exceptionData, this->nova_datastruct_list_Nova_IntArrayIterator_Nova_position++);
	}
...
{
	return nova_datastruct_list_Nova_List_virtual_Accessor1_Nova_count((nova_datastruct_list_Nova_List*)(this->nova_datastruct_list_Nova_IntArrayIterator_Nova_array), exceptionData) > this->nova_datastruct_list_Nova_IntArrayIterator_Nova_position;
}
...
void nova_datastruct_list_Nova_IntArrayIterator_Nova_super(nova_datastruct_list_Nova_IntArrayIterator* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->nova_datastruct_list_Nova_IntArrayIterator_Nova_array = (nova_datastruct_list_Nova_IntArray*)nova_null;
}
