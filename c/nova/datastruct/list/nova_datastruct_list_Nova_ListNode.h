...
typedef struct nova_datastruct_list_Nova_nova_datastruct_list_ListNodeFunctionMap nova_datastruct_list_Nova_nova_datastruct_list_ListNodeFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_list_Nova_nova_datastruct_list_ListNodeFunctionMap, 
	
	nova_datastruct_list_ListNode_nova_datastruct_list_ListNodeFunctionMap_Extension_VTable* vtable;
)
