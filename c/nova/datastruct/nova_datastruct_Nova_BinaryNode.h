...
typedef struct nova_datastruct_Nova_nova_datastruct_BinaryNodeFunctionMap nova_datastruct_Nova_nova_datastruct_BinaryNodeFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_Nova_nova_datastruct_BinaryNodeFunctionMap, 
	
	nova_datastruct_BinaryNode_nova_datastruct_BinaryNodeFunctionMap_Extension_VTable* vtable;
)
