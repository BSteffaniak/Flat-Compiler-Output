...
nova_datastruct_Nova_Tuple2FunctionMap* nova_datastruct_Nova_Tuple2FunctionMap_Nova_construct(nova_datastruct_Nova_Tuple2FunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_datastruct_Nova_TupleFunctionMap_Nova_super((nova_datastruct_Nova_TupleFunctionMap*)this, exceptionData);
...
{
	CCLASS_NEW(nova_datastruct_Nova_Tuple2PropertyMap, this,);
	this->vtable = &nova_datastruct_Tuple2_Tuple2PropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	nova_datastruct_Nova_TuplePropertyMap_Nova_super((nova_datastruct_Nova_TuplePropertyMap*)this, exceptionData);
	nova_datastruct_Nova_Tuple2PropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_Nova_Tuple2PropertyMap_Nova_this(this, exceptionData);
	}
...
{
	return (nova_Nova_Object*)nova_datastruct_Nova_Tuple2_Accessor_Nova_item1(reference, exceptionData);
}
...
{
	return (nova_Nova_Object*)nova_datastruct_Nova_Tuple2_Accessor_Nova_item2(reference, exceptionData);
}
