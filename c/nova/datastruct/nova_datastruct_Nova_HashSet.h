...
typedef struct nova_datastruct_Nova_HashSetPropertyMap nova_datastruct_Nova_HashSetPropertyMap;
...
(
	...
	nova_datastruct_HashSet_HashSetPropertyMap_Extension_VTable* vtable;
)
