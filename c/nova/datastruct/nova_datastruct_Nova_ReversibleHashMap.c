...
{
	CCLASS_NEW(nova_datastruct_Nova_ReversibleHashMapPropertyMap, this,);
	this->vtable = &nova_datastruct_ReversibleHashMap_ReversibleHashMapPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	nova_datastruct_Nova_ReversibleHashMapPropertyMap_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_Nova_ReversibleHashMapPropertyMap_Nova_this(this, exceptionData);
	}
