...
typedef struct nova_datastruct_Nova_nova_datastruct_PairFunctionMap nova_datastruct_Nova_nova_datastruct_PairFunctionMap;
...
CCLASS_CLASS
(
	nova_datastruct_Nova_nova_datastruct_PairFunctionMap, 
	
	nova_datastruct_Pair_nova_datastruct_PairFunctionMap_Extension_VTable* vtable;
)
