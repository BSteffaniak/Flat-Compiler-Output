...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_HashSet_Nova_lambda76(nova_datastruct_Nova_HashSet* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
...
void nova_datastruct_Nova_HashSet_Nova_this(nova_datastruct_Nova_HashSet* this, nova_exception_Nova_ExceptionData* exceptionData, int bucketCount, int bucketSize)
{
	...
	contextArg76->nova_datastruct_Nova_HashSet_Nova_bucketSize = &bucketSize;
...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_HashSetFunctionMap_functionMap0_Nova_reverse(nova_datastruct_Nova_HashSetFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_HashSet* reference)
{
...
{
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_Nova_HashSet_Nova_getBucket(reference, exceptionData, value);
}
...
{
	return nova_datastruct_Nova_HashSet_Nova_add(reference, exceptionData, value);
}
...
{
	return (nova_Nova_Object*)nova_datastruct_Nova_HashSet_Nova_get(reference, exceptionData, value);
}
...
{
	return (nova_Nova_Object*)nova_datastruct_Nova_HashSet_Nova_remove(reference, exceptionData, value);
}
...
{
	return nova_datastruct_Nova_HashSet_0_Nova_contains(reference, exceptionData, value);
}
