...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_HashSet_Nova_lambda79(nova_datastruct_Nova_HashSet* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
...
void nova_datastruct_Nova_HashSet_Nova_this(nova_datastruct_Nova_HashSet* this, nova_exception_Nova_ExceptionData* exceptionData, int bucketCount, int bucketSize)
{
	...
	contextArg79->nova_datastruct_Nova_HashSet_Nova_bucketSize = &bucketSize;
