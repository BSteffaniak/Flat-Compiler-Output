...
typedef struct nova_ar_Nova_TrackPointFunctionMap nova_ar_Nova_TrackPointFunctionMap;
typedef struct nova_ar_Nova_TrackPointPropertyMap nova_ar_Nova_TrackPointPropertyMap;
...
(
	...
	nova_ar_TrackPoint_TrackPointFunctionMap_Extension_VTable* vtable;
)
...
(
	...
	nova_ar_TrackPoint_TrackPointPropertyMap_Extension_VTable* vtable;
)
