...
nova_primitive_Nova_Primitive* nova_primitive_Nova_PrimitiveFunctionMap_virtualfunctionMapPrimitive_static_Nova_construct(nova_primitive_Nova_PrimitiveFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return this->vtable->nova_primitive_Nova_PrimitiveFunctionMap_virtualfunctionMapPrimitive_static_Nova_construct(0, exceptionData);
}
