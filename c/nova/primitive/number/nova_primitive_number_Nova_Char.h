...
typedef struct nova_primitive_number_Nova_CharPropertyMap nova_primitive_number_Nova_CharPropertyMap;
...
(
	...
	nova_primitive_number_Char_CharPropertyMap_Extension_VTable* vtable;
)
