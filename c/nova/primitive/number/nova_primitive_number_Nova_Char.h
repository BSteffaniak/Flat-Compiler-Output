...
typedef struct nova_primitive_number_Nova_nova_primitive_number_CharFunctionMap nova_primitive_number_Nova_nova_primitive_number_CharFunctionMap;
...
CCLASS_CLASS
(
	nova_primitive_number_Nova_nova_primitive_number_CharFunctionMap, 
	
	nova_primitive_number_Char_nova_primitive_number_CharFunctionMap_Extension_VTable* vtable;
)
