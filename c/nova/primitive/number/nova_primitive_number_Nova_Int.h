...
typedef struct nova_primitive_number_Nova_nova_primitive_number_IntFunctionMap nova_primitive_number_Nova_nova_primitive_number_IntFunctionMap;
...
CCLASS_CLASS
(
	nova_primitive_number_Nova_nova_primitive_number_IntFunctionMap, 
	
	nova_primitive_number_Int_nova_primitive_number_IntFunctionMap_Extension_VTable* vtable;
)
