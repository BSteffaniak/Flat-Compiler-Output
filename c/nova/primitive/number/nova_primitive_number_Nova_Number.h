...
typedef struct nova_primitive_number_Nova_nova_primitive_number_NumberFunctionMap nova_primitive_number_Nova_nova_primitive_number_NumberFunctionMap;
...
CCLASS_CLASS
(
	nova_primitive_number_Nova_nova_primitive_number_NumberFunctionMap, 
	
	nova_primitive_number_Number_nova_primitive_number_NumberFunctionMap_Extension_VTable* vtable;
)
