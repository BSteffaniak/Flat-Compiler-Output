...
typedef struct nova_primitive_number_Nova_DoubleFunctionMap nova_primitive_number_Nova_DoubleFunctionMap;
...
(
	...
	nova_primitive_number_Double_DoubleFunctionMap_Extension_VTable* vtable;
)
