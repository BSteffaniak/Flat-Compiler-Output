...
typedef struct nova_primitive_number_Nova_DoublePropertyMap nova_primitive_number_Nova_DoublePropertyMap;
...
(
	...
	nova_primitive_number_Double_DoublePropertyMap_Extension_VTable* vtable;
)
