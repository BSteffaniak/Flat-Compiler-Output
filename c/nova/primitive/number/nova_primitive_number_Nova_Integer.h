...
typedef struct nova_primitive_number_Nova_IntegerPropertyMap nova_primitive_number_Nova_IntegerPropertyMap;
...
(
	...
	nova_primitive_number_Integer_IntegerPropertyMap_Extension_VTable* vtable;
)
