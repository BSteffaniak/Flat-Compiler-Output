...
typedef struct nova_primitive_Nova_nova_primitive_BoolFunctionMap nova_primitive_Nova_nova_primitive_BoolFunctionMap;
...
CCLASS_CLASS
(
	nova_primitive_Nova_nova_primitive_BoolFunctionMap, 
	
	nova_primitive_Bool_nova_primitive_BoolFunctionMap_Extension_VTable* vtable;
)
