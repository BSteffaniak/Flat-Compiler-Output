...
{
	CCLASS_NEW(stabilitytest_Nova_FileStabilityPropertyMap, this,);
	this->vtable = &stabilitytest_FileStability_FileStabilityPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	stabilitytest_Nova_FileStabilityPropertyMap_Nova_super(this, exceptionData);
	
	{
		stabilitytest_Nova_FileStabilityPropertyMap_Nova_this(this, exceptionData);
	}
