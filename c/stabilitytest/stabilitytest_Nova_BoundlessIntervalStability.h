#ifndef FILE_stabilitytest_Nova_BoundlessIntervalStability_NOVA
#define FILE_stabilitytest_Nova_BoundlessIntervalStability_NOVA

typedef struct stabilitytest_Nova_BoundlessIntervalStability stabilitytest_Nova_BoundlessIntervalStability;

typedef struct nova_exception_Nova_ExceptionData nova_exception_Nova_ExceptionData;
typedef struct novex_nest_Nova_TestResult novex_nest_Nova_TestResult;

typedef void (*stabilitytest_Nova_BoundlessIntervalStability_closure520_Nova_onResult)(void*, novex_nest_Nova_TestResult*, void*);
...
CCLASS_CLASS
(
	stabilitytest_Nova_BoundlessIntervalStability, 
	
	stabilitytest_Nova_BoundlessIntervalStability_VTable* vtable;
	void* prv;
	nova_Nova_String* nova_Nova_Object_Nova_hashCode;
	novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_BoundlessIntervalStability_Nova_model;
)
extern novex_nest_Nova_TestCase* stabilitytest_Nova_BoundlessIntervalStability_Nova__invalidBoundlessIntervalBoundsTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_BoundlessIntervalStability_Nova__validIntervalBoundsTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_BoundlessIntervalStability_Nova__infiniteIntervalValuesTestCase;
extern novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_BoundlessIntervalStability_Nova__runTestsTestRunner;

extern char stabilitytest_Nova_BoundlessIntervalStability_Nova_init_static_inited;
