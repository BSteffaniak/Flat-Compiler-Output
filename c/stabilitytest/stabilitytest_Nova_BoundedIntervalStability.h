#ifndef FILE_stabilitytest_Nova_BoundedIntervalStability_NOVA
#define FILE_stabilitytest_Nova_BoundedIntervalStability_NOVA

typedef struct stabilitytest_Nova_BoundedIntervalStability stabilitytest_Nova_BoundedIntervalStability;

typedef struct nova_exception_Nova_ExceptionData nova_exception_Nova_ExceptionData;
typedef struct novex_nest_Nova_TestResult novex_nest_Nova_TestResult;

typedef void (*stabilitytest_Nova_BoundedIntervalStability_closure519_Nova_onResult)(void*, novex_nest_Nova_TestResult*, void*);
...
CCLASS_CLASS
(
	stabilitytest_Nova_BoundedIntervalStability, 
	
	stabilitytest_Nova_BoundedIntervalStability_VTable* vtable;
	void* prv;
	nova_Nova_String* nova_Nova_Object_Nova_hashCode;
	novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_BoundedIntervalStability_Nova_model;
)
extern novex_nest_Nova_TestCase* stabilitytest_Nova_BoundedIntervalStability_Nova__invalidUnboundedIntervalBoundsTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_BoundedIntervalStability_Nova__invalidIntervalBoundsTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_BoundedIntervalStability_Nova__validIntervalBoundsTestCase;
extern novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_BoundedIntervalStability_Nova__runTestsTestRunner;

extern char stabilitytest_Nova_BoundedIntervalStability_Nova_init_static_inited;
