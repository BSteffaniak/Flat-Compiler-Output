...
typedef struct stabilitytest_Nova_stabilitytest_PolymorphicSuperClassFunctionMap stabilitytest_Nova_stabilitytest_PolymorphicSuperClassFunctionMap;
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_PolymorphicSuperClassFunctionMap, 
	
	stabilitytest_PolymorphicSuperClass_stabilitytest_PolymorphicSuperClassFunctionMap_Extension_VTable* vtable;
)
