...
(
	...
	stabilitytest_PolymorphicSuperClass_Extension_VTable* vtable;
...
(
	...
	stabilitytest_PolymorphicSuperClass_PolymorphicSuperClassFunctionMap_Extension_VTable* vtable;
)
