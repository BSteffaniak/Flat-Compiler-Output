...
(
	...
	stabilitytest_PolymorphismStability_Extension_VTable* vtable;
...
(
	...
	stabilitytest_PolymorphismStability_PolymorphismStabilityFunctionMap_Extension_VTable* vtable;
)
