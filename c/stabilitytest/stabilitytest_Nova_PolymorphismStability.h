...
typedef struct stabilitytest_Nova_stabilitytest_PolymorphismStabilityFunctionMap stabilitytest_Nova_stabilitytest_PolymorphismStabilityFunctionMap;
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_PolymorphismStabilityFunctionMap, 
	
	stabilitytest_PolymorphismStability_stabilitytest_PolymorphismStabilityFunctionMap_Extension_VTable* vtable;
)
