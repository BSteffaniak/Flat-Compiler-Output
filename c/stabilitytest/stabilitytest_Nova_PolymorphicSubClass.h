...
typedef struct stabilitytest_Nova_stabilitytest_PolymorphicSubClassFunctionMap stabilitytest_Nova_stabilitytest_PolymorphicSubClassFunctionMap;
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_PolymorphicSubClassFunctionMap, 
	
	stabilitytest_PolymorphicSubClass_stabilitytest_PolymorphicSubClassFunctionMap_Extension_VTable* vtable;
)
