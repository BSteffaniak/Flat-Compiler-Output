...
int main(int argc, char** argvs)
{
		...
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 174);
		...
		nova_all_classes[150] = stabilitytest_AssignmentStability_Extension_VTable_val.classInstance;
		nova_all_classes[151] = stabilitytest_ClassWithProperties_Extension_VTable_val.classInstance;
		nova_all_classes[152] = stabilitytest_ClientThread_Extension_VTable_val.classInstance;
		nova_all_classes[153] = stabilitytest_ClosureStability_Extension_VTable_val.classInstance;
		nova_all_classes[154] = stabilitytest_ExceptionStability_Extension_VTable_val.classInstance;
		nova_all_classes[155] = stabilitytest_FileStability_Extension_VTable_val.classInstance;
		nova_all_classes[156] = stabilitytest_LambdaStability_Extension_VTable_val.classInstance;
		nova_all_classes[157] = stabilitytest_NetworkStability_Extension_VTable_val.classInstance;
		nova_all_classes[158] = stabilitytest_Node_Extension_VTable_val.classInstance;
		nova_all_classes[159] = stabilitytest_PolymorphicSubClass_Extension_VTable_val.classInstance;
		nova_all_classes[160] = stabilitytest_PolymorphicSuperClass_Extension_VTable_val.classInstance;
		nova_all_classes[161] = stabilitytest_PolymorphismStability_Extension_VTable_val.classInstance;
		nova_all_classes[162] = stabilitytest_RegexStability_Extension_VTable_val.classInstance;
		nova_all_classes[163] = stabilitytest_StabilityExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[164] = stabilitytest_StabilityTest_Extension_VTable_val.classInstance;
		nova_all_classes[165] = stabilitytest_StabilityTestCase_Extension_VTable_val.classInstance;
		nova_all_classes[166] = stabilitytest_StabilityTestException_Extension_VTable_val.classInstance;
		nova_all_classes[167] = stabilitytest_StaticImportStability_Extension_VTable_val.classInstance;
		nova_all_classes[168] = stabilitytest_SyntaxStability_Extension_VTable_val.classInstance;
		nova_all_classes[169] = stabilitytest_ThreadImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[170] = stabilitytest_ThreadStability_Extension_VTable_val.classInstance;
		nova_all_classes[171] = stabilitytest_TimeStability_Extension_VTable_val.classInstance;
		nova_all_classes[172] = stabilitytest_ToStringStability_Extension_VTable_val.classInstance;
		nova_all_classes[173] = stabilitytest_UnstableException_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 174);
