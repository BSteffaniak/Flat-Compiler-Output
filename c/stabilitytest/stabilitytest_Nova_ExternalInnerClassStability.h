...
(
	...
	stabilitytest_ExternalInnerClassStability_Extension_VTable* vtable;
...
(
	...
	stabilitytest_ExternalInnerClassStability_ExternalInnerClassStabilityFunctionMap_Extension_VTable* vtable;
)
