#ifndef FILE_stabilitytest_Nova_IntervalStability_NOVA
#define FILE_stabilitytest_Nova_IntervalStability_NOVA

typedef struct stabilitytest_Nova_IntervalStability stabilitytest_Nova_IntervalStability;

typedef struct nova_exception_Nova_ExceptionData nova_exception_Nova_ExceptionData;
typedef struct novex_nest_Nova_TestResult novex_nest_Nova_TestResult;

typedef void (*stabilitytest_Nova_IntervalStability_closure888_Nova_onResult)(void*, novex_nest_Nova_TestResult*, void*);
...
CCLASS_CLASS
(
	stabilitytest_Nova_IntervalStability, 
	
	stabilitytest_Nova_IntervalStability_VTable* vtable;
	void* prv;
	nova_Nova_String* nova_Nova_Object_Nova_hashCode;
	novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_IntervalStability_Nova_model;
)
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__threeHourIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__threeHourTwentyMinuteIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__threeHourTwentyMinuteFifteenSecondIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__threeHourTwentyMinuteFifteenSecondOneHundredTwentyOneMillisecondIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__oneDayIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__twoDayIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__twoAndAHalfDayIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__twoMonthIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__oneYearIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__twoAndAHalfYearIntervalTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__invalidIntervalGapTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_IntervalStability_Nova__validIntervalGapTestCase;
extern novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_IntervalStability_Nova__runTestsTestRunner;

extern char stabilitytest_Nova_IntervalStability_Nova_init_static_inited;
