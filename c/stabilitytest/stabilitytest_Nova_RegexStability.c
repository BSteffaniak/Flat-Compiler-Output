...
void stabilitytest_Nova_RegexStability_Nova_testLambda75(stabilitytest_Nova_RegexStability* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
void stabilitytest_Nova_RegexStability_Nova_testLambda76(stabilitytest_Nova_RegexStability* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
...
void stabilitytest_Nova_RegexStability_Nova_match(stabilitytest_Nova_RegexStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	stabilitytest_Nova_StabilityTest_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Failed to find valid match")), !nova_regex_Nova_Regex_static_Nova_containsMatch(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("a[bd]c")), nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("hello adc goodbye"))));
	stabilitytest_Nova_StabilityTest_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Failed to not find match")), nova_regex_Nova_Regex_static_Nova_containsMatch(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("a[bd]c")), nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("no match here..."))));
	l1_Nova_matches = nova_regex_Nova_Regex_static_Nova_getMatches(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("a[bd]c")), nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("this is abc test adc adc hello")));
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_matches), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&stabilitytest_Nova_RegexStability_Nova_testLambda75, this, &contextArg75);
	l1_Nova_matches2 = nova_regex_Nova_Regex_static_Nova_getMatches(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\\d+")), nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("whats my number? 818 414-5326")));
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_matches2), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&stabilitytest_Nova_RegexStability_Nova_testLambda76, this, &contextArg76);
