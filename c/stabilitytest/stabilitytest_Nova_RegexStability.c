...
void stabilitytest_Nova_RegexStability_Nova_lambda154(stabilitytest_Nova_RegexStability* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
void stabilitytest_Nova_RegexStability_Nova_lambda155(stabilitytest_Nova_RegexStability* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
...
void stabilitytest_Nova_RegexStability_Nova_match(stabilitytest_Nova_RegexStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	Context1* contextArg154 = NOVA_MALLOC(sizeof(Context1));
	nova_datastruct_list_Nova_Array* l1_Nova_matches2 = (nova_datastruct_list_Nova_Array*)nova_null;
	Context2* contextArg155 = NOVA_MALLOC(sizeof(Context2));
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_matches), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&stabilitytest_Nova_RegexStability_Nova_lambda154, this, contextArg154);
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_matches2), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&stabilitytest_Nova_RegexStability_Nova_lambda155, this, contextArg155);
...
void stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap* stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_construct(stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap, this,);
	this->vtable = &stabilitytest_RegexStability_stabilitytest_RegexStabilityFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_super(this, exceptionData);
	
	{
		stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_destroy(stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_this(stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap_Nova_super(stabilitytest_Nova_stabilitytest_RegexStabilityFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
