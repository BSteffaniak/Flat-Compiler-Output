...
typedef struct stabilitytest_Nova_stabilitytest_InnerClassStabilityFunctionMap stabilitytest_Nova_stabilitytest_InnerClassStabilityFunctionMap;
typedef struct stabilitytest_Nova_stabilitytest_InnerClassStability_MyOuterFunctionMap stabilitytest_Nova_stabilitytest_InnerClassStability_MyOuterFunctionMap;
typedef struct stabilitytest_Nova_MyInner stabilitytest_Nova_MyInner;
typedef struct stabilitytest_Nova_stabilitytest_InnerClassStability_MyInnerFunctionMap stabilitytest_Nova_stabilitytest_InnerClassStability_MyInnerFunctionMap;
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_InnerClassStabilityFunctionMap, 
	
	stabilitytest_InnerClassStability_stabilitytest_InnerClassStabilityFunctionMap_Extension_VTable* vtable;
)
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_InnerClassStability_MyOuterFunctionMap, 
	
	stabilitytest_InnerClassStability_stabilitytest_InnerClassStability_MyOuterFunctionMap_Extension_VTable* vtable;
)
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_InnerClassStability_MyInnerFunctionMap, 
	
	stabilitytest_InnerClassStability_stabilitytest_InnerClassStability_MyInnerFunctionMap_Extension_VTable* vtable;
)
