...
{
	CCLASS_NEW(stabilitytest_Nova_stabilitytest_ToStringStabilityFunctionMap, this,);
	this->vtable = &stabilitytest_ToStringStability_stabilitytest_ToStringStabilityFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	stabilitytest_Nova_stabilitytest_ToStringStabilityFunctionMap_Nova_super(this, exceptionData);
	
	{
		stabilitytest_Nova_stabilitytest_ToStringStabilityFunctionMap_Nova_this(this, exceptionData);
	}
