...
typedef struct stabilitytest_Nova_stabilitytest_NetworkStabilityFunctionMap stabilitytest_Nova_stabilitytest_NetworkStabilityFunctionMap;
...
CCLASS_CLASS
(
	stabilitytest_Nova_stabilitytest_NetworkStabilityFunctionMap, 
	
	stabilitytest_NetworkStability_stabilitytest_NetworkStabilityFunctionMap_Extension_VTable* vtable;
)
