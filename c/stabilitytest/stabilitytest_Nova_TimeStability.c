...
{
	CCLASS_NEW(stabilitytest_Nova_TimeStabilityPropertyMap, this,);
	this->vtable = &stabilitytest_TimeStability_TimeStabilityPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	stabilitytest_Nova_TimeStabilityPropertyMap_Nova_super(this, exceptionData);
	
	{
		stabilitytest_Nova_TimeStabilityPropertyMap_Nova_this(this, exceptionData);
	}
