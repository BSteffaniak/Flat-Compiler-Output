...
nova_datastruct_list_Nova_Array* generated36(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData);
nova_datastruct_list_Nova_Array* generated37(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData);
nova_datastruct_list_Nova_Array* generated38(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData);
nova_Nova_String* stabilitytest_Nova_SyntaxStability_Nova_testLambda122(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* x, nova_Nova_Object* y, Context1* context);
nova_datastruct_list_Nova_Array* generated39(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData);
nova_datastruct_list_Nova_IntArray* generated40(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData, int value2, int value3);
...
void stabilitytest_Nova_SyntaxStability_Nova_checkIterators(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_list = generated36(this, exceptionData);
...
void stabilitytest_Nova_SyntaxStability_Nova_checkRepeat(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_i = (int)(0);
	for (repeatCounter4 = 0; repeatCounter4 < 101; repeatCounter4++)
	{
		l1_Nova_i++;
	}
	...
	l1_Nova_i = (int)(0);
	for (repeatCounter6 = 0; repeatCounter6 < l1_Nova_times; repeatCounter6++)
	{
		l1_Nova_i++;
	}
...
void stabilitytest_Nova_SyntaxStability_Nova_checkZipper(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_array1 = generated37(this, exceptionData);
	l1_Nova_array2 = generated38(this, exceptionData);
	l1_Nova_zipped = nova_datastruct_list_Nova_List_Nova_zip((nova_datastruct_list_Nova_List*)(l1_Nova_array1), exceptionData, (nova_datastruct_list_Nova_List*)(l1_Nova_array2), (nova_datastruct_list_Nova_List_closure24_Nova_zipper)&stabilitytest_Nova_SyntaxStability_Nova_testLambda122, this, &contextArg122);
...
void stabilitytest_Nova_SyntaxStability_Nova_checkSafeNavigation(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	if ((int)((l1_Nova_nova_local_13 = l1_Nova_node) != (stabilitytest_Nova_Node*)nova_null ? ((int)((l1_Nova_nova_local_14 = l1_Nova_nova_local_13->stabilitytest_Nova_Node_Nova_child) != (stabilitytest_Nova_Node*)nova_null ? ((int)((l1_Nova_nova_local_15 = l1_Nova_nova_local_14->stabilitytest_Nova_Node_Nova_child) != (stabilitytest_Nova_Node*)nova_null ? (l1_Nova_nova_local_15->stabilitytest_Nova_Node_Nova_value) : 0)) : 0)) : 0) == 3 && (int)((l1_Nova_nova_local_16 = l1_Nova_node) != (stabilitytest_Nova_Node*)nova_null ? ((int)((l1_Nova_nova_local_17 = l1_Nova_nova_local_16->stabilitytest_Nova_Node_Nova_child) != (stabilitytest_Nova_Node*)nova_null ? (l1_Nova_nova_local_17->stabilitytest_Nova_Node_Nova_value) : 0)) : 0) == 2 && (int)((l1_Nova_nova_local_18 = l1_Nova_node) != (stabilitytest_Nova_Node*)nova_null ? (l1_Nova_nova_local_18->stabilitytest_Nova_Node_Nova_value) : 0) == 1)
	{
		...
		l1_Nova_array = generated39(this, exceptionData);
...
void stabilitytest_Nova_SyntaxStability_Nova_checkArrayInitializers(stabilitytest_Nova_SyntaxStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_num1 = (int)(1);
	l1_Nova_num2 = (int)(2);
	l1_Nova_myInts = generated40(this, exceptionData, l1_Nova_num1, l1_Nova_num2);
