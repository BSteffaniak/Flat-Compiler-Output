#ifndef FILE_stabilitytest_Nova_CastStability_NOVA
#define FILE_stabilitytest_Nova_CastStability_NOVA

typedef struct stabilitytest_Nova_CastStability stabilitytest_Nova_CastStability;

typedef struct nova_exception_Nova_ExceptionData nova_exception_Nova_ExceptionData;
typedef struct novex_nest_Nova_TestResult novex_nest_Nova_TestResult;

typedef void (*stabilitytest_Nova_CastStability_closure521_Nova_onResult)(void*, novex_nest_Nova_TestResult*, void*);
...
CCLASS_CLASS
(
	stabilitytest_Nova_CastStability, 
	
	stabilitytest_Nova_CastStability_VTable* vtable;
	void* prv;
	nova_Nova_String* nova_Nova_Object_Nova_hashCode;
	novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_CastStability_Nova_model;
)
extern novex_nest_Nova_TestCase* stabilitytest_Nova_CastStability_Nova__validPrimitveNumericCastsTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_CastStability_Nova__validArrayTypeCastTestCase;
extern novex_nest_Nova_TestCase* stabilitytest_Nova_CastStability_Nova__incompatibleCastTestCase;
extern novex_nest_Nova_TestRunnerModel* stabilitytest_Nova_CastStability_Nova__runTestsTestRunner;

extern char stabilitytest_Nova_CastStability_Nova_init_static_inited;
