...
typedef int (*stabilitytest_Nova_ClosureStabilityFunctionMap_closure13_Nova_closure)(void*, nova_exception_Nova_ExceptionData*, int, int, void*);
typedef double (*stabilitytest_Nova_ClosureStabilityFunctionMap_closure14_Nova_closure)(void*, nova_exception_Nova_ExceptionData*, double, void*);
typedef void (*stabilitytest_Nova_ClosureStabilityFunctionMap_closure15_Nova_closure)(void*, nova_exception_Nova_ExceptionData*, void*);
...
void stabilitytest_Nova_ClosureStability_Nova_testMathClosures(stabilitytest_Nova_ClosureStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	stabilitytest_Nova_StabilityTest_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Failed to call multiply(Int, Int) closure")), stabilitytest_Nova_ClosureStability_static_Nova_callClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure4_Nova_closure)&stabilitytest_Nova_ClosureStability_static_Nova_multiply, this, nova_null, l1_Nova_a, l1_Nova_b) != stabilitytest_Nova_ClosureStability_static_Nova_multiply(this, exceptionData, l1_Nova_a, l1_Nova_b));
	stabilitytest_Nova_StabilityTest_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Failed to call pow(Int, Int) closure")), stabilitytest_Nova_ClosureStability_static_Nova_callClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure4_Nova_closure)&stabilitytest_Nova_ClosureStability_static_Nova_pow, this, nova_null, l1_Nova_a, l1_Nova_b) != stabilitytest_Nova_ClosureStability_static_Nova_pow(this, exceptionData, l1_Nova_a, l1_Nova_b));
	stabilitytest_Nova_StabilityTest_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Failed to call Math.sin(Double) closure")), stabilitytest_Nova_ClosureStability_static_Nova_mathClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure8_Nova_closure)&nova_math_Nova_Math_static_Nova_sin, nova_math_Nova_Math_static_Nova_sin, nova_null, l1_Nova_value) - nova_math_Nova_Math_static_Nova_sin(0, exceptionData, l1_Nova_value) >= stabilitytest_Nova_ClosureStability_Nova_TOLERANCE);
	stabilitytest_Nova_StabilityTest_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Failed to call Math.tan(Double) closure")), stabilitytest_Nova_ClosureStability_static_Nova_mathClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure8_Nova_closure)&nova_math_Nova_Math_static_Nova_tan, nova_math_Nova_Math_static_Nova_tan, nova_null, l1_Nova_value) - nova_math_Nova_Math_static_Nova_tan(0, exceptionData, l1_Nova_value) >= stabilitytest_Nova_ClosureStability_Nova_TOLERANCE);
...
void stabilitytest_Nova_ClosureStability_Nova_testInstanceClosure(stabilitytest_Nova_ClosureStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	stabilitytest_Nova_ClosureStability_static_Nova_instanceClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure12_Nova_closure)&stabilitytest_Nova_ClosureStability_Nova_incrementNumber, l1_Nova_c, nova_null);
	...
	stabilitytest_Nova_ClosureStability_static_Nova_instanceClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure12_Nova_closure)&stabilitytest_Nova_ClosureStability_Nova_incrementNumber, stabilitytest_Nova_ClosureStability_Nova_construct(0, exceptionData, this->stabilitytest_Nova_StabilityTestCase_Nova_program), nova_null);
	stabilitytest_Nova_ClosureStability_static_Nova_instanceClosure(this, exceptionData, (stabilitytest_Nova_ClosureStability_closure12_Nova_closure)&stabilitytest_Nova_ClosureStability_Nova_incrementNumber, l1_Nova_c, nova_null);
	nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("OK")));
}
...
int stabilitytest_Nova_ClosureStabilityFunctionMap_functionMap_static_Nova_callClosure(stabilitytest_Nova_ClosureStabilityFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_ClosureStabilityFunctionMap_closure13_Nova_closure stabilitytest_Nova_ClosureStabilityFunctionMap_Nova_closure, void* stabilitytest_Nova_ClosureStabilityFunctionMap_ref_Nova_closure, void* closure_context, int a, int b)
{
	return stabilitytest_Nova_ClosureStability_static_Nova_callClosure(0, exceptionData, (stabilitytest_Nova_ClosureStability_closure4_Nova_closure)stabilitytest_Nova_ClosureStabilityFunctionMap_Nova_closure, stabilitytest_Nova_ClosureStabilityFunctionMap_ref_Nova_closure, closure_context, a, b);
}

double stabilitytest_Nova_ClosureStabilityFunctionMap_functionMap_static_Nova_mathClosure(stabilitytest_Nova_ClosureStabilityFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_ClosureStabilityFunctionMap_closure14_Nova_closure stabilitytest_Nova_ClosureStabilityFunctionMap_Nova_closure, void* stabilitytest_Nova_ClosureStabilityFunctionMap_ref_Nova_closure, void* closure_context, double value)
{
	return stabilitytest_Nova_ClosureStability_static_Nova_mathClosure(0, exceptionData, (stabilitytest_Nova_ClosureStability_closure8_Nova_closure)stabilitytest_Nova_ClosureStabilityFunctionMap_Nova_closure, stabilitytest_Nova_ClosureStabilityFunctionMap_ref_Nova_closure, closure_context, value);
}

void stabilitytest_Nova_ClosureStabilityFunctionMap_functionMap_static_Nova_instanceClosure(stabilitytest_Nova_ClosureStabilityFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_ClosureStabilityFunctionMap_closure15_Nova_closure stabilitytest_Nova_ClosureStabilityFunctionMap_Nova_closure, void* stabilitytest_Nova_ClosureStabilityFunctionMap_ref_Nova_closure, void* closure_context)
{
	stabilitytest_Nova_ClosureStability_static_Nova_instanceClosure(0, exceptionData, (stabilitytest_Nova_ClosureStability_closure12_Nova_closure)stabilitytest_Nova_ClosureStabilityFunctionMap_Nova_closure, stabilitytest_Nova_ClosureStabilityFunctionMap_ref_Nova_closure, closure_context);
}
