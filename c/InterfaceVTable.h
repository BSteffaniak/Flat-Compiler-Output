...
spectra_tree_nodes_functions_Nova_Parameter* (*spectra_tree_nodes_functions_Nova_CallableFunctionFunctionMap_virtualfunctionMap0_Nova_parseParameter)(spectra_tree_nodes_functions_Nova_CallableFunctionFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_functions_Nova_CallableFunction*, nova_Nova_String*, int);
char (*spectra_tree_nodes_functions_Nova_CallableFunctionFunctionMap_virtualfunctionMap0_Nova_parseParameters)(spectra_tree_nodes_functions_Nova_CallableFunctionFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_functions_Nova_CallableFunction*, nova_Nova_String*, int);
