...
{
	CCLASS_NEW(example_network_Nova_example_network_ConnectionThreadFunctionMap, this,);
	this->vtable = &example_network_ConnectionThread_example_network_ConnectionThreadFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	example_network_Nova_example_network_ConnectionThreadFunctionMap_Nova_super(this, exceptionData);
	
	{
		example_network_Nova_example_network_ConnectionThreadFunctionMap_Nova_this(this, exceptionData);
	}
