...
nova_datastruct_list_Nova_IntArray* generated19(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData);
...
nova_Nova_Object* example_Nova_Lab_static_Nova_testLambda65(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* x, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
char example_Nova_Lab_static_Nova_testLambda66(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
nova_Nova_Object* example_Nova_Lab_static_Nova_testLambda67(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
...
nova_Nova_Object* example_Nova_Lab_static_Nova_testLambda69(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
nova_Nova_Object* example_Nova_Lab_static_Nova_testLambda70(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, int _1, int _2, nova_datastruct_list_Nova_IntArray* _3, Context7* context);
nova_datastruct_list_Nova_Array* generated22(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData);
nova_Nova_Object* example_Nova_Lab_static_Nova_testLambda71(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* _1, int _2, nova_datastruct_list_Nova_List* _3, Context8* context);
...
void example_Nova_Lab_static_Nova_main(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
	...
	l1_Nova_tree = nova_datastruct_Nova_BinaryTree_Nova_construct(0, exceptionData, (nova_datastruct_list_Nova_Array*)(generated17(0, exceptionData)));
	...
	l1_Nova_list = generated18(0, exceptionData);
	l1_Nova_list2 = generated19(0, exceptionData);
	...
	nova_datastruct_list_Nova_Array_0_Nova_add((nova_datastruct_list_Nova_Array*)(l1_Nova_multi), exceptionData, (nova_Nova_Object*)(generated20(0, exceptionData)));
