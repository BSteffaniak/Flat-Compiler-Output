...
void example_Nova_Lab_static_Nova_main(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		Context2* contextArg61 = NOVA_MALLOC(sizeof(Context2));
		nova_datastruct_list_Nova_Array* l1_Nova_multi = (nova_datastruct_list_Nova_Array*)nova_null;
		Context4* contextArg62 = NOVA_MALLOC(sizeof(Context4));
		Context5* contextArg63 = NOVA_MALLOC(sizeof(Context5));
		Context6* contextArg64 = NOVA_MALLOC(sizeof(Context6));
		Context7* contextArg65 = NOVA_MALLOC(sizeof(Context7));
		Context8* contextArg66 = NOVA_MALLOC(sizeof(Context8));
		Context9* contextArg67 = NOVA_MALLOC(sizeof(Context9));
		...
		nova_datastruct_list_Nova_Array_virtual0_Nova_add((nova_datastruct_list_Nova_Array*)(l1_Nova_multi), exceptionData, (nova_Nova_Object*)(generated16(0, exceptionData)));
		nova_datastruct_list_Nova_Array_virtual0_Nova_add((nova_datastruct_list_Nova_Array*)(l1_Nova_multi), exceptionData, (nova_Nova_Object*)(generated17(0, exceptionData)));
		...
		if (1)
		{
				...
				nova_datastruct_list_Nova_Array_virtual0_Nova_add((nova_datastruct_list_Nova_Array*)(l1_Nova_x), exceptionData, (nova_Nova_Object*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("hey"))));
				nova_datastruct_list_Nova_Array_virtual0_Nova_add((nova_datastruct_list_Nova_Array*)(l1_Nova_x), exceptionData, (nova_Nova_Object*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("its now an array"))));
		}
		...
		nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, (nova_Nova_String*)(nova_Nova_String_Nova_plus(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Matrix:\n")), exceptionData, (nova_Nova_String*)(nova_Nova_String_Nova_plus(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((nova_math_Nova_Matrix_Nova_multiply(l1_Nova_matrix1, exceptionData, l1_Nova_matrix2))), exceptionData), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))))));
		nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, (nova_Nova_String*)(nova_Nova_String_Nova_plus(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Matrix:\n")), exceptionData, (nova_Nova_String*)(nova_Nova_String_Nova_plus(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((nova_math_Nova_Matrix_Nova_add(nova_math_Nova_Matrix_Nova_transpose(l1_Nova_matrix1, exceptionData), exceptionData, l1_Nova_matrix2, (intptr_t)nova_null))), exceptionData), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))))));
		...
		l1_Nova_myImmutableArray = nova_datastruct_list_Nova_Array_Nova_toImmutable((nova_datastruct_list_Nova_Array*)(generated19(0, exceptionData)), exceptionData);
		...
		l1_Nova_outputArray = (nova_datastruct_list_Nova_ImmutableArray*)(nova_datastruct_list_Nova_ImmutableArray_0_Nova_add((nova_datastruct_list_Nova_ImmutableArray*)(l1_Nova_myImmutableArray), exceptionData, (nova_Nova_Object*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("four")))));
...
void example_Nova_Lab_static_Nova_doSomething(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_List* list)
{
		Context10* contextArg68 = NOVA_MALLOC(sizeof(Context10));
		
		nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(list), exceptionData, (nova_datastruct_list_Nova_List_closure8_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda68, nova_null, contextArg68)), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&nova_io_Nova_Console_1_static_Nova_writeLine, nova_io_Nova_Console_1_static_Nova_writeLine, nova_null);
}
...
int main(int argc, char** argvs)
{
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Animal_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ArrayDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_BodyBuilder_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ClosureDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Dog_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ExceptionHandlingDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_FileTest_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_GenericDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_HashMapDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_HashSetDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_IntegerTest_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Lab_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_MathDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_NonWholeDivisionException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Person_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		example_Polygon_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = (nova_Nova_Class*)nova_null;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Polygon_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_PolymorphismDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_QueueDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Spider_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		example_Square_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_SvgChart_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_SvgFractal_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_T1_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_T2_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Test_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ThreadDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ThreadDemoImplementation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ackermann_Ackermann_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_copy_Dog_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_database_DatabaseDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_ClientDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_ConnectionThread_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_OutputThread_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_ServerDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_AssignmentStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ClassWithProperties_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ClientThread_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ClosureStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ExceptionStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_FileStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_LambdaStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_NetworkStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_Node_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_PolymorphicSubClass_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_PolymorphicSuperClass_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_PolymorphismStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_RegexStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityExceptionHandler_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityTest_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityTestCase_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityTestException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StaticImportStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_SyntaxStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ThreadImplementation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ThreadStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_TimeStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ToStringStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_UnstableException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		
		
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 211);
		...
		nova_all_classes[153] = example_Animal_Extension_VTable_val.classInstance;
		nova_all_classes[154] = example_ArrayDemo_Extension_VTable_val.classInstance;
		nova_all_classes[155] = example_BodyBuilder_Extension_VTable_val.classInstance;
		nova_all_classes[156] = example_ClosureDemo_Extension_VTable_val.classInstance;
		nova_all_classes[157] = example_Dog_Extension_VTable_val.classInstance;
		nova_all_classes[158] = example_ExceptionHandlingDemo_Extension_VTable_val.classInstance;
		nova_all_classes[159] = example_FileTest_Extension_VTable_val.classInstance;
		nova_all_classes[160] = example_GenericDemo_Extension_VTable_val.classInstance;
		nova_all_classes[161] = example_HashMapDemo_Extension_VTable_val.classInstance;
		nova_all_classes[162] = example_HashSetDemo_Extension_VTable_val.classInstance;
		nova_all_classes[163] = example_IntegerTest_Extension_VTable_val.classInstance;
		nova_all_classes[164] = example_Lab_Extension_VTable_val.classInstance;
		nova_all_classes[165] = example_MathDemo_Extension_VTable_val.classInstance;
		nova_all_classes[166] = example_NonWholeDivisionException_Extension_VTable_val.classInstance;
		nova_all_classes[167] = example_Person_Extension_VTable_val.classInstance;
		nova_all_classes[168] = example_Polygon_Extension_VTable_val.classInstance;
		nova_all_classes[169] = example_PolymorphismDemo_Extension_VTable_val.classInstance;
		nova_all_classes[170] = example_QueueDemo_Extension_VTable_val.classInstance;
		nova_all_classes[171] = example_Spider_Extension_VTable_val.classInstance;
		nova_all_classes[172] = example_Square_Extension_VTable_val.classInstance;
		nova_all_classes[173] = example_SvgChart_Extension_VTable_val.classInstance;
		nova_all_classes[174] = example_SvgFractal_Extension_VTable_val.classInstance;
		nova_all_classes[175] = example_T1_Extension_VTable_val.classInstance;
		nova_all_classes[176] = example_T2_Extension_VTable_val.classInstance;
		nova_all_classes[177] = example_Test_Extension_VTable_val.classInstance;
		nova_all_classes[178] = example_ThreadDemo_Extension_VTable_val.classInstance;
		nova_all_classes[179] = example_ThreadDemoImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[180] = example_ackermann_Ackermann_Extension_VTable_val.classInstance;
		nova_all_classes[181] = example_copy_Dog_Extension_VTable_val.classInstance;
		nova_all_classes[182] = example_database_DatabaseDemo_Extension_VTable_val.classInstance;
		nova_all_classes[183] = example_network_ClientDemo_Extension_VTable_val.classInstance;
		nova_all_classes[184] = example_network_ConnectionThread_Extension_VTable_val.classInstance;
		nova_all_classes[185] = example_network_OutputThread_Extension_VTable_val.classInstance;
		nova_all_classes[186] = example_network_ServerDemo_Extension_VTable_val.classInstance;
		nova_all_classes[187] = stabilitytest_AssignmentStability_Extension_VTable_val.classInstance;
		nova_all_classes[188] = stabilitytest_ClassWithProperties_Extension_VTable_val.classInstance;
		nova_all_classes[189] = stabilitytest_ClientThread_Extension_VTable_val.classInstance;
		nova_all_classes[190] = stabilitytest_ClosureStability_Extension_VTable_val.classInstance;
		nova_all_classes[191] = stabilitytest_ExceptionStability_Extension_VTable_val.classInstance;
		nova_all_classes[192] = stabilitytest_FileStability_Extension_VTable_val.classInstance;
		nova_all_classes[193] = stabilitytest_LambdaStability_Extension_VTable_val.classInstance;
		nova_all_classes[194] = stabilitytest_NetworkStability_Extension_VTable_val.classInstance;
		nova_all_classes[195] = stabilitytest_Node_Extension_VTable_val.classInstance;
		nova_all_classes[196] = stabilitytest_PolymorphicSubClass_Extension_VTable_val.classInstance;
		nova_all_classes[197] = stabilitytest_PolymorphicSuperClass_Extension_VTable_val.classInstance;
		nova_all_classes[198] = stabilitytest_PolymorphismStability_Extension_VTable_val.classInstance;
		nova_all_classes[199] = stabilitytest_RegexStability_Extension_VTable_val.classInstance;
		nova_all_classes[200] = stabilitytest_StabilityExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[201] = stabilitytest_StabilityTest_Extension_VTable_val.classInstance;
		nova_all_classes[202] = stabilitytest_StabilityTestCase_Extension_VTable_val.classInstance;
		nova_all_classes[203] = stabilitytest_StabilityTestException_Extension_VTable_val.classInstance;
		nova_all_classes[204] = stabilitytest_StaticImportStability_Extension_VTable_val.classInstance;
		nova_all_classes[205] = stabilitytest_SyntaxStability_Extension_VTable_val.classInstance;
		nova_all_classes[206] = stabilitytest_ThreadImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[207] = stabilitytest_ThreadStability_Extension_VTable_val.classInstance;
		nova_all_classes[208] = stabilitytest_TimeStability_Extension_VTable_val.classInstance;
		nova_all_classes[209] = stabilitytest_ToStringStability_Extension_VTable_val.classInstance;
		nova_all_classes[210] = stabilitytest_UnstableException_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 211);
