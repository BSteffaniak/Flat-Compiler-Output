...
void example_Nova_Lab_static_Nova_lambda54(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, Context1* context);
nova_datastruct_list_Nova_Array* example_Nova_Lab_static_Nova_lambda55(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
nova_datastruct_list_Nova_Array* example_Nova_Lab_static_Nova_lambda56(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
...
nova_Nova_String* example_Nova_Lab_static_Nova_lambda57(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* x, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
char example_Nova_Lab_static_Nova_lambda58(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context5* context);
nova_Nova_String* example_Nova_Lab_static_Nova_lambda59(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
char example_Nova_Lab_static_Nova_lambda60(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
nova_Nova_String* example_Nova_Lab_static_Nova_lambda61(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context8* context);
nova_Nova_String* example_Nova_Lab_static_Nova_lambda62(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, char _1, int _2, nova_datastruct_list_Nova_Array* _3, Context9* context);
nova_datastruct_list_Nova_Array* generated18(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData);
nova_Nova_String* example_Nova_Lab_static_Nova_lambda63(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* _1, int _2, nova_datastruct_list_Nova_List* _3, Context10* context);
...
void example_Nova_Lab_static_Nova_main(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		Context4 contextArg57 = 
		{
		};
		Context5 contextArg58 = 
		{
		};
		Context6 contextArg59 = 
		{
		};
		Context7 contextArg60 = 
		{
		};
		Context8 contextArg61 = 
		{
		};
		Context9 contextArg62 = 
		{
		};
		...
		l1_Nova_tree = nova_datastruct_Nova_BinaryTree_Nova_construct(0, exceptionData, (nova_datastruct_list_Nova_Array*)(generated13(0, exceptionData)));
		...
		l1_Nova_list = generated14(0, exceptionData);
		l1_Nova_list2 = generated15(0, exceptionData);
		nova_thread_async_Nova_Async_static_Nova_execute(0, exceptionData, (nova_thread_async_Nova_Async_closure3_Nova_func)&example_Nova_Lab_static_Nova_lambda54, nova_null, &contextArg54);
		l1_Nova_sss = (nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_0_Nova_map((nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_1_Nova_construct(0, exceptionData, 4, (intptr_t)nova_null)), exceptionData, (nova_datastruct_list_Nova_Array_closure3_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda55, nova_null, &contextArg56));
		...
		nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(l1_Nova_list), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda57, nova_null, &contextArg57)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", "))));
		nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Mapped: "))), exceptionData, nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_filter((nova_datastruct_list_Nova_List*)(l1_Nova_list), exceptionData, (nova_datastruct_list_Nova_List_closure15_Nova_filterFunc)&example_Nova_Lab_static_Nova_lambda58, nova_null, &contextArg58)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda59, nova_null, &contextArg59)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")))));
		nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Mapped backwards: "))), exceptionData, nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual_Nova_reverse((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_filter((nova_datastruct_list_Nova_List*)(l1_Nova_list), exceptionData, (nova_datastruct_list_Nova_List_closure15_Nova_filterFunc)&example_Nova_Lab_static_Nova_lambda60, nova_null, &contextArg60)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda61, nova_null, &contextArg61)), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")))));
		nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Mapped2: "))), exceptionData, nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(l1_Nova_list2), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda62, nova_null, &contextArg62)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")))));
		l1_Nova_linked = nova_datastruct_list_Nova_LinkedList_Nova_construct(0, exceptionData);
		nova_datastruct_list_Nova_LinkedList_Nova_addAll(l1_Nova_linked, exceptionData, (nova_datastruct_list_Nova_Array*)(generated18(0, exceptionData)));
...
void example_Nova_Lab_static_Nova_doSomething(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_List* list)
{
		Context10 contextArg63 = 
		{
		};
		
		nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(list), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda63, nova_null, &contextArg63)), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&nova_io_Nova_Console_1_static_Nova_writeLine, nova_io_Nova_Console_1_static_Nova_writeLine, nova_null);
}
...
nova_datastruct_list_Nova_Array* example_Nova_Lab_static_Nova_lambda55(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context)
{
		...
		return (nova_datastruct_list_Nova_Array*)nova_datastruct_list_Nova_Array_0_Nova_map((nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_1_Nova_construct(0, exceptionData, 2, (intptr_t)nova_null)), exceptionData, (nova_datastruct_list_Nova_Array_closure3_Nova_mapFunc)&example_Nova_Lab_static_Nova_lambda56, nova_null, &contextArg55);
}
...
int main(int argc, char** argvs)
{
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Animal_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ArrayDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_BodyBuilder_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ClosureDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Dog_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ExceptionHandlingDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_FileTest_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_GenericDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_HashMapDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_HashSetDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_IntegerTest_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Lab_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_MathDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_NonWholeDivisionException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Person_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		example_Polygon_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = (nova_Nova_Class*)nova_null;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Polygon_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_PolymorphismDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_QueueDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Spider_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		example_Square_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_SvgChart_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_SvgFractal_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_T1_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_T2_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_Test_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ThreadDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ThreadDemoImplementation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_ackermann_Ackermann_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_copy_Dog_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_database_DatabaseDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_ClientDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_ConnectionThread_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_OutputThread_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		example_network_ServerDemo_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_AssignmentStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ClassWithProperties_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ClientThread_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ClosureStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ExceptionStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_FileStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_LambdaStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_NetworkStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_Node_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_PolymorphicSubClass_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_PolymorphicSuperClass_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_PolymorphismStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_RegexStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityExceptionHandler_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityTest_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityTestCase_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_StabilityTestException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_SyntaxStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ThreadImplementation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ThreadStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_TimeStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_ToStringStability_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		stabilitytest_UnstableException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		
		
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 203);
		...
		nova_all_classes[146] = example_Animal_Extension_VTable_val.classInstance;
		nova_all_classes[147] = example_ArrayDemo_Extension_VTable_val.classInstance;
		nova_all_classes[148] = example_BodyBuilder_Extension_VTable_val.classInstance;
		nova_all_classes[149] = example_ClosureDemo_Extension_VTable_val.classInstance;
		nova_all_classes[150] = example_Dog_Extension_VTable_val.classInstance;
		nova_all_classes[151] = example_ExceptionHandlingDemo_Extension_VTable_val.classInstance;
		nova_all_classes[152] = example_FileTest_Extension_VTable_val.classInstance;
		nova_all_classes[153] = example_GenericDemo_Extension_VTable_val.classInstance;
		nova_all_classes[154] = example_HashMapDemo_Extension_VTable_val.classInstance;
		nova_all_classes[155] = example_HashSetDemo_Extension_VTable_val.classInstance;
		nova_all_classes[156] = example_IntegerTest_Extension_VTable_val.classInstance;
		nova_all_classes[157] = example_Lab_Extension_VTable_val.classInstance;
		nova_all_classes[158] = example_MathDemo_Extension_VTable_val.classInstance;
		nova_all_classes[159] = example_NonWholeDivisionException_Extension_VTable_val.classInstance;
		nova_all_classes[160] = example_Person_Extension_VTable_val.classInstance;
		nova_all_classes[161] = example_Polygon_Extension_VTable_val.classInstance;
		nova_all_classes[162] = example_PolymorphismDemo_Extension_VTable_val.classInstance;
		nova_all_classes[163] = example_QueueDemo_Extension_VTable_val.classInstance;
		nova_all_classes[164] = example_Spider_Extension_VTable_val.classInstance;
		nova_all_classes[165] = example_Square_Extension_VTable_val.classInstance;
		nova_all_classes[166] = example_SvgChart_Extension_VTable_val.classInstance;
		nova_all_classes[167] = example_SvgFractal_Extension_VTable_val.classInstance;
		nova_all_classes[168] = example_T1_Extension_VTable_val.classInstance;
		nova_all_classes[169] = example_T2_Extension_VTable_val.classInstance;
		nova_all_classes[170] = example_Test_Extension_VTable_val.classInstance;
		nova_all_classes[171] = example_ThreadDemo_Extension_VTable_val.classInstance;
		nova_all_classes[172] = example_ThreadDemoImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[173] = example_ackermann_Ackermann_Extension_VTable_val.classInstance;
		nova_all_classes[174] = example_copy_Dog_Extension_VTable_val.classInstance;
		nova_all_classes[175] = example_database_DatabaseDemo_Extension_VTable_val.classInstance;
		nova_all_classes[176] = example_network_ClientDemo_Extension_VTable_val.classInstance;
		nova_all_classes[177] = example_network_ConnectionThread_Extension_VTable_val.classInstance;
		nova_all_classes[178] = example_network_OutputThread_Extension_VTable_val.classInstance;
		nova_all_classes[179] = example_network_ServerDemo_Extension_VTable_val.classInstance;
		nova_all_classes[180] = stabilitytest_AssignmentStability_Extension_VTable_val.classInstance;
		nova_all_classes[181] = stabilitytest_ClassWithProperties_Extension_VTable_val.classInstance;
		nova_all_classes[182] = stabilitytest_ClientThread_Extension_VTable_val.classInstance;
		nova_all_classes[183] = stabilitytest_ClosureStability_Extension_VTable_val.classInstance;
		nova_all_classes[184] = stabilitytest_ExceptionStability_Extension_VTable_val.classInstance;
		nova_all_classes[185] = stabilitytest_FileStability_Extension_VTable_val.classInstance;
		nova_all_classes[186] = stabilitytest_LambdaStability_Extension_VTable_val.classInstance;
		nova_all_classes[187] = stabilitytest_NetworkStability_Extension_VTable_val.classInstance;
		nova_all_classes[188] = stabilitytest_Node_Extension_VTable_val.classInstance;
		nova_all_classes[189] = stabilitytest_PolymorphicSubClass_Extension_VTable_val.classInstance;
		nova_all_classes[190] = stabilitytest_PolymorphicSuperClass_Extension_VTable_val.classInstance;
		nova_all_classes[191] = stabilitytest_PolymorphismStability_Extension_VTable_val.classInstance;
		nova_all_classes[192] = stabilitytest_RegexStability_Extension_VTable_val.classInstance;
		nova_all_classes[193] = stabilitytest_StabilityExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[194] = stabilitytest_StabilityTest_Extension_VTable_val.classInstance;
		nova_all_classes[195] = stabilitytest_StabilityTestCase_Extension_VTable_val.classInstance;
		nova_all_classes[196] = stabilitytest_StabilityTestException_Extension_VTable_val.classInstance;
		nova_all_classes[197] = stabilitytest_SyntaxStability_Extension_VTable_val.classInstance;
		nova_all_classes[198] = stabilitytest_ThreadImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[199] = stabilitytest_ThreadStability_Extension_VTable_val.classInstance;
		nova_all_classes[200] = stabilitytest_TimeStability_Extension_VTable_val.classInstance;
		nova_all_classes[201] = stabilitytest_ToStringStability_Extension_VTable_val.classInstance;
		nova_all_classes[202] = stabilitytest_UnstableException_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 203);
