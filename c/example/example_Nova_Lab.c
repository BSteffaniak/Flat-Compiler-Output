...
void example_Nova_Lab_static_Nova_main(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		nova_io_Nova_Console_static_Nova_log(0, exceptionData, (nova_Nova_Object*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Immutable: "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((l1_Nova_myImmutableArray)), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""))))));
		...
		nova_io_Nova_Console_static_Nova_log(0, exceptionData, (nova_Nova_Object*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Modified("))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_static_Nova_toString(0, exceptionData, (nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count((nova_datastruct_list_Nova_ImmutableArray*)(l1_Nova_myImmutableArray), exceptionData)))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("): "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((l1_Nova_myImmutableArray)), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""))))))));
		nova_io_Nova_Console_static_Nova_log(0, exceptionData, (nova_Nova_Object*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Output("))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_static_Nova_toString(0, exceptionData, (nova_datastruct_list_Nova_ImmutableArray_Accessorfunc_Nova_count((nova_datastruct_list_Nova_ImmutableArray*)(l1_Nova_outputArray), exceptionData)))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("): "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual_Nova_toString((nova_Nova_Object*)((l1_Nova_outputArray)), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""))))))));
...
int main(int argc, char** argvs)
{
		...
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 208);
		...
		nova_all_classes[150] = example_Animal_Extension_VTable_val.classInstance;
		nova_all_classes[151] = example_ArrayDemo_Extension_VTable_val.classInstance;
		nova_all_classes[152] = example_BodyBuilder_Extension_VTable_val.classInstance;
		nova_all_classes[153] = example_ClosureDemo_Extension_VTable_val.classInstance;
		nova_all_classes[154] = example_Dog_Extension_VTable_val.classInstance;
		nova_all_classes[155] = example_ExceptionHandlingDemo_Extension_VTable_val.classInstance;
		nova_all_classes[156] = example_FileTest_Extension_VTable_val.classInstance;
		nova_all_classes[157] = example_GenericDemo_Extension_VTable_val.classInstance;
		nova_all_classes[158] = example_HashMapDemo_Extension_VTable_val.classInstance;
		nova_all_classes[159] = example_HashSetDemo_Extension_VTable_val.classInstance;
		nova_all_classes[160] = example_IntegerTest_Extension_VTable_val.classInstance;
		nova_all_classes[161] = example_Lab_Extension_VTable_val.classInstance;
		nova_all_classes[162] = example_MathDemo_Extension_VTable_val.classInstance;
		nova_all_classes[163] = example_NonWholeDivisionException_Extension_VTable_val.classInstance;
		nova_all_classes[164] = example_Person_Extension_VTable_val.classInstance;
		nova_all_classes[165] = example_Polygon_Extension_VTable_val.classInstance;
		nova_all_classes[166] = example_PolymorphismDemo_Extension_VTable_val.classInstance;
		nova_all_classes[167] = example_QueueDemo_Extension_VTable_val.classInstance;
		nova_all_classes[168] = example_Spider_Extension_VTable_val.classInstance;
		nova_all_classes[169] = example_Square_Extension_VTable_val.classInstance;
		nova_all_classes[170] = example_SvgChart_Extension_VTable_val.classInstance;
		nova_all_classes[171] = example_SvgFractal_Extension_VTable_val.classInstance;
		nova_all_classes[172] = example_T1_Extension_VTable_val.classInstance;
		nova_all_classes[173] = example_T2_Extension_VTable_val.classInstance;
		nova_all_classes[174] = example_Test_Extension_VTable_val.classInstance;
		nova_all_classes[175] = example_ThreadDemo_Extension_VTable_val.classInstance;
		nova_all_classes[176] = example_ThreadDemoImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[177] = example_ackermann_Ackermann_Extension_VTable_val.classInstance;
		nova_all_classes[178] = example_copy_Dog_Extension_VTable_val.classInstance;
		nova_all_classes[179] = example_database_DatabaseDemo_Extension_VTable_val.classInstance;
		nova_all_classes[180] = example_network_ClientDemo_Extension_VTable_val.classInstance;
		nova_all_classes[181] = example_network_ConnectionThread_Extension_VTable_val.classInstance;
		nova_all_classes[182] = example_network_OutputThread_Extension_VTable_val.classInstance;
		nova_all_classes[183] = example_network_ServerDemo_Extension_VTable_val.classInstance;
		nova_all_classes[184] = stabilitytest_AssignmentStability_Extension_VTable_val.classInstance;
		nova_all_classes[185] = stabilitytest_ClassWithProperties_Extension_VTable_val.classInstance;
		nova_all_classes[186] = stabilitytest_ClientThread_Extension_VTable_val.classInstance;
		nova_all_classes[187] = stabilitytest_ClosureStability_Extension_VTable_val.classInstance;
		nova_all_classes[188] = stabilitytest_ExceptionStability_Extension_VTable_val.classInstance;
		nova_all_classes[189] = stabilitytest_FileStability_Extension_VTable_val.classInstance;
		nova_all_classes[190] = stabilitytest_LambdaStability_Extension_VTable_val.classInstance;
		nova_all_classes[191] = stabilitytest_NetworkStability_Extension_VTable_val.classInstance;
		nova_all_classes[192] = stabilitytest_Node_Extension_VTable_val.classInstance;
		nova_all_classes[193] = stabilitytest_PolymorphicSubClass_Extension_VTable_val.classInstance;
		nova_all_classes[194] = stabilitytest_PolymorphicSuperClass_Extension_VTable_val.classInstance;
		nova_all_classes[195] = stabilitytest_PolymorphismStability_Extension_VTable_val.classInstance;
		nova_all_classes[196] = stabilitytest_RegexStability_Extension_VTable_val.classInstance;
		nova_all_classes[197] = stabilitytest_StabilityExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[198] = stabilitytest_StabilityTest_Extension_VTable_val.classInstance;
		nova_all_classes[199] = stabilitytest_StabilityTestCase_Extension_VTable_val.classInstance;
		nova_all_classes[200] = stabilitytest_StabilityTestException_Extension_VTable_val.classInstance;
		nova_all_classes[201] = stabilitytest_StaticImportStability_Extension_VTable_val.classInstance;
		nova_all_classes[202] = stabilitytest_SyntaxStability_Extension_VTable_val.classInstance;
		nova_all_classes[203] = stabilitytest_ThreadImplementation_Extension_VTable_val.classInstance;
		nova_all_classes[204] = stabilitytest_ThreadStability_Extension_VTable_val.classInstance;
		nova_all_classes[205] = stabilitytest_TimeStability_Extension_VTable_val.classInstance;
		nova_all_classes[206] = stabilitytest_ToStringStability_Extension_VTable_val.classInstance;
		nova_all_classes[207] = stabilitytest_UnstableException_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_1_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 208);
