...
typedef struct example_Nova_example_DogFunctionMap example_Nova_example_DogFunctionMap;
...
CCLASS_CLASS
(
	example_Nova_example_DogFunctionMap, 
	
	example_Dog_example_DogFunctionMap_Extension_VTable* vtable;
)
