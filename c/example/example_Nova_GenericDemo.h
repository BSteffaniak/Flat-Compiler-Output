...
typedef struct example_Nova_example_GenericDemoFunctionMap example_Nova_example_GenericDemoFunctionMap;
...
CCLASS_CLASS
(
	example_Nova_example_GenericDemoFunctionMap, 
	
	example_GenericDemo_example_GenericDemoFunctionMap_Extension_VTable* vtable;
)
