...
typedef struct example_Nova_example_PersonFunctionMap example_Nova_example_PersonFunctionMap;
...
CCLASS_CLASS
(
	example_Nova_example_PersonFunctionMap, 
	
	example_Person_example_PersonFunctionMap_Extension_VTable* vtable;
)
