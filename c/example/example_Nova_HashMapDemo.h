...
typedef struct example_Nova_example_HashMapDemoFunctionMap example_Nova_example_HashMapDemoFunctionMap;
...
CCLASS_CLASS
(
	example_Nova_example_HashMapDemoFunctionMap, 
	
	example_HashMapDemo_example_HashMapDemoFunctionMap_Extension_VTable* vtable;
)
