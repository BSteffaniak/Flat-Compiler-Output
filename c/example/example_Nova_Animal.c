...
{
	CCLASS_NEW(example_Nova_AnimalPropertyMap, this,);
	this->vtable = &example_Animal_AnimalPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	example_Nova_AnimalPropertyMap_Nova_super(this, exceptionData);
	
	{
		example_Nova_AnimalPropertyMap_Nova_this(this, exceptionData);
	}
