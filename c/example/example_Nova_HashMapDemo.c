...
void example_Nova_HashMapDemo_static_Nova_testLambda42(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context1* context);
void example_Nova_HashMapDemo_static_Nova_testLambda43(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context2* context);
char example_Nova_HashMapDemo_static_Nova_testLambda44(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context3* context);
nova_Nova_Object* example_Nova_HashMapDemo_static_Nova_testLambda45(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_list_Nova_Array* example_Nova_HashMapDemo_Nova__3, Context4* context);
void example_Nova_HashMapDemo_static_Nova_testLambda46(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context5* context);
...
void example_Nova_HashMapDemo_static_Nova_main(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_HashMapDemo_Nova_args)
{
	...
	nova_datastruct_Nova_HashMap_Nova_forEach((nova_datastruct_Nova_HashMap*)(l1_Nova_words), exceptionData, (nova_datastruct_Nova_HashMap_closure18_Nova_func)&example_Nova_HashMapDemo_static_Nova_testLambda42, nova_null, &contextArg42);
	...
	nova_datastruct_Nova_HashMap_Nova_forEach((nova_datastruct_Nova_HashMap*)(l1_Nova_words), exceptionData, (nova_datastruct_Nova_HashMap_closure18_Nova_func)&example_Nova_HashMapDemo_static_Nova_testLambda43, nova_null, &contextArg43);
	nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n"))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(nova_datastruct_Nova_HashMap_Nova_filter((nova_datastruct_Nova_HashMap*)(l1_Nova_words), exceptionData, (nova_datastruct_Nova_HashMap_closure12_Nova_func)&example_Nova_HashMapDemo_static_Nova_testLambda44, nova_null, &contextArg44)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_HashMapDemo_static_Nova_testLambda45, nova_null, &contextArg45)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n")))));
	nova_datastruct_Nova_HashMap_Nova_forEach((nova_datastruct_Nova_HashMap*)(l1_Nova_words), exceptionData, (nova_datastruct_Nova_HashMap_closure18_Nova_func)&example_Nova_HashMapDemo_static_Nova_testLambda46, nova_null, &contextArg46);
...
char example_Nova_HashMapDemo_static_Nova_testLambda44(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context3* context)
{
	return (char)nova_Nova_String_Nova_contains((nova_Nova_String*)(((nova_Nova_String*)example_Nova_HashMapDemo_Nova__1->nova_datastruct_Nova_Pair_Nova_key)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("hey")));
}
