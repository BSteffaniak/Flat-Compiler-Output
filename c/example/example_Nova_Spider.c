...
{
	CCLASS_NEW(example_Nova_SpiderFunctionMap, this,);
	...
	{
		example_Nova_SpiderFunctionMap_Nova_this(this, exceptionData);
	}
...
{
	CCLASS_NEW(example_Nova_SpiderPropertyMap, this,);
	this->vtable = &example_Spider_SpiderPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	example_Nova_AnimalPropertyMap_Nova_super((example_Nova_AnimalPropertyMap*)this, exceptionData);
	example_Nova_SpiderPropertyMap_Nova_super(this, exceptionData);
	
	{
		example_Nova_SpiderPropertyMap_Nova_this(this, exceptionData);
	}
