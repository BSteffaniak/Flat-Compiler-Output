...
{
	CCLASS_NEW(example_Nova_ThreadDemoPropertyMap, this,);
	this->vtable = &example_ThreadDemo_ThreadDemoPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	example_Nova_ThreadDemoPropertyMap_Nova_super(this, exceptionData);
	
	{
		example_Nova_ThreadDemoPropertyMap_Nova_this(this, exceptionData);
	}
