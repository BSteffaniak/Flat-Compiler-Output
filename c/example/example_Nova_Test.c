...
{
	return example_Nova_Test_Nova_construct(0, exceptionData);
}
...
{
	example_Nova_Test_static_Nova_main(0, exceptionData, args);
}
...
{
	CCLASS_NEW(example_Nova_TestPropertyMap, this,);
	this->vtable = &example_Test_TestPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	example_Nova_TestPropertyMap_Nova_super(this, exceptionData);
	
	{
		example_Nova_TestPropertyMap_Nova_this(this, exceptionData);
	}
