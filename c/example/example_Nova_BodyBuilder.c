...
{
	CCLASS_NEW(example_Nova_BodyBuilderPropertyMap, this,);
	this->vtable = &example_BodyBuilder_BodyBuilderPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	example_Nova_PersonPropertyMap_Nova_super((example_Nova_PersonPropertyMap*)this, exceptionData);
	example_Nova_BodyBuilderPropertyMap_Nova_super(this, exceptionData);
	
	{
		example_Nova_BodyBuilderPropertyMap_Nova_this(this, exceptionData);
	}
...
{
	return reference->example_Nova_BodyBuilder_Nova_weightClass;
}
