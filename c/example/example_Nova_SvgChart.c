...
void example_Nova_SvgChart_static_Nova_main(example_Nova_SvgChart* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
	...
	nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_web_svg_no3_Nova_No3Node_virtual_Nova_toJs((nova_web_svg_no3_Nova_No3Node*)(l1_Nova_selection), exceptionData));
...
{
	CCLASS_NEW(example_Nova_SvgChartPropertyMap, this,);
	this->vtable = &example_SvgChart_SvgChartPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_PropertyMap_Nova_super((nova_meta_Nova_PropertyMap*)this, exceptionData);
	example_Nova_SvgChartPropertyMap_Nova_super(this, exceptionData);
	
	{
		example_Nova_SvgChartPropertyMap_Nova_this(this, exceptionData);
	}
