...
typedef struct example_Nova_example_ExceptionHandlingDemoFunctionMap example_Nova_example_ExceptionHandlingDemoFunctionMap;
...
CCLASS_CLASS
(
	example_Nova_example_ExceptionHandlingDemoFunctionMap, 
	
	example_ExceptionHandlingDemo_example_ExceptionHandlingDemoFunctionMap_Extension_VTable* vtable;
)
