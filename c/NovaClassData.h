...
char (*nova_datastruct_list_Nova_List_virtual1_Nova_any)(nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_List_closure1335_Nova_anyFunc nova_datastruct_list_Nova_List_Nova_anyFunc, void* nova_datastruct_list_Nova_List_ref_Nova_anyFunc, void* nova_datastruct_list_Nova_List_context_Nova_anyFunc);
char (*nova_datastruct_list_Nova_List_virtual1_Nova_all)(nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_List_closure1336_Nova_allFunc nova_datastruct_list_Nova_List_Nova_allFunc, void* nova_datastruct_list_Nova_List_ref_Nova_allFunc, void* nova_datastruct_list_Nova_List_context_Nova_allFunc, int);
nova_datastruct_list_Nova_List* (*nova_datastruct_list_Nova_List_virtual1_Nova_filter)(nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_List_closure1337_Nova_filterFunc nova_datastruct_list_Nova_List_Nova_filterFunc, void* nova_datastruct_list_Nova_List_ref_Nova_filterFunc, void* nova_datastruct_list_Nova_List_context_Nova_filterFunc);
...
nova_Nova_Object* (*nova_datastruct_list_Nova_List_virtual1_Nova_firstWhere)(nova_datastruct_list_Nova_List*, nova_datastruct_list_Nova_List_closure1340_Nova_func nova_datastruct_list_Nova_List_Nova_func, void* nova_datastruct_list_Nova_List_ref_Nova_func, void* nova_datastruct_list_Nova_List_context_Nova_func);
