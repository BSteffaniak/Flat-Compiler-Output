...
spectra_tree_nodes_Nova_Accessible* (*spectra_tree_nodes_Nova_Accessible_virtual_Accessor1_Nova_accessedNode)(spectra_tree_nodes_Nova_Accessible*, nova_exception_Nova_ExceptionData*);
spectra_tree_nodes_Nova_Accessible* (*spectra_tree_nodes_Nova_Accessible_virtual_Mutator0_Nova_accessedNode)(spectra_tree_nodes_Nova_Accessible*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_Accessible*);
};
...
nova_datastruct_Nova_Node* (*nova_datastruct_Nova_NodeFunctionMap_virtualfunctionMapNodeFunctionMap_static_Nova_construct)(nova_datastruct_Nova_NodeFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*, int);
...
nova_datastruct_Nova_HashMap* (*nova_datastruct_Nova_HashMapFunctionMap_virtualfunctionMapHashMapFunctionMap0_static_Nova_construct)(nova_datastruct_Nova_HashMapFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
...
nova_datastruct_Nova_Tree* (*nova_datastruct_Nova_TreeFunctionMap_virtualfunctionMapTreeFunctionMap_static_Nova_construct)(nova_datastruct_Nova_TreeFunctionMap*, nova_exception_Nova_ExceptionData*, nova_datastruct_Nova_Node*);
...
nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArrayFunctionMap0_static_Nova_construct)(nova_datastruct_list_Nova_ArrayFunctionMap*, nova_exception_Nova_ExceptionData*);
nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArrayFunctionMap1_static_Nova_construct)(nova_datastruct_list_Nova_ArrayFunctionMap*, nova_exception_Nova_ExceptionData*, int, int);
nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_ArrayFunctionMap_virtualfunctionMapArrayFunctionMap2_static_Nova_construct)(nova_datastruct_list_Nova_ArrayFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_Object**, int);
...
nova_exception_Nova_Exception* (*nova_exception_Nova_ExceptionFunctionMap_virtualfunctionMapExceptionFunctionMap_static_Nova_construct)(nova_exception_Nova_ExceptionFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
...
nova_math_Nova_NumericOperand* (*nova_math_Nova_NumericOperandFunctionMap_virtualfunctionMapNumericOperandFunctionMap_static_Nova_construct)(nova_math_Nova_NumericOperandFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
...
nova_math_logic_Nova_LogicalStatement* (*nova_math_logic_Nova_LogicalStatementFunctionMap_virtualfunctionMapLogicalStatementFunctionMap_static_Nova_construct)(nova_math_logic_Nova_LogicalStatementFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
nova_math_logic_Nova_StatementComponent* (*nova_math_logic_Nova_StatementComponentFunctionMap_virtualfunctionMapStatementComponentFunctionMap_static_Nova_construct)(nova_math_logic_Nova_StatementComponentFunctionMap*, nova_exception_Nova_ExceptionData*);
nova_primitive_Nova_Primitive* (*nova_primitive_Nova_PrimitiveFunctionMap_virtualfunctionMapPrimitiveFunctionMap_static_Nova_construct)(nova_primitive_Nova_PrimitiveFunctionMap*, nova_exception_Nova_ExceptionData*);
...
nova_time_Nova_Timer* (*nova_time_Nova_TimerFunctionMap_virtualfunctionMapTimerFunctionMap_static_Nova_construct)(nova_time_Nova_TimerFunctionMap*, nova_exception_Nova_ExceptionData*);
...
nova_web_svg_Nova_SvgComponent* (*nova_web_svg_Nova_SvgComponentFunctionMap_virtualfunctionMapSvgComponentFunctionMap_static_Nova_construct)(nova_web_svg_Nova_SvgComponentFunctionMap*, nova_exception_Nova_ExceptionData*);
...
spectra_tree_nodes_Nova_Node* (*spectra_tree_nodes_Nova_NodeFunctionMap_virtualfunctionMapNodeFunctionMap_static_Nova_construct)(spectra_tree_nodes_Nova_NodeFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*);
...
spectra_tree_nodes_Nova_Value* (*spectra_tree_nodes_Nova_ValueFunctionMap_virtualfunctionMapValueFunctionMap_static_Nova_construct)(spectra_tree_nodes_Nova_ValueFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*, spectra_tree_nodes_Nova_Type*);
...
spectra_tree_nodes_variables_Nova_Variable* (*spectra_tree_nodes_variables_Nova_VariableFunctionMap_virtualfunctionMapVariableFunctionMap_static_Nova_construct)(spectra_tree_nodes_variables_Nova_VariableFunctionMap*, nova_exception_Nova_ExceptionData*, spectra_tree_nodes_Nova_Node*, spectra_util_Nova_Location*, spectra_tree_nodes_variables_Nova_VariableDeclaration*);
...
spectra_tree_nodes_Nova_Type* (*spectra_tree_nodes_Nova_TypeFunctionMap_virtualfunctionMapTypeFunctionMap_static_Nova_construct)(spectra_tree_nodes_Nova_TypeFunctionMap*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
