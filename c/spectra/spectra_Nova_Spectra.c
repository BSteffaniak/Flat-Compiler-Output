...
char spectra_Nova_Spectra_Nova_lambda91(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Class* _1, int _2, nova_datastruct_list_Nova_ImmutableArray* _3, Context1* context);
char spectra_Nova_Spectra_Nova_lambda92(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_io_Nova_File* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
spectra_tree_nodes_Nova_NovaFile* spectra_Nova_Spectra_Nova_lambda93(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_io_Nova_File* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
void spectra_Nova_Spectra_Nova_lambda94(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
nova_Nova_String* spectra_Nova_Spectra_Nova_lambda95(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context5* context);
void spectra_Nova_Spectra_Nova_lambda96(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
void spectra_Nova_Spectra_Nova_lambda97(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
void spectra_Nova_Spectra_Nova_lambda98(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context8* context);
...
void spectra_Nova_Spectra_Nova_compile(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		if (spectra_Nova_Spectra_Nova_DEBUG)
		{
				...
				this->prv->spectra_Nova_Spectra_Nova_files = (nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_filter((nova_datastruct_list_Nova_List*)(nova_io_Nova_File_Nova_getChildFiles(l1_Nova_parentDir, exceptionData, 1, (intptr_t)nova_null)), exceptionData, (nova_datastruct_list_Nova_List_closure15_Nova_filterFunc)&spectra_Nova_Spectra_Nova_lambda92, this, &contextArg92)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&spectra_Nova_Spectra_Nova_lambda93, this, &contextArg93));
				...
				TRY
				{
						...
						
						{
								...
								nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->prv->spectra_Nova_Spectra_Nova_files), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&spectra_Nova_Spectra_Nova_lambda94, this, &contextArg94);
								...
								nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(spectra_tree_nodes_Nova_Program_Accessor_Nova_files(l2_Nova_tree->spectra_tree_Nova_SyntaxTree_Nova_root, exceptionData)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&spectra_Nova_Spectra_Nova_lambda95, this, &contextArg95)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n"))));
				...
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_errors), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&spectra_Nova_Spectra_Nova_lambda96, this, &contextArg96);
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_warnings), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&spectra_Nova_Spectra_Nova_lambda97, this, &contextArg97);
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_info), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&spectra_Nova_Spectra_Nova_lambda98, this, &contextArg98);
...
int main(int argc, char** argvs)
{
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_InvalidParseException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_Spectra_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_SyntaxErrorException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_SyntaxMessage_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_engines_CodeGeneratorEngine_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_error_UnimplementedOperationException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_AnnotationSearchResult_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)nova_datastruct_list_Iterator_Extension_VTable_val.classInstance;
		spectra_tree_StatementIterator_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_SyntaxTree_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Abstractable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_ArgumentList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 2);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Identifier_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Import_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_ImportList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_Listener_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = (nova_Nova_Class*)nova_null;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Listener_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_Literal_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		spectra_tree_nodes_Node_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_NodeList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_NumericRange_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Package_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		spectra_tree_nodes_Priority_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Program_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Return_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Scope_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Skeleton_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		spectra_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Type_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_ValidationResult_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Value_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces[1] = (nova_Nova_Object*)spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		spectra_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 2);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		spectra_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		spectra_tree_nodes_functions_closures_LambdaExpression_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Operation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Operator_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		spectra_tree_nodes_variables_Variable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 2);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_Bounds_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_CompilerStringFunctions_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_FileUtils_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_Location_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_OS_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_SyntaxUtils_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_all_classes[147] = spectra_InvalidParseException_Extension_VTable_val.classInstance;
		nova_all_classes[148] = spectra_Spectra_Extension_VTable_val.classInstance;
		nova_all_classes[149] = spectra_SyntaxErrorException_Extension_VTable_val.classInstance;
		nova_all_classes[150] = spectra_SyntaxMessage_Extension_VTable_val.classInstance;
		nova_all_classes[151] = spectra_engines_CodeGeneratorEngine_Extension_VTable_val.classInstance;
		nova_all_classes[152] = spectra_error_UnimplementedOperationException_Extension_VTable_val.classInstance;
		nova_all_classes[153] = spectra_tree_AnnotationSearchResult_Extension_VTable_val.classInstance;
		nova_all_classes[154] = spectra_tree_StatementIterator_Extension_VTable_val.classInstance;
		nova_all_classes[155] = spectra_tree_SyntaxTree_Extension_VTable_val.classInstance;
		nova_all_classes[156] = spectra_tree_nodes_Abstractable_Extension_VTable_val.classInstance;
		nova_all_classes[157] = spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		nova_all_classes[158] = spectra_tree_nodes_ArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[159] = spectra_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[160] = spectra_tree_nodes_Identifier_Extension_VTable_val.classInstance;
		nova_all_classes[161] = spectra_tree_nodes_Import_Extension_VTable_val.classInstance;
		nova_all_classes[162] = spectra_tree_nodes_ImportList_Extension_VTable_val.classInstance;
		nova_all_classes[163] = spectra_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[164] = spectra_tree_nodes_Listener_Extension_VTable_val.classInstance;
		nova_all_classes[165] = spectra_tree_nodes_Literal_Extension_VTable_val.classInstance;
		nova_all_classes[166] = spectra_tree_nodes_Node_Extension_VTable_val.classInstance;
		nova_all_classes[167] = spectra_tree_nodes_NodeList_Extension_VTable_val.classInstance;
		nova_all_classes[168] = spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance;
		nova_all_classes[169] = spectra_tree_nodes_NumericRange_Extension_VTable_val.classInstance;
		nova_all_classes[170] = spectra_tree_nodes_Package_Extension_VTable_val.classInstance;
		nova_all_classes[171] = spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance;
		nova_all_classes[172] = spectra_tree_nodes_Priority_Extension_VTable_val.classInstance;
		nova_all_classes[173] = spectra_tree_nodes_Program_Extension_VTable_val.classInstance;
		nova_all_classes[174] = spectra_tree_nodes_Return_Extension_VTable_val.classInstance;
		nova_all_classes[175] = spectra_tree_nodes_Scope_Extension_VTable_val.classInstance;
		nova_all_classes[176] = spectra_tree_nodes_Skeleton_Extension_VTable_val.classInstance;
		nova_all_classes[177] = spectra_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance;
		nova_all_classes[178] = spectra_tree_nodes_Type_Extension_VTable_val.classInstance;
		nova_all_classes[179] = spectra_tree_nodes_ValidationResult_Extension_VTable_val.classInstance;
		nova_all_classes[180] = spectra_tree_nodes_Value_Extension_VTable_val.classInstance;
		nova_all_classes[181] = spectra_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance;
		nova_all_classes[182] = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_all_classes[183] = spectra_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[184] = spectra_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[185] = spectra_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[186] = spectra_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance;
		nova_all_classes[187] = spectra_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance;
		nova_all_classes[188] = spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance;
		nova_all_classes[189] = spectra_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance;
		nova_all_classes[190] = spectra_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance;
		nova_all_classes[191] = spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance;
		nova_all_classes[192] = spectra_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance;
		nova_all_classes[193] = spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance;
		nova_all_classes[194] = spectra_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[195] = spectra_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance;
		nova_all_classes[196] = spectra_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance;
		nova_all_classes[197] = spectra_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[198] = spectra_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance;
		nova_all_classes[199] = spectra_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[200] = spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		nova_all_classes[201] = spectra_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance;
		nova_all_classes[202] = spectra_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[203] = spectra_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance;
		nova_all_classes[204] = spectra_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[205] = spectra_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance;
		nova_all_classes[206] = spectra_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance;
		nova_all_classes[207] = spectra_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[208] = spectra_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance;
		nova_all_classes[209] = spectra_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance;
		nova_all_classes[210] = spectra_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance;
		nova_all_classes[211] = spectra_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance;
		nova_all_classes[212] = spectra_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[213] = spectra_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance;
		nova_all_classes[214] = spectra_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[215] = spectra_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance;
		nova_all_classes[216] = spectra_tree_nodes_functions_closures_LambdaExpression_Extension_VTable_val.classInstance;
		nova_all_classes[217] = spectra_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val.classInstance;
		nova_all_classes[218] = spectra_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance;
		nova_all_classes[219] = spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		nova_all_classes[220] = spectra_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance;
		nova_all_classes[221] = spectra_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance;
		nova_all_classes[222] = spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		nova_all_classes[223] = spectra_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance;
		nova_all_classes[224] = spectra_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance;
		nova_all_classes[225] = spectra_tree_nodes_operations_Operation_Extension_VTable_val.classInstance;
		nova_all_classes[226] = spectra_tree_nodes_operations_Operator_Extension_VTable_val.classInstance;
		nova_all_classes[227] = spectra_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[228] = spectra_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[229] = spectra_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance;
		nova_all_classes[230] = spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[231] = spectra_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[232] = spectra_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[233] = spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[234] = spectra_tree_nodes_variables_Variable_Extension_VTable_val.classInstance;
		nova_all_classes[235] = spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[236] = spectra_util_Bounds_Extension_VTable_val.classInstance;
		nova_all_classes[237] = spectra_util_CompilerStringFunctions_Extension_VTable_val.classInstance;
		nova_all_classes[238] = spectra_util_FileUtils_Extension_VTable_val.classInstance;
		nova_all_classes[239] = spectra_util_Location_Extension_VTable_val.classInstance;
		nova_all_classes[240] = spectra_util_OS_Extension_VTable_val.classInstance;
		nova_all_classes[241] = spectra_util_SyntaxUtils_Extension_VTable_val.classInstance;
