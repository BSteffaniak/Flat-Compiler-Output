...
char spectra_Nova_Spectra_Nova_lambda99(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Class* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
char spectra_Nova_Spectra_Nova_lambda100(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_io_Nova_File* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
spectra_tree_nodes_Nova_NovaFile* spectra_Nova_Spectra_Nova_lambda101(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_io_Nova_File* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
void spectra_Nova_Spectra_Nova_lambda102(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
nova_Nova_String* spectra_Nova_Spectra_Nova_lambda103(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context5* context);
void spectra_Nova_Spectra_Nova_lambda104(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
void spectra_Nova_Spectra_Nova_lambda105(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
void spectra_Nova_Spectra_Nova_lambda106(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context8* context);
...
void spectra_Nova_Spectra_Nova_compile(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		if (spectra_Nova_Spectra_Nova_DEBUG)
		{
				...
				Context2* contextArg100 = NOVA_MALLOC(sizeof(Context2));
				Context3* contextArg101 = NOVA_MALLOC(sizeof(Context3));
				Context6* contextArg104 = NOVA_MALLOC(sizeof(Context6));
				Context7* contextArg105 = NOVA_MALLOC(sizeof(Context7));
				Context8* contextArg106 = NOVA_MALLOC(sizeof(Context8));
				...
				TRY
				{
						...
						{
								Context4* contextArg102 = NOVA_MALLOC(sizeof(Context4));
								contextArg102->spectra_Nova_Spectra_Nova_program = &l2_Nova_program;
								...
								Context5* contextArg103 = NOVA_MALLOC(sizeof(Context5));
								contextArg103->spectra_Nova_Spectra_Nova_separator = &l3_Nova_separator;
								
								nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->prv->spectra_Nova_Spectra_Nova_files), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda102, this, contextArg102);
				...
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_errors), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda104, this, contextArg104);
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_warnings), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda105, this, contextArg105);
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_info), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda106, this, contextArg106);
...
int main(int argc, char** argvs)
{
		...
		spectra_tree_nodes_Cast_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/Cast")), 0);
		...
		spectra_tree_nodes_annotations_AbstractAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/AbstractAnnotation")), 0);
		...
		spectra_tree_nodes_annotations_AutoFinalAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/AutoFinalAnnotation")), 0);
		spectra_tree_nodes_annotations_AutoPureAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/AutoPureAnnotation")), 0);
		spectra_tree_nodes_annotations_FinalAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/FinalAnnotation")), 0);
		spectra_tree_nodes_annotations_ImmutableAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/ImmutableAnnotation")), 0);
		spectra_tree_nodes_annotations_ImpureAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/ImpureAnnotation")), 0);
		...
		spectra_tree_nodes_annotations_PrivateAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/PrivateAnnotation")), 0);
		spectra_tree_nodes_annotations_PublicAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/PublicAnnotation")), 0);
		spectra_tree_nodes_annotations_PureAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/PureAnnotation")), 0);
		spectra_tree_nodes_annotations_StaticAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/StaticAnnotation")), 0);
		...
		spectra_tree_nodes_annotations_VarAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/VarAnnotation")), 0);
		spectra_tree_nodes_annotations_VisibleAnnotation_Extension_VTable_val.classInstance = nova_Nova_Class_Nova_construct(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("spectra/tree/nodes/annotations/VisibleAnnotation")), 0);
		...
		nova_String_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 3);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)nova_datastruct_list_List_Extension_VTable_val.classInstance;
		nova_datastruct_list_Array_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_InvalidParseException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_Spectra_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_SyntaxErrorException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_SyntaxMessage_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_engines_CodeGeneratorEngine_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_error_UnimplementedOperationException_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_AnnotationSearchResult_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)nova_datastruct_list_Iterator_Extension_VTable_val.classInstance;
		spectra_tree_StatementIterator_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_SyntaxTree_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Abstractable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_ArgumentList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_Cast_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_Value_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Cast_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 2);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Identifier_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Import_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_ImportList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_Listener_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = (nova_Nova_Class*)nova_null;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Listener_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_Literal_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		spectra_tree_nodes_Node_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_NodeList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_NumericRange_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Package_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		spectra_tree_nodes_Priority_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Program_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Return_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Scope_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Skeleton_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		spectra_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Type_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_ValidationResult_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_Value_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_AbstractAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_AbstractAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_AutoFinalAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_AutoFinalAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_AutoPureAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_AutoPureAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_FinalAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_FinalAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_ImmutableAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_ImmutableAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_ImpureAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_ImpureAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_Modifier_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_PrivateAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_PrivateAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_PublicAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_PublicAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_PureAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_PureAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_StaticAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_StaticAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_VarAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_VarAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		spectra_tree_nodes_annotations_VisibleAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_extension = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_VisibleAnnotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces[1] = (nova_Nova_Object*)spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		spectra_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 2);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		spectra_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		spectra_tree_nodes_functions_closures_LambdaExpression_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Operation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_Operator_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		spectra_tree_nodes_variables_Variable_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 2);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_Bounds_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_CompilerStringFunctions_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_FileUtils_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_Location_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_OS_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_util_SyntaxUtils_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		
		
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 262);
		...
		nova_all_classes[107] = nova_operators_EqualsOperator_Extension_VTable_val.classInstance;
		nova_all_classes[108] = nova_operators_MultiplyOperator_Extension_VTable_val.classInstance;
		nova_all_classes[109] = nova_operators_NotEqualToOperator_Extension_VTable_val.classInstance;
		nova_all_classes[110] = nova_operators_PlusEqualsOperator_Extension_VTable_val.classInstance;
		nova_all_classes[111] = nova_operators_PlusOperator_Extension_VTable_val.classInstance;
		nova_all_classes[112] = nova_primitive_Bool_Extension_VTable_val.classInstance;
		nova_all_classes[113] = nova_primitive_Null_Extension_VTable_val.classInstance;
		nova_all_classes[114] = nova_primitive_Primitive_Extension_VTable_val.classInstance;
		nova_all_classes[115] = nova_primitive_number_Byte_Extension_VTable_val.classInstance;
		nova_all_classes[116] = nova_primitive_number_Char_Extension_VTable_val.classInstance;
		nova_all_classes[117] = nova_primitive_number_Double_Extension_VTable_val.classInstance;
		nova_all_classes[118] = nova_primitive_number_Float_Extension_VTable_val.classInstance;
		nova_all_classes[119] = nova_primitive_number_Int_Extension_VTable_val.classInstance;
		nova_all_classes[120] = nova_primitive_number_Integer_Extension_VTable_val.classInstance;
		nova_all_classes[121] = nova_primitive_number_Long_Extension_VTable_val.classInstance;
		nova_all_classes[122] = nova_primitive_number_Number_Extension_VTable_val.classInstance;
		nova_all_classes[123] = nova_primitive_number_RealNumber_Extension_VTable_val.classInstance;
		nova_all_classes[124] = nova_primitive_number_Short_Extension_VTable_val.classInstance;
		nova_all_classes[125] = nova_process_Process_Extension_VTable_val.classInstance;
		nova_all_classes[126] = nova_regex_Match_Extension_VTable_val.classInstance;
		nova_all_classes[127] = nova_regex_Pattern_Extension_VTable_val.classInstance;
		nova_all_classes[128] = nova_regex_Regex_Extension_VTable_val.classInstance;
		nova_all_classes[129] = nova_security_MD5_Extension_VTable_val.classInstance;
		nova_all_classes[130] = nova_security_Sha256_Extension_VTable_val.classInstance;
		nova_all_classes[131] = nova_star_Frame_Extension_VTable_val.classInstance;
		nova_all_classes[132] = nova_star_Window_Extension_VTable_val.classInstance;
		nova_all_classes[133] = nova_star_WindowThread_Extension_VTable_val.classInstance;
		nova_all_classes[134] = nova_thread_Thread_Extension_VTable_val.classInstance;
		nova_all_classes[135] = nova_thread_UncaughtExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[136] = nova_thread_async_Async_Extension_VTable_val.classInstance;
		nova_all_classes[137] = nova_thread_async_Task_Extension_VTable_val.classInstance;
		nova_all_classes[138] = nova_time_CumulativeTimer_Extension_VTable_val.classInstance;
		nova_all_classes[139] = nova_time_Date_Extension_VTable_val.classInstance;
		nova_all_classes[140] = nova_time_Time_Extension_VTable_val.classInstance;
		nova_all_classes[141] = nova_time_Timer_Extension_VTable_val.classInstance;
		nova_all_classes[142] = nova_web_js_json_Json_Extension_VTable_val.classInstance;
		nova_all_classes[143] = nova_web_svg_Svg_Extension_VTable_val.classInstance;
		nova_all_classes[144] = nova_web_svg_SvgCircle_Extension_VTable_val.classInstance;
		nova_all_classes[145] = nova_web_svg_SvgComponent_Extension_VTable_val.classInstance;
		nova_all_classes[146] = nova_web_svg_SvgComponentList_Extension_VTable_val.classInstance;
		nova_all_classes[147] = nova_web_svg_SvgComponentNode_Extension_VTable_val.classInstance;
		nova_all_classes[148] = nova_web_svg_SvgMainComponent_Extension_VTable_val.classInstance;
		nova_all_classes[149] = nova_web_svg_no3_No3_Extension_VTable_val.classInstance;
		nova_all_classes[150] = nova_web_svg_no3_No3Node_Extension_VTable_val.classInstance;
		nova_all_classes[151] = nova_web_svg_no3_No3Select_Extension_VTable_val.classInstance;
		nova_all_classes[152] = nova_web_svg_no3_No3SelectAll_Extension_VTable_val.classInstance;
		nova_all_classes[153] = spectra_InvalidParseException_Extension_VTable_val.classInstance;
		nova_all_classes[154] = spectra_Spectra_Extension_VTable_val.classInstance;
		nova_all_classes[155] = spectra_SyntaxErrorException_Extension_VTable_val.classInstance;
		nova_all_classes[156] = spectra_SyntaxMessage_Extension_VTable_val.classInstance;
		nova_all_classes[157] = spectra_engines_CodeGeneratorEngine_Extension_VTable_val.classInstance;
		nova_all_classes[158] = spectra_error_UnimplementedOperationException_Extension_VTable_val.classInstance;
		nova_all_classes[159] = spectra_tree_AnnotationSearchResult_Extension_VTable_val.classInstance;
		nova_all_classes[160] = spectra_tree_StatementIterator_Extension_VTable_val.classInstance;
		nova_all_classes[161] = spectra_tree_SyntaxTree_Extension_VTable_val.classInstance;
		nova_all_classes[162] = spectra_tree_nodes_Abstractable_Extension_VTable_val.classInstance;
		nova_all_classes[163] = spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		nova_all_classes[164] = spectra_tree_nodes_ArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[165] = spectra_tree_nodes_Cast_Extension_VTable_val.classInstance;
		nova_all_classes[166] = spectra_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[167] = spectra_tree_nodes_Identifier_Extension_VTable_val.classInstance;
		nova_all_classes[168] = spectra_tree_nodes_Import_Extension_VTable_val.classInstance;
		nova_all_classes[169] = spectra_tree_nodes_ImportList_Extension_VTable_val.classInstance;
		nova_all_classes[170] = spectra_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[171] = spectra_tree_nodes_Listener_Extension_VTable_val.classInstance;
		nova_all_classes[172] = spectra_tree_nodes_Literal_Extension_VTable_val.classInstance;
		nova_all_classes[173] = spectra_tree_nodes_Node_Extension_VTable_val.classInstance;
		nova_all_classes[174] = spectra_tree_nodes_NodeList_Extension_VTable_val.classInstance;
		nova_all_classes[175] = spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance;
		nova_all_classes[176] = spectra_tree_nodes_NumericRange_Extension_VTable_val.classInstance;
		nova_all_classes[177] = spectra_tree_nodes_Package_Extension_VTable_val.classInstance;
		nova_all_classes[178] = spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance;
		nova_all_classes[179] = spectra_tree_nodes_Priority_Extension_VTable_val.classInstance;
		nova_all_classes[180] = spectra_tree_nodes_Program_Extension_VTable_val.classInstance;
		nova_all_classes[181] = spectra_tree_nodes_Return_Extension_VTable_val.classInstance;
		nova_all_classes[182] = spectra_tree_nodes_Scope_Extension_VTable_val.classInstance;
		nova_all_classes[183] = spectra_tree_nodes_Skeleton_Extension_VTable_val.classInstance;
		nova_all_classes[184] = spectra_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance;
		nova_all_classes[185] = spectra_tree_nodes_Type_Extension_VTable_val.classInstance;
		nova_all_classes[186] = spectra_tree_nodes_ValidationResult_Extension_VTable_val.classInstance;
		nova_all_classes[187] = spectra_tree_nodes_Value_Extension_VTable_val.classInstance;
		nova_all_classes[188] = spectra_tree_nodes_annotations_AbstractAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[189] = spectra_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance;
		nova_all_classes[190] = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_all_classes[191] = spectra_tree_nodes_annotations_AutoFinalAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[192] = spectra_tree_nodes_annotations_AutoPureAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[193] = spectra_tree_nodes_annotations_FinalAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[194] = spectra_tree_nodes_annotations_ImmutableAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[195] = spectra_tree_nodes_annotations_ImpureAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[196] = spectra_tree_nodes_annotations_Modifier_Extension_VTable_val.classInstance;
		nova_all_classes[197] = spectra_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[198] = spectra_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[199] = spectra_tree_nodes_annotations_PrivateAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[200] = spectra_tree_nodes_annotations_PublicAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[201] = spectra_tree_nodes_annotations_PureAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[202] = spectra_tree_nodes_annotations_StaticAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[203] = spectra_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[204] = spectra_tree_nodes_annotations_VarAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[205] = spectra_tree_nodes_annotations_VisibleAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[206] = spectra_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance;
		nova_all_classes[207] = spectra_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance;
		nova_all_classes[208] = spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance;
		nova_all_classes[209] = spectra_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance;
		nova_all_classes[210] = spectra_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance;
		nova_all_classes[211] = spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance;
		nova_all_classes[212] = spectra_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance;
		nova_all_classes[213] = spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance;
		nova_all_classes[214] = spectra_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[215] = spectra_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance;
		nova_all_classes[216] = spectra_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance;
		nova_all_classes[217] = spectra_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[218] = spectra_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance;
		nova_all_classes[219] = spectra_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[220] = spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		nova_all_classes[221] = spectra_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance;
		nova_all_classes[222] = spectra_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[223] = spectra_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance;
		nova_all_classes[224] = spectra_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[225] = spectra_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance;
		nova_all_classes[226] = spectra_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance;
		nova_all_classes[227] = spectra_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[228] = spectra_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance;
		nova_all_classes[229] = spectra_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance;
		nova_all_classes[230] = spectra_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance;
		nova_all_classes[231] = spectra_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance;
		nova_all_classes[232] = spectra_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[233] = spectra_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance;
		nova_all_classes[234] = spectra_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[235] = spectra_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance;
		nova_all_classes[236] = spectra_tree_nodes_functions_closures_LambdaExpression_Extension_VTable_val.classInstance;
		nova_all_classes[237] = spectra_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val.classInstance;
		nova_all_classes[238] = spectra_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance;
		nova_all_classes[239] = spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		nova_all_classes[240] = spectra_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance;
		nova_all_classes[241] = spectra_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance;
		nova_all_classes[242] = spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		nova_all_classes[243] = spectra_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance;
		nova_all_classes[244] = spectra_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance;
		nova_all_classes[245] = spectra_tree_nodes_operations_Operation_Extension_VTable_val.classInstance;
		nova_all_classes[246] = spectra_tree_nodes_operations_Operator_Extension_VTable_val.classInstance;
		nova_all_classes[247] = spectra_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[248] = spectra_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[249] = spectra_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance;
		nova_all_classes[250] = spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[251] = spectra_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[252] = spectra_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[253] = spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[254] = spectra_tree_nodes_variables_Variable_Extension_VTable_val.classInstance;
		nova_all_classes[255] = spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[256] = spectra_util_Bounds_Extension_VTable_val.classInstance;
		nova_all_classes[257] = spectra_util_CompilerStringFunctions_Extension_VTable_val.classInstance;
		nova_all_classes[258] = spectra_util_FileUtils_Extension_VTable_val.classInstance;
		nova_all_classes[259] = spectra_util_Location_Extension_VTable_val.classInstance;
		nova_all_classes[260] = spectra_util_OS_Extension_VTable_val.classInstance;
		nova_all_classes[261] = spectra_util_SyntaxUtils_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 262);
