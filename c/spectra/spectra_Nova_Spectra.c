...
{
	CCLASS_NEW(spectra_Nova_spectra_SpectraFunctionMap, this,);
	this->vtable = &spectra_Spectra_spectra_SpectraFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_Nova_spectra_SpectraFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_Nova_spectra_SpectraFunctionMap_Nova_this(this, exceptionData);
	}
