...
nova_Nova_String* spectra_Nova_Spectra_Nova_lambda104(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context5* context);
void spectra_Nova_Spectra_Nova_lambda105(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
void spectra_Nova_Spectra_Nova_lambda106(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
void spectra_Nova_Spectra_Nova_lambda107(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context8* context);
...
void spectra_Nova_Spectra_Nova_compile(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		if (spectra_Nova_Spectra_Nova_DEBUG)
		{
				...
				Context2* contextArg101 = NOVA_MALLOC(sizeof(Context2));
				Context3* contextArg102 = NOVA_MALLOC(sizeof(Context3));
				Context6* contextArg105 = NOVA_MALLOC(sizeof(Context6));
				Context7* contextArg106 = NOVA_MALLOC(sizeof(Context7));
				Context8* contextArg107 = NOVA_MALLOC(sizeof(Context8));
				...
				TRY
				{
						...
						{
								Context4* contextArg103 = NOVA_MALLOC(sizeof(Context4));
								contextArg103->spectra_Nova_Spectra_Nova_program = &l2_Nova_program;
								...
								Context5* contextArg104 = NOVA_MALLOC(sizeof(Context5));
								contextArg104->spectra_Nova_Spectra_Nova_separator = &l3_Nova_separator;
								
								nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->prv->spectra_Nova_Spectra_Nova_files), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda103, this, contextArg103);
				...
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_errors), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda105, this, contextArg105);
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_warnings), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda106, this, contextArg106);
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_info), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda107, this, contextArg107);
...
int main(int argc, char** argvs)
{
		...
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 264);
		...
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 264);
