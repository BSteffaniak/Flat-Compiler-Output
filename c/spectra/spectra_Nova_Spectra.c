...
char spectra_Nova_Spectra_Nova_lambda96(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Class* _1, int _2, nova_datastruct_list_Nova_ImmutableArray* _3, Context1* context);
...
int main(int argc, char** argvs)
{
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 1);
		nova_class_interfaces[0] = (nova_Nova_Object*)nova_datastruct_list_List_Extension_VTable_val.classInstance;
		nova_datastruct_ImmutableHashMap_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 1);
		...
		nova_class_interfaces = NOVA_MALLOC(sizeof(nova_Nova_Object**) * 0);
		spectra_tree_nodes_annotations_Modifier_Extension_VTable_val.classInstance->nova_Nova_Class_Nova_interfaces = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_class_interfaces, 0);
		...
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 244);
		...
		nova_all_classes[32] = nova_datastruct_list_IntArray_Extension_VTable_val.classInstance;
		nova_all_classes[33] = nova_datastruct_list_IntArrayIterator_Extension_VTable_val.classInstance;
		nova_all_classes[34] = nova_datastruct_list_IntRange_Extension_VTable_val.classInstance;
		nova_all_classes[35] = nova_datastruct_list_IntRangeIterator_Extension_VTable_val.classInstance;
		nova_all_classes[36] = nova_datastruct_list_Iterable_Extension_VTable_val.classInstance;
		nova_all_classes[37] = nova_datastruct_list_Iterator_Extension_VTable_val.classInstance;
		nova_all_classes[38] = nova_datastruct_list_LinkedList_Extension_VTable_val.classInstance;
		nova_all_classes[39] = nova_datastruct_list_LinkedListIterator_Extension_VTable_val.classInstance;
		nova_all_classes[40] = nova_datastruct_list_List_Extension_VTable_val.classInstance;
		nova_all_classes[41] = nova_datastruct_list_ListNode_Extension_VTable_val.classInstance;
		nova_all_classes[42] = nova_datastruct_list_NoSuchElementException_Extension_VTable_val.classInstance;
		nova_all_classes[43] = nova_datastruct_list_Queue_Extension_VTable_val.classInstance;
		nova_all_classes[44] = nova_datastruct_list_Stack_Extension_VTable_val.classInstance;
		nova_all_classes[45] = nova_datastruct_list_StringCharArray_Extension_VTable_val.classInstance;
		nova_all_classes[46] = nova_datastruct_list_SubstringCharArray_Extension_VTable_val.classInstance;
		nova_all_classes[47] = nova_exception_Backtraces_Extension_VTable_val.classInstance;
		nova_all_classes[48] = nova_exception_CaughtException_Extension_VTable_val.classInstance;
		nova_all_classes[49] = nova_exception_DivideByZeroException_Extension_VTable_val.classInstance;
		nova_all_classes[50] = nova_exception_Exception_Extension_VTable_val.classInstance;
		nova_all_classes[51] = nova_exception_ExceptionData_Extension_VTable_val.classInstance;
		nova_all_classes[52] = nova_exception_InvalidArgumentException_Extension_VTable_val.classInstance;
		nova_all_classes[53] = nova_exception_InvalidOperationException_Extension_VTable_val.classInstance;
		nova_all_classes[54] = nova_exception_UnimplementedOperationException_Extension_VTable_val.classInstance;
		nova_all_classes[55] = nova_gc_GC_Extension_VTable_val.classInstance;
		nova_all_classes[56] = nova_io_Console_Extension_VTable_val.classInstance;
		nova_all_classes[57] = nova_io_File_Extension_VTable_val.classInstance;
		nova_all_classes[58] = nova_io_FileNotFoundException_Extension_VTable_val.classInstance;
		nova_all_classes[59] = nova_io_FileReader_Extension_VTable_val.classInstance;
		nova_all_classes[60] = nova_io_FileWriter_Extension_VTable_val.classInstance;
		nova_all_classes[61] = nova_io_InputStream_Extension_VTable_val.classInstance;
		nova_all_classes[62] = nova_io_OutputStream_Extension_VTable_val.classInstance;
		nova_all_classes[63] = nova_io_StreamReader_Extension_VTable_val.classInstance;
		nova_all_classes[64] = nova_math_ArithmeticSequence_Extension_VTable_val.classInstance;
		nova_all_classes[65] = nova_math_Diekstra_Extension_VTable_val.classInstance;
		nova_all_classes[66] = nova_math_GeometricSequence_Extension_VTable_val.classInstance;
		nova_all_classes[67] = nova_math_Graph_Extension_VTable_val.classInstance;
		nova_all_classes[68] = nova_math_InvalidNumericStatementException_Extension_VTable_val.classInstance;
		nova_all_classes[69] = nova_math_Math_Extension_VTable_val.classInstance;
		nova_all_classes[70] = nova_math_Matrix_Extension_VTable_val.classInstance;
		nova_all_classes[71] = nova_math_NumericOperand_Extension_VTable_val.classInstance;
		nova_all_classes[72] = nova_math_NumericOperation_Extension_VTable_val.classInstance;
		nova_all_classes[73] = nova_math_NumericStatement_Extension_VTable_val.classInstance;
		nova_all_classes[74] = nova_math_NumericTree_Extension_VTable_val.classInstance;
		nova_all_classes[75] = nova_math_Polynomial_Extension_VTable_val.classInstance;
		nova_all_classes[76] = nova_math_Sequence_Extension_VTable_val.classInstance;
		nova_all_classes[77] = nova_math_Statement_Extension_VTable_val.classInstance;
		nova_all_classes[78] = nova_math_StatementComponent_Extension_VTable_val.classInstance;
		nova_all_classes[79] = nova_math_VariableOperand_Extension_VTable_val.classInstance;
		nova_all_classes[80] = nova_math_Vector_Extension_VTable_val.classInstance;
		nova_all_classes[81] = nova_math_Vector2D_Extension_VTable_val.classInstance;
		nova_all_classes[82] = nova_math_Vector3D_Extension_VTable_val.classInstance;
		nova_all_classes[83] = nova_math_Vector4D_Extension_VTable_val.classInstance;
		nova_all_classes[84] = nova_math_calculus_Calculus_Extension_VTable_val.classInstance;
		nova_all_classes[85] = nova_math_huffman_HuffmanTree_Extension_VTable_val.classInstance;
		nova_all_classes[86] = nova_math_logic_Conclusion_Extension_VTable_val.classInstance;
		nova_all_classes[87] = nova_math_logic_Hypothesis_Extension_VTable_val.classInstance;
		nova_all_classes[88] = nova_math_logic_InvalidFormulaException_Extension_VTable_val.classInstance;
		nova_all_classes[89] = nova_math_logic_LogicalConnective_Extension_VTable_val.classInstance;
		nova_all_classes[90] = nova_math_logic_LogicalStatement_Extension_VTable_val.classInstance;
		nova_all_classes[91] = nova_math_logic_StatementComponent_Extension_VTable_val.classInstance;
		nova_all_classes[92] = nova_math_logic_StatementGroup_Extension_VTable_val.classInstance;
		nova_all_classes[93] = nova_math_logic_StatementLetter_Extension_VTable_val.classInstance;
		nova_all_classes[94] = nova_math_logic_WFF_Extension_VTable_val.classInstance;
		nova_all_classes[95] = nova_meta_Field_Extension_VTable_val.classInstance;
		nova_all_classes[96] = nova_meta_GenericArgument_Extension_VTable_val.classInstance;
		nova_all_classes[97] = nova_meta_GenericParameter_Extension_VTable_val.classInstance;
		nova_all_classes[98] = nova_meta_Type_Extension_VTable_val.classInstance;
		nova_all_classes[99] = nova_network_ClientSocket_Extension_VTable_val.classInstance;
		nova_all_classes[100] = nova_network_ConnectionSocket_Extension_VTable_val.classInstance;
		nova_all_classes[101] = nova_network_NetworkInputStream_Extension_VTable_val.classInstance;
		nova_all_classes[102] = nova_network_NetworkOutputStream_Extension_VTable_val.classInstance;
		nova_all_classes[103] = nova_network_ServerSocket_Extension_VTable_val.classInstance;
		nova_all_classes[104] = nova_network_Socket_Extension_VTable_val.classInstance;
		nova_all_classes[105] = nova_operators_Equals_Extension_VTable_val.classInstance;
		nova_all_classes[106] = nova_operators_Multiply_Extension_VTable_val.classInstance;
		nova_all_classes[107] = nova_primitive_Bool_Extension_VTable_val.classInstance;
		nova_all_classes[108] = nova_primitive_Null_Extension_VTable_val.classInstance;
		nova_all_classes[109] = nova_primitive_Primitive_Extension_VTable_val.classInstance;
		nova_all_classes[110] = nova_primitive_number_Byte_Extension_VTable_val.classInstance;
		nova_all_classes[111] = nova_primitive_number_Char_Extension_VTable_val.classInstance;
		nova_all_classes[112] = nova_primitive_number_Double_Extension_VTable_val.classInstance;
		nova_all_classes[113] = nova_primitive_number_Float_Extension_VTable_val.classInstance;
		nova_all_classes[114] = nova_primitive_number_Int_Extension_VTable_val.classInstance;
		nova_all_classes[115] = nova_primitive_number_Integer_Extension_VTable_val.classInstance;
		nova_all_classes[116] = nova_primitive_number_Long_Extension_VTable_val.classInstance;
		nova_all_classes[117] = nova_primitive_number_Number_Extension_VTable_val.classInstance;
		nova_all_classes[118] = nova_primitive_number_RealNumber_Extension_VTable_val.classInstance;
		nova_all_classes[119] = nova_primitive_number_Short_Extension_VTable_val.classInstance;
		nova_all_classes[120] = nova_process_Process_Extension_VTable_val.classInstance;
		nova_all_classes[121] = nova_regex_Match_Extension_VTable_val.classInstance;
		nova_all_classes[122] = nova_regex_Pattern_Extension_VTable_val.classInstance;
		nova_all_classes[123] = nova_regex_Regex_Extension_VTable_val.classInstance;
		nova_all_classes[124] = nova_security_MD5_Extension_VTable_val.classInstance;
		nova_all_classes[125] = nova_security_Sha256_Extension_VTable_val.classInstance;
		nova_all_classes[126] = nova_star_Frame_Extension_VTable_val.classInstance;
		nova_all_classes[127] = nova_star_Window_Extension_VTable_val.classInstance;
		nova_all_classes[128] = nova_star_WindowThread_Extension_VTable_val.classInstance;
		nova_all_classes[129] = nova_thread_Thread_Extension_VTable_val.classInstance;
		nova_all_classes[130] = nova_thread_UncaughtExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[131] = nova_thread_async_Async_Extension_VTable_val.classInstance;
		nova_all_classes[132] = nova_thread_async_AsyncResult_Extension_VTable_val.classInstance;
		nova_all_classes[133] = nova_time_CumulativeTimer_Extension_VTable_val.classInstance;
		nova_all_classes[134] = nova_time_Date_Extension_VTable_val.classInstance;
		nova_all_classes[135] = nova_time_Time_Extension_VTable_val.classInstance;
		nova_all_classes[136] = nova_time_Timer_Extension_VTable_val.classInstance;
		nova_all_classes[137] = nova_web_js_json_Json_Extension_VTable_val.classInstance;
		nova_all_classes[138] = nova_web_svg_Svg_Extension_VTable_val.classInstance;
		nova_all_classes[139] = nova_web_svg_SvgCircle_Extension_VTable_val.classInstance;
		nova_all_classes[140] = nova_web_svg_SvgComponent_Extension_VTable_val.classInstance;
		nova_all_classes[141] = nova_web_svg_SvgComponentList_Extension_VTable_val.classInstance;
		nova_all_classes[142] = nova_web_svg_SvgComponentNode_Extension_VTable_val.classInstance;
		nova_all_classes[143] = nova_web_svg_SvgMainComponent_Extension_VTable_val.classInstance;
		nova_all_classes[144] = nova_web_svg_no3_No3_Extension_VTable_val.classInstance;
		nova_all_classes[145] = nova_web_svg_no3_No3Node_Extension_VTable_val.classInstance;
		nova_all_classes[146] = nova_web_svg_no3_No3Select_Extension_VTable_val.classInstance;
		nova_all_classes[147] = nova_web_svg_no3_No3SelectAll_Extension_VTable_val.classInstance;
		nova_all_classes[148] = spectra_InvalidParseException_Extension_VTable_val.classInstance;
		nova_all_classes[149] = spectra_Spectra_Extension_VTable_val.classInstance;
		nova_all_classes[150] = spectra_SyntaxErrorException_Extension_VTable_val.classInstance;
		nova_all_classes[151] = spectra_SyntaxMessage_Extension_VTable_val.classInstance;
		nova_all_classes[152] = spectra_engines_CodeGeneratorEngine_Extension_VTable_val.classInstance;
		nova_all_classes[153] = spectra_error_UnimplementedOperationException_Extension_VTable_val.classInstance;
		nova_all_classes[154] = spectra_tree_AnnotationSearchResult_Extension_VTable_val.classInstance;
		nova_all_classes[155] = spectra_tree_StatementIterator_Extension_VTable_val.classInstance;
		nova_all_classes[156] = spectra_tree_SyntaxTree_Extension_VTable_val.classInstance;
		nova_all_classes[157] = spectra_tree_nodes_Abstractable_Extension_VTable_val.classInstance;
		nova_all_classes[158] = spectra_tree_nodes_Accessible_Extension_VTable_val.classInstance;
		nova_all_classes[159] = spectra_tree_nodes_ArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[160] = spectra_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[161] = spectra_tree_nodes_Identifier_Extension_VTable_val.classInstance;
		nova_all_classes[162] = spectra_tree_nodes_Import_Extension_VTable_val.classInstance;
		nova_all_classes[163] = spectra_tree_nodes_ImportList_Extension_VTable_val.classInstance;
		nova_all_classes[164] = spectra_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[165] = spectra_tree_nodes_Listener_Extension_VTable_val.classInstance;
		nova_all_classes[166] = spectra_tree_nodes_Literal_Extension_VTable_val.classInstance;
		nova_all_classes[167] = spectra_tree_nodes_Node_Extension_VTable_val.classInstance;
		nova_all_classes[168] = spectra_tree_nodes_NodeList_Extension_VTable_val.classInstance;
		nova_all_classes[169] = spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance;
		nova_all_classes[170] = spectra_tree_nodes_NumericRange_Extension_VTable_val.classInstance;
		nova_all_classes[171] = spectra_tree_nodes_Package_Extension_VTable_val.classInstance;
		nova_all_classes[172] = spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance;
		nova_all_classes[173] = spectra_tree_nodes_Priority_Extension_VTable_val.classInstance;
		nova_all_classes[174] = spectra_tree_nodes_Program_Extension_VTable_val.classInstance;
		nova_all_classes[175] = spectra_tree_nodes_Return_Extension_VTable_val.classInstance;
		nova_all_classes[176] = spectra_tree_nodes_Scope_Extension_VTable_val.classInstance;
		nova_all_classes[177] = spectra_tree_nodes_Skeleton_Extension_VTable_val.classInstance;
		nova_all_classes[178] = spectra_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance;
		nova_all_classes[179] = spectra_tree_nodes_Type_Extension_VTable_val.classInstance;
		nova_all_classes[180] = spectra_tree_nodes_ValidationResult_Extension_VTable_val.classInstance;
		nova_all_classes[181] = spectra_tree_nodes_Value_Extension_VTable_val.classInstance;
		nova_all_classes[182] = spectra_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance;
		nova_all_classes[183] = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_all_classes[184] = spectra_tree_nodes_annotations_Modifier_Extension_VTable_val.classInstance;
		nova_all_classes[185] = spectra_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[186] = spectra_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[187] = spectra_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[188] = spectra_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance;
		nova_all_classes[189] = spectra_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance;
		nova_all_classes[190] = spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance;
		nova_all_classes[191] = spectra_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance;
		nova_all_classes[192] = spectra_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance;
		nova_all_classes[193] = spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance;
		nova_all_classes[194] = spectra_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance;
		nova_all_classes[195] = spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance;
		nova_all_classes[196] = spectra_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[197] = spectra_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance;
		nova_all_classes[198] = spectra_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance;
		nova_all_classes[199] = spectra_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[200] = spectra_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance;
		nova_all_classes[201] = spectra_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[202] = spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		nova_all_classes[203] = spectra_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance;
		nova_all_classes[204] = spectra_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[205] = spectra_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance;
		nova_all_classes[206] = spectra_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[207] = spectra_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance;
		nova_all_classes[208] = spectra_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance;
		nova_all_classes[209] = spectra_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[210] = spectra_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance;
		nova_all_classes[211] = spectra_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance;
		nova_all_classes[212] = spectra_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance;
		nova_all_classes[213] = spectra_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance;
		nova_all_classes[214] = spectra_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[215] = spectra_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance;
		nova_all_classes[216] = spectra_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[217] = spectra_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance;
		nova_all_classes[218] = spectra_tree_nodes_functions_closures_LambdaExpression_Extension_VTable_val.classInstance;
		nova_all_classes[219] = spectra_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val.classInstance;
		nova_all_classes[220] = spectra_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance;
		nova_all_classes[221] = spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		nova_all_classes[222] = spectra_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance;
		nova_all_classes[223] = spectra_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance;
		nova_all_classes[224] = spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		nova_all_classes[225] = spectra_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance;
		nova_all_classes[226] = spectra_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance;
		nova_all_classes[227] = spectra_tree_nodes_operations_Operation_Extension_VTable_val.classInstance;
		nova_all_classes[228] = spectra_tree_nodes_operations_Operator_Extension_VTable_val.classInstance;
		nova_all_classes[229] = spectra_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[230] = spectra_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[231] = spectra_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance;
		nova_all_classes[232] = spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[233] = spectra_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[234] = spectra_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[235] = spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[236] = spectra_tree_nodes_variables_Variable_Extension_VTable_val.classInstance;
		nova_all_classes[237] = spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[238] = spectra_util_Bounds_Extension_VTable_val.classInstance;
		nova_all_classes[239] = spectra_util_CompilerStringFunctions_Extension_VTable_val.classInstance;
		nova_all_classes[240] = spectra_util_FileUtils_Extension_VTable_val.classInstance;
		nova_all_classes[241] = spectra_util_Location_Extension_VTable_val.classInstance;
		nova_all_classes[242] = spectra_util_OS_Extension_VTable_val.classInstance;
		nova_all_classes[243] = spectra_util_SyntaxUtils_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_4_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 244);
