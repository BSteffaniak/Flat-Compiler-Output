...
void spectra_Nova_Spectra_Nova_compile(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
		...
		if (spectra_Nova_Spectra_Nova_DEBUG)
		{
				...
				nova_Nova_String* l1_Nova_myString = (nova_Nova_String*)nova_null;
				...
				l1_Nova_myString = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("hey this is my string"));
				...
				TRY
				{
						...
						
						{
								...
								contextArg101->spectra_Nova_Spectra_Nova_program = &l1_Nova_program;
								...
								contextArg102->spectra_Nova_Spectra_Nova_separator = &l2_Nova_separator;
								...
								nova_io_Nova_Console_1_static_Nova_writeLine(0, exceptionData, nova_datastruct_list_Nova_List_virtual_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(spectra_tree_nodes_Nova_Program_Accessor_Nova_files(l2_Nova_tree->spectra_tree_Nova_SyntaxTree_Nova_root, exceptionData)), exceptionData, (nova_datastruct_list_Nova_List_closure8_Nova_mapFunc)&spectra_Nova_Spectra_Nova_lambda102, this, contextArg102)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n"))));
...
int main(int argc, char** argvs)
{
		...
		nova_Nova_Class** nova_all_classes = NOVA_MALLOC(sizeof(nova_Nova_Class*) * 261);
		...
		nova_all_classes[165] = spectra_tree_nodes_ClassDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[166] = spectra_tree_nodes_Identifier_Extension_VTable_val.classInstance;
		nova_all_classes[167] = spectra_tree_nodes_Import_Extension_VTable_val.classInstance;
		nova_all_classes[168] = spectra_tree_nodes_ImportList_Extension_VTable_val.classInstance;
		nova_all_classes[169] = spectra_tree_nodes_InterfaceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[170] = spectra_tree_nodes_Listener_Extension_VTable_val.classInstance;
		nova_all_classes[171] = spectra_tree_nodes_Literal_Extension_VTable_val.classInstance;
		nova_all_classes[172] = spectra_tree_nodes_Node_Extension_VTable_val.classInstance;
		nova_all_classes[173] = spectra_tree_nodes_NodeList_Extension_VTable_val.classInstance;
		nova_all_classes[174] = spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance;
		nova_all_classes[175] = spectra_tree_nodes_NumericRange_Extension_VTable_val.classInstance;
		nova_all_classes[176] = spectra_tree_nodes_Package_Extension_VTable_val.classInstance;
		nova_all_classes[177] = spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance;
		nova_all_classes[178] = spectra_tree_nodes_Priority_Extension_VTable_val.classInstance;
		nova_all_classes[179] = spectra_tree_nodes_Program_Extension_VTable_val.classInstance;
		nova_all_classes[180] = spectra_tree_nodes_Return_Extension_VTable_val.classInstance;
		nova_all_classes[181] = spectra_tree_nodes_Scope_Extension_VTable_val.classInstance;
		nova_all_classes[182] = spectra_tree_nodes_Skeleton_Extension_VTable_val.classInstance;
		nova_all_classes[183] = spectra_tree_nodes_StaticClassReference_Extension_VTable_val.classInstance;
		nova_all_classes[184] = spectra_tree_nodes_Type_Extension_VTable_val.classInstance;
		nova_all_classes[185] = spectra_tree_nodes_ValidationResult_Extension_VTable_val.classInstance;
		nova_all_classes[186] = spectra_tree_nodes_Value_Extension_VTable_val.classInstance;
		nova_all_classes[187] = spectra_tree_nodes_annotations_AbstractAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[188] = spectra_tree_nodes_annotations_Annotatable_Extension_VTable_val.classInstance;
		nova_all_classes[189] = spectra_tree_nodes_annotations_Annotation_Extension_VTable_val.classInstance;
		nova_all_classes[190] = spectra_tree_nodes_annotations_AutoFinalAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[191] = spectra_tree_nodes_annotations_AutoPureAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[192] = spectra_tree_nodes_annotations_FinalAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[193] = spectra_tree_nodes_annotations_ImmutableAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[194] = spectra_tree_nodes_annotations_ImpureAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[195] = spectra_tree_nodes_annotations_Modifier_Extension_VTable_val.classInstance;
		nova_all_classes[196] = spectra_tree_nodes_annotations_NativeAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[197] = spectra_tree_nodes_annotations_OverrideAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[198] = spectra_tree_nodes_annotations_PrivateAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[199] = spectra_tree_nodes_annotations_PublicAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[200] = spectra_tree_nodes_annotations_PureAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[201] = spectra_tree_nodes_annotations_StaticAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[202] = spectra_tree_nodes_annotations_TargetAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[203] = spectra_tree_nodes_annotations_VarAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[204] = spectra_tree_nodes_annotations_VisibleAnnotation_Extension_VTable_val.classInstance;
		nova_all_classes[205] = spectra_tree_nodes_arrays_ArrayAccess_Extension_VTable_val.classInstance;
		nova_all_classes[206] = spectra_tree_nodes_controlstructures_ControlStructure_Extension_VTable_val.classInstance;
		nova_all_classes[207] = spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance;
		nova_all_classes[208] = spectra_tree_nodes_controlstructures_IfStatement_Extension_VTable_val.classInstance;
		nova_all_classes[209] = spectra_tree_nodes_controlstructures_loops_ForEachLoop_Extension_VTable_val.classInstance;
		nova_all_classes[210] = spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable_val.classInstance;
		nova_all_classes[211] = spectra_tree_nodes_controlstructures_loops_WhileLoop_Extension_VTable_val.classInstance;
		nova_all_classes[212] = spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance;
		nova_all_classes[213] = spectra_tree_nodes_exceptionhandling_ExceptionHandler_Extension_VTable_val.classInstance;
		nova_all_classes[214] = spectra_tree_nodes_exceptionhandling_Throw_Extension_VTable_val.classInstance;
		nova_all_classes[215] = spectra_tree_nodes_exceptionhandling_Try_Extension_VTable_val.classInstance;
		nova_all_classes[216] = spectra_tree_nodes_functions_AccessorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[217] = spectra_tree_nodes_functions_ArrayInstantiation_Extension_VTable_val.classInstance;
		nova_all_classes[218] = spectra_tree_nodes_functions_BodyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[219] = spectra_tree_nodes_functions_CallableFunction_Extension_VTable_val.classInstance;
		nova_all_classes[220] = spectra_tree_nodes_functions_Constructor_Extension_VTable_val.classInstance;
		nova_all_classes[221] = spectra_tree_nodes_functions_FunctionArgumentList_Extension_VTable_val.classInstance;
		nova_all_classes[222] = spectra_tree_nodes_functions_FunctionCall_Extension_VTable_val.classInstance;
		nova_all_classes[223] = spectra_tree_nodes_functions_FunctionDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[224] = spectra_tree_nodes_functions_InitializationFunction_Extension_VTable_val.classInstance;
		nova_all_classes[225] = spectra_tree_nodes_functions_Instantiation_Extension_VTable_val.classInstance;
		nova_all_classes[226] = spectra_tree_nodes_functions_MutatorFunction_Extension_VTable_val.classInstance;
		nova_all_classes[227] = spectra_tree_nodes_functions_ObjectNotation_Extension_VTable_val.classInstance;
		nova_all_classes[228] = spectra_tree_nodes_functions_ObjectNotationProperty_Extension_VTable_val.classInstance;
		nova_all_classes[229] = spectra_tree_nodes_functions_Parameter_Extension_VTable_val.classInstance;
		nova_all_classes[230] = spectra_tree_nodes_functions_ParameterList_Extension_VTable_val.classInstance;
		nova_all_classes[231] = spectra_tree_nodes_functions_PropertyFunction_Extension_VTable_val.classInstance;
		nova_all_classes[232] = spectra_tree_nodes_functions_closures_ClosureContext_Extension_VTable_val.classInstance;
		nova_all_classes[233] = spectra_tree_nodes_functions_closures_ClosureDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[234] = spectra_tree_nodes_functions_closures_ClosureParameter_Extension_VTable_val.classInstance;
		nova_all_classes[235] = spectra_tree_nodes_functions_closures_LambdaExpression_Extension_VTable_val.classInstance;
		nova_all_classes[236] = spectra_tree_nodes_functions_closures_LambdaParameter_Extension_VTable_val.classInstance;
		nova_all_classes[237] = spectra_tree_nodes_generics_GenericArgument_Extension_VTable_val.classInstance;
		nova_all_classes[238] = spectra_tree_nodes_generics_GenericCompatible_Extension_VTable_val.classInstance;
		nova_all_classes[239] = spectra_tree_nodes_generics_GenericParameter_Extension_VTable_val.classInstance;
		nova_all_classes[240] = spectra_tree_nodes_generics_GenericType_Extension_VTable_val.classInstance;
		nova_all_classes[241] = spectra_tree_nodes_operations_Assignable_Extension_VTable_val.classInstance;
		nova_all_classes[242] = spectra_tree_nodes_operations_Assignment_Extension_VTable_val.classInstance;
		nova_all_classes[243] = spectra_tree_nodes_operations_ElvisOperation_Extension_VTable_val.classInstance;
		nova_all_classes[244] = spectra_tree_nodes_operations_Operation_Extension_VTable_val.classInstance;
		nova_all_classes[245] = spectra_tree_nodes_operations_Operator_Extension_VTable_val.classInstance;
		nova_all_classes[246] = spectra_tree_nodes_operations_TernaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[247] = spectra_tree_nodes_operations_UnaryOperation_Extension_VTable_val.classInstance;
		nova_all_classes[248] = spectra_tree_nodes_variables_ArrayBracketOverload_Extension_VTable_val.classInstance;
		nova_all_classes[249] = spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[250] = spectra_tree_nodes_variables_ImplicitDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[251] = spectra_tree_nodes_variables_InstanceDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[252] = spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[253] = spectra_tree_nodes_variables_Variable_Extension_VTable_val.classInstance;
		nova_all_classes[254] = spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable_val.classInstance;
		nova_all_classes[255] = spectra_util_Bounds_Extension_VTable_val.classInstance;
		nova_all_classes[256] = spectra_util_CompilerStringFunctions_Extension_VTable_val.classInstance;
		nova_all_classes[257] = spectra_util_FileUtils_Extension_VTable_val.classInstance;
		nova_all_classes[258] = spectra_util_Location_Extension_VTable_val.classInstance;
		nova_all_classes[259] = spectra_util_OS_Extension_VTable_val.classInstance;
		nova_all_classes[260] = spectra_util_SyntaxUtils_Extension_VTable_val.classInstance;
		nova_Nova_Class_Nova_ALL = nova_datastruct_list_Nova_ImmutableArray_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)nova_all_classes, 261);
