...
char spectra_Nova_Spectra_Nova_lambda104(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_meta_Nova_Class* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
char spectra_Nova_Spectra_Nova_lambda105(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_io_Nova_File* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
spectra_tree_nodes_Nova_NovaFile* spectra_Nova_Spectra_Nova_lambda106(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_io_Nova_File* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
void spectra_Nova_Spectra_Nova_lambda107(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
nova_Nova_String* spectra_Nova_Spectra_Nova_lambda108(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context5* context);
void spectra_Nova_Spectra_Nova_lambda109(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
void spectra_Nova_Spectra_Nova_lambda110(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
void spectra_Nova_Spectra_Nova_lambda111(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context8* context);
...
void spectra_Nova_Spectra_Nova_compile(spectra_Nova_Spectra* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* args)
{
	...
	if (spectra_Nova_Spectra_Nova_DEBUG)
	{
		...
		Context2* contextArg105 = NOVA_MALLOC(sizeof(Context2));
		Context3* contextArg106 = NOVA_MALLOC(sizeof(Context3));
		Context6* contextArg109 = NOVA_MALLOC(sizeof(Context6));
		Context7* contextArg110 = NOVA_MALLOC(sizeof(Context7));
		...
		TRY
		{
			...
			{
				Context4* contextArg107 = NOVA_MALLOC(sizeof(Context4));
				contextArg107->spectra_Nova_Spectra_Nova_program = &l2_Nova_program;
				...
				Context5* contextArg108 = NOVA_MALLOC(sizeof(Context5));
				contextArg108->spectra_Nova_Spectra_Nova_separator = &l3_Nova_separator;
				
				nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->prv->spectra_Nova_Spectra_Nova_files), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda107, this, contextArg107);
		...
		nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_errors), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda109, this, contextArg109);
		nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_warnings), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda110, this, contextArg110);
		nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_Nova_Spectra_Nova_info), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_Nova_Spectra_Nova_lambda111, this, contextArg111);
