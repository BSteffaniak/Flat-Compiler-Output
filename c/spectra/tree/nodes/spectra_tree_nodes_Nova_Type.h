...
typedef struct spectra_tree_nodes_Nova_TypePropertyMap spectra_tree_nodes_Nova_TypePropertyMap;
...
(
	...
	spectra_tree_nodes_Type_TypePropertyMap_Extension_VTable* vtable;
)
