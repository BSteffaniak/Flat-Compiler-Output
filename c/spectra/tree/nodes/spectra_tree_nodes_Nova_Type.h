...
typedef struct spectra_tree_nodes_Nova_spectra_tree_nodes_TypeFunctionMap spectra_tree_nodes_Nova_spectra_tree_nodes_TypeFunctionMap;
...
CCLASS_CLASS
(
	spectra_tree_nodes_Nova_spectra_tree_nodes_TypeFunctionMap, 
	
	spectra_tree_nodes_Type_spectra_tree_nodes_TypeFunctionMap_Extension_VTable* vtable;
)
