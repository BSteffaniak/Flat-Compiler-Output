#ifndef FILE_spectra_tree_nodes_variables_Nova_FieldDeclaration_NOVA
#define FILE_spectra_tree_nodes_variables_Nova_FieldDeclaration_NOVA
...
(
	...
	spectra_tree_nodes_variables_FieldDeclaration_Extension_VTable* vtable;
