#ifndef FILE_spectra_tree_nodes_variables_Nova_VariableDeclaration_NOVA
#define FILE_spectra_tree_nodes_variables_Nova_VariableDeclaration_NOVA
...
(
	...
	spectra_tree_nodes_variables_VariableDeclaration_Extension_VTable* vtable;
