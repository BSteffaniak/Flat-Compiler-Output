...
spectra_tree_nodes_variables_Nova_ArrayBracketOverload* spectra_tree_nodes_variables_Nova_ArrayBracketOverloadFunctionMap_functionMapArrayBracketOverloadFunctionMap_Nova_construct(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location)
{
	return spectra_tree_nodes_variables_Nova_ArrayBracketOverload_Nova_construct(0, exceptionData, parent, location);
}

spectra_tree_nodes_variables_Nova_ArrayBracketOverload* spectra_tree_nodes_variables_Nova_ArrayBracketOverloadFunctionMap_functionMap_static_Nova_parse(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location, char require)
{
	return spectra_tree_nodes_variables_Nova_ArrayBracketOverload_static_Nova_parse(0, exceptionData, input, parent, location, require);
}

nova_Nova_String* spectra_tree_nodes_variables_Nova_ArrayBracketOverloadFunctionMap_functionMap_Nova_writeNova(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_variables_Nova_ArrayBracketOverload* reference)
{
	return spectra_tree_nodes_variables_Nova_ArrayBracketOverload_Nova_writeNova(reference, exceptionData);
}
...
void spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap* spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_construct(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap, this,);
	this->vtable = &spectra_tree_nodes_variables_ArrayBracketOverload_ArrayBracketOverloadPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_destroy(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_this(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

spectra_tree_nodes_variables_Nova_LocalDeclaration* spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_functionMap_Nova_index(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_variables_Nova_ArrayBracketOverload* reference)
{
	return reference->spectra_tree_nodes_variables_Nova_ArrayBracketOverload_Nova_index;
}

void spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap_Nova_super(spectra_tree_nodes_variables_Nova_ArrayBracketOverloadPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
