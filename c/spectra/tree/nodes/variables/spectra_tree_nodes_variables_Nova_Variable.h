#ifndef FILE_spectra_tree_nodes_variables_Nova_Variable_NOVA
#define FILE_spectra_tree_nodes_variables_Nova_Variable_NOVA
...
(
	...
	spectra_tree_nodes_variables_Variable_Extension_VTable* vtable;
