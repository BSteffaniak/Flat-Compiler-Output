...
void spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap* spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_construct(spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_variables_InstanceDeclaration_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_destroy(spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_this(spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap_Nova_super(spectra_tree_nodes_variables_Nova_spectra_tree_nodes_variables_InstanceDeclarationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
