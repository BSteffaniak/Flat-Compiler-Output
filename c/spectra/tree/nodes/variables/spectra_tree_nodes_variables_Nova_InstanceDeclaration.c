...
{
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((spectra_tree_nodes_variables_Nova_InstanceDeclaration_Nova_writeVisibility(this, exceptionData))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((spectra_tree_nodes_variables_Nova_InstanceDeclaration_Nova_writeStatic(this, exceptionData))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" ")))));
}
