...
{
	return this->vtable->spectra_tree_nodes_variables_Nova_VariableFunctionMap_virtualfunctionMapVariable_static_Nova_construct(0, exceptionData, parent, location, declaration);
}
