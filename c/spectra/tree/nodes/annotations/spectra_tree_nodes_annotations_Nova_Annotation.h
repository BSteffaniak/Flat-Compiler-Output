#pragma once
#ifndef FILE_spectra_tree_nodes_annotations_Nova_Annotation_NOVA
#define FILE_spectra_tree_nodes_annotations_Nova_Annotation_NOVA
...
(
	...
	spectra_tree_nodes_annotations_Annotation_Extension_VTable* vtable;
