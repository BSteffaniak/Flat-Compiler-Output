...
nova_Nova_String* spectra_tree_nodes_annotations_Nova_AutoFinalAnnotation_Nova_writeNova(spectra_tree_nodes_annotations_Nova_AutoFinalAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("[AutoFinal]"));
}
...
void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	CCLASS_NEW(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_annotations_AutoFinalAnnotation_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Nova_destroy(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Nova_this(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap_Nova_super(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_AutoFinalAnnotationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
