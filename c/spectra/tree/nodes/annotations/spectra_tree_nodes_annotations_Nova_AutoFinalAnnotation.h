#ifndef FILE_spectra_tree_nodes_annotations_Nova_AutoFinalAnnotation_NOVA
#define FILE_spectra_tree_nodes_annotations_Nova_AutoFinalAnnotation_NOVA
...
(
	...
	spectra_tree_nodes_annotations_AutoFinalAnnotation_Extension_VTable* vtable;
