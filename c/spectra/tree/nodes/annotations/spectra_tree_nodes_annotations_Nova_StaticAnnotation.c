...
spectra_tree_nodes_annotations_Nova_StaticAnnotation* spectra_tree_nodes_annotations_Nova_StaticAnnotation_static_Nova_parse(spectra_tree_nodes_annotations_Nova_StaticAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* type, nova_Nova_String* parameters, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location, int require)
{
	...
	{
		spectra_tree_nodes_annotations_Nova_StaticAnnotation* l1_Nova_node = (spectra_tree_nodes_annotations_Nova_StaticAnnotation*)nova_null;
		
		l1_Nova_node = spectra_tree_nodes_annotations_Nova_StaticAnnotation_Nova_construct(0, exceptionData, parent, location);
		return l1_Nova_node;
	}
	return (spectra_tree_nodes_annotations_Nova_StaticAnnotation*)(nova_Nova_Object*)nova_null;
}

nova_Nova_String* spectra_tree_nodes_annotations_Nova_StaticAnnotation_Nova_writeNova(spectra_tree_nodes_annotations_Nova_StaticAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
