...
void spectra_tree_nodes_annotations_Nova_OverrideAnnotation_Nova_destroy(spectra_tree_nodes_annotations_Nova_OverrideAnnotation** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_Nova_String_Nova_destroy(&(*this)->spectra_tree_nodes_annotations_Nova_OverrideAnnotation_Nova_aliasUsed, exceptionData);
...
{
	return this->spectra_tree_nodes_annotations_Nova_OverrideAnnotation_Nova_aliasUsed;
}
...
{
	this->spectra_tree_nodes_annotations_Nova_OverrideAnnotation_Nova_aliasUsed = value;
	return value;
}
...
{
	this->spectra_tree_nodes_annotations_Nova_OverrideAnnotation_Nova_aliasUsed = (nova_Nova_String*)nova_null;
}
