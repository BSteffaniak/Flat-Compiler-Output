...
nova_datastruct_list_Nova_Array* generated17(spectra_tree_nodes_annotations_Nova_VisibleAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData);
...
void spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_destroy(spectra_tree_nodes_annotations_Nova_VisibleAnnotation** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_Nova_String_Nova_destroy(&(*this)->spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_alias, exceptionData);
	
	NOVA_FREE(*this);
}

spectra_tree_nodes_annotations_Nova_Modifier* spectra_tree_nodes_annotations_Nova_VisibleAnnotation_static_Nova_default(spectra_tree_nodes_annotations_Nova_VisibleAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return (spectra_tree_nodes_annotations_Nova_Modifier*)spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_construct(0, exceptionData, 0, 0);
}
...
nova_datastruct_list_Nova_Array* generated17(spectra_tree_nodes_annotations_Nova_VisibleAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_temp[0] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("visible"));
	return nova_datastruct_list_Nova_Array_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)(l1_Nova_temp), 1);
}

nova_datastruct_list_Nova_ImmutableArray* spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Accessor_static_Nova_aliases(spectra_tree_nodes_annotations_Nova_VisibleAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return (nova_datastruct_list_Nova_ImmutableArray*)nova_datastruct_list_Nova_Array_Nova_toImmutable((nova_datastruct_list_Nova_Array*)(generated17(0, exceptionData)), exceptionData);
}


nova_Nova_String* spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Accessorfunc1_Nova_alias(spectra_tree_nodes_annotations_Nova_VisibleAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return this->spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_alias;
}

nova_Nova_String* spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Mutatorfunc0_Nova_alias(spectra_tree_nodes_annotations_Nova_VisibleAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* value)
{
	this->spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_alias = value;
	return value;
}
...
{
	this->spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_alias = (nova_Nova_String*)nova_null;
}
...
spectra_tree_nodes_annotations_Nova_VisibleAnnotation* spectra_tree_nodes_annotations_Nova_VisibleAnnotationFunctionMap_functionMapVisibleAnnotationFunctionMap_Nova_construct(spectra_tree_nodes_annotations_Nova_VisibleAnnotationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location)
{
	return spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Nova_construct(0, exceptionData, parent, location);
}

spectra_tree_nodes_annotations_Nova_Modifier* spectra_tree_nodes_annotations_Nova_VisibleAnnotationFunctionMap_functionMap_static_Nova_default(spectra_tree_nodes_annotations_Nova_VisibleAnnotationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return spectra_tree_nodes_annotations_Nova_VisibleAnnotation_static_Nova_default(0, exceptionData);
}
...
void spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap* spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_construct(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap, this,);
	this->vtable = &spectra_tree_nodes_annotations_VisibleAnnotation_VisibleAnnotationPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_destroy(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_this(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

nova_Nova_String* spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_functionMap0_Nova_alias(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_annotations_Nova_VisibleAnnotation* reference)
{
	return spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Accessorfunc1_Nova_alias(reference, exceptionData);
}

nova_datastruct_list_Nova_ImmutableArray* spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_functionMap_static_Nova_aliases(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return (nova_datastruct_list_Nova_ImmutableArray*)spectra_tree_nodes_annotations_Nova_VisibleAnnotation_Accessor_static_Nova_aliases(0, exceptionData);
}

void spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap_Nova_super(spectra_tree_nodes_annotations_Nova_VisibleAnnotationPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
