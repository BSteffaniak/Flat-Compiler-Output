...
nova_Nova_String* spectra_tree_nodes_annotations_Nova_NativeAnnotation_Nova_writeNova(spectra_tree_nodes_annotations_Nova_NativeAnnotation* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	CCLASS_NEW(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_annotations_NativeAnnotation_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Nova_destroy(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Nova_this(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap_Nova_super(spectra_tree_nodes_annotations_Nova_spectra_tree_nodes_annotations_NativeAnnotationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
