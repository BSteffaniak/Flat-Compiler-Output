...
{
	Context1* contextArg43 = NOVA_MALLOC(sizeof(Context1));
	contextArg43->spectra_tree_nodes_Nova_NovaFile_Nova_name = &name;
...
{
	Context7* contextArg49 = NOVA_MALLOC(sizeof(Context7));
