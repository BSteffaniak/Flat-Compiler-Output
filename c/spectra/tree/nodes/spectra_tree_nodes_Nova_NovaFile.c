...
char spectra_tree_nodes_Nova_NovaFile_Nova_lambda50(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
void spectra_tree_nodes_Nova_NovaFile_Nova_lambda51(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
void spectra_tree_nodes_Nova_NovaFile_Nova_lambda52(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_ClassDeclaration* _1, int _2, nova_datastruct_list_Nova_List* _3, Context4* context);
char spectra_tree_nodes_Nova_NovaFile_Nova_lambda53(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Import* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context5* context);
nova_Nova_String* spectra_tree_nodes_Nova_NovaFile_Nova_lambda54(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Import* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context6* context);
nova_Nova_String* spectra_tree_nodes_Nova_NovaFile_Nova_lambda55(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_ClassDeclaration* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context7* context);
char spectra_tree_nodes_Nova_NovaFile_Nova_lambda56(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_ClassDeclaration* _1, Context8* context);
...
void spectra_tree_nodes_Nova_NovaFile_Nova_lambda51(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context)
{
	Context4* contextArg51 = NOVA_MALLOC(sizeof(Context4));
	
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_Nova_filterNull((nova_datastruct_list_Nova_List*)(_1->spectra_tree_nodes_Nova_NovaFile_Nova_classes), exceptionData)), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_tree_nodes_Nova_NovaFile_Nova_lambda52, this, contextArg51);
}

void spectra_tree_nodes_Nova_NovaFile_Nova_lambda52(spectra_tree_nodes_Nova_NovaFile* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_ClassDeclaration* _1, int _2, nova_datastruct_list_Nova_List* _3, Context4* context)
{
	spectra_tree_nodes_Nova_NovaFile_Nova_addImport(this, exceptionData, spectra_tree_nodes_Nova_ClassDeclaration_Accessorfunc_Nova_location(_1, exceptionData));
}
