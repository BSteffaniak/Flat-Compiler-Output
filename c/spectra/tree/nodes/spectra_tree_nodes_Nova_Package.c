...
spectra_tree_nodes_Nova_Package* spectra_tree_nodes_Nova_Package_static_Nova_parse(spectra_tree_nodes_Nova_Package* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location, int require)
{
	...
	{
		spectra_tree_nodes_Nova_Package* l1_Nova_node = (spectra_tree_nodes_Nova_Package*)nova_null;
		int l1_Nova_quoteStart = 0;
		int l1_Nova_quoteEnd = 0;
		nova_Nova_String* l1_Nova_packageLocation = (nova_Nova_String*)nova_null;
		
		l1_Nova_node = spectra_tree_nodes_Nova_Package_Nova_construct(0, exceptionData, parent, location);
		l1_Nova_quoteStart = spectra_util_Nova_CompilerStringFunctions_Nova_nextNonWhitespaceIndex(input, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("package"))->nova_Nova_String_Nova_count, (intptr_t)nova_null, (intptr_t)nova_null);
		...
		{
			spectra_Nova_SyntaxMessage_static_Nova_error(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Missing ending quotation for Package statement")), (spectra_tree_nodes_Nova_Node*)(l1_Nova_node), (intptr_t)nova_null);
		}
		...
		l1_Nova_node->spectra_tree_nodes_Nova_Package_Nova_location = l1_Nova_packageLocation;
		if (spectra_tree_nodes_Nova_Package_Nova_validateLocation(l1_Nova_node, exceptionData) && spectra_tree_nodes_Nova_Package_Nova_validateAlias(l1_Nova_node, exceptionData))
		{
			nova_datastruct_list_Nova_Array* nova_local_0 = (nova_datastruct_list_Nova_Array*)nova_null;
			
			nova_datastruct_Nova_HashMap_virtual_Nova_put((nova_datastruct_Nova_HashMap*)(spectra_tree_nodes_Nova_Package_Nova_filesMap), exceptionData, (nova_Nova_Object*)(l1_Nova_node->spectra_tree_nodes_Nova_Package_Nova_location), (nova_Nova_Object*)((nova_datastruct_list_Nova_Array*)((nova_local_0 = (nova_datastruct_list_Nova_Array*)(nova_datastruct_Nova_HashMap_Nova_get((nova_datastruct_Nova_HashMap*)(spectra_tree_nodes_Nova_Package_Nova_filesMap), exceptionData, (nova_Nova_Object*)(l1_Nova_node->spectra_tree_nodes_Nova_Package_Nova_location)))) != (nova_datastruct_list_Nova_Array*)nova_null ? nova_local_0 : nova_datastruct_list_Nova_Array_0_Nova_construct(0, exceptionData))));
			nova_datastruct_list_Nova_Array_virtual0_Nova_add((nova_datastruct_list_Nova_Array*)(nova_datastruct_Nova_HashMap_Nova_get((nova_datastruct_Nova_HashMap*)(spectra_tree_nodes_Nova_Package_Nova_filesMap), exceptionData, (nova_Nova_Object*)(l1_Nova_node->spectra_tree_nodes_Nova_Package_Nova_location))), exceptionData, (nova_Nova_Object*)(spectra_tree_nodes_Nova_Node_virtual_Accessor_Nova_parentFile((spectra_tree_nodes_Nova_Node*)(parent), exceptionData)));
			return l1_Nova_node;
		}
	}
	return (spectra_tree_nodes_Nova_Package*)(nova_Nova_Object*)nova_null;
...
{
	return (nova_Nova_String*)(this->spectra_tree_nodes_Nova_Package_Nova_location != (nova_Nova_String*)nova_null ? nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("package \""))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((this->spectra_tree_nodes_Nova_Package_Nova_location)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\"")))) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")));
}
