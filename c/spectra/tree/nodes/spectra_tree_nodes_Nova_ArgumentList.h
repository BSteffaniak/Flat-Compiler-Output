...
typedef struct spectra_tree_nodes_Nova_ArgumentListPropertyMap spectra_tree_nodes_Nova_ArgumentListPropertyMap;
...
(
	...
	spectra_tree_nodes_ArgumentList_ArgumentListPropertyMap_Extension_VTable* vtable;
)
