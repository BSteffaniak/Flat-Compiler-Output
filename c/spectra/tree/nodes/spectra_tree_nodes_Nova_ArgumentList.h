...
typedef struct spectra_tree_nodes_Nova_ArgumentListFunctionMap spectra_tree_nodes_Nova_ArgumentListFunctionMap;
...
(
	...
	spectra_tree_nodes_ArgumentList_ArgumentListFunctionMap_Extension_VTable* vtable;
)
...
spectra_tree_nodes_Nova_ArgumentList* spectra_tree_nodes_Nova_ArgumentListFunctionMap_functionMapArgumentListFunctionMap_static_Nova_construct(spectra_tree_nodes_Nova_ArgumentListFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location);
