...
nova_datastruct_list_Nova_Array* generated21(spectra_tree_nodes_Nova_Accessible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Class* value0);
...
char spectra_tree_nodes_Nova_Accessible_static_Nova_lambda108(spectra_tree_nodes_Nova_Accessible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_List* _3, Context1* context);
...
{
	return spectra_tree_nodes_Nova_Accessible_1_Nova_getNextAccessingOfType(this, exceptionData, generated21(this, exceptionData, type));
}
...
spectra_tree_nodes_Nova_Accessible* spectra_tree_nodes_Nova_Accessible_0_Nova_getLastAccessingOfType(spectra_tree_nodes_Nova_Accessible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Class* type, char opposite, int inclusive)
{
	...
	return spectra_tree_nodes_Nova_Accessible_1_Nova_getLastAccessingOfType(this, exceptionData, generated22(this, exceptionData, type), opposite, inclusive);
}
...
{
	return spectra_tree_nodes_Nova_Accessible_1_Nova_getLastAccessedOfType(this, exceptionData, generated23(this, exceptionData, type), opposite);
}
...
{
	return spectra_tree_nodes_Nova_Accessible_1_Nova_getNextAccessedOfType(this, exceptionData, generated24(this, exceptionData, type));
}
...
spectra_tree_nodes_Nova_Node* spectra_tree_nodes_Nova_Accessible_static_Nova_parseDotAccess(spectra_tree_nodes_Nova_Accessible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, spectra_tree_nodes_Nova_Node* parent, int require)
{
	...
	if (l1_Nova_fragments != (nova_datastruct_list_Nova_Array*)nova_null)
	{
		...
		l2_Nova_root = spectra_tree_nodes_Nova_Accessible_0_static_Nova_parse(0, exceptionData, (nova_Nova_String*)(nova_datastruct_list_Nova_Array_virtual_Accessorfunc_Nova_first((nova_datastruct_list_Nova_Array*)(l1_Nova_fragments), exceptionData)), parent, require);
		l2_Nova_current = l2_Nova_root;
		if (l2_Nova_current != (spectra_tree_nodes_Nova_Accessible*)nova_null)
		{
			Context1 contextArg108 = 
			{
				&l2_Nova_current,
				&require,
			};
			
			if (nova_datastruct_list_Nova_List_virtual0_Nova_all((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual_Nova_skip((nova_datastruct_list_Nova_List*)(l1_Nova_fragments), exceptionData, 1)), exceptionData, (nova_datastruct_list_Nova_List_closure12_Nova_allFunc)&spectra_tree_nodes_Nova_Accessible_static_Nova_lambda108, nova_null, &contextArg108, (intptr_t)nova_null))
			{
...
{
	other->spectra_tree_nodes_Nova_Accessible_Nova_safeNavigation = this->spectra_tree_nodes_Nova_Accessible_Nova_safeNavigation;
...
char spectra_tree_nodes_Nova_Accessible_static_Nova_lambda108(spectra_tree_nodes_Nova_Accessible* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_List* _3, Context1* context)
{
	...
	{
		spectra_tree_nodes_Nova_Accessible_virtual_Mutator0_Nova_accessedNode((spectra_tree_nodes_Nova_Accessible*)((*context->spectra_tree_nodes_Nova_Accessible_Nova_current)), exceptionData, l4_Nova_accessed);
		return 1;
	}
	return 0;
}
