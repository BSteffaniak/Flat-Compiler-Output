...
{
	CCLASS_NEW(spectra_tree_nodes_Nova_spectra_tree_nodes_LiteralFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_Literal_spectra_tree_nodes_LiteralFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_Nova_spectra_tree_nodes_LiteralFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_Nova_spectra_tree_nodes_LiteralFunctionMap_Nova_this(this, exceptionData);
	}
