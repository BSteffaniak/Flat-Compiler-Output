...
void spectra_tree_nodes_Nova_NodeList_Nova_lambda44(spectra_tree_nodes_Nova_NodeList* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* child, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
void spectra_tree_nodes_Nova_NodeList_Nova_lambda45(spectra_tree_nodes_Nova_NodeList* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* head, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
...
{
	CCLASS_NEW(spectra_tree_nodes_Nova_spectra_tree_nodes_NodeListFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_NodeList_spectra_tree_nodes_NodeListFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_Nova_spectra_tree_nodes_NodeListFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_Nova_spectra_tree_nodes_NodeListFunctionMap_Nova_this(this, exceptionData);
	}
