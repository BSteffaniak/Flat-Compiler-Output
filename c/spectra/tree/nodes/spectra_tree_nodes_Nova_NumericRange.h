...
typedef struct spectra_tree_nodes_Nova_spectra_tree_nodes_NumericRangeFunctionMap spectra_tree_nodes_Nova_spectra_tree_nodes_NumericRangeFunctionMap;
...
CCLASS_CLASS
(
	spectra_tree_nodes_Nova_spectra_tree_nodes_NumericRangeFunctionMap, 
	
	spectra_tree_nodes_NumericRange_spectra_tree_nodes_NumericRangeFunctionMap_Extension_VTable* vtable;
)
