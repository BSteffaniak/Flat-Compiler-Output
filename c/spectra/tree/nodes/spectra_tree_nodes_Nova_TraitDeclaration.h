#ifndef FILE_spectra_tree_nodes_Nova_TraitDeclaration_NOVA
#define FILE_spectra_tree_nodes_Nova_TraitDeclaration_NOVA

typedef struct spectra_tree_nodes_Nova_TraitDeclaration spectra_tree_nodes_Nova_TraitDeclaration;
typedef struct spectra_tree_nodes_Nova_TraitDeclarationFunctionMap spectra_tree_nodes_Nova_TraitDeclarationFunctionMap;
...
(
	...
	spectra_tree_nodes_TraitDeclaration_Extension_VTable* vtable;
...
(
	...
	spectra_tree_nodes_TraitDeclaration_TraitDeclarationFunctionMap_Extension_VTable* vtable;
)
