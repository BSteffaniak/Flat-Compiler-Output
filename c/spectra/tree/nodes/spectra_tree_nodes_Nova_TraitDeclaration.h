...
typedef struct spectra_tree_nodes_Nova_TraitDeclarationPropertyMap spectra_tree_nodes_Nova_TraitDeclarationPropertyMap;
...
(
	...
	spectra_tree_nodes_TraitDeclaration_TraitDeclarationPropertyMap_Extension_VTable* vtable;
)
