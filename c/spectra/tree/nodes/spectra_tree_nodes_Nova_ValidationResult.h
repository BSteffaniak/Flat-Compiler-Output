...
typedef struct spectra_tree_nodes_Nova_ValidationResultFunctionMap spectra_tree_nodes_Nova_ValidationResultFunctionMap;
...
(
	...
	spectra_tree_nodes_ValidationResult_ValidationResultFunctionMap_Extension_VTable* vtable;
)
