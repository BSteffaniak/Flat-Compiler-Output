...
typedef struct spectra_tree_nodes_Nova_ValidationResultPropertyMap spectra_tree_nodes_Nova_ValidationResultPropertyMap;
...
(
	...
	spectra_tree_nodes_ValidationResult_ValidationResultPropertyMap_Extension_VTable* vtable;
)
