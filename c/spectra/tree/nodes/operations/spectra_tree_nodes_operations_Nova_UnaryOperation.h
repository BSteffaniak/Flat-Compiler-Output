...
typedef struct spectra_tree_nodes_operations_Nova_UnaryOperationFunctionMap spectra_tree_nodes_operations_Nova_UnaryOperationFunctionMap;
...
(
	...
	spectra_tree_nodes_operations_UnaryOperation_UnaryOperationFunctionMap_Extension_VTable* vtable;
)
