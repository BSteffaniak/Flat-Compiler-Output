...
void spectra_tree_nodes_operations_Nova_Operation_Nova_lambda68(spectra_tree_nodes_operations_Nova_Operation* this, nova_exception_Nova_ExceptionData* exceptionData, int start, int _2, nova_datastruct_list_Nova_IntArray* _3, Context1* context);
char spectra_tree_nodes_operations_Nova_Operation_Nova_lambda69(spectra_tree_nodes_operations_Nova_Operation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, int _2, nova_datastruct_list_Nova_List* _3, Context2* context);
char spectra_tree_nodes_operations_Nova_Operation_Nova_lambda140(spectra_tree_nodes_operations_Nova_Operation* this, nova_exception_Nova_ExceptionData* exceptionData, int start, int _2, nova_datastruct_list_Nova_IntArray* _3, Context3* context);
...
nova_datastruct_list_Nova_IntArray* spectra_tree_nodes_operations_Nova_Operation_Nova_parseOperators(spectra_tree_nodes_operations_Nova_Operation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, nova_datastruct_list_Nova_IntArray* matches)
{
	...
	contextArg68->spectra_tree_nodes_operations_Nova_Operation_Nova_input = &input;
	
	return (nova_datastruct_list_Nova_IntArray*)(intptr_t)nova_datastruct_list_Nova_IntArray_Nova_forEach(matches, exceptionData, (nova_datastruct_list_Nova_IntArray_closure8_Nova_func)&spectra_tree_nodes_operations_Nova_Operation_Nova_lambda68, this, contextArg68);
}
...
char spectra_tree_nodes_operations_Nova_Operation_0_Nova_parseOperands(spectra_tree_nodes_operations_Nova_Operation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* operands)
{
	...
	return nova_datastruct_list_Nova_List_virtual0_Nova_all((nova_datastruct_list_Nova_List*)(operands), exceptionData, (nova_datastruct_list_Nova_List_closure16_Nova_allFunc)&spectra_tree_nodes_operations_Nova_Operation_Nova_lambda69, this, contextArg69, (intptr_t)nova_null);
}
...
char spectra_tree_nodes_operations_Nova_Operation_1_Nova_parseOperands(spectra_tree_nodes_operations_Nova_Operation* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, nova_datastruct_list_Nova_IntArray* matches)
{
	...
	contextArg140->spectra_tree_nodes_operations_Nova_Operation_Nova_prev = &l1_Nova_prev;
	contextArg140->spectra_tree_nodes_operations_Nova_Operation_Nova_input = &input;
	contextArg140->spectra_tree_nodes_operations_Nova_Operation_Nova_operands = &l1_Nova_operands;
	
	l1_Nova_operands = nova_datastruct_list_Nova_Array_0_Nova_construct(0, exceptionData);
	l1_Nova_prev = 0;
	if (!nova_datastruct_list_Nova_IntArray_Nova_all(matches, exceptionData, (nova_datastruct_list_Nova_IntArray_closure16_Nova_allFunc)&spectra_tree_nodes_operations_Nova_Operation_Nova_lambda140, this, contextArg140, (intptr_t)nova_null))
	{
		return 0;
	}
