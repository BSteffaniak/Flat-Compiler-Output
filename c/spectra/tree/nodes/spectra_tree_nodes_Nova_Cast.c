...
spectra_tree_nodes_Nova_Cast* spectra_tree_nodes_Nova_CastFunctionMap_functionMapCastFunctionMap_Nova_construct(spectra_tree_nodes_Nova_CastFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location)
{
...
{
	CCLASS_NEW(spectra_tree_nodes_Nova_CastPropertyMap, this,);
	this->vtable = &spectra_tree_nodes_Cast_CastPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_Nova_CastPropertyMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_Nova_CastPropertyMap_Nova_this(this, exceptionData);
	}
...
{
	return reference->spectra_tree_nodes_Nova_Cast_Nova_value;
}
