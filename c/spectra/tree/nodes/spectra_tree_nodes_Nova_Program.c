...
char spectra_tree_nodes_Nova_Program_Nova_lambda51(spectra_tree_nodes_Nova_Program* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* f, Context1* context);
