...
char spectra_tree_nodes_Nova_Program_Nova_lambda60(spectra_tree_nodes_Nova_Program* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* f, Context59* context);
...
{
	if (!nova_meta_Nova_Class_Nova_isOfType((nova_meta_Nova_Class*)(child->vtable->classInstance), exceptionData, (nova_meta_Nova_Class*)(spectra_tree_nodes_NovaFile_Extension_VTable_val.classInstance)))
	{
...
spectra_tree_nodes_Nova_ClassDeclaration* spectra_tree_nodes_Nova_Program_Nova_getClassDeclaration(spectra_tree_nodes_Nova_Program* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* location)
{
	...
	contextArg60->spectra_tree_nodes_Nova_Program_Nova_location = &location;
	spectra_tree_nodes_Nova_NovaFile* nova_local_0 = (spectra_tree_nodes_Nova_NovaFile*)nova_null;
	
	return (spectra_tree_nodes_Nova_ClassDeclaration*)((nova_local_0 = (spectra_tree_nodes_Nova_NovaFile*)(nova_datastruct_list_Nova_List_virtual0_Nova_firstWhere((nova_datastruct_list_Nova_List*)(spectra_tree_nodes_Nova_Program_Accessor_Nova_files(this, exceptionData)), exceptionData, (nova_datastruct_list_Nova_List_closure316_Nova_func)&spectra_tree_nodes_Nova_Program_Nova_lambda60, this, contextArg60))) != (spectra_tree_nodes_Nova_NovaFile*)nova_null ? (nova_Nova_Object*)(spectra_tree_nodes_Nova_NovaFile_Accessor_Nova_classDeclaration(nova_local_0, exceptionData)) : (nova_Nova_Object*)nova_null);
}
...
void spectra_tree_nodes_Nova_ProgramFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_Nova_ProgramFunctionMap* spectra_tree_nodes_Nova_ProgramFunctionMap_Nova_construct(spectra_tree_nodes_Nova_ProgramFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_Nova_ProgramFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_Program_ProgramFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_Nova_ProgramFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_Nova_ProgramFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_Nova_ProgramFunctionMap_Nova_destroy(spectra_tree_nodes_Nova_ProgramFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_Nova_ProgramFunctionMap_Nova_this(spectra_tree_nodes_Nova_ProgramFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
...
void spectra_tree_nodes_Nova_ProgramFunctionMap_functionMap_Nova_addChild(spectra_tree_nodes_Nova_ProgramFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Program* reference, spectra_tree_nodes_Nova_Node* child)
{
	spectra_tree_nodes_Nova_Program_Nova_addChild(reference, exceptionData, child);
}

spectra_tree_nodes_Nova_ClassDeclaration* spectra_tree_nodes_Nova_ProgramFunctionMap_functionMap_Nova_getClassDeclaration(spectra_tree_nodes_Nova_ProgramFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Program* reference, nova_Nova_String* location)
{
	return spectra_tree_nodes_Nova_Program_Nova_getClassDeclaration(reference, exceptionData, location);
}
...
void spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_Nova_ProgramPropertyMap* spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_construct(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_Nova_ProgramPropertyMap, this,);
	this->vtable = &spectra_tree_nodes_Program_ProgramPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_destroy(spectra_tree_nodes_Nova_ProgramPropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_this(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

spectra_tree_nodes_Nova_Program* spectra_tree_nodes_Nova_ProgramPropertyMap_functionMap_Nova_program(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Program* reference)
{
	return spectra_tree_nodes_Nova_Program_Accessor_Nova_program(reference, exceptionData);
}

nova_datastruct_list_Nova_Array* spectra_tree_nodes_Nova_ProgramPropertyMap_functionMap_Nova_files(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Program* reference)
{
	return spectra_tree_nodes_Nova_Program_Accessor_Nova_files(reference, exceptionData);
}

spectra_tree_Nova_SyntaxTree* spectra_tree_nodes_Nova_ProgramPropertyMap_functionMap_Nova_tree(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Program* reference)
{
	return reference->spectra_tree_nodes_Nova_Program_Nova_tree;
}

spectra_Nova_Spectra* spectra_tree_nodes_Nova_ProgramPropertyMap_functionMap_Nova_compiler(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Program* reference)
{
	return spectra_tree_nodes_Nova_Program_Accessor_Nova_compiler(reference, exceptionData);
}

void spectra_tree_nodes_Nova_ProgramPropertyMap_Nova_super(spectra_tree_nodes_Nova_ProgramPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
