#ifndef FILE_spectra_tree_nodes_Nova_Cast_NOVA
#define FILE_spectra_tree_nodes_Nova_Cast_NOVA

typedef struct spectra_tree_nodes_Nova_Cast spectra_tree_nodes_Nova_Cast;
typedef struct spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap;
...
(
	...
	spectra_tree_nodes_Cast_Extension_VTable* vtable;
...
CCLASS_CLASS
(
	spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap, 
	
	spectra_tree_nodes_Cast_spectra_tree_nodes_CastFunctionMap_Extension_VTable* vtable;
)

void spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData);
spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap* spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap_Nova_construct(spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData);
void spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap_Nova_destroy(spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData);
void spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap_Nova_this(spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData);
void spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap_Nova_super(spectra_tree_nodes_Nova_spectra_tree_nodes_CastFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData);
