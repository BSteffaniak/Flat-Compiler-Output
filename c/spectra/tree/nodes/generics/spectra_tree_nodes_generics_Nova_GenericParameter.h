#ifndef FILE_spectra_tree_nodes_generics_Nova_GenericParameter_NOVA
#define FILE_spectra_tree_nodes_generics_Nova_GenericParameter_NOVA

typedef struct spectra_tree_nodes_generics_Nova_GenericParameter spectra_tree_nodes_generics_Nova_GenericParameter;
typedef struct spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap;
...
(
	...
	spectra_tree_nodes_generics_GenericParameter_Extension_VTable* vtable;
...
(
	...
	spectra_tree_nodes_generics_GenericParameter_spectra_tree_nodes_generics_GenericParameterFunctionMap_Extension_VTable* vtable;
)

void spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData);
spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap* spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap_Nova_construct(spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData);
void spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap_Nova_destroy(spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData);
void spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap_Nova_this(spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData);
void spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap_Nova_super(spectra_tree_nodes_generics_Nova_spectra_tree_nodes_generics_GenericParameterFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData);
