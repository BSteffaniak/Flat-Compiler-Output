...
void spectra_tree_nodes_generics_Nova_GenericArgumentFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	CCLASS_NEW(spectra_tree_nodes_generics_Nova_GenericArgumentFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_generics_GenericArgument_GenericArgumentFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_generics_Nova_GenericArgumentFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_generics_Nova_GenericArgumentFunctionMap_Nova_this(this, exceptionData);
	}
...
{
	return spectra_tree_nodes_generics_Nova_GenericArgument_Nova_writeNova(reference, exceptionData);
}
...
void spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap* spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_construct(spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap, this,);
	this->vtable = &spectra_tree_nodes_generics_GenericArgument_GenericArgumentPropertyMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_destroy(spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_this(spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap_Nova_super(spectra_tree_nodes_generics_Nova_GenericArgumentPropertyMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
