...
typedef struct spectra_tree_nodes_Nova_ProgramFunctionMap spectra_tree_nodes_Nova_ProgramFunctionMap;
...
(
	...
	spectra_tree_nodes_Program_ProgramFunctionMap_Extension_VTable* vtable;
)
