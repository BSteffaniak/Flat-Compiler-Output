#ifndef FILE_spectra_tree_nodes_controlstructures_loops_Nova_Loop_NOVA
#define FILE_spectra_tree_nodes_controlstructures_loops_Nova_Loop_NOVA
...
(
	...
	spectra_tree_nodes_controlstructures_loops_Loop_Extension_VTable* vtable;
