...
void spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop_Nova_destroy(spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_Nova_String_Nova_destroy(&(*this)->spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop_Nova_variableName, exceptionData);
	...
	if (nova_Nova_String_Nova_equals(spectra_util_Nova_CompilerStringFunctions_Nova_nextWord(input, exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("for"))))
	{
		...
		if (l2_Nova_end > 0)
		{
			...
			if (l3_Nova_inIndex > 0)
			{
				...
				{
					THROW(spectra_Nova_InvalidParseException_Nova_construct(0, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Unable to parse for each loop variable '"))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((l4_Nova_variable)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("'")))), (spectra_tree_nodes_Nova_Node*)(l1_Nova_node)), 1);
				}
				else
				{
					return l1_Nova_node;
...
char spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop_Nova_parseVariable(spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input)
{
	this->spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop_Nova_variableName = input;
	return 1;
}
...
{
	this->spectra_tree_nodes_controlstructures_loops_Nova_ForEachLoop_Nova_variableName = (nova_Nova_String*)nova_null;
