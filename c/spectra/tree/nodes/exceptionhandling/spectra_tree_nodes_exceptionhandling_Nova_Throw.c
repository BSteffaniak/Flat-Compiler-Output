...
{
	return nova_Nova_String_Nova_trim(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(((nova_Nova_String*)(this->spectra_tree_nodes_exceptionhandling_Nova_Throw_Nova_soft ? nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("softly")) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""))))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" throw "))), exceptionData, (spectra_tree_nodes_Nova_Node_virtual_Nova_toNova((spectra_tree_nodes_Nova_Node*)(this->spectra_tree_nodes_exceptionhandling_Nova_Throw_Nova_exception), exceptionData)))), exceptionData, (intptr_t)nova_null, (intptr_t)nova_null, 0);
}
