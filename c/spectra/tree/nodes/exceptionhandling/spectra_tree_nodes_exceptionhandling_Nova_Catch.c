...
{
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(spectra_tree_nodes_Nova_Type_Nova_toNova(this->spectra_tree_nodes_exceptionhandling_Nova_Catch_Nova_exception, exceptionData)), exceptionData, ((nova_Nova_String*)(this->spectra_tree_nodes_exceptionhandling_Nova_Catch_Nova_variable != (nova_Nova_String*)nova_null ? nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(" "))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)((this->spectra_tree_nodes_exceptionhandling_Nova_Catch_Nova_variable)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))));
}
