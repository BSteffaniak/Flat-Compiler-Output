...
typedef struct spectra_tree_nodes_Nova_PriorityPropertyMap spectra_tree_nodes_Nova_PriorityPropertyMap;
...
(
	...
	spectra_tree_nodes_Priority_PriorityPropertyMap_Extension_VTable* vtable;
)
