...
typedef struct spectra_tree_nodes_Nova_SkeletonPropertyMap spectra_tree_nodes_Nova_SkeletonPropertyMap;
...
(
	...
	spectra_tree_nodes_Skeleton_SkeletonPropertyMap_Extension_VTable* vtable;
)
