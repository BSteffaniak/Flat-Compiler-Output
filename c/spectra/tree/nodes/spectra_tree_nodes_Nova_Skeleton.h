...
typedef struct spectra_tree_nodes_Nova_SkeletonFunctionMap spectra_tree_nodes_Nova_SkeletonFunctionMap;
...
(
	...
	spectra_tree_nodes_Skeleton_SkeletonFunctionMap_Extension_VTable* vtable;
)
...
spectra_tree_nodes_Nova_Skeleton* spectra_tree_nodes_Nova_SkeletonFunctionMap_functionMapSkeletonFunctionMap_static_Nova_construct(spectra_tree_nodes_Nova_SkeletonFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location);
