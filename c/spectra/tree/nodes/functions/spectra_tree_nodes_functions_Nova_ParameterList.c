...
{
	nova_datastruct_list_Nova_Array_virtual_Nova_set((nova_datastruct_list_Nova_Array*)(spectra_tree_nodes_functions_Nova_ParameterList_Accessor_Nova_parameters(this, exceptionData)), exceptionData, index, (nova_Nova_Object*)(value));
	return value;
}
...
void spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap* spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_construct(spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_functions_ParameterList_spectra_tree_nodes_functions_ParameterListFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_destroy(spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_this(spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap_Nova_super(spectra_tree_nodes_functions_Nova_spectra_tree_nodes_functions_ParameterListFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
