#ifndef FILE_spectra_tree_nodes_functions_Nova_Instantiation_NOVA
#define FILE_spectra_tree_nodes_functions_Nova_Instantiation_NOVA
...
(
	...
	spectra_tree_nodes_functions_Instantiation_Extension_VTable* vtable;
