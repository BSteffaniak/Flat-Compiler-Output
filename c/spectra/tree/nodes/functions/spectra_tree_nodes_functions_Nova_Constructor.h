...
typedef struct spectra_tree_nodes_functions_Nova_ConstructorPropertyMap spectra_tree_nodes_functions_Nova_ConstructorPropertyMap;
...
(
	...
	spectra_tree_nodes_functions_Constructor_ConstructorPropertyMap_Extension_VTable* vtable;
)
