...
typedef struct spectra_tree_nodes_functions_Nova_BodyFunctionPropertyMap spectra_tree_nodes_functions_Nova_BodyFunctionPropertyMap;
...
(
	...
	spectra_tree_nodes_functions_BodyFunction_BodyFunctionPropertyMap_Extension_VTable* vtable;
)
