...
typedef struct spectra_tree_nodes_functions_closures_Nova_LambdaParameterPropertyMap spectra_tree_nodes_functions_closures_Nova_LambdaParameterPropertyMap;
...
(
	...
	spectra_tree_nodes_functions_closures_LambdaParameter_LambdaParameterPropertyMap_Extension_VTable* vtable;
)
