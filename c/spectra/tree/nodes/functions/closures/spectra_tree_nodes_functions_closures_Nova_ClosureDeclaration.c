...
void spectra_tree_nodes_functions_closures_Nova_ClosureDeclaration_Nova_this(spectra_tree_nodes_functions_closures_Nova_ClosureDeclaration* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location)
{
	...
	spectra_tree_nodes_functions_closures_Nova_ClosureDeclaration_Mutatorfunc0_Nova_parameterList(this, exceptionData, spectra_tree_nodes_functions_Nova_ParameterList_Nova_construct(0, exceptionData, (spectra_tree_nodes_Nova_Node*)(this), 0));
}
...
void spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap* spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_construct(spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_functions_closures_ClosureDeclaration_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_destroy(spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_this(spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap_Nova_super(spectra_tree_nodes_functions_closures_Nova_spectra_tree_nodes_functions_closures_ClosureDeclarationFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
