#ifndef FILE_spectra_tree_nodes_functions_Nova_ParameterList_NOVA
#define FILE_spectra_tree_nodes_functions_Nova_ParameterList_NOVA
...
(
	...
	spectra_tree_nodes_functions_ParameterList_Extension_VTable* vtable;
