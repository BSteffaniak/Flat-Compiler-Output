...
nova_Nova_String* spectra_tree_nodes_functions_Nova_ObjectNotation_Nova_lambda53(spectra_tree_nodes_functions_Nova_ObjectNotation* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
