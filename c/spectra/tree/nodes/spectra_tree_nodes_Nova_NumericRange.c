...
spectra_tree_nodes_Nova_NumericRange* spectra_tree_nodes_Nova_NumericRange_static_Nova_parse(spectra_tree_nodes_Nova_NumericRange* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location, int require)
{
	...
	if (l1_Nova_startIndex > 0 && spectra_util_Nova_CompilerStringFunctions_1_Nova_isStrictlyOperator(input, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("..")), l1_Nova_startIndex))
	{
		...
		spectra_tree_nodes_functions_Nova_Instantiation* l1_Nova_instantiation = (spectra_tree_nodes_functions_Nova_Instantiation*)nova_null;
...
{
	spectra_tree_nodes_Nova_Value* l1_Nova_nova_local_0 = (spectra_tree_nodes_Nova_Value*)nova_null;
	spectra_tree_nodes_Nova_Value* l1_Nova_nova_local_1 = (spectra_tree_nodes_Nova_Value*)nova_null;
	
	return nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(((nova_Nova_String*)((l1_Nova_nova_local_0 = spectra_tree_nodes_Nova_NumericRange_Accessor_Nova_start(this, exceptionData)) != (spectra_tree_nodes_Nova_Value*)nova_null ? (nova_Nova_Object*)(spectra_tree_nodes_Nova_Node_virtual_Nova_toNova((spectra_tree_nodes_Nova_Node*)(l1_Nova_nova_local_0), exceptionData)) : (nova_Nova_Object*)nova_null))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(".."))), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(((nova_Nova_String*)((l1_Nova_nova_local_1 = spectra_tree_nodes_Nova_NumericRange_Accessor_Nova_end(this, exceptionData)) != (spectra_tree_nodes_Nova_Value*)nova_null ? (nova_Nova_Object*)(spectra_tree_nodes_Nova_Node_virtual_Nova_toNova((spectra_tree_nodes_Nova_Node*)(l1_Nova_nova_local_1), exceptionData)) : (nova_Nova_Object*)nova_null))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))));
}
