...
char spectra_tree_nodes_Nova_Scope_Nova_lambda35(spectra_tree_nodes_Nova_Scope* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* child, int _2, nova_datastruct_list_Nova_List* _3, Context1* context);
void spectra_tree_nodes_Nova_Scope_Nova_lambda36(spectra_tree_nodes_Nova_Scope* this, nova_exception_Nova_ExceptionData* exceptionData, Context2* context);
nova_datastruct_list_Nova_Array* generated18(spectra_tree_nodes_Nova_Scope* this, nova_exception_Nova_ExceptionData* exceptionData, nova_meta_Nova_Class* value0, nova_meta_Nova_Class* value1);
...
{
	{
		spectra_tree_nodes_Nova_Scope_Nova_LADDER_FORM = generated18(0, exceptionData, (nova_meta_Nova_Class*)(spectra_tree_nodes_controlstructures_ElseStatement_Extension_VTable_val.classInstance), (nova_meta_Nova_Class*)(spectra_tree_nodes_exceptionhandling_Catch_Extension_VTable_val.classInstance));
	}
}
...
spectra_tree_nodes_Nova_Node* spectra_tree_nodes_Nova_Scope_Nova_parseStatement(spectra_tree_nodes_Nova_Scope* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* input, spectra_tree_nodes_Nova_Node* parent, spectra_util_Nova_Location* location, int require)
{
	...
	if (nova_meta_Nova_Class_Nova_isOfType(l1_Nova_node->vtable->classInstance, exceptionData, (nova_meta_Nova_Class*)(spectra_tree_nodes_variables_LocalDeclaration_Extension_VTable_val.classInstance)))
	{
...
{
	Context1* contextArg36 = NOVA_MALLOC(sizeof(Context1));
	
	return nova_datastruct_list_Nova_List_virtual0_Nova_all((nova_datastruct_list_Nova_List*)(this->spectra_tree_nodes_Nova_NodeList_Nova_children), exceptionData, (nova_datastruct_list_Nova_List_closure16_Nova_allFunc)&spectra_tree_nodes_Nova_Scope_Nova_lambda35, this, contextArg36, 0);
}
...
char spectra_tree_nodes_Nova_Scope_Nova_lambda35(spectra_tree_nodes_Nova_Scope* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* child, int _2, nova_datastruct_list_Nova_List* _3, Context1* context)
{
	if (nova_meta_Nova_Class_Nova_isOfType(child->vtable->classInstance, exceptionData, (nova_meta_Nova_Class*)(spectra_tree_nodes_PlaceholderValue_Extension_VTable_val.classInstance)))
	{
		...
		contextArg35->spectra_tree_nodes_Nova_Scope_Nova_placeholder = &l2_Nova_placeholder;
		contextArg35->spectra_tree_nodes_Nova_Scope_Nova_child = &child;
		
		l2_Nova_placeholder = (spectra_tree_nodes_Nova_PlaceholderValue*)child;
		spectra_tree_nodes_Nova_Node_static_Nova_catchSyntaxErrors(0, exceptionData, (spectra_tree_nodes_Nova_Node_closure8_Nova_action)&spectra_tree_nodes_Nova_Scope_Nova_lambda36, this, contextArg35);
		return 0;
	}
	else
	{
...
void spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap* spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_construct(spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap, this,);
	this->vtable = &spectra_tree_nodes_Scope_spectra_tree_nodes_ScopeFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_destroy(spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_this(spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap_Nova_super(spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
