...
typedef struct spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap;
...
CCLASS_CLASS
(
	spectra_tree_nodes_Nova_spectra_tree_nodes_ScopeFunctionMap, 
	
	spectra_tree_nodes_Scope_spectra_tree_nodes_ScopeFunctionMap_Extension_VTable* vtable;
)
