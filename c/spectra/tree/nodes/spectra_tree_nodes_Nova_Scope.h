...
typedef struct spectra_tree_nodes_Nova_ScopePropertyMap spectra_tree_nodes_Nova_ScopePropertyMap;
...
(
	...
	spectra_tree_nodes_Scope_ScopePropertyMap_Extension_VTable* vtable;
)
