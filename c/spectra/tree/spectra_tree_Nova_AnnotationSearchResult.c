...
void spectra_tree_Nova_AnnotationSearchResult_Nova_lambda27(spectra_tree_Nova_AnnotationSearchResult* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_annotations_Nova_Annotation* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
void spectra_tree_Nova_AnnotationSearchResult_Nova_lambda28(spectra_tree_Nova_AnnotationSearchResult* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_annotations_Nova_Annotation* _1, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
...
nova_datastruct_list_Nova_Array* spectra_tree_Nova_AnnotationSearchResult_0_Nova_addTo(spectra_tree_Nova_AnnotationSearchResult* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_Node* node)
{
	...
	contextArg27->spectra_tree_Nova_AnnotationSearchResult_Nova_node = &node;
...
nova_datastruct_list_Nova_Array* spectra_tree_Nova_AnnotationSearchResult_1_Nova_addTo(spectra_tree_Nova_AnnotationSearchResult* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Stack* stack)
{
	...
	contextArg28->spectra_tree_Nova_AnnotationSearchResult_Nova_stack = &stack;
	
	return (nova_datastruct_list_Nova_Array*)nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(this->spectra_tree_Nova_AnnotationSearchResult_Nova_annotations), exceptionData, (nova_datastruct_list_Nova_List_closure4_Nova_func)&spectra_tree_Nova_AnnotationSearchResult_Nova_lambda28, this, contextArg28);
}
...
void spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_init_static(nova_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap* spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_construct(spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap, this,);
	this->vtable = &spectra_tree_AnnotationSearchResult_spectra_tree_AnnotationSearchResultFunctionMap_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_meta_Nova_FunctionMap_Nova_super((nova_meta_Nova_FunctionMap*)this, exceptionData);
	spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_super(this, exceptionData);
	
	{
		spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_this(this, exceptionData);
	}
	
	return this;
}

void spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_destroy(spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap** this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (!*this)
	{
		return;
...
void spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_this(spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}

void spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap_Nova_super(spectra_tree_Nova_spectra_tree_AnnotationSearchResultFunctionMap* this, nova_exception_Nova_ExceptionData* exceptionData)
{
}
