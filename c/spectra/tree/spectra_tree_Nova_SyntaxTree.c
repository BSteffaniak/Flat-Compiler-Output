...
void spectra_tree_Nova_SyntaxTree_Nova_lambda107(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, Context1* context);
void spectra_tree_Nova_SyntaxTree_Nova_lambda108(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
char spectra_tree_Nova_SyntaxTree_Nova_lambda109(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_ClassDeclaration* _1, int _2, nova_datastruct_list_Nova_List* _3, Context3* context);
void spectra_tree_Nova_SyntaxTree_Nova_lambda110(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
char spectra_tree_Nova_SyntaxTree_Nova_lambda111(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_ClassDeclaration* _1, int _2, nova_datastruct_list_Nova_List* _3, Context5* context);
...
{
	Context1* contextArg107 = NOVA_MALLOC(sizeof(Context1));
	
	spectra_tree_Nova_SyntaxTree_Nova_processFiles(this, exceptionData, (spectra_tree_Nova_SyntaxTree_closure4_Nova_func)&spectra_tree_Nova_SyntaxTree_Nova_lambda107, this, contextArg107);
...
{
	Context2* contextArg109 = NOVA_MALLOC(sizeof(Context2));
...
{
	Context4* contextArg111 = NOVA_MALLOC(sizeof(Context4));
...
void spectra_tree_Nova_SyntaxTree_Nova_lambda108(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context)
{
	Context3* contextArg108 = NOVA_MALLOC(sizeof(Context3));
...
void spectra_tree_Nova_SyntaxTree_Nova_lambda110(spectra_tree_Nova_SyntaxTree* this, nova_exception_Nova_ExceptionData* exceptionData, spectra_tree_nodes_Nova_NovaFile* file, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context)
{
	Context5* contextArg110 = NOVA_MALLOC(sizeof(Context5));
