...
typedef struct spectra_tree_Nova_StatementIteratorPropertyMap spectra_tree_Nova_StatementIteratorPropertyMap;
...
(
	...
	spectra_tree_StatementIterator_StatementIteratorPropertyMap_Extension_VTable* vtable;
)
