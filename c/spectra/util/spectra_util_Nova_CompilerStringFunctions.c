...
char spectra_util_Nova_CompilerStringFunctions_Nova_lambda55(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* _1, Context1* context);
int spectra_util_Nova_CompilerStringFunctions_Nova_lambda56(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* str, char c, int i, int dir, Context2* context);
...
void spectra_util_Nova_CompilerStringFunctions_Nova_lambda127(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* operator, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context);
void spectra_util_Nova_CompilerStringFunctions_Nova_lambda128(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* match, int _2, nova_datastruct_list_Nova_Array* _3, Context4* context);
...
char spectra_util_Nova_CompilerStringFunctions_0_Nova_containsString(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* needles, int index)
{
	...
	return nova_datastruct_list_Nova_List_virtual0_Nova_any((nova_datastruct_list_Nova_List*)(needles), exceptionData, (nova_datastruct_list_Nova_List_closure9_Nova_anyFunc)&spectra_util_Nova_CompilerStringFunctions_Nova_lambda55, this, &contextArg55);
}
...
int spectra_util_Nova_CompilerStringFunctions_Nova_findEndingQuote(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int start, int direction)
{
	...
	direction = (int)(direction == (intptr_t)nova_null ? 1 : direction);
	return spectra_util_Nova_CompilerStringFunctions_Nova_findEndingChar(this, exceptionData, '"', start, direction, (spectra_util_Nova_CompilerStringFunctions_closure1_Nova_advance)&spectra_util_Nova_CompilerStringFunctions_Nova_lambda56, this, &contextArg56, (intptr_t)nova_null);
}
...
nova_datastruct_list_Nova_IntArray* spectra_util_Nova_CompilerStringFunctions_Nova_findOperatorIndices(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* operators, int includeEdges)
{
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(operators), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&spectra_util_Nova_CompilerStringFunctions_Nova_lambda127, this, &contextArg127);
	l2_Nova_i = (int)0;
...
nova_Nova_String* spectra_util_Nova_CompilerStringFunctions_Nova_formatIndentation(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_matches), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&spectra_util_Nova_CompilerStringFunctions_Nova_lambda128, this, &contextArg128);
...
void spectra_util_Nova_CompilerStringFunctions_Nova_lambda127(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* operator, int _2, nova_datastruct_list_Nova_Array* _3, Context3* context)
{
	...
	l1_Nova_index = (int)(0);
	while ((l1_Nova_index = spectra_util_Nova_CompilerStringFunctions_0_Nova_findStringOnTopLevel(this, exceptionData, operator, l1_Nova_index + 1, (intptr_t)nova_null, (intptr_t)nova_null)) >= 0)
	{
