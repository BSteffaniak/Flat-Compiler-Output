#ifndef FILE_spectra_engines_Nova_CodeGeneratorEngine_NOVA
#define FILE_spectra_engines_Nova_CodeGeneratorEngine_NOVA

typedef struct spectra_engines_Nova_CodeGeneratorEngine spectra_engines_Nova_CodeGeneratorEngine;
typedef struct spectra_engines_Nova_CodeGeneratorEngineFunctionMap spectra_engines_Nova_CodeGeneratorEngineFunctionMap;
...
(
	...
	spectra_engines_CodeGeneratorEngine_Extension_VTable* vtable;
...
(
	...
	spectra_engines_CodeGeneratorEngine_CodeGeneratorEngineFunctionMap_Extension_VTable* vtable;
)
