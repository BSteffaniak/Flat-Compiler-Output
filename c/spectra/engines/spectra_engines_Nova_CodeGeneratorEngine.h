...
typedef struct spectra_engines_Nova_CodeGeneratorEnginePropertyMap spectra_engines_Nova_CodeGeneratorEnginePropertyMap;
...
(
	...
	spectra_engines_CodeGeneratorEngine_CodeGeneratorEnginePropertyMap_Extension_VTable* vtable;
)
