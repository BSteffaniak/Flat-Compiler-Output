...
nova_env novaEnv = {
{
&plumbercalc_pipes_Nova_Fitting_Nova_construct,
},

{
&plumbercalc_pipes_Nova_Fraction_Nova_simplify,
&plumbercalc_pipes_Nova_Fraction_Nova_divide,
&plumbercalc_pipes_Nova_Fraction_Nova_divideEquals,
&plumbercalc_pipes_Nova_Fraction_Nova_construct,
},

{
&plumbercalc_pipes_Nova_Pipe_Nova_construct,
},

{
&plumbercalc_pipes_Nova_TeeFitting_Nova_construct,
},

{
&plumbercalc_pipes_Nova_Units_Nova_construct,
},

{
&plumbercalc_tests_Nova_AllTestsRunner_Nova_construct,
},

{
&plumbercalc_tests_Nova_FractionTests_Nova_construct,
},

{
&plumbercalc_tests_Nova_PipeTests_Nova_construct,
},

{
&plumbercalc_tests_Nova_UnitConversionTests_Nova_construct,
},
...
{
&stabilitytest_Nova_BoundedIntervalStability_Nova_construct,
},
...
{
&stabilitytest_Nova_FancyOutputStreamTests_Nova_construct,
},
...
{
&stabilitytest_Nova_IntervalStability_Nova_construct,
},
...
{
&novex_nest_Nova_Nest_Nova_toBe,
&novex_nest_Nova_Nest_Nova_toNotBe,
&novex_nest_Nova_Nest_Nova_toBeWithinToleranceOf,
&novex_nest_Nova_Nest_Nova_toThrow,
&novex_nest_Nova_Nest_Nova_toNotThrow,
},

{
&novex_nest_Nova_NestException_Nova_construct,
},

{
&novex_nest_Nova_TestCase_Nova_construct,
},

{
&novex_nest_Nova_TestResult_Nova_construct,
},
...
{
&novex_nest_Nova_TestRunnerModel_Nova_construct,
},

{
&novex_nest_Nova_TestSuite_Nova_construct,
},
...
{
&novex_nest_Nova_TestSuiteRunnerModel_Nova_construct,
},

{
&novex_nest_ui_Nova_ResultBar_Nova_construct,
},

{
&novex_nest_ui_Nova_ResultWindow_Nova_construct,
},
...
&nova_datastruct_list_Nova_List_Nova_min,
&nova_datastruct_list_Nova_List_Nova_max,
0,
...
&nova_datastruct_list_Nova_OrderedList_Nova_indexOf,
},
...
{
&nova_exception_Nova_Exception_Nova_onThrown,
...
{
&nova_exception_Nova_NullAccessException_Nova_construct,
},

{
&nova_exception_Nova_StackTrace_Nova_trace,
&nova_exception_Nova_StackTrace_0_Nova_construct,
&nova_exception_Nova_StackTrace_1_Nova_construct,
},
...
{
&nova_io_Nova_EmptyOutputStream_Nova_construct,
},

{
&nova_io_Nova_FancyOutputStream_0_Nova_writeHeader,
&nova_io_Nova_FancyOutputStream_1_Nova_writeHeader,
&nova_io_Nova_FancyOutputStream_Nova_writeSeparator,
&nova_io_Nova_FancyOutputStream_Nova_construct,
},
...
&nova_io_Nova_FileReader_Nova_readChar,
...
&nova_io_Nova_FileWriter_2_Nova_construct,
},
...
{
&nova_io_Nova_StringBuilder_Nova_construct,
},
...
{
&nova_meta_Nova_InvalidLibraryException_Nova_construct,
},

{
&nova_meta_Nova_Library_Nova_getInstance,
&nova_meta_Nova_Library_Nova_getConstructor,
&nova_meta_Nova_Library_0_Nova_getFunction,
&nova_meta_Nova_Library_1_Nova_getFunction,
&nova_meta_Nova_Library_Nova_load,
&nova_meta_Nova_Library_Nova_construct,
},
...
{
&nova_package_Nova_Package_Nova_construct,
},
...
{
&nova_primitive_number_Nova_Double_Nova_withinTolerance,
&nova_primitive_number_Nova_Double_Nova_construct,
},

{
&nova_primitive_number_Nova_Float_Nova_withinTolerance,
...
&nova_serialization_Nova_JsonSerializer_0_Nova_parse,
&nova_serialization_Nova_JsonSerializer_1_Nova_parse,
&nova_serialization_Nova_JsonSerializer_Nova_parseArray,
&nova_serialization_Nova_JsonSerializer_Nova_isObject,
&nova_serialization_Nova_JsonSerializer_Nova_isArray,
&nova_serialization_Nova_JsonSerializer_Nova_isSingleQuoteString,
&nova_serialization_Nova_JsonSerializer_Nova_isDoubleQuoteString,
&nova_serialization_Nova_JsonSerializer_Nova_isString,
&nova_serialization_Nova_JsonSerializer_0_Nova_parseObject,
&nova_serialization_Nova_JsonSerializer_1_Nova_parseObject,
&nova_serialization_Nova_JsonSerializer_Nova_construct,
},
{
&nova_serialization_Nova_InvalidParseException_Nova_construct,
},
{
&nova_serialization_Nova_MissingMatchingTokenException_Nova_construct,
},

{
&nova_serialization_Nova_SyntaxStringFunctions_Nova_containsAllWhitespaceAfter,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_getArrayAccesses,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_containsWord,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextWordIndex,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextWord,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextNonWhitespaceChar,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextNonWhitespaceIndex,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextWhitespaceIndex,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextIndexThatDoesntContain,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextIndexThatContains,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_nextLetterIndex,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_isSurroundedByQuotes,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_removeSurroundingQuotes,
&nova_serialization_Nova_SyntaxStringFunctions_0_Nova_containsString,
&nova_serialization_Nova_SyntaxStringFunctions_1_Nova_containsString,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findEndingChar,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findEndingQuote,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findEndingSingleQuote,
&nova_serialization_Nova_SyntaxStringFunctions_0_Nova_findEndingMatch,
&nova_serialization_Nova_SyntaxStringFunctions_1_Nova_findEndingMatch,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_splitAtDotOperator,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_splitValues,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_splitAtCommas,
&nova_serialization_Nova_SyntaxStringFunctions_0_Nova_findCharOnTopLevel,
&nova_serialization_Nova_SyntaxStringFunctions_1_Nova_findCharOnTopLevel,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findWordOnTopLevel,
&nova_serialization_Nova_SyntaxStringFunctions_0_Nova_findStringOnTopLevel,
&nova_serialization_Nova_SyntaxStringFunctions_1_Nova_findStringOnTopLevel,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findGroupedSymbols,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findGroupedChars,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_searchGenericType,
&nova_serialization_Nova_SyntaxStringFunctions_Nova_findDotOperatorIndex,
},

{
&nova_star_Nova_Button_Nova_construct,
},

{
&nova_star_Nova_Color_Nova_toImmutable,
&nova_star_Nova_Color_0_Nova_construct,
&nova_star_Nova_Color_1_Nova_construct,
&nova_star_Nova_Color_2_Nova_construct,
},
...
{
&nova_star_Nova_ImmutableColor_0_Nova_construct,
&nova_star_Nova_ImmutableColor_1_Nova_construct,
&nova_star_Nova_ImmutableColor_2_Nova_construct,
&nova_star_Nova_ImmutableColor_3_Nova_construct,
},
...
{
&nova_star_Nova_Screen_Nova_construct,
},

{
&nova_star_Nova_ScrollBar_Nova_construct,
},

{
&nova_star_Nova_UIAction_Nova_onAction,
&nova_star_Nova_UIAction_Nova_addActionListener,
},

{
0,
&nova_star_Nova_UIComponent_Nova_onRemoved,
0,
0,
0,
&nova_star_Nova_UIComponent_Nova_repaint,
&nova_star_Nova_UIComponent_Nova_construct,
},

{
&nova_star_Nova_UIParent_Nova_addChild,
},

{
&nova_star_Nova_Window_Nova_show,
&nova_star_Nova_Window_Nova_refreshPosition,
&nova_star_Nova_Window_Nova_center,
&nova_star_Nova_Window_Nova_repaint,
&nova_star_Nova_Window_Nova_construct,
},

{
&nova_star_Nova_WindowThread_Nova_show,
...
{
&nova_thread_Nova_ThreadLocal_Nova_get,
&nova_thread_Nova_ThreadLocal_Nova_set,
&nova_thread_Nova_ThreadLocal_Nova_remove,
&nova_thread_Nova_ThreadLocal_Nova_construct,
},
...
{
&nova_time_Nova_BoundedInterval_Nova_construct,
},

{
&nova_time_Nova_BoundlessInterval_Nova_construct,
},
...
{
&nova_time_Nova_DateTime_Nova_addMonth,
&nova_time_Nova_DateTime_Nova_addMonths,
&nova_time_Nova_DateTime_Nova_subtractMonth,
&nova_time_Nova_DateTime_Nova_subtractMonths,
&nova_time_Nova_DateTime_Nova_addYear,
&nova_time_Nova_DateTime_Nova_addYears,
&nova_time_Nova_DateTime_Nova_subtractYear,
&nova_time_Nova_DateTime_Nova_subtractYears,
&nova_time_Nova_DateTime_1_Nova_toString,
&nova_time_Nova_DateTime_0_Nova_construct,
&nova_time_Nova_DateTime_1_Nova_construct,
&nova_time_Nova_DateTime_2_Nova_construct,
&nova_time_Nova_DateTime_3_Nova_construct,
},
{
&nova_time_Nova_InvalidDateException_Nova_construct,
},
{
&nova_time_Nova_InvalidDateFormatException_Nova_construct,
},
{
&nova_time_Nova_Calculator_Nova_construct,
},

{
&nova_time_Nova_Interval_Nova_getGap,
&nova_time_Nova_Interval_Nova_construct,
},
{
&nova_time_Nova_IntervalException_Nova_construct,
},
{
&nova_time_Nova_InvalidIntervalException_Nova_construct,
},
{
&nova_time_Nova_NoGapException_Nova_construct,
},
