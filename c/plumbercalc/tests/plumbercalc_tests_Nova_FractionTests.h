#ifndef FILE_plumbercalc_tests_Nova_FractionTests_NOVA
#define FILE_plumbercalc_tests_Nova_FractionTests_NOVA

typedef struct plumbercalc_tests_Nova_FractionTests plumbercalc_tests_Nova_FractionTests;

typedef struct nova_exception_Nova_ExceptionData nova_exception_Nova_ExceptionData;
typedef struct novex_nest_Nova_TestResult novex_nest_Nova_TestResult;

typedef void (*plumbercalc_tests_Nova_FractionTests_closure507_Nova_onResult)(void*, novex_nest_Nova_TestResult*, void*);
...
CCLASS_CLASS
(
	plumbercalc_tests_Nova_FractionTests, 
	
	plumbercalc_tests_Nova_FractionTests_VTable* vtable;
	void* prv;
	nova_Nova_String* nova_Nova_Object_Nova_hashCode;
	novex_nest_Nova_TestRunnerModel* plumbercalc_tests_Nova_FractionTests_Nova_model;
)
extern novex_nest_Nova_TestCase* plumbercalc_tests_Nova_FractionTests_Nova__fractionPropertiesTestCase;
extern novex_nest_Nova_TestCase* plumbercalc_tests_Nova_FractionTests_Nova__simplifyFractionTestCase;
extern novex_nest_Nova_TestCase* plumbercalc_tests_Nova_FractionTests_Nova__addFractionTestCase;
extern novex_nest_Nova_TestCase* plumbercalc_tests_Nova_FractionTests_Nova__subtractFractionTestCase;
extern novex_nest_Nova_TestCase* plumbercalc_tests_Nova_FractionTests_Nova__multiplyFractionTestCase;
extern novex_nest_Nova_TestCase* plumbercalc_tests_Nova_FractionTests_Nova__divideFractionTestCase;
extern novex_nest_Nova_TestRunnerModel* plumbercalc_tests_Nova_FractionTests_Nova__runTestsTestRunner;

extern char plumbercalc_tests_Nova_FractionTests_Nova_init_static_inited;
